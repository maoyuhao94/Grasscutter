...
public final class GravenInnocenceCarveInfoOuterClass {
  ...
  public interface GravenInnocenceCarveInfoOrBuilder extends
    ...
    /**
     * <code>repeated uint32 hasEditConfigIdList = 12;</code>
    ...
    /**
     * <code>uint32 canEditCount = 15;</code>
     * @return The canEditCount.
     */
    int getCanEditCount();

    /**
     * <code>repeated .GravenInnocenceCarveStageInfo stageInfoList = 4;</code>
     */
    java.util.List<GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfo> 
        getStageInfoListList();
    /**
     * <code>repeated .GravenInnocenceCarveStageInfo stageInfoList = 4;</code>
     */
    GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfo getStageInfoList(int index);
    /**
     * <code>repeated .GravenInnocenceCarveStageInfo stageInfoList = 4;</code>
     */
     ...
     * <code>repeated .GravenInnocenceCarveStageInfo stageInfoList = 4;</code>
     */
    java.util.List<? extends GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfoOrBuilder> 
        getStageInfoListOrBuilderList();
    /**
     * <code>repeated .GravenInnocenceCarveStageInfo stageInfoList = 4;</code>
     */
    GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfoOrBuilder getStageInfoListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 34: {
              if (!((mutable_bitField0_ & 0x00000002) != 0)) {
                stageInfoList_ = new java.util.ArrayList<GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfo>();
                mutable_bitField0_ |= 0x00000002;
              }
              stageInfoList_.add(
                  input.readMessage(GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfo.parser(), extensionRegistry));
              break;
            }
            case 96: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return GravenInnocenceCarveInfoOuterClass.internal_static_GravenInnocenceCarveInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo.class, GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo.Builder.class);
    }
    ...
    private java.util.List<GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfo> stageInfoList_;
    /**
     * <code>repeated .GravenInnocenceCarveStageInfo stageInfoList = 4;</code>
     */
    @java.lang.Override
    public java.util.List<GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfo> getStageInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfoOrBuilder> 
        getStageInfoListOrBuilderList() {
      return stageInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfoOrBuilder getStageInfoListOrBuilder(
        int index) {
      return stageInfoList_.get(index);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (canEditCount_ != 0) {
        output.writeUInt32(15, canEditCount_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (canEditCount_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(15, canEditCount_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo)) {
        return super.equals(obj);
      }
      GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo other = (GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo) obj;
    ...
    public int hashCode() {
      ...
      if (getHasEditConfigIdListCount() > 0) {
        hash = (37 * hash) + HASEDITCONFIGIDLIST_FIELD_NUMBER;
        hash = (53 * hash) + getHasEditConfigIdListList().hashCode();
      }
      hash = (37 * hash) + CANEDITCOUNT_FIELD_NUMBER;
    ...
    public static GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo parseFrom(
    ...
    public static GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo parseFrom(
    ...
    public static GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo prototype) {
    ...
    public static final class Builder extends
        ...
        GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return GravenInnocenceCarveInfoOuterClass.internal_static_GravenInnocenceCarveInfo_descriptor;
      }
      ...
      // Construct using GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo getDefaultInstanceForType() {
        return GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo.getDefaultInstance();
      }

      @java.lang.Override
      public GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo build() {
        GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo result = buildPartial();
      ...
      @java.lang.Override
      public GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo buildPartial() {
        GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo result = new GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo) {
          return mergeFrom((GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo)other);
        } else {
      ...
      public Builder mergeFrom(GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo other) {
        if (other == GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo) e.getUnfinishedMessage();
      ...
      private void ensureStageInfoListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          stageInfoList_ = new java.util.ArrayList<GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfo>(stageInfoList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfo, GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfo.Builder, GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfoOrBuilder> stageInfoListBuilder_;
      ...
      public Builder setStageInfoList(
          int index, GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfo value) {
        if (stageInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setStageInfoList(
          int index, GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfo.Builder builderForValue) {
        if (stageInfoListBuilder_ == null) {
          ensureStageInfoListIsMutable();
       ...
       */
      public Builder addStageInfoList(
          GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfo.Builder builderForValue) {
        if (stageInfoListBuilder_ == null) {
          ensureStageInfoListIsMutable();
      ...
      public Builder addAllStageInfoList(
          java.lang.Iterable<? extends GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfo> values) {
        if (stageInfoListBuilder_ == null) {
          ensureStageInfoListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .GravenInnocenceCarveStageInfo stageInfoList = 4;</code>
       */
      public GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfo.Builder getStageInfoListBuilder(
          int index) {
      ...
      public GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfo.Builder addStageInfoListBuilder() {
        return getStageInfoListFieldBuilder().addBuilder(
            GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .GravenInnocenceCarveStageInfo stageInfoList = 4;</code>
       */
      public GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfo.Builder addStageInfoListBuilder(
          int index) {
        return getStageInfoListFieldBuilder().addBuilder(
            index, GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .GravenInnocenceCarveStageInfo stageInfoList = 4;</code>
       */
      public java.util.List<GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfo.Builder> 
           getStageInfoListBuilderList() {
        return getStageInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfo, GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfo.Builder, GravenInnocenceCarveStageInfoOuterClass.GravenInnocenceCarveStageInfoOrBuilder> 
          getStageInfoListFieldBuilder() {
        if (stageInfoListBuilder_ == null) {
    ...
    private static final GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo();
    }

    public static GravenInnocenceCarveInfoOuterClass.GravenInnocenceCarveInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "InnocenceCarveStageInfo.proto\"\204\001\n\030Graven" +
      "InnocenceCarveInfo\022\033\n\023hasEditConfigIdLis" +
      "t\030\014 \003(\r\022\024\n\014canEditCount\030\017 \001(\r\0225\n\rstageIn" +
      "foList\030\004 \003(\0132\036.GravenInnocenceCarveStage" +
      "Infob\006proto3"
    };
