...
public final class EchoShellInfoOuterClass {
  ...
  public interface EchoShellInfoOrBuilder extends
     ...
     */
    java.util.List<SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo> 
        getSummerTimeDungeonListList();
    /**
     * <code>repeated .SummerTimeDungeonInfo summerTimeDungeonList = 13;</code>
     */
    SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo getSummerTimeDungeonList(int index);
    /**
     * <code>repeated .SummerTimeDungeonInfo summerTimeDungeonList = 13;</code>
     */
     ...
     * <code>repeated .SummerTimeDungeonInfo summerTimeDungeonList = 13;</code>
     */
    java.util.List<? extends SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfoOrBuilder> 
        getSummerTimeDungeonListOrBuilderList();
    /**
     * <code>repeated .SummerTimeDungeonInfo summerTimeDungeonList = 13;</code>
     */
    SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfoOrBuilder getSummerTimeDungeonListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 106: {
              if (!((mutable_bitField0_ & 0x00000008) != 0)) {
                summerTimeDungeonList_ = new java.util.ArrayList<SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo>();
                mutable_bitField0_ |= 0x00000008;
              }
              summerTimeDungeonList_.add(
                  input.readMessage(SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.parser(), extensionRegistry));
              break;
            }
            case 112: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return EchoShellInfoOuterClass.internal_static_EchoShellInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              EchoShellInfoOuterClass.EchoShellInfo.class, EchoShellInfoOuterClass.EchoShellInfo.Builder.class);
    }
    ...
    private java.util.List<SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo> summerTimeDungeonList_;
    /**
     * <code>repeated .SummerTimeDungeonInfo summerTimeDungeonList = 13;</code>
     */
    @java.lang.Override
    public java.util.List<SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo> getSummerTimeDungeonListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfoOrBuilder> 
        getSummerTimeDungeonListOrBuilderList() {
      return summerTimeDungeonList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfoOrBuilder getSummerTimeDungeonListOrBuilder(
        int index) {
      return summerTimeDungeonList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof EchoShellInfoOuterClass.EchoShellInfo)) {
        return super.equals(obj);
      }
      EchoShellInfoOuterClass.EchoShellInfo other = (EchoShellInfoOuterClass.EchoShellInfo) obj;
    ...
    public static EchoShellInfoOuterClass.EchoShellInfo parseFrom(
    ...
    public static EchoShellInfoOuterClass.EchoShellInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static EchoShellInfoOuterClass.EchoShellInfo parseFrom(
    ...
    public static EchoShellInfoOuterClass.EchoShellInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static EchoShellInfoOuterClass.EchoShellInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static EchoShellInfoOuterClass.EchoShellInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(EchoShellInfoOuterClass.EchoShellInfo prototype) {
    ...
    public static final class Builder extends
        ...
        EchoShellInfoOuterClass.EchoShellInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return EchoShellInfoOuterClass.internal_static_EchoShellInfo_descriptor;
      }
      ...
      // Construct using EchoShellInfoOuterClass.EchoShellInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public EchoShellInfoOuterClass.EchoShellInfo getDefaultInstanceForType() {
        return EchoShellInfoOuterClass.EchoShellInfo.getDefaultInstance();
      }

      @java.lang.Override
      public EchoShellInfoOuterClass.EchoShellInfo build() {
        EchoShellInfoOuterClass.EchoShellInfo result = buildPartial();
      ...
      @java.lang.Override
      public EchoShellInfoOuterClass.EchoShellInfo buildPartial() {
        EchoShellInfoOuterClass.EchoShellInfo result = new EchoShellInfoOuterClass.EchoShellInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof EchoShellInfoOuterClass.EchoShellInfo) {
          return mergeFrom((EchoShellInfoOuterClass.EchoShellInfo)other);
        } else {
      ...
      public Builder mergeFrom(EchoShellInfoOuterClass.EchoShellInfo other) {
        if (other == EchoShellInfoOuterClass.EchoShellInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        EchoShellInfoOuterClass.EchoShellInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (EchoShellInfoOuterClass.EchoShellInfo) e.getUnfinishedMessage();
      ...
      private void ensureSummerTimeDungeonListIsMutable() {
        if (!((bitField0_ & 0x00000008) != 0)) {
          summerTimeDungeonList_ = new java.util.ArrayList<SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo>(summerTimeDungeonList_);
          bitField0_ |= 0x00000008;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo, SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.Builder, SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfoOrBuilder> summerTimeDungeonListBuilder_;
      ...
      public Builder setSummerTimeDungeonList(
          int index, SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo value) {
        if (summerTimeDungeonListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setSummerTimeDungeonList(
          int index, SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.Builder builderForValue) {
        if (summerTimeDungeonListBuilder_ == null) {
          ensureSummerTimeDungeonListIsMutable();
       ...
       */
      public Builder addSummerTimeDungeonList(
          SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.Builder builderForValue) {
        if (summerTimeDungeonListBuilder_ == null) {
          ensureSummerTimeDungeonListIsMutable();
      ...
      public Builder addAllSummerTimeDungeonList(
          java.lang.Iterable<? extends SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo> values) {
        if (summerTimeDungeonListBuilder_ == null) {
          ensureSummerTimeDungeonListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .SummerTimeDungeonInfo summerTimeDungeonList = 13;</code>
       */
      public SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.Builder getSummerTimeDungeonListBuilder(
          int index) {
      ...
      public SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.Builder addSummerTimeDungeonListBuilder() {
        return getSummerTimeDungeonListFieldBuilder().addBuilder(
            SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SummerTimeDungeonInfo summerTimeDungeonList = 13;</code>
       */
      public SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.Builder addSummerTimeDungeonListBuilder(
          int index) {
        return getSummerTimeDungeonListFieldBuilder().addBuilder(
            index, SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SummerTimeDungeonInfo summerTimeDungeonList = 13;</code>
       */
      public java.util.List<SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.Builder> 
           getSummerTimeDungeonListBuilderList() {
        return getSummerTimeDungeonListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo, SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.Builder, SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfoOrBuilder> 
          getSummerTimeDungeonListFieldBuilder() {
        if (summerTimeDungeonListBuilder_ == null) {
    ...
    private static final EchoShellInfoOuterClass.EchoShellInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new EchoShellInfoOuterClass.EchoShellInfo();
    }

    public static EchoShellInfoOuterClass.EchoShellInfo getDefaultInstance() {
