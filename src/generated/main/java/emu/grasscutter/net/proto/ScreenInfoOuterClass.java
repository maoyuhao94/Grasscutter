...
public final class ScreenInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return ScreenInfoOuterClass.internal_static_ScreenInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ScreenInfoOuterClass.ScreenInfo.class, ScreenInfoOuterClass.ScreenInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof ScreenInfoOuterClass.ScreenInfo)) {
        return super.equals(obj);
      }
      ScreenInfoOuterClass.ScreenInfo other = (ScreenInfoOuterClass.ScreenInfo) obj;
    ...
    public static ScreenInfoOuterClass.ScreenInfo parseFrom(
    ...
    public static ScreenInfoOuterClass.ScreenInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ScreenInfoOuterClass.ScreenInfo parseFrom(
    ...
    public static ScreenInfoOuterClass.ScreenInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ScreenInfoOuterClass.ScreenInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static ScreenInfoOuterClass.ScreenInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(ScreenInfoOuterClass.ScreenInfo prototype) {
    ...
    public static final class Builder extends
        ...
        ScreenInfoOuterClass.ScreenInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ScreenInfoOuterClass.internal_static_ScreenInfo_descriptor;
      }
      ...
      // Construct using ScreenInfoOuterClass.ScreenInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public ScreenInfoOuterClass.ScreenInfo getDefaultInstanceForType() {
        return ScreenInfoOuterClass.ScreenInfo.getDefaultInstance();
      }

      @java.lang.Override
      public ScreenInfoOuterClass.ScreenInfo build() {
        ScreenInfoOuterClass.ScreenInfo result = buildPartial();
      ...
      @java.lang.Override
      public ScreenInfoOuterClass.ScreenInfo buildPartial() {
        ScreenInfoOuterClass.ScreenInfo result = new ScreenInfoOuterClass.ScreenInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ScreenInfoOuterClass.ScreenInfo) {
          return mergeFrom((ScreenInfoOuterClass.ScreenInfo)other);
        } else {
      ...
      public Builder mergeFrom(ScreenInfoOuterClass.ScreenInfo other) {
        if (other == ScreenInfoOuterClass.ScreenInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ScreenInfoOuterClass.ScreenInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ScreenInfoOuterClass.ScreenInfo) e.getUnfinishedMessage();
    ...
    private static final ScreenInfoOuterClass.ScreenInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ScreenInfoOuterClass.ScreenInfo();
    }

    public static ScreenInfoOuterClass.ScreenInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "Id\030\001 \001(\r\022\031\n\021projectorEntityId\030\002 \001(\rb\006pro" +
      "to3"
    };
