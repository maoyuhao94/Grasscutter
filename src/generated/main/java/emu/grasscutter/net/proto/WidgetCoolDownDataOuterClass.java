...
public final class WidgetCoolDownDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return WidgetCoolDownDataOuterClass.internal_static_WidgetCoolDownData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              WidgetCoolDownDataOuterClass.WidgetCoolDownData.class, WidgetCoolDownDataOuterClass.WidgetCoolDownData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof WidgetCoolDownDataOuterClass.WidgetCoolDownData)) {
        return super.equals(obj);
      }
      WidgetCoolDownDataOuterClass.WidgetCoolDownData other = (WidgetCoolDownDataOuterClass.WidgetCoolDownData) obj;
    ...
    public static WidgetCoolDownDataOuterClass.WidgetCoolDownData parseFrom(
    ...
    public static WidgetCoolDownDataOuterClass.WidgetCoolDownData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static WidgetCoolDownDataOuterClass.WidgetCoolDownData parseFrom(
    ...
    public static WidgetCoolDownDataOuterClass.WidgetCoolDownData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static WidgetCoolDownDataOuterClass.WidgetCoolDownData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static WidgetCoolDownDataOuterClass.WidgetCoolDownData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(WidgetCoolDownDataOuterClass.WidgetCoolDownData prototype) {
    ...
    public static final class Builder extends
        ...
        WidgetCoolDownDataOuterClass.WidgetCoolDownDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return WidgetCoolDownDataOuterClass.internal_static_WidgetCoolDownData_descriptor;
      }
      ...
      // Construct using WidgetCoolDownDataOuterClass.WidgetCoolDownData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public WidgetCoolDownDataOuterClass.WidgetCoolDownData getDefaultInstanceForType() {
        return WidgetCoolDownDataOuterClass.WidgetCoolDownData.getDefaultInstance();
      }

      @java.lang.Override
      public WidgetCoolDownDataOuterClass.WidgetCoolDownData build() {
        WidgetCoolDownDataOuterClass.WidgetCoolDownData result = buildPartial();
      ...
      @java.lang.Override
      public WidgetCoolDownDataOuterClass.WidgetCoolDownData buildPartial() {
        WidgetCoolDownDataOuterClass.WidgetCoolDownData result = new WidgetCoolDownDataOuterClass.WidgetCoolDownData(this);
        result.id_ = id_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof WidgetCoolDownDataOuterClass.WidgetCoolDownData) {
          return mergeFrom((WidgetCoolDownDataOuterClass.WidgetCoolDownData)other);
        } else {
      ...
      public Builder mergeFrom(WidgetCoolDownDataOuterClass.WidgetCoolDownData other) {
        if (other == WidgetCoolDownDataOuterClass.WidgetCoolDownData.getDefaultInstance()) return this;
        if (other.getId() != 0) {
          setId(other.getId());
        }
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        WidgetCoolDownDataOuterClass.WidgetCoolDownData parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (WidgetCoolDownDataOuterClass.WidgetCoolDownData) e.getUnfinishedMessage();
    ...
    private static final WidgetCoolDownDataOuterClass.WidgetCoolDownData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new WidgetCoolDownDataOuterClass.WidgetCoolDownData();
    }

    public static WidgetCoolDownDataOuterClass.WidgetCoolDownData getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "(\004\022\021\n\tisSuccess\030\014 \001(\010b\006proto3"
    };
