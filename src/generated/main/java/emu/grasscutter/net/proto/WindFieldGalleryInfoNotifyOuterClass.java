...
public final class WindFieldGalleryInfoNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return WindFieldGalleryInfoNotifyOuterClass.internal_static_WindFieldGalleryInfoNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return WindFieldGalleryInfoNotifyOuterClass.internal_static_WindFieldGalleryInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify.class, WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify.Builder.class);
    }

    /**
     * Protobuf enum {@code WindFieldGalleryInfoNotify.JOCNCDOAALP}
     */
    public enum JOCNCDOAALP
       ...
       */
      public static final JOCNCDOAALP DCDNILFDFLB = NONE;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 5573;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 5573;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static JOCNCDOAALP valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static JOCNCDOAALP forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 5573: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<JOCNCDOAALP>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          JOCNCDOAALP> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<JOCNCDOAALP>() {
              public JOCNCDOAALP findValueByNumber(int number) {
                return JOCNCDOAALP.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify.getDescriptor().getEnumTypes().get(0);
      }

      private static final JOCNCDOAALP[] VALUES = getStaticValuesArray();
      private static JOCNCDOAALP[] getStaticValuesArray() {
        return new JOCNCDOAALP[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, 
        };
      }
      public static JOCNCDOAALP valueOf(
      ...
      private JOCNCDOAALP(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:WindFieldGalleryInfoNotify.JOCNCDOAALP)
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify)) {
        return super.equals(obj);
      }
      WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify other = (WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify) obj;
    ...
    public static WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify parseFrom(
    ...
    public static WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify parseFrom(
    ...
    public static WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return WindFieldGalleryInfoNotifyOuterClass.internal_static_WindFieldGalleryInfoNotify_descriptor;
      }
      ...
      // Construct using WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify getDefaultInstanceForType() {
        return WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify build() {
        WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify result = buildPartial();
      ...
      @java.lang.Override
      public WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify buildPartial() {
        WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify result = new WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify) {
          return mergeFrom((WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify other) {
        if (other == WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify) e.getUnfinishedMessage();
    ...
    private static final WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify();
    }

    public static WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n WindFieldGalleryInfoNotify.proto\"\325\002\n\032W" +
      ...
      "GNKCFHMDOHJ\030\003 \001(\r\"O\n\013JOCNCDOAALP\022\010\n\004NONE" +
