...
public final class WorldPlayerInfoNotifyOuterClass {
  ...
  public interface WorldPlayerInfoNotifyOrBuilder extends
     ...
     */
    java.util.List<OnlinePlayerInfoOuterClass.OnlinePlayerInfo> 
        getPlayerInfoListList();
    /**
     * <code>repeated .OnlinePlayerInfo playerInfoList = 12;</code>
     */
    OnlinePlayerInfoOuterClass.OnlinePlayerInfo getPlayerInfoList(int index);
    /**
     * <code>repeated .OnlinePlayerInfo playerInfoList = 12;</code>
     */
     ...
     * <code>repeated .OnlinePlayerInfo playerInfoList = 12;</code>
     */
    java.util.List<? extends OnlinePlayerInfoOuterClass.OnlinePlayerInfoOrBuilder> 
        getPlayerInfoListOrBuilderList();
    /**
     * <code>repeated .OnlinePlayerInfo playerInfoList = 12;</code>
     */
    OnlinePlayerInfoOuterClass.OnlinePlayerInfoOrBuilder getPlayerInfoListOrBuilder(
        int index);

    /**
     * <code>repeated .PlayerWidgetInfo playerWidgetInfoList = 1;</code>
     */
    java.util.List<PlayerWidgetInfoOuterClass.PlayerWidgetInfo> 
        getPlayerWidgetInfoListList();
    /**
     * <code>repeated .PlayerWidgetInfo playerWidgetInfoList = 1;</code>
     */
    PlayerWidgetInfoOuterClass.PlayerWidgetInfo getPlayerWidgetInfoList(int index);
    /**
     * <code>repeated .PlayerWidgetInfo playerWidgetInfoList = 1;</code>
     */
     ...
     * <code>repeated .PlayerWidgetInfo playerWidgetInfoList = 1;</code>
     */
    java.util.List<? extends PlayerWidgetInfoOuterClass.PlayerWidgetInfoOrBuilder> 
        getPlayerWidgetInfoListOrBuilderList();
    /**
     * <code>repeated .PlayerWidgetInfo playerWidgetInfoList = 1;</code>
     */
    PlayerWidgetInfoOuterClass.PlayerWidgetInfoOrBuilder getPlayerWidgetInfoListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000004) != 0)) {
                playerWidgetInfoList_ = new java.util.ArrayList<PlayerWidgetInfoOuterClass.PlayerWidgetInfo>();
                mutable_bitField0_ |= 0x00000004;
              }
              playerWidgetInfoList_.add(
                  input.readMessage(PlayerWidgetInfoOuterClass.PlayerWidgetInfo.parser(), extensionRegistry));
              break;
            }
            case 80: {
            ...
            case 98: {
              if (!((mutable_bitField0_ & 0x00000002) != 0)) {
                playerInfoList_ = new java.util.ArrayList<OnlinePlayerInfoOuterClass.OnlinePlayerInfo>();
                mutable_bitField0_ |= 0x00000002;
              }
              playerInfoList_.add(
                  input.readMessage(OnlinePlayerInfoOuterClass.OnlinePlayerInfo.parser(), extensionRegistry));
              break;
            }
            default: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return WorldPlayerInfoNotifyOuterClass.internal_static_WorldPlayerInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify.class, WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify.Builder.class);
    }
    ...
    public enum LACJFKEDHAN
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify.getDescriptor().getEnumTypes().get(0);
      }
    ...
    private java.util.List<OnlinePlayerInfoOuterClass.OnlinePlayerInfo> playerInfoList_;
    /**
     * <code>repeated .OnlinePlayerInfo playerInfoList = 12;</code>
     */
    @java.lang.Override
    public java.util.List<OnlinePlayerInfoOuterClass.OnlinePlayerInfo> getPlayerInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends OnlinePlayerInfoOuterClass.OnlinePlayerInfoOrBuilder> 
        getPlayerInfoListOrBuilderList() {
      return playerInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public OnlinePlayerInfoOuterClass.OnlinePlayerInfoOrBuilder getPlayerInfoListOrBuilder(
        int index) {
      return playerInfoList_.get(index);
    }

    public static final int PLAYERWIDGETINFOLIST_FIELD_NUMBER = 1;
    private java.util.List<PlayerWidgetInfoOuterClass.PlayerWidgetInfo> playerWidgetInfoList_;
    /**
     * <code>repeated .PlayerWidgetInfo playerWidgetInfoList = 1;</code>
     */
    @java.lang.Override
    public java.util.List<PlayerWidgetInfoOuterClass.PlayerWidgetInfo> getPlayerWidgetInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends PlayerWidgetInfoOuterClass.PlayerWidgetInfoOrBuilder> 
        getPlayerWidgetInfoListOrBuilderList() {
      return playerWidgetInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public PlayerWidgetInfoOuterClass.PlayerWidgetInfoOrBuilder getPlayerWidgetInfoListOrBuilder(
        int index) {
      return playerWidgetInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify)) {
        return super.equals(obj);
      }
      WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify other = (WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify) obj;
    ...
    public static WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify parseFrom(
    ...
    public static WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify parseFrom(
    ...
    public static WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return WorldPlayerInfoNotifyOuterClass.internal_static_WorldPlayerInfoNotify_descriptor;
      }
      ...
      // Construct using WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify getDefaultInstanceForType() {
        return WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify build() {
        WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify result = buildPartial();
      ...
      @java.lang.Override
      public WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify buildPartial() {
        WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify result = new WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify) {
          return mergeFrom((WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify other) {
        if (other == WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify) e.getUnfinishedMessage();
      ...
      private void ensurePlayerInfoListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          playerInfoList_ = new java.util.ArrayList<OnlinePlayerInfoOuterClass.OnlinePlayerInfo>(playerInfoList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          OnlinePlayerInfoOuterClass.OnlinePlayerInfo, OnlinePlayerInfoOuterClass.OnlinePlayerInfo.Builder, OnlinePlayerInfoOuterClass.OnlinePlayerInfoOrBuilder> playerInfoListBuilder_;
      ...
      public Builder setPlayerInfoList(
          int index, OnlinePlayerInfoOuterClass.OnlinePlayerInfo value) {
        if (playerInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setPlayerInfoList(
          int index, OnlinePlayerInfoOuterClass.OnlinePlayerInfo.Builder builderForValue) {
        if (playerInfoListBuilder_ == null) {
          ensurePlayerInfoListIsMutable();
      ...
      public Builder addAllPlayerInfoList(
          java.lang.Iterable<? extends OnlinePlayerInfoOuterClass.OnlinePlayerInfo> values) {
        if (playerInfoListBuilder_ == null) {
          ensurePlayerInfoListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .OnlinePlayerInfo playerInfoList = 12;</code>
       */
      public OnlinePlayerInfoOuterClass.OnlinePlayerInfo.Builder getPlayerInfoListBuilder(
          int index) {
      ...
      public OnlinePlayerInfoOuterClass.OnlinePlayerInfo.Builder addPlayerInfoListBuilder() {
        return getPlayerInfoListFieldBuilder().addBuilder(
            OnlinePlayerInfoOuterClass.OnlinePlayerInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .OnlinePlayerInfo playerInfoList = 12;</code>
       */
      public OnlinePlayerInfoOuterClass.OnlinePlayerInfo.Builder addPlayerInfoListBuilder(
          int index) {
        return getPlayerInfoListFieldBuilder().addBuilder(
            index, OnlinePlayerInfoOuterClass.OnlinePlayerInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .OnlinePlayerInfo playerInfoList = 12;</code>
       */
      public java.util.List<OnlinePlayerInfoOuterClass.OnlinePlayerInfo.Builder> 
      ...
      private void ensurePlayerWidgetInfoListIsMutable() {
        if (!((bitField0_ & 0x00000004) != 0)) {
          playerWidgetInfoList_ = new java.util.ArrayList<PlayerWidgetInfoOuterClass.PlayerWidgetInfo>(playerWidgetInfoList_);
          bitField0_ |= 0x00000004;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          PlayerWidgetInfoOuterClass.PlayerWidgetInfo, PlayerWidgetInfoOuterClass.PlayerWidgetInfo.Builder, PlayerWidgetInfoOuterClass.PlayerWidgetInfoOrBuilder> playerWidgetInfoListBuilder_;
      ...
      public Builder setPlayerWidgetInfoList(
          int index, PlayerWidgetInfoOuterClass.PlayerWidgetInfo value) {
        if (playerWidgetInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setPlayerWidgetInfoList(
          int index, PlayerWidgetInfoOuterClass.PlayerWidgetInfo.Builder builderForValue) {
        if (playerWidgetInfoListBuilder_ == null) {
          ensurePlayerWidgetInfoListIsMutable();
       ...
       */
      public Builder addPlayerWidgetInfoList(
          PlayerWidgetInfoOuterClass.PlayerWidgetInfo.Builder builderForValue) {
        if (playerWidgetInfoListBuilder_ == null) {
          ensurePlayerWidgetInfoListIsMutable();
      ...
      public Builder addAllPlayerWidgetInfoList(
          java.lang.Iterable<? extends PlayerWidgetInfoOuterClass.PlayerWidgetInfo> values) {
        if (playerWidgetInfoListBuilder_ == null) {
          ensurePlayerWidgetInfoListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .PlayerWidgetInfo playerWidgetInfoList = 1;</code>
       */
      public PlayerWidgetInfoOuterClass.PlayerWidgetInfo.Builder getPlayerWidgetInfoListBuilder(
          int index) {
      ...
      public PlayerWidgetInfoOuterClass.PlayerWidgetInfo.Builder addPlayerWidgetInfoListBuilder() {
        return getPlayerWidgetInfoListFieldBuilder().addBuilder(
            PlayerWidgetInfoOuterClass.PlayerWidgetInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .PlayerWidgetInfo playerWidgetInfoList = 1;</code>
       */
      public PlayerWidgetInfoOuterClass.PlayerWidgetInfo.Builder addPlayerWidgetInfoListBuilder(
          int index) {
        return getPlayerWidgetInfoListFieldBuilder().addBuilder(
            index, PlayerWidgetInfoOuterClass.PlayerWidgetInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .PlayerWidgetInfo playerWidgetInfoList = 1;</code>
       */
      public java.util.List<PlayerWidgetInfoOuterClass.PlayerWidgetInfo.Builder> 
           getPlayerWidgetInfoListBuilderList() {
        return getPlayerWidgetInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          PlayerWidgetInfoOuterClass.PlayerWidgetInfo, PlayerWidgetInfoOuterClass.PlayerWidgetInfo.Builder, PlayerWidgetInfoOuterClass.PlayerWidgetInfoOrBuilder> 
          getPlayerWidgetInfoListFieldBuilder() {
        if (playerWidgetInfoListBuilder_ == null) {
    ...
    private static final WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify();
    }

    public static WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify getDefaultInstance() {
