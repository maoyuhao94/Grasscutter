...
public final class CanUseSkillNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return CanUseSkillNotifyOuterClass.internal_static_CanUseSkillNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              CanUseSkillNotifyOuterClass.CanUseSkillNotify.class, CanUseSkillNotifyOuterClass.CanUseSkillNotify.Builder.class);
    }
    ...
    public enum BKAHAJDKDCC
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return CanUseSkillNotifyOuterClass.CanUseSkillNotify.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof CanUseSkillNotifyOuterClass.CanUseSkillNotify)) {
        return super.equals(obj);
      }
      CanUseSkillNotifyOuterClass.CanUseSkillNotify other = (CanUseSkillNotifyOuterClass.CanUseSkillNotify) obj;
    ...
    public static CanUseSkillNotifyOuterClass.CanUseSkillNotify parseFrom(
    ...
    public static CanUseSkillNotifyOuterClass.CanUseSkillNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static CanUseSkillNotifyOuterClass.CanUseSkillNotify parseFrom(
    ...
    public static CanUseSkillNotifyOuterClass.CanUseSkillNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static CanUseSkillNotifyOuterClass.CanUseSkillNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static CanUseSkillNotifyOuterClass.CanUseSkillNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(CanUseSkillNotifyOuterClass.CanUseSkillNotify prototype) {
    ...
    public static final class Builder extends
        ...
        CanUseSkillNotifyOuterClass.CanUseSkillNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return CanUseSkillNotifyOuterClass.internal_static_CanUseSkillNotify_descriptor;
      }
      ...
      // Construct using CanUseSkillNotifyOuterClass.CanUseSkillNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public CanUseSkillNotifyOuterClass.CanUseSkillNotify getDefaultInstanceForType() {
        return CanUseSkillNotifyOuterClass.CanUseSkillNotify.getDefaultInstance();
      }

      @java.lang.Override
      public CanUseSkillNotifyOuterClass.CanUseSkillNotify build() {
        CanUseSkillNotifyOuterClass.CanUseSkillNotify result = buildPartial();
      ...
      @java.lang.Override
      public CanUseSkillNotifyOuterClass.CanUseSkillNotify buildPartial() {
        CanUseSkillNotifyOuterClass.CanUseSkillNotify result = new CanUseSkillNotifyOuterClass.CanUseSkillNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof CanUseSkillNotifyOuterClass.CanUseSkillNotify) {
          return mergeFrom((CanUseSkillNotifyOuterClass.CanUseSkillNotify)other);
        } else {
      ...
      public Builder mergeFrom(CanUseSkillNotifyOuterClass.CanUseSkillNotify other) {
        if (other == CanUseSkillNotifyOuterClass.CanUseSkillNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        CanUseSkillNotifyOuterClass.CanUseSkillNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (CanUseSkillNotifyOuterClass.CanUseSkillNotify) e.getUnfinishedMessage();
    ...
    private static final CanUseSkillNotifyOuterClass.CanUseSkillNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new CanUseSkillNotifyOuterClass.CanUseSkillNotify();
    }

    public static CanUseSkillNotifyOuterClass.CanUseSkillNotify getDefaultInstance() {
