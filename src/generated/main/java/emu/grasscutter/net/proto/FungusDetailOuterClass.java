...
public final class FungusDetailOuterClass {
  ...
  public interface FungusDetailOrBuilder extends
    ...
    /**
     * <code>bool isCultivate = 12;</code>
     * @return The isCultivate.
     */
    boolean getIsCultivate();

    /**
     * <code>uint32 Unk3300_GCLBPDJDEDN = 14;</code>
     * @return The unk3300GCLBPDJDEDN.
     */
    int getUnk3300GCLBPDJDEDN();

    /**
     * <code>uint32 Unk3300_EHNBDJPANKL = 3;</code>
     * @return The unk3300EHNBDJPANKL.
     */
    int getUnk3300EHNBDJPANKL();

    /**
     * <code>uint32 fungusId = 6;</code>
     * @return The fungusId.
     */
    int getFungusId();

    /**
     * <code>uint32 nameId = 4;</code>
     * @return The nameId.
     */
    int getNameId();
  }
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return FungusDetailOuterClass.internal_static_FungusDetail_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              FungusDetailOuterClass.FungusDetail.class, FungusDetailOuterClass.FungusDetail.Builder.class);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3300EHNBDJPANKL_ != 0) {
        output.writeUInt32(3, unk3300EHNBDJPANKL_);
      }
      if (nameId_ != 0) {
        output.writeUInt32(4, nameId_);
      }
      if (fungusId_ != 0) {
        output.writeUInt32(6, fungusId_);
      }
      if (isCultivate_ != false) {
        output.writeBool(12, isCultivate_);
      }
      if (unk3300GCLBPDJDEDN_ != 0) {
        output.writeUInt32(14, unk3300GCLBPDJDEDN_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3300EHNBDJPANKL_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(3, unk3300EHNBDJPANKL_);
      }
      if (nameId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(4, nameId_);
      }
      if (fungusId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (isCultivate_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(12, isCultivate_);
      }
      if (unk3300GCLBPDJDEDN_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(14, unk3300GCLBPDJDEDN_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof FungusDetailOuterClass.FungusDetail)) {
        return super.equals(obj);
      }
      FungusDetailOuterClass.FungusDetail other = (FungusDetailOuterClass.FungusDetail) obj;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + ISCULTIVATE_FIELD_NUMBER;
    ...
    public static FungusDetailOuterClass.FungusDetail parseFrom(
    ...
    public static FungusDetailOuterClass.FungusDetail parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static FungusDetailOuterClass.FungusDetail parseFrom(
    ...
    public static FungusDetailOuterClass.FungusDetail parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static FungusDetailOuterClass.FungusDetail parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static FungusDetailOuterClass.FungusDetail parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(FungusDetailOuterClass.FungusDetail prototype) {
    ...
    public static final class Builder extends
        ...
        FungusDetailOuterClass.FungusDetailOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return FungusDetailOuterClass.internal_static_FungusDetail_descriptor;
      }
      ...
      // Construct using FungusDetailOuterClass.FungusDetail.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public FungusDetailOuterClass.FungusDetail getDefaultInstanceForType() {
        return FungusDetailOuterClass.FungusDetail.getDefaultInstance();
      }

      @java.lang.Override
      public FungusDetailOuterClass.FungusDetail build() {
        FungusDetailOuterClass.FungusDetail result = buildPartial();
      ...
      @java.lang.Override
      public FungusDetailOuterClass.FungusDetail buildPartial() {
        FungusDetailOuterClass.FungusDetail result = new FungusDetailOuterClass.FungusDetail(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof FungusDetailOuterClass.FungusDetail) {
          return mergeFrom((FungusDetailOuterClass.FungusDetail)other);
        } else {
      ...
      public Builder mergeFrom(FungusDetailOuterClass.FungusDetail other) {
        if (other == FungusDetailOuterClass.FungusDetail.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        FungusDetailOuterClass.FungusDetail parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (FungusDetailOuterClass.FungusDetail) e.getUnfinishedMessage();
    ...
    private static final FungusDetailOuterClass.FungusDetail DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new FungusDetailOuterClass.FungusDetail();
    }

    public static FungusDetailOuterClass.FungusDetail getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\022FungusDetail.proto\"\177\n\014FungusDetail\022\023\n\013" +
      "isCultivate\030\014 \001(\010\022\033\n\023Unk3300_GCLBPDJDEDN" +
      "\030\016 \001(\r\022\033\n\023Unk3300_EHNBDJPANKL\030\003 \001(\r\022\020\n\010f" +
      "ungusId\030\006 \001(\r\022\016\n\006nameId\030\004 \001(\rb\006proto3"
    };
    ...
    internal_static_FungusDetail_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_FungusDetail_descriptor,
        new java.lang.String[] { "IsCultivate", "Unk3300GCLBPDJDEDN", "Unk3300EHNBDJPANKL", "FungusId", "NameId", });
  }
