...
public final class CreateVehicleReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return CreateVehicleReqOuterClass.internal_static_CreateVehicleReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              CreateVehicleReqOuterClass.CreateVehicleReq.class, CreateVehicleReqOuterClass.CreateVehicleReq.Builder.class);
    }
    ...
    public enum JAAHLAPFNJN
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return CreateVehicleReqOuterClass.CreateVehicleReq.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof CreateVehicleReqOuterClass.CreateVehicleReq)) {
        return super.equals(obj);
      }
      CreateVehicleReqOuterClass.CreateVehicleReq other = (CreateVehicleReqOuterClass.CreateVehicleReq) obj;
    ...
    public static CreateVehicleReqOuterClass.CreateVehicleReq parseFrom(
    ...
    public static CreateVehicleReqOuterClass.CreateVehicleReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static CreateVehicleReqOuterClass.CreateVehicleReq parseFrom(
    ...
    public static CreateVehicleReqOuterClass.CreateVehicleReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static CreateVehicleReqOuterClass.CreateVehicleReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static CreateVehicleReqOuterClass.CreateVehicleReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(CreateVehicleReqOuterClass.CreateVehicleReq prototype) {
    ...
    public static final class Builder extends
        ...
        CreateVehicleReqOuterClass.CreateVehicleReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return CreateVehicleReqOuterClass.internal_static_CreateVehicleReq_descriptor;
      }
      ...
      // Construct using CreateVehicleReqOuterClass.CreateVehicleReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public CreateVehicleReqOuterClass.CreateVehicleReq getDefaultInstanceForType() {
        return CreateVehicleReqOuterClass.CreateVehicleReq.getDefaultInstance();
      }

      @java.lang.Override
      public CreateVehicleReqOuterClass.CreateVehicleReq build() {
        CreateVehicleReqOuterClass.CreateVehicleReq result = buildPartial();
      ...
      @java.lang.Override
      public CreateVehicleReqOuterClass.CreateVehicleReq buildPartial() {
        CreateVehicleReqOuterClass.CreateVehicleReq result = new CreateVehicleReqOuterClass.CreateVehicleReq(this);
        if (posBuilder_ == null) {
          result.pos_ = pos_;
        } else {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof CreateVehicleReqOuterClass.CreateVehicleReq) {
          return mergeFrom((CreateVehicleReqOuterClass.CreateVehicleReq)other);
        } else {
      ...
      public Builder mergeFrom(CreateVehicleReqOuterClass.CreateVehicleReq other) {
        if (other == CreateVehicleReqOuterClass.CreateVehicleReq.getDefaultInstance()) return this;
        if (other.hasPos()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        CreateVehicleReqOuterClass.CreateVehicleReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (CreateVehicleReqOuterClass.CreateVehicleReq) e.getUnfinishedMessage();
    ...
    private static final CreateVehicleReqOuterClass.CreateVehicleReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new CreateVehicleReqOuterClass.CreateVehicleReq();
    }

    public static CreateVehicleReqOuterClass.CreateVehicleReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\026CreateVehicleReq.proto\032\016Rotation.proto" +
      "\"\315\001\n\020CreateVehicleReq\022\026\n\003pos\030\002 \001(\0132\t.Rot" +
      "ation\022\026\n\003rot\030\n \001(\0132\t.Rotation\022\021\n\tvehicle" +
