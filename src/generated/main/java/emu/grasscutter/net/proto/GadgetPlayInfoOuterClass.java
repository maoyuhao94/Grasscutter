...
public final class GadgetPlayInfoOuterClass {
  ...
  public interface GadgetPlayInfoOrBuilder extends
    ...
    /**
     * <code>repeated uint32 progressStageList = 3;</code>
    ...
    /**
     * <code>.CrucibleInfo crucible_info = 21;</code>
    ...
    public GadgetPlayInfoOuterClass.GadgetPlayInfo.IAFCHJBAJFACase getIAFCHJBAJFACase();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 170: {
              ...
              if (iAFCHJBAJFACase_ == 21) {
                subBuilder = ((CrucibleInfoOuterClass.CrucibleInfo) iAFCHJBAJFA_).toBuilder();
              }
              iAFCHJBAJFA_ =
                  input.readMessage(CrucibleInfoOuterClass.CrucibleInfo.parser(), extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom((CrucibleInfoOuterClass.CrucibleInfo) iAFCHJBAJFA_);
                iAFCHJBAJFA_ = subBuilder.buildPartial();
              }
              iAFCHJBAJFACase_ = 21;
              break;
            }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return GadgetPlayInfoOuterClass.internal_static_GadgetPlayInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              GadgetPlayInfoOuterClass.GadgetPlayInfo.class, GadgetPlayInfoOuterClass.GadgetPlayInfo.Builder.class);
    }

    private int iAFCHJBAJFACase_ = 0;
    private java.lang.Object iAFCHJBAJFA_;
    public enum IAFCHJBAJFACase
        implements com.google.protobuf.Internal.EnumLite,
            com.google.protobuf.AbstractMessage.InternalOneOfEnum {
      CRUCIBLE_INFO(21),
      IAFCHJBAJFA_NOT_SET(0);
      private final int value;
      private IAFCHJBAJFACase(int value) {
        this.value = value;
      }
      /**
      ...
      public static IAFCHJBAJFACase valueOf(int value) {
        return forNumber(value);
      }

      public static IAFCHJBAJFACase forNumber(int value) {
        switch (value) {
          case 21: return CRUCIBLE_INFO;
          case 0: return IAFCHJBAJFA_NOT_SET;
          default: return null;
        }
      }
    ...
    public IAFCHJBAJFACase
    getIAFCHJBAJFACase() {
      return IAFCHJBAJFACase.forNumber(
          iAFCHJBAJFACase_);
    }
    ...
    public CrucibleInfoOuterClass.CrucibleInfo getCrucibleInfo() {
      if (iAFCHJBAJFACase_ == 21) {
         return (CrucibleInfoOuterClass.CrucibleInfo) iAFCHJBAJFA_;
      }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (iAFCHJBAJFACase_ == 21) {
        output.writeMessage(21, (CrucibleInfoOuterClass.CrucibleInfo) iAFCHJBAJFA_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (iAFCHJBAJFACase_ == 21) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(21, (CrucibleInfoOuterClass.CrucibleInfo) iAFCHJBAJFA_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof GadgetPlayInfoOuterClass.GadgetPlayInfo)) {
        return super.equals(obj);
      }
      GadgetPlayInfoOuterClass.GadgetPlayInfo other = (GadgetPlayInfoOuterClass.GadgetPlayInfo) obj;
      ...
      if (!getIAFCHJBAJFACase().equals(other.getIAFCHJBAJFACase())) return false;
      switch (iAFCHJBAJFACase_) {
        case 21:
          if (!getCrucibleInfo()
    ...
    public int hashCode() {
      ...
      if (getProgressStageListCount() > 0) {
        hash = (37 * hash) + PROGRESSSTAGELIST_FIELD_NUMBER;
        hash = (53 * hash) + getProgressStageListList().hashCode();
      }
      hash = (37 * hash) + STARTCD_FIELD_NUMBER;
    ...
    public static GadgetPlayInfoOuterClass.GadgetPlayInfo parseFrom(
    ...
    public static GadgetPlayInfoOuterClass.GadgetPlayInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static GadgetPlayInfoOuterClass.GadgetPlayInfo parseFrom(
    ...
    public static GadgetPlayInfoOuterClass.GadgetPlayInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static GadgetPlayInfoOuterClass.GadgetPlayInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static GadgetPlayInfoOuterClass.GadgetPlayInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(GadgetPlayInfoOuterClass.GadgetPlayInfo prototype) {
    ...
    public static final class Builder extends
        ...
        GadgetPlayInfoOuterClass.GadgetPlayInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return GadgetPlayInfoOuterClass.internal_static_GadgetPlayInfo_descriptor;
      }
      ...
      // Construct using GadgetPlayInfoOuterClass.GadgetPlayInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public GadgetPlayInfoOuterClass.GadgetPlayInfo getDefaultInstanceForType() {
        return GadgetPlayInfoOuterClass.GadgetPlayInfo.getDefaultInstance();
      }

      @java.lang.Override
      public GadgetPlayInfoOuterClass.GadgetPlayInfo build() {
        GadgetPlayInfoOuterClass.GadgetPlayInfo result = buildPartial();
      ...
      @java.lang.Override
      public GadgetPlayInfoOuterClass.GadgetPlayInfo buildPartial() {
        GadgetPlayInfoOuterClass.GadgetPlayInfo result = new GadgetPlayInfoOuterClass.GadgetPlayInfo(this);
        ...
        if (iAFCHJBAJFACase_ == 21) {
          if (crucibleInfoBuilder_ == null) {
            result.iAFCHJBAJFA_ = iAFCHJBAJFA_;
          } else {
            result.iAFCHJBAJFA_ = crucibleInfoBuilder_.build();
          }
        }
        result.iAFCHJBAJFACase_ = iAFCHJBAJFACase_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof GadgetPlayInfoOuterClass.GadgetPlayInfo) {
          return mergeFrom((GadgetPlayInfoOuterClass.GadgetPlayInfo)other);
        } else {
      ...
      public Builder mergeFrom(GadgetPlayInfoOuterClass.GadgetPlayInfo other) {
        if (other == GadgetPlayInfoOuterClass.GadgetPlayInfo.getDefaultInstance()) return this;
        ...
        switch (other.getIAFCHJBAJFACase()) {
          case CRUCIBLE_INFO: {
            mergeCrucibleInfo(other.getCrucibleInfo());
            break;
          }
          case IAFCHJBAJFA_NOT_SET: {
            break;
          }
        }
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        GadgetPlayInfoOuterClass.GadgetPlayInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (GadgetPlayInfoOuterClass.GadgetPlayInfo) e.getUnfinishedMessage();
      ...
      public Builder clearIAFCHJBAJFA() {
        iAFCHJBAJFACase_ = 0;
        iAFCHJBAJFA_ = null;
        onChanged();
        return this;
      ...
      public Builder setCrucibleInfo(
        ...
        if (crucibleInfoBuilder_ == null) {
          iAFCHJBAJFA_ = builderForValue.build();
          onChanged();
        } else {
      ...
      public Builder mergeCrucibleInfo(CrucibleInfoOuterClass.CrucibleInfo value) {
        if (crucibleInfoBuilder_ == null) {
          if (iAFCHJBAJFACase_ == 21 &&
              iAFCHJBAJFA_ != CrucibleInfoOuterClass.CrucibleInfo.getDefaultInstance()) {
            iAFCHJBAJFA_ = CrucibleInfoOuterClass.CrucibleInfo.newBuilder((CrucibleInfoOuterClass.CrucibleInfo) iAFCHJBAJFA_)
      ...
      @java.lang.Override
      public CrucibleInfoOuterClass.CrucibleInfoOrBuilder getCrucibleInfoOrBuilder() {
        if ((iAFCHJBAJFACase_ == 21) && (crucibleInfoBuilder_ != null)) {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
        ...
        if (crucibleInfoBuilder_ == null) {
          ...
          crucibleInfoBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              CrucibleInfoOuterClass.CrucibleInfo, CrucibleInfoOuterClass.CrucibleInfo.Builder, CrucibleInfoOuterClass.CrucibleInfoOrBuilder>(
                  (CrucibleInfoOuterClass.CrucibleInfo) iAFCHJBAJFA_,
    ...
    private static final GadgetPlayInfoOuterClass.GadgetPlayInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new GadgetPlayInfoOuterClass.GadgetPlayInfo();
    }

    public static GadgetPlayInfoOuterClass.GadgetPlayInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\024GadgetPlayInfo.proto\032\022CrucibleInfo.pro" +
      "to\"\274\001\n\016GadgetPlayInfo\022\020\n\010playType\030\001 \001(\r\022" +
      "\020\n\010duration\030\002 \001(\r\022\031\n\021progressStageList\030\003" +
      " \003(\r\022\017\n\007startCd\030\004 \001(\r\022\021\n\tstartTime\030\005 \001(\r" +
      "\022\020\n\010progress\030\006 \001(\r\022&\n\rcrucible_info\030\025 \001(" +
      "\0132\r.CrucibleInfoH\000B\r\n\013IAFCHJBAJFAb\006proto" +
      "3"
    };
    ...
    internal_static_GadgetPlayInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_GadgetPlayInfo_descriptor,
        new java.lang.String[] { "PlayType", "Duration", "ProgressStageList", "StartCd", "StartTime", "Progress", "CrucibleInfo", "IAFCHJBAJFA", });
    CrucibleInfoOuterClass.getDescriptor();
  }
