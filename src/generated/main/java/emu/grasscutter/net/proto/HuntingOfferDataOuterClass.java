...
public final class HuntingOfferDataOuterClass {
  ...
  public interface HuntingOfferDataOrBuilder extends
     ...
     * @return The state.
     */
    HuntingOfferStateOuterClass.HuntingOfferState getState();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return HuntingOfferDataOuterClass.internal_static_HuntingOfferData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return HuntingOfferDataOuterClass.internal_static_HuntingOfferData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              HuntingOfferDataOuterClass.HuntingOfferData.class, HuntingOfferDataOuterClass.HuntingOfferData.Builder.class);
    }
     ...
     * @return The state.
     */
    @java.lang.Override public HuntingOfferStateOuterClass.HuntingOfferState getState() {
      @SuppressWarnings("deprecation")
      HuntingOfferStateOuterClass.HuntingOfferState result = HuntingOfferStateOuterClass.HuntingOfferState.valueOf(state_);
      return result == null ? HuntingOfferStateOuterClass.HuntingOfferState.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (state_ != HuntingOfferStateOuterClass.HuntingOfferState.HUNTING_OFFER_STATE_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof HuntingOfferDataOuterClass.HuntingOfferData)) {
        return super.equals(obj);
      }
      HuntingOfferDataOuterClass.HuntingOfferData other = (HuntingOfferDataOuterClass.HuntingOfferData) obj;
    ...
    public static HuntingOfferDataOuterClass.HuntingOfferData parseFrom(
    ...
    public static HuntingOfferDataOuterClass.HuntingOfferData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static HuntingOfferDataOuterClass.HuntingOfferData parseFrom(
    ...
    public static HuntingOfferDataOuterClass.HuntingOfferData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static HuntingOfferDataOuterClass.HuntingOfferData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static HuntingOfferDataOuterClass.HuntingOfferData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(HuntingOfferDataOuterClass.HuntingOfferData prototype) {
    ...
    public static final class Builder extends
        ...
        HuntingOfferDataOuterClass.HuntingOfferDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return HuntingOfferDataOuterClass.internal_static_HuntingOfferData_descriptor;
      }
      ...
      // Construct using HuntingOfferDataOuterClass.HuntingOfferData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public HuntingOfferDataOuterClass.HuntingOfferData getDefaultInstanceForType() {
        return HuntingOfferDataOuterClass.HuntingOfferData.getDefaultInstance();
      }

      @java.lang.Override
      public HuntingOfferDataOuterClass.HuntingOfferData build() {
        HuntingOfferDataOuterClass.HuntingOfferData result = buildPartial();
      ...
      @java.lang.Override
      public HuntingOfferDataOuterClass.HuntingOfferData buildPartial() {
        HuntingOfferDataOuterClass.HuntingOfferData result = new HuntingOfferDataOuterClass.HuntingOfferData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof HuntingOfferDataOuterClass.HuntingOfferData) {
          return mergeFrom((HuntingOfferDataOuterClass.HuntingOfferData)other);
        } else {
      ...
      public Builder mergeFrom(HuntingOfferDataOuterClass.HuntingOfferData other) {
        if (other == HuntingOfferDataOuterClass.HuntingOfferData.getDefaultInstance()) return this;
        if (other.state_ != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        HuntingOfferDataOuterClass.HuntingOfferData parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (HuntingOfferDataOuterClass.HuntingOfferData) e.getUnfinishedMessage();
       ...
       */
      @java.lang.Override
      public HuntingOfferStateOuterClass.HuntingOfferState getState() {
        @SuppressWarnings("deprecation")
        HuntingOfferStateOuterClass.HuntingOfferState result = HuntingOfferStateOuterClass.HuntingOfferState.valueOf(state_);
        return result == null ? HuntingOfferStateOuterClass.HuntingOfferState.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setState(HuntingOfferStateOuterClass.HuntingOfferState value) {
        if (value == null) {
    ...
    private static final HuntingOfferDataOuterClass.HuntingOfferData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new HuntingOfferDataOuterClass.HuntingOfferData();
    }

    public static HuntingOfferDataOuterClass.HuntingOfferData getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ate.proto\032\021HuntingPair.proto\"h\n\020HuntingO" +
      "fferData\022!\n\005state\030\013 \001(\0162\022.HuntingOfferSt" +
      "ate\022\016\n\006cityId\030\010 \001(\r\022!\n\013huntingPair\030\r \001(\013" +
      "2\014.HuntingPairb\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          HuntingOfferStateOuterClass.getDescriptor(),
    ...
    internal_static_HuntingOfferData_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_HuntingOfferData_descriptor,
        new java.lang.String[] { "State", "CityId", "HuntingPair", });
    HuntingOfferStateOuterClass.getDescriptor();
    HuntingPairOuterClass.getDescriptor();
  }
