...
public final class WidgetGadgetDataNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 82: {
              ...
              widgetGadgetData_ = input.readMessage(WidgetGadgetDataOuterClass.WidgetGadgetData.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return WidgetGadgetDataNotifyOuterClass.internal_static_WidgetGadgetDataNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify.class, WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify.Builder.class);
    }
    ...
    public enum PKEFBEFMGGI
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public WidgetGadgetDataOuterClass.WidgetGadgetData getWidgetGadgetData() {
      return widgetGadgetData_ == null ? WidgetGadgetDataOuterClass.WidgetGadgetData.getDefaultInstance() : widgetGadgetData_;
    }
    /**
     * <code>.WidgetGadgetData widgetGadgetData = 10;</code>
     */
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify)) {
        return super.equals(obj);
      }
      WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify other = (WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify) obj;
    ...
    public static WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify parseFrom(
    ...
    public static WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify parseFrom(
    ...
    public static WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify prototype) {
    ...
    public static final class Builder extends
        ...
        WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return WidgetGadgetDataNotifyOuterClass.internal_static_WidgetGadgetDataNotify_descriptor;
      }
      ...
      // Construct using WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify getDefaultInstanceForType() {
        return WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify.getDefaultInstance();
      }

      @java.lang.Override
      public WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify build() {
        WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify result = buildPartial();
      ...
      @java.lang.Override
      public WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify buildPartial() {
        WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify result = new WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify(this);
        if (widgetGadgetDataBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify) {
          return mergeFrom((WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify)other);
        } else {
      ...
      public Builder mergeFrom(WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify other) {
        if (other == WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify) e.getUnfinishedMessage();
      ...
      public Builder mergeWidgetGadgetData(WidgetGadgetDataOuterClass.WidgetGadgetData value) {
        if (widgetGadgetDataBuilder_ == null) {
          if (widgetGadgetData_ != null) {
            widgetGadgetData_ =
              WidgetGadgetDataOuterClass.WidgetGadgetData.newBuilder(widgetGadgetData_).mergeFrom(value).buildPartial();
          } else {
            widgetGadgetData_ = value;
          }
          onChanged();
      ...
      public WidgetGadgetDataOuterClass.WidgetGadgetDataOrBuilder getWidgetGadgetDataOrBuilder() {
        if (widgetGadgetDataBuilder_ != null) {
          ...
          return widgetGadgetData_ == null ?
              WidgetGadgetDataOuterClass.WidgetGadgetData.getDefaultInstance() : widgetGadgetData_;
        }
      }
      /**
       * <code>.WidgetGadgetData widgetGadgetData = 10;</code>
    ...
    private static final WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify();
    }

    public static WidgetGadgetDataNotifyOuterClass.WidgetGadgetDataNotify getDefaultInstance() {
