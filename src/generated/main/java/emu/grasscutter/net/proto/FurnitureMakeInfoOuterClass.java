...
public final class FurnitureMakeInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return FurnitureMakeInfoOuterClass.internal_static_FurnitureMakeInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              FurnitureMakeInfoOuterClass.FurnitureMakeInfo.class, FurnitureMakeInfoOuterClass.FurnitureMakeInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof FurnitureMakeInfoOuterClass.FurnitureMakeInfo)) {
        return super.equals(obj);
      }
      FurnitureMakeInfoOuterClass.FurnitureMakeInfo other = (FurnitureMakeInfoOuterClass.FurnitureMakeInfo) obj;
    ...
    public static FurnitureMakeInfoOuterClass.FurnitureMakeInfo parseFrom(
    ...
    public static FurnitureMakeInfoOuterClass.FurnitureMakeInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static FurnitureMakeInfoOuterClass.FurnitureMakeInfo parseFrom(
    ...
    public static FurnitureMakeInfoOuterClass.FurnitureMakeInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static FurnitureMakeInfoOuterClass.FurnitureMakeInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static FurnitureMakeInfoOuterClass.FurnitureMakeInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(FurnitureMakeInfoOuterClass.FurnitureMakeInfo prototype) {
    ...
    public static final class Builder extends
        ...
        FurnitureMakeInfoOuterClass.FurnitureMakeInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return FurnitureMakeInfoOuterClass.internal_static_FurnitureMakeInfo_descriptor;
      }
      ...
      // Construct using FurnitureMakeInfoOuterClass.FurnitureMakeInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public FurnitureMakeInfoOuterClass.FurnitureMakeInfo getDefaultInstanceForType() {
        return FurnitureMakeInfoOuterClass.FurnitureMakeInfo.getDefaultInstance();
      }

      @java.lang.Override
      public FurnitureMakeInfoOuterClass.FurnitureMakeInfo build() {
        FurnitureMakeInfoOuterClass.FurnitureMakeInfo result = buildPartial();
      ...
      @java.lang.Override
      public FurnitureMakeInfoOuterClass.FurnitureMakeInfo buildPartial() {
        FurnitureMakeInfoOuterClass.FurnitureMakeInfo result = new FurnitureMakeInfoOuterClass.FurnitureMakeInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof FurnitureMakeInfoOuterClass.FurnitureMakeInfo) {
          return mergeFrom((FurnitureMakeInfoOuterClass.FurnitureMakeInfo)other);
        } else {
      ...
      public Builder mergeFrom(FurnitureMakeInfoOuterClass.FurnitureMakeInfo other) {
        if (other == FurnitureMakeInfoOuterClass.FurnitureMakeInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        FurnitureMakeInfoOuterClass.FurnitureMakeInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (FurnitureMakeInfoOuterClass.FurnitureMakeInfo) e.getUnfinishedMessage();
    ...
    private static final FurnitureMakeInfoOuterClass.FurnitureMakeInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new FurnitureMakeInfoOuterClass.FurnitureMakeInfo();
    }

    public static FurnitureMakeInfoOuterClass.FurnitureMakeInfo getDefaultInstance() {
