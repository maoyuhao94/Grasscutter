...
public final class TowerCurLevelRecordOuterClass {
  ...
  public interface TowerCurLevelRecordOrBuilder extends
    ...
    /**
     * <code>repeated .TowerTeam towerTeamList = 13;</code>
     */
    java.util.List<TowerTeamOuterClass.TowerTeam> 
        getTowerTeamListList();
    /**
     * <code>repeated .TowerTeam towerTeamList = 13;</code>
     */
    TowerTeamOuterClass.TowerTeam getTowerTeamList(int index);
    /**
     * <code>repeated .TowerTeam towerTeamList = 13;</code>
     */
     ...
     * <code>repeated .TowerTeam towerTeamList = 13;</code>
     */
    java.util.List<? extends TowerTeamOuterClass.TowerTeamOrBuilder> 
        getTowerTeamListOrBuilderList();
    /**
     * <code>repeated .TowerTeam towerTeamList = 13;</code>
     */
    TowerTeamOuterClass.TowerTeamOrBuilder getTowerTeamListOrBuilder(
        int index);

    /**
     * <code>uint32 curLevelIndex = 14;</code>
     * @return The curLevelIndex.
     */
    int getCurLevelIndex();

    /**
     * <code>repeated uint32 buffIdList = 12;</code>
    ...
    /**
     * <code>bool isUpperPart = 1;</code>
     * @return The isUpperPart.
     */
    boolean getIsUpperPart();

    /**
     * <code>bool isEmpty = 7;</code>
     * @return The isEmpty.
     */
    boolean getIsEmpty();

    /**
     * <code>uint32 curFloorId = 9;</code>
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 106: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                towerTeamList_ = new java.util.ArrayList<TowerTeamOuterClass.TowerTeam>();
                mutable_bitField0_ |= 0x00000001;
              }
              towerTeamList_.add(
                  input.readMessage(TowerTeamOuterClass.TowerTeam.parser(), extensionRegistry));
              break;
            }
            case 112: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return TowerCurLevelRecordOuterClass.internal_static_TowerCurLevelRecord_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              TowerCurLevelRecordOuterClass.TowerCurLevelRecord.class, TowerCurLevelRecordOuterClass.TowerCurLevelRecord.Builder.class);
    }

    public static final int TOWERTEAMLIST_FIELD_NUMBER = 13;
    private java.util.List<TowerTeamOuterClass.TowerTeam> towerTeamList_;
    /**
     * <code>repeated .TowerTeam towerTeamList = 13;</code>
     */
    @java.lang.Override
    public java.util.List<TowerTeamOuterClass.TowerTeam> getTowerTeamListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends TowerTeamOuterClass.TowerTeamOrBuilder> 
        getTowerTeamListOrBuilderList() {
      return towerTeamList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public TowerTeamOuterClass.TowerTeamOrBuilder getTowerTeamListOrBuilder(
        int index) {
      return towerTeamList_.get(index);
    }

    public static final int CURLEVELINDEX_FIELD_NUMBER = 14;
    ...
    public static final int BUFFIDLIST_FIELD_NUMBER = 12;
    ...
    public static final int ISUPPERPART_FIELD_NUMBER = 1;
    ...
    public static final int CURFLOORID_FIELD_NUMBER = 9;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (isUpperPart_ != false) {
        output.writeBool(1, isUpperPart_);
      }
      if (isEmpty_ != false) {
        output.writeBool(7, isEmpty_);
      }
      if (curFloorId_ != 0) {
      ...
      for (int i = 0; i < towerTeamList_.size(); i++) {
        output.writeMessage(13, towerTeamList_.get(i));
      }
      if (curLevelIndex_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (isUpperPart_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(1, isUpperPart_);
      }
      if (isEmpty_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(7, isEmpty_);
      }
      if (curFloorId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      for (int i = 0; i < towerTeamList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(13, towerTeamList_.get(i));
      }
      if (curLevelIndex_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof TowerCurLevelRecordOuterClass.TowerCurLevelRecord)) {
        return super.equals(obj);
      }
      TowerCurLevelRecordOuterClass.TowerCurLevelRecord other = (TowerCurLevelRecordOuterClass.TowerCurLevelRecord) obj;
    ...
    public static TowerCurLevelRecordOuterClass.TowerCurLevelRecord parseFrom(
    ...
    public static TowerCurLevelRecordOuterClass.TowerCurLevelRecord parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static TowerCurLevelRecordOuterClass.TowerCurLevelRecord parseFrom(
    ...
    public static TowerCurLevelRecordOuterClass.TowerCurLevelRecord parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static TowerCurLevelRecordOuterClass.TowerCurLevelRecord parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static TowerCurLevelRecordOuterClass.TowerCurLevelRecord parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(TowerCurLevelRecordOuterClass.TowerCurLevelRecord prototype) {
    ...
    public static final class Builder extends
        ...
        TowerCurLevelRecordOuterClass.TowerCurLevelRecordOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return TowerCurLevelRecordOuterClass.internal_static_TowerCurLevelRecord_descriptor;
      }
      ...
      // Construct using TowerCurLevelRecordOuterClass.TowerCurLevelRecord.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public TowerCurLevelRecordOuterClass.TowerCurLevelRecord getDefaultInstanceForType() {
        return TowerCurLevelRecordOuterClass.TowerCurLevelRecord.getDefaultInstance();
      }

      @java.lang.Override
      public TowerCurLevelRecordOuterClass.TowerCurLevelRecord build() {
        TowerCurLevelRecordOuterClass.TowerCurLevelRecord result = buildPartial();
      ...
      @java.lang.Override
      public TowerCurLevelRecordOuterClass.TowerCurLevelRecord buildPartial() {
        TowerCurLevelRecordOuterClass.TowerCurLevelRecord result = new TowerCurLevelRecordOuterClass.TowerCurLevelRecord(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof TowerCurLevelRecordOuterClass.TowerCurLevelRecord) {
          return mergeFrom((TowerCurLevelRecordOuterClass.TowerCurLevelRecord)other);
        } else {
      ...
      public Builder mergeFrom(TowerCurLevelRecordOuterClass.TowerCurLevelRecord other) {
        if (other == TowerCurLevelRecordOuterClass.TowerCurLevelRecord.getDefaultInstance()) return this;
        if (towerTeamListBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        TowerCurLevelRecordOuterClass.TowerCurLevelRecord parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (TowerCurLevelRecordOuterClass.TowerCurLevelRecord) e.getUnfinishedMessage();
      ...
      private void ensureTowerTeamListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          towerTeamList_ = new java.util.ArrayList<TowerTeamOuterClass.TowerTeam>(towerTeamList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          TowerTeamOuterClass.TowerTeam, TowerTeamOuterClass.TowerTeam.Builder, TowerTeamOuterClass.TowerTeamOrBuilder> towerTeamListBuilder_;
      ...
      public Builder setTowerTeamList(
          int index, TowerTeamOuterClass.TowerTeam value) {
        if (towerTeamListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setTowerTeamList(
          int index, TowerTeamOuterClass.TowerTeam.Builder builderForValue) {
        if (towerTeamListBuilder_ == null) {
          ensureTowerTeamListIsMutable();
       ...
       */
      public Builder addTowerTeamList(
          TowerTeamOuterClass.TowerTeam.Builder builderForValue) {
        if (towerTeamListBuilder_ == null) {
          ensureTowerTeamListIsMutable();
      ...
      public Builder addAllTowerTeamList(
          java.lang.Iterable<? extends TowerTeamOuterClass.TowerTeam> values) {
        if (towerTeamListBuilder_ == null) {
          ensureTowerTeamListIsMutable();
       ...
       * <code>repeated .TowerTeam towerTeamList = 13;</code>
       */
      public TowerTeamOuterClass.TowerTeam.Builder getTowerTeamListBuilder(
          int index) {
      ...
      public TowerTeamOuterClass.TowerTeam.Builder addTowerTeamListBuilder() {
        return getTowerTeamListFieldBuilder().addBuilder(
            TowerTeamOuterClass.TowerTeam.getDefaultInstance());
      }
      /**
       * <code>repeated .TowerTeam towerTeamList = 13;</code>
       */
      public TowerTeamOuterClass.TowerTeam.Builder addTowerTeamListBuilder(
          int index) {
        return getTowerTeamListFieldBuilder().addBuilder(
            index, TowerTeamOuterClass.TowerTeam.getDefaultInstance());
      }
      /**
       * <code>repeated .TowerTeam towerTeamList = 13;</code>
       */
      public java.util.List<TowerTeamOuterClass.TowerTeam.Builder> 
           getTowerTeamListBuilderList() {
        return getTowerTeamListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          TowerTeamOuterClass.TowerTeam, TowerTeamOuterClass.TowerTeam.Builder, TowerTeamOuterClass.TowerTeamOrBuilder> 
          getTowerTeamListFieldBuilder() {
        if (towerTeamListBuilder_ == null) {
    ...
    private static final TowerCurLevelRecordOuterClass.TowerCurLevelRecord DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new TowerCurLevelRecordOuterClass.TowerCurLevelRecord();
    }

    public static TowerCurLevelRecordOuterClass.TowerCurLevelRecord getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "mList\030\r \003(\0132\n.TowerTeam\022\025\n\rcurLevelIndex" +
      "\030\016 \001(\r\022\022\n\nbuffIdList\030\014 \003(\r\022\023\n\013isUpperPar" +
      "t\030\001 \001(\010\022\017\n\007isEmpty\030\007 \001(\010\022\022\n\ncurFloorId\030\t" +
      " \001(\rb\006proto3"
    };
    ...
    internal_static_TowerCurLevelRecord_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_TowerCurLevelRecord_descriptor,
        new java.lang.String[] { "TowerTeamList", "CurLevelIndex", "BuffIdList", "IsUpperPart", "IsEmpty", "CurFloorId", });
    TowerTeamOuterClass.getDescriptor();
  }
