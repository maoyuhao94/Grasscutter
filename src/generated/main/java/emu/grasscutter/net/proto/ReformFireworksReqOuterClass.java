...
public final class ReformFireworksReqOuterClass {
  ...
  public interface ReformFireworksReqOrBuilder extends
     ...
     */
    FireworksReformDataOuterClass.FireworksReformData getFireworksReformData();
    /**
     * <code>.FireworksReformData fireworksReformData = 8;</code>
     */
    FireworksReformDataOuterClass.FireworksReformDataOrBuilder getFireworksReformDataOrBuilder();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 66: {
              FireworksReformDataOuterClass.FireworksReformData.Builder subBuilder = null;
              if (fireworksReformData_ != null) {
                subBuilder = fireworksReformData_.toBuilder();
              }
              fireworksReformData_ = input.readMessage(FireworksReformDataOuterClass.FireworksReformData.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return ReformFireworksReqOuterClass.internal_static_ReformFireworksReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return ReformFireworksReqOuterClass.internal_static_ReformFireworksReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ReformFireworksReqOuterClass.ReformFireworksReq.class, ReformFireworksReqOuterClass.ReformFireworksReq.Builder.class);
    }
    ...
    public enum KPLMIHEDFMI
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return ReformFireworksReqOuterClass.ReformFireworksReq.getDescriptor().getEnumTypes().get(0);
      }
    ...
    private FireworksReformDataOuterClass.FireworksReformData fireworksReformData_;
    /**
     * <code>.FireworksReformData fireworksReformData = 8;</code>
     * @return Whether the fireworksReformData field is set.
     */
     ...
     */
    @java.lang.Override
    public FireworksReformDataOuterClass.FireworksReformData getFireworksReformData() {
      return fireworksReformData_ == null ? FireworksReformDataOuterClass.FireworksReformData.getDefaultInstance() : fireworksReformData_;
    }
    /**
     * <code>.FireworksReformData fireworksReformData = 8;</code>
     */
    @java.lang.Override
    public FireworksReformDataOuterClass.FireworksReformDataOrBuilder getFireworksReformDataOrBuilder() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof ReformFireworksReqOuterClass.ReformFireworksReq)) {
        return super.equals(obj);
      }
      ReformFireworksReqOuterClass.ReformFireworksReq other = (ReformFireworksReqOuterClass.ReformFireworksReq) obj;
    ...
    public static ReformFireworksReqOuterClass.ReformFireworksReq parseFrom(
    ...
    public static ReformFireworksReqOuterClass.ReformFireworksReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ReformFireworksReqOuterClass.ReformFireworksReq parseFrom(
    ...
    public static ReformFireworksReqOuterClass.ReformFireworksReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ReformFireworksReqOuterClass.ReformFireworksReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static ReformFireworksReqOuterClass.ReformFireworksReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(ReformFireworksReqOuterClass.ReformFireworksReq prototype) {
    ...
    public static final class Builder extends
        ...
        ReformFireworksReqOuterClass.ReformFireworksReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ReformFireworksReqOuterClass.internal_static_ReformFireworksReq_descriptor;
      }
      ...
      // Construct using ReformFireworksReqOuterClass.ReformFireworksReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public ReformFireworksReqOuterClass.ReformFireworksReq getDefaultInstanceForType() {
        return ReformFireworksReqOuterClass.ReformFireworksReq.getDefaultInstance();
      }

      @java.lang.Override
      public ReformFireworksReqOuterClass.ReformFireworksReq build() {
        ReformFireworksReqOuterClass.ReformFireworksReq result = buildPartial();
      ...
      @java.lang.Override
      public ReformFireworksReqOuterClass.ReformFireworksReq buildPartial() {
        ReformFireworksReqOuterClass.ReformFireworksReq result = new ReformFireworksReqOuterClass.ReformFireworksReq(this);
        if (fireworksReformDataBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ReformFireworksReqOuterClass.ReformFireworksReq) {
          return mergeFrom((ReformFireworksReqOuterClass.ReformFireworksReq)other);
        } else {
      ...
      public Builder mergeFrom(ReformFireworksReqOuterClass.ReformFireworksReq other) {
        if (other == ReformFireworksReqOuterClass.ReformFireworksReq.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ReformFireworksReqOuterClass.ReformFireworksReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ReformFireworksReqOuterClass.ReformFireworksReq) e.getUnfinishedMessage();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          FireworksReformDataOuterClass.FireworksReformData, FireworksReformDataOuterClass.FireworksReformData.Builder, FireworksReformDataOuterClass.FireworksReformDataOrBuilder> fireworksReformDataBuilder_;
      /**
       * <code>.FireworksReformData fireworksReformData = 8;</code>
       * @return Whether the fireworksReformData field is set.
       */
       ...
       * <code>.FireworksReformData fireworksReformData = 8;</code>
       */
      public Builder setFireworksReformData(FireworksReformDataOuterClass.FireworksReformData value) {
        if (fireworksReformDataBuilder_ == null) {
          if (value == null) {
       ...
       * <code>.FireworksReformData fireworksReformData = 8;</code>
       */
      public Builder mergeFireworksReformData(FireworksReformDataOuterClass.FireworksReformData value) {
        if (fireworksReformDataBuilder_ == null) {
          if (fireworksReformData_ != null) {
            fireworksReformData_ =
              FireworksReformDataOuterClass.FireworksReformData.newBuilder(fireworksReformData_).mergeFrom(value).buildPartial();
          } else {
            fireworksReformData_ = value;
          }
          onChanged();
       ...
       * <code>.FireworksReformData fireworksReformData = 8;</code>
       */
      public FireworksReformDataOuterClass.FireworksReformData.Builder getFireworksReformDataBuilder() {
      ...
      public FireworksReformDataOuterClass.FireworksReformDataOrBuilder getFireworksReformDataOrBuilder() {
        if (fireworksReformDataBuilder_ != null) {
          ...
          return fireworksReformData_ == null ?
              FireworksReformDataOuterClass.FireworksReformData.getDefaultInstance() : fireworksReformData_;
        }
      }
      /**
       * <code>.FireworksReformData fireworksReformData = 8;</code>
    ...
    private static final ReformFireworksReqOuterClass.ReformFireworksReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ReformFireworksReqOuterClass.ReformFireworksReq();
    }

    public static ReformFireworksReqOuterClass.ReformFireworksReq getDefaultInstance() {
