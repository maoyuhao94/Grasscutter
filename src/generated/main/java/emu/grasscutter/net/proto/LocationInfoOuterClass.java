...
public final class LocationInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return LocationInfoOuterClass.internal_static_LocationInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              LocationInfoOuterClass.LocationInfo.class, LocationInfoOuterClass.LocationInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof LocationInfoOuterClass.LocationInfo)) {
        return super.equals(obj);
      }
      LocationInfoOuterClass.LocationInfo other = (LocationInfoOuterClass.LocationInfo) obj;
    ...
    public static LocationInfoOuterClass.LocationInfo parseFrom(
    ...
    public static LocationInfoOuterClass.LocationInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static LocationInfoOuterClass.LocationInfo parseFrom(
    ...
    public static LocationInfoOuterClass.LocationInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static LocationInfoOuterClass.LocationInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static LocationInfoOuterClass.LocationInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(LocationInfoOuterClass.LocationInfo prototype) {
    ...
    public static final class Builder extends
        ...
        LocationInfoOuterClass.LocationInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return LocationInfoOuterClass.internal_static_LocationInfo_descriptor;
      }
      ...
      // Construct using LocationInfoOuterClass.LocationInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public LocationInfoOuterClass.LocationInfo getDefaultInstanceForType() {
        return LocationInfoOuterClass.LocationInfo.getDefaultInstance();
      }

      @java.lang.Override
      public LocationInfoOuterClass.LocationInfo build() {
        LocationInfoOuterClass.LocationInfo result = buildPartial();
      ...
      @java.lang.Override
      public LocationInfoOuterClass.LocationInfo buildPartial() {
        LocationInfoOuterClass.LocationInfo result = new LocationInfoOuterClass.LocationInfo(this);
        if (posBuilder_ == null) {
          result.pos_ = pos_;
        } else {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof LocationInfoOuterClass.LocationInfo) {
          return mergeFrom((LocationInfoOuterClass.LocationInfo)other);
        } else {
      ...
      public Builder mergeFrom(LocationInfoOuterClass.LocationInfo other) {
        if (other == LocationInfoOuterClass.LocationInfo.getDefaultInstance()) return this;
        if (other.hasPos()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        LocationInfoOuterClass.LocationInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (LocationInfoOuterClass.LocationInfo) e.getUnfinishedMessage();
    ...
    private static final LocationInfoOuterClass.LocationInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new LocationInfoOuterClass.LocationInfo();
    }

    public static LocationInfoOuterClass.LocationInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\022LocationInfo.proto\032\016Rotation.proto\">\n\014" +
      "LocationInfo\022\026\n\003pos\030\003 \001(\0132\t.Rotation\022\026\n\003" +
      "rot\030\002 \001(\0132\t.Rotationb\006proto3"
    };
