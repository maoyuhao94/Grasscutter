...
public final class SetChatEmojiCollectionReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 90: {
              ...
              chatEmojiCollectionData_ = input.readMessage(ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return SetChatEmojiCollectionReqOuterClass.internal_static_SetChatEmojiCollectionReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq.class, SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq.Builder.class);
    }
    ...
    public enum AMDGEFGHKLC
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq)) {
        return super.equals(obj);
      }
      SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq other = (SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq) obj;
    ...
    public static SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq parseFrom(
    ...
    public static SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq parseFrom(
    ...
    public static SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq prototype) {
    ...
    public static final class Builder extends
        ...
        SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return SetChatEmojiCollectionReqOuterClass.internal_static_SetChatEmojiCollectionReq_descriptor;
      }
      ...
      // Construct using SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq getDefaultInstanceForType() {
        return SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq.getDefaultInstance();
      }

      @java.lang.Override
      public SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq build() {
        SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq result = buildPartial();
      ...
      @java.lang.Override
      public SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq buildPartial() {
        SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq result = new SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq(this);
        if (chatEmojiCollectionDataBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq) {
          return mergeFrom((SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq)other);
        } else {
      ...
      public Builder mergeFrom(SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq other) {
        if (other == SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq) e.getUnfinishedMessage();
        ...
        if (chatEmojiCollectionDataBuilder_ == null) {
          if (chatEmojiCollectionData_ != null) {
            chatEmojiCollectionData_ =
              ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData.newBuilder(chatEmojiCollectionData_).mergeFrom(value).buildPartial();
          } else {
            chatEmojiCollectionData_ = value;
          }
          onChanged();
    ...
    private static final SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq();
    }

    public static SetChatEmojiCollectionReqOuterClass.SetChatEmojiCollectionReq getDefaultInstance() {
