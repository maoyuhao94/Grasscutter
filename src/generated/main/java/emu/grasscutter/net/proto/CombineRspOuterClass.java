...
public final class CombineRspOuterClass {
  ...
  public interface CombineRspOrBuilder extends
     ...
     * <code>repeated .ItemParam resultItemList = 13;</code>
     */
    ItemParamOuterClass.ItemParam getResultItemList(int index);
    /**
     * <code>repeated .ItemParam resultItemList = 13;</code>
     */
     ...
     * <code>repeated .ItemParam resultItemList = 13;</code>
     */
    ItemParamOuterClass.ItemParamOrBuilder getResultItemListOrBuilder(
        int index);
     ...
     * <code>repeated .ItemParam totalExtraItemList = 1;</code>
     */
    ItemParamOuterClass.ItemParam getTotalExtraItemList(int index);
    /**
     * <code>repeated .ItemParam totalExtraItemList = 1;</code>
     */
     ...
     * <code>repeated .ItemParam totalExtraItemList = 1;</code>
     */
    ItemParamOuterClass.ItemParamOrBuilder getTotalExtraItemListOrBuilder(
        int index);
     ...
     * <code>repeated .ItemParam totalRandomItemList = 3;</code>
     */
    ItemParamOuterClass.ItemParam getTotalRandomItemList(int index);
    /**
     * <code>repeated .ItemParam totalRandomItemList = 3;</code>
     */
     ...
     * <code>repeated .ItemParam totalRandomItemList = 3;</code>
     */
    ItemParamOuterClass.ItemParamOrBuilder getTotalRandomItemListOrBuilder(
        int index);
     ...
     * <code>repeated .ItemParam totalReturnItemList = 4;</code>
     */
    ItemParamOuterClass.ItemParam getTotalReturnItemList(int index);
    /**
     * <code>repeated .ItemParam totalReturnItemList = 4;</code>
     */
     ...
     * <code>repeated .ItemParam totalReturnItemList = 4;</code>
     */
    ItemParamOuterClass.ItemParamOrBuilder getTotalReturnItemListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000002) != 0)) {
                totalExtraItemList_ = new java.util.ArrayList<ItemParamOuterClass.ItemParam>();
            ...
            case 18: {
              if (!((mutable_bitField0_ & 0x00000008) != 0)) {
                costItemList_ = new java.util.ArrayList<ItemParamOuterClass.ItemParam>();
            ...
            case 26: {
              if (!((mutable_bitField0_ & 0x00000004) != 0)) {
                totalRandomItemList_ = new java.util.ArrayList<ItemParamOuterClass.ItemParam>();
            ...
            case 34: {
              if (!((mutable_bitField0_ & 0x00000010) != 0)) {
                totalReturnItemList_ = new java.util.ArrayList<ItemParamOuterClass.ItemParam>();
            ...
            case 106: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                resultItemList_ = new java.util.ArrayList<ItemParamOuterClass.ItemParam>();
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return CombineRspOuterClass.internal_static_CombineRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              CombineRspOuterClass.CombineRsp.class, CombineRspOuterClass.CombineRsp.Builder.class);
    }
    ...
    public enum HJFFHHJPMKC
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return CombineRspOuterClass.CombineRsp.getDescriptor().getEnumTypes().get(0);
      }
    ...
    private java.util.List<ItemParamOuterClass.ItemParam> resultItemList_;
    /**
     * <code>repeated .ItemParam resultItemList = 13;</code>
     */
    @java.lang.Override
    public java.util.List<ItemParamOuterClass.ItemParam> getResultItemListList() {
     ...
     */
    @java.lang.Override
    public ItemParamOuterClass.ItemParamOrBuilder getResultItemListOrBuilder(
        int index) {
      return resultItemList_.get(index);
    }
    ...
    private java.util.List<ItemParamOuterClass.ItemParam> totalExtraItemList_;
    /**
     * <code>repeated .ItemParam totalExtraItemList = 1;</code>
     */
    @java.lang.Override
    public java.util.List<ItemParamOuterClass.ItemParam> getTotalExtraItemListList() {
     ...
     */
    @java.lang.Override
    public ItemParamOuterClass.ItemParamOrBuilder getTotalExtraItemListOrBuilder(
        int index) {
      return totalExtraItemList_.get(index);
    }
    ...
    private java.util.List<ItemParamOuterClass.ItemParam> totalRandomItemList_;
    /**
     * <code>repeated .ItemParam totalRandomItemList = 3;</code>
     */
    @java.lang.Override
    public java.util.List<ItemParamOuterClass.ItemParam> getTotalRandomItemListList() {
     ...
     */
    @java.lang.Override
    public ItemParamOuterClass.ItemParamOrBuilder getTotalRandomItemListOrBuilder(
        int index) {
      return totalRandomItemList_.get(index);
    }
    ...
    private java.util.List<ItemParamOuterClass.ItemParam> totalReturnItemList_;
    /**
     * <code>repeated .ItemParam totalReturnItemList = 4;</code>
     */
    @java.lang.Override
    public java.util.List<ItemParamOuterClass.ItemParam> getTotalReturnItemListList() {
     ...
     */
    @java.lang.Override
    public ItemParamOuterClass.ItemParamOrBuilder getTotalReturnItemListOrBuilder(
        int index) {
      return totalReturnItemList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof CombineRspOuterClass.CombineRsp)) {
        return super.equals(obj);
      }
      CombineRspOuterClass.CombineRsp other = (CombineRspOuterClass.CombineRsp) obj;
    ...
    public static CombineRspOuterClass.CombineRsp parseFrom(
    ...
    public static CombineRspOuterClass.CombineRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static CombineRspOuterClass.CombineRsp parseFrom(
    ...
    public static CombineRspOuterClass.CombineRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static CombineRspOuterClass.CombineRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static CombineRspOuterClass.CombineRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(CombineRspOuterClass.CombineRsp prototype) {
    ...
    public static final class Builder extends
        ...
        CombineRspOuterClass.CombineRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return CombineRspOuterClass.internal_static_CombineRsp_descriptor;
      }
      ...
      // Construct using CombineRspOuterClass.CombineRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public CombineRspOuterClass.CombineRsp getDefaultInstanceForType() {
        return CombineRspOuterClass.CombineRsp.getDefaultInstance();
      }

      @java.lang.Override
      public CombineRspOuterClass.CombineRsp build() {
        CombineRspOuterClass.CombineRsp result = buildPartial();
      ...
      @java.lang.Override
      public CombineRspOuterClass.CombineRsp buildPartial() {
        CombineRspOuterClass.CombineRsp result = new CombineRspOuterClass.CombineRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof CombineRspOuterClass.CombineRsp) {
          return mergeFrom((CombineRspOuterClass.CombineRsp)other);
        } else {
      ...
      public Builder mergeFrom(CombineRspOuterClass.CombineRsp other) {
        if (other == CombineRspOuterClass.CombineRsp.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        CombineRspOuterClass.CombineRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (CombineRspOuterClass.CombineRsp) e.getUnfinishedMessage();
      ...
      private void ensureResultItemListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          resultItemList_ = new java.util.ArrayList<ItemParamOuterClass.ItemParam>(resultItemList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          ItemParamOuterClass.ItemParam, ItemParamOuterClass.ItemParam.Builder, ItemParamOuterClass.ItemParamOrBuilder> resultItemListBuilder_;
       ...
       * <code>repeated .ItemParam resultItemList = 13;</code>
       */
      public ItemParamOuterClass.ItemParam.Builder getResultItemListBuilder(
          int index) {
      ...
      private void ensureTotalExtraItemListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          totalExtraItemList_ = new java.util.ArrayList<ItemParamOuterClass.ItemParam>(totalExtraItemList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          ItemParamOuterClass.ItemParam, ItemParamOuterClass.ItemParam.Builder, ItemParamOuterClass.ItemParamOrBuilder> totalExtraItemListBuilder_;
       ...
       * <code>repeated .ItemParam totalExtraItemList = 1;</code>
       */
      public ItemParamOuterClass.ItemParam.Builder getTotalExtraItemListBuilder(
          int index) {
      ...
      private void ensureTotalRandomItemListIsMutable() {
        if (!((bitField0_ & 0x00000004) != 0)) {
          totalRandomItemList_ = new java.util.ArrayList<ItemParamOuterClass.ItemParam>(totalRandomItemList_);
          bitField0_ |= 0x00000004;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          ItemParamOuterClass.ItemParam, ItemParamOuterClass.ItemParam.Builder, ItemParamOuterClass.ItemParamOrBuilder> totalRandomItemListBuilder_;
       ...
       * <code>repeated .ItemParam totalRandomItemList = 3;</code>
       */
      public ItemParamOuterClass.ItemParam.Builder getTotalRandomItemListBuilder(
          int index) {
      ...
      private void ensureTotalReturnItemListIsMutable() {
        if (!((bitField0_ & 0x00000010) != 0)) {
          totalReturnItemList_ = new java.util.ArrayList<ItemParamOuterClass.ItemParam>(totalReturnItemList_);
          bitField0_ |= 0x00000010;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          ItemParamOuterClass.ItemParam, ItemParamOuterClass.ItemParam.Builder, ItemParamOuterClass.ItemParamOrBuilder> totalReturnItemListBuilder_;
       ...
       * <code>repeated .ItemParam totalReturnItemList = 4;</code>
       */
      public ItemParamOuterClass.ItemParam.Builder getTotalReturnItemListBuilder(
          int index) {
    ...
    private static final CombineRspOuterClass.CombineRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new CombineRspOuterClass.CombineRsp();
    }

    public static CombineRspOuterClass.CombineRsp getDefaultInstance() {
