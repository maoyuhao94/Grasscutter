...
public final class AFLCCHIGHFCOuterClass {
  ...
  public interface AFLCCHIGHFCOrBuilder extends
     ...
     */
    java.util.List<KIEHIGCKOHOOuterClass.KIEHIGCKOHO> 
        getNkifjffiglbList();
    /**
     * <code>repeated .KIEHIGCKOHO nkifjffiglb = 5;</code>
     */
    KIEHIGCKOHOOuterClass.KIEHIGCKOHO getNkifjffiglb(int index);
    /**
     * <code>repeated .KIEHIGCKOHO nkifjffiglb = 5;</code>
     */
     ...
     * <code>repeated .KIEHIGCKOHO nkifjffiglb = 5;</code>
     */
    java.util.List<? extends KIEHIGCKOHOOuterClass.KIEHIGCKOHOOrBuilder> 
        getNkifjffiglbOrBuilderList();
    /**
     * <code>repeated .KIEHIGCKOHO nkifjffiglb = 5;</code>
     */
    KIEHIGCKOHOOuterClass.KIEHIGCKOHOOrBuilder getNkifjffiglbOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 42: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                nkifjffiglb_ = new java.util.ArrayList<KIEHIGCKOHOOuterClass.KIEHIGCKOHO>();
                mutable_bitField0_ |= 0x00000001;
              }
              nkifjffiglb_.add(
                  input.readMessage(KIEHIGCKOHOOuterClass.KIEHIGCKOHO.parser(), extensionRegistry));
              break;
            }
            default: {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return AFLCCHIGHFCOuterClass.internal_static_AFLCCHIGHFC_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return AFLCCHIGHFCOuterClass.internal_static_AFLCCHIGHFC_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              AFLCCHIGHFCOuterClass.AFLCCHIGHFC.class, AFLCCHIGHFCOuterClass.AFLCCHIGHFC.Builder.class);
    }
    ...
    private java.util.List<KIEHIGCKOHOOuterClass.KIEHIGCKOHO> nkifjffiglb_;
    /**
     * <code>repeated .KIEHIGCKOHO nkifjffiglb = 5;</code>
     */
    @java.lang.Override
    public java.util.List<KIEHIGCKOHOOuterClass.KIEHIGCKOHO> getNkifjffiglbList() {
      return nkifjffiglb_;
    }
    /**
     * <code>repeated .KIEHIGCKOHO nkifjffiglb = 5;</code>
     */
    @java.lang.Override
    public java.util.List<? extends KIEHIGCKOHOOuterClass.KIEHIGCKOHOOrBuilder> 
        getNkifjffiglbOrBuilderList() {
      return nkifjffiglb_;
    }
    /**
     ...
     */
    @java.lang.Override
    public KIEHIGCKOHOOuterClass.KIEHIGCKOHO getNkifjffiglb(int index) {
     ...
     */
    @java.lang.Override
    public KIEHIGCKOHOOuterClass.KIEHIGCKOHOOrBuilder getNkifjffiglbOrBuilder(
        int index) {
      return nkifjffiglb_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof AFLCCHIGHFCOuterClass.AFLCCHIGHFC)) {
        return super.equals(obj);
      }
      AFLCCHIGHFCOuterClass.AFLCCHIGHFC other = (AFLCCHIGHFCOuterClass.AFLCCHIGHFC) obj;
    ...
    public static AFLCCHIGHFCOuterClass.AFLCCHIGHFC parseFrom(
    ...
    public static AFLCCHIGHFCOuterClass.AFLCCHIGHFC parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static AFLCCHIGHFCOuterClass.AFLCCHIGHFC parseFrom(
    ...
    public static AFLCCHIGHFCOuterClass.AFLCCHIGHFC parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static AFLCCHIGHFCOuterClass.AFLCCHIGHFC parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static AFLCCHIGHFCOuterClass.AFLCCHIGHFC parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(AFLCCHIGHFCOuterClass.AFLCCHIGHFC prototype) {
    ...
    public static final class Builder extends
        ...
        AFLCCHIGHFCOuterClass.AFLCCHIGHFCOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return AFLCCHIGHFCOuterClass.internal_static_AFLCCHIGHFC_descriptor;
      }
      ...
      // Construct using AFLCCHIGHFCOuterClass.AFLCCHIGHFC.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public AFLCCHIGHFCOuterClass.AFLCCHIGHFC getDefaultInstanceForType() {
        return AFLCCHIGHFCOuterClass.AFLCCHIGHFC.getDefaultInstance();
      }

      @java.lang.Override
      public AFLCCHIGHFCOuterClass.AFLCCHIGHFC build() {
        AFLCCHIGHFCOuterClass.AFLCCHIGHFC result = buildPartial();
      ...
      @java.lang.Override
      public AFLCCHIGHFCOuterClass.AFLCCHIGHFC buildPartial() {
        AFLCCHIGHFCOuterClass.AFLCCHIGHFC result = new AFLCCHIGHFCOuterClass.AFLCCHIGHFC(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof AFLCCHIGHFCOuterClass.AFLCCHIGHFC) {
          return mergeFrom((AFLCCHIGHFCOuterClass.AFLCCHIGHFC)other);
        } else {
      ...
      public Builder mergeFrom(AFLCCHIGHFCOuterClass.AFLCCHIGHFC other) {
        if (other == AFLCCHIGHFCOuterClass.AFLCCHIGHFC.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        AFLCCHIGHFCOuterClass.AFLCCHIGHFC parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (AFLCCHIGHFCOuterClass.AFLCCHIGHFC) e.getUnfinishedMessage();
      ...
      private void ensureNkifjffiglbIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          nkifjffiglb_ = new java.util.ArrayList<KIEHIGCKOHOOuterClass.KIEHIGCKOHO>(nkifjffiglb_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          KIEHIGCKOHOOuterClass.KIEHIGCKOHO, KIEHIGCKOHOOuterClass.KIEHIGCKOHO.Builder, KIEHIGCKOHOOuterClass.KIEHIGCKOHOOrBuilder> nkifjffiglbBuilder_;
      ...
      public Builder setNkifjffiglb(
          int index, KIEHIGCKOHOOuterClass.KIEHIGCKOHO value) {
        if (nkifjffiglbBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setNkifjffiglb(
          int index, KIEHIGCKOHOOuterClass.KIEHIGCKOHO.Builder builderForValue) {
        if (nkifjffiglbBuilder_ == null) {
          ensureNkifjffiglbIsMutable();
       ...
       * <code>repeated .KIEHIGCKOHO nkifjffiglb = 5;</code>
       */
      public Builder addNkifjffiglb(KIEHIGCKOHOOuterClass.KIEHIGCKOHO value) {
        if (nkifjffiglbBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addNkifjffiglb(
          KIEHIGCKOHOOuterClass.KIEHIGCKOHO.Builder builderForValue) {
        if (nkifjffiglbBuilder_ == null) {
          ensureNkifjffiglbIsMutable();
      ...
      public Builder addAllNkifjffiglb(
          java.lang.Iterable<? extends KIEHIGCKOHOOuterClass.KIEHIGCKOHO> values) {
        if (nkifjffiglbBuilder_ == null) {
          ensureNkifjffiglbIsMutable();
       ...
       * <code>repeated .KIEHIGCKOHO nkifjffiglb = 5;</code>
       */
      public KIEHIGCKOHOOuterClass.KIEHIGCKOHO.Builder getNkifjffiglbBuilder(
          int index) {
       ...
       * <code>repeated .KIEHIGCKOHO nkifjffiglb = 5;</code>
       */
      public KIEHIGCKOHOOuterClass.KIEHIGCKOHO.Builder addNkifjffiglbBuilder() {
        return getNkifjffiglbFieldBuilder().addBuilder(
            KIEHIGCKOHOOuterClass.KIEHIGCKOHO.getDefaultInstance());
      }
      /**
       * <code>repeated .KIEHIGCKOHO nkifjffiglb = 5;</code>
       */
      public KIEHIGCKOHOOuterClass.KIEHIGCKOHO.Builder addNkifjffiglbBuilder(
          int index) {
        return getNkifjffiglbFieldBuilder().addBuilder(
            index, KIEHIGCKOHOOuterClass.KIEHIGCKOHO.getDefaultInstance());
      }
      /**
       * <code>repeated .KIEHIGCKOHO nkifjffiglb = 5;</code>
       */
      public java.util.List<KIEHIGCKOHOOuterClass.KIEHIGCKOHO.Builder> 
           getNkifjffiglbBuilderList() {
        return getNkifjffiglbFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          KIEHIGCKOHOOuterClass.KIEHIGCKOHO, KIEHIGCKOHOOuterClass.KIEHIGCKOHO.Builder, KIEHIGCKOHOOuterClass.KIEHIGCKOHOOrBuilder> 
          getNkifjffiglbFieldBuilder() {
        if (nkifjffiglbBuilder_ == null) {
    ...
    private static final AFLCCHIGHFCOuterClass.AFLCCHIGHFC DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new AFLCCHIGHFCOuterClass.AFLCCHIGHFC();
    }

    public static AFLCCHIGHFCOuterClass.AFLCCHIGHFC getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\014.KIEHIGCKOHOb\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          KIEHIGCKOHOOuterClass.getDescriptor(),
        });
    internal_static_AFLCCHIGHFC_descriptor =
