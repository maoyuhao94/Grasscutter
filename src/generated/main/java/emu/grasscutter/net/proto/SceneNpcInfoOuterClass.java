...
public final class SceneNpcInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return SceneNpcInfoOuterClass.internal_static_SceneNpcInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              SceneNpcInfoOuterClass.SceneNpcInfo.class, SceneNpcInfoOuterClass.SceneNpcInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof SceneNpcInfoOuterClass.SceneNpcInfo)) {
        return super.equals(obj);
      }
      SceneNpcInfoOuterClass.SceneNpcInfo other = (SceneNpcInfoOuterClass.SceneNpcInfo) obj;
    ...
    public static SceneNpcInfoOuterClass.SceneNpcInfo parseFrom(
    ...
    public static SceneNpcInfoOuterClass.SceneNpcInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static SceneNpcInfoOuterClass.SceneNpcInfo parseFrom(
    ...
    public static SceneNpcInfoOuterClass.SceneNpcInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static SceneNpcInfoOuterClass.SceneNpcInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static SceneNpcInfoOuterClass.SceneNpcInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(SceneNpcInfoOuterClass.SceneNpcInfo prototype) {
    ...
    public static final class Builder extends
        ...
        SceneNpcInfoOuterClass.SceneNpcInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return SceneNpcInfoOuterClass.internal_static_SceneNpcInfo_descriptor;
      }
      ...
      // Construct using SceneNpcInfoOuterClass.SceneNpcInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public SceneNpcInfoOuterClass.SceneNpcInfo getDefaultInstanceForType() {
        return SceneNpcInfoOuterClass.SceneNpcInfo.getDefaultInstance();
      }

      @java.lang.Override
      public SceneNpcInfoOuterClass.SceneNpcInfo build() {
        SceneNpcInfoOuterClass.SceneNpcInfo result = buildPartial();
      ...
      @java.lang.Override
      public SceneNpcInfoOuterClass.SceneNpcInfo buildPartial() {
        SceneNpcInfoOuterClass.SceneNpcInfo result = new SceneNpcInfoOuterClass.SceneNpcInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof SceneNpcInfoOuterClass.SceneNpcInfo) {
          return mergeFrom((SceneNpcInfoOuterClass.SceneNpcInfo)other);
        } else {
      ...
      public Builder mergeFrom(SceneNpcInfoOuterClass.SceneNpcInfo other) {
        if (other == SceneNpcInfoOuterClass.SceneNpcInfo.getDefaultInstance()) return this;
        if (other.getNpcId() != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        SceneNpcInfoOuterClass.SceneNpcInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (SceneNpcInfoOuterClass.SceneNpcInfo) e.getUnfinishedMessage();
    ...
    private static final SceneNpcInfoOuterClass.SceneNpcInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new SceneNpcInfoOuterClass.SceneNpcInfo();
    }

    public static SceneNpcInfoOuterClass.SceneNpcInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "stId\030\003 \001(\r\022\017\n\007blockId\030\004 \001(\rb\006proto3"
    };
