...
public final class HomeLimitedShopInfoNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 106: {
              ...
              shopInfo_ = input.readMessage(HomeLimitedShopInfoOuterClass.HomeLimitedShopInfo.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return HomeLimitedShopInfoNotifyOuterClass.internal_static_HomeLimitedShopInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify.class, HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify.Builder.class);
    }
    ...
    public enum LIBPBIGJPBM
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public HomeLimitedShopInfoOuterClass.HomeLimitedShopInfo getShopInfo() {
      return shopInfo_ == null ? HomeLimitedShopInfoOuterClass.HomeLimitedShopInfo.getDefaultInstance() : shopInfo_;
    }
    /**
     * <code>.HomeLimitedShopInfo shopInfo = 13;</code>
     */
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify)) {
        return super.equals(obj);
      }
      HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify other = (HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify) obj;
    ...
    public static HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify parseFrom(
    ...
    public static HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify parseFrom(
    ...
    public static HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return HomeLimitedShopInfoNotifyOuterClass.internal_static_HomeLimitedShopInfoNotify_descriptor;
      }
      ...
      // Construct using HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify getDefaultInstanceForType() {
        return HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify build() {
        HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify result = buildPartial();
      ...
      @java.lang.Override
      public HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify buildPartial() {
        HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify result = new HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify(this);
        if (shopInfoBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify) {
          return mergeFrom((HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify other) {
        if (other == HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify) e.getUnfinishedMessage();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          HomeLimitedShopInfoOuterClass.HomeLimitedShopInfo, HomeLimitedShopInfoOuterClass.HomeLimitedShopInfo.Builder, HomeLimitedShopInfoOuterClass.HomeLimitedShopInfoOrBuilder> shopInfoBuilder_;
      /**
       * <code>.HomeLimitedShopInfo shopInfo = 13;</code>
       * @return Whether the shopInfo field is set.
       */
      ...
      public Builder setShopInfo(
          HomeLimitedShopInfoOuterClass.HomeLimitedShopInfo.Builder builderForValue) {
        if (shopInfoBuilder_ == null) {
      ...
      public Builder mergeShopInfo(HomeLimitedShopInfoOuterClass.HomeLimitedShopInfo value) {
        if (shopInfoBuilder_ == null) {
          if (shopInfo_ != null) {
            shopInfo_ =
              HomeLimitedShopInfoOuterClass.HomeLimitedShopInfo.newBuilder(shopInfo_).mergeFrom(value).buildPartial();
          } else {
            shopInfo_ = value;
          }
          onChanged();
      ...
      public HomeLimitedShopInfoOuterClass.HomeLimitedShopInfoOrBuilder getShopInfoOrBuilder() {
        if (shopInfoBuilder_ != null) {
          ...
          return shopInfo_ == null ?
              HomeLimitedShopInfoOuterClass.HomeLimitedShopInfo.getDefaultInstance() : shopInfo_;
        }
      }
      /**
       * <code>.HomeLimitedShopInfo shopInfo = 13;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          HomeLimitedShopInfoOuterClass.HomeLimitedShopInfo, HomeLimitedShopInfoOuterClass.HomeLimitedShopInfo.Builder, HomeLimitedShopInfoOuterClass.HomeLimitedShopInfoOrBuilder> 
    ...
    private static final HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify();
    }

    public static HomeLimitedShopInfoNotifyOuterClass.HomeLimitedShopInfoNotify getDefaultInstance() {
