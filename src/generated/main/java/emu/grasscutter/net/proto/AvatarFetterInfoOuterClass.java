...
public final class AvatarFetterInfoOuterClass {
  ...
  public interface AvatarFetterInfoOrBuilder extends
    ...
    /**
     * <code>uint32 expNumber = 1;</code>
     * @return The expNumber.
     */
    int getExpNumber();

    /**
     * <code>uint32 expLevel = 2;</code>
     * @return The expLevel.
     */
    int getExpLevel();

    /**
     * <code>repeated uint32 openIdList = 3;</code>
    ...
    /**
     * <code>repeated uint32 finishIdList = 4;</code>
    ...
    /**
     * <code>repeated uint32 rewardedFetterLevelList = 5;</code>
    ...
    /**
     * <code>repeated .FetterData fetterList = 6;</code>
     */
    java.util.List<FetterDataOuterClass.FetterData> 
        getFetterListList();
    /**
     * <code>repeated .FetterData fetterList = 6;</code>
     */
    FetterDataOuterClass.FetterData getFetterList(int index);
    /**
     * <code>repeated .FetterData fetterList = 6;</code>
     */
     ...
     * <code>repeated .FetterData fetterList = 6;</code>
     */
    java.util.List<? extends FetterDataOuterClass.FetterDataOrBuilder> 
        getFetterListOrBuilderList();
    /**
     * <code>repeated .FetterData fetterList = 6;</code>
     */
    FetterDataOuterClass.FetterDataOrBuilder getFetterListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 50: {
              if (!((mutable_bitField0_ & 0x00000008) != 0)) {
                fetterList_ = new java.util.ArrayList<FetterDataOuterClass.FetterData>();
                mutable_bitField0_ |= 0x00000008;
              }
              fetterList_.add(
                  input.readMessage(FetterDataOuterClass.FetterData.parser(), extensionRegistry));
              break;
            }
            default: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return AvatarFetterInfoOuterClass.internal_static_AvatarFetterInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              AvatarFetterInfoOuterClass.AvatarFetterInfo.class, AvatarFetterInfoOuterClass.AvatarFetterInfo.Builder.class);
    }
    ...
    private java.util.List<FetterDataOuterClass.FetterData> fetterList_;
    /**
     * <code>repeated .FetterData fetterList = 6;</code>
     */
    @java.lang.Override
    public java.util.List<FetterDataOuterClass.FetterData> getFetterListList() {
      return fetterList_;
    }
    /**
     * <code>repeated .FetterData fetterList = 6;</code>
     */
    @java.lang.Override
    public java.util.List<? extends FetterDataOuterClass.FetterDataOrBuilder> 
        getFetterListOrBuilderList() {
      return fetterList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public FetterDataOuterClass.FetterDataOrBuilder getFetterListOrBuilder(
        int index) {
      return fetterList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof AvatarFetterInfoOuterClass.AvatarFetterInfo)) {
        return super.equals(obj);
      }
      AvatarFetterInfoOuterClass.AvatarFetterInfo other = (AvatarFetterInfoOuterClass.AvatarFetterInfo) obj;
    ...
    public static AvatarFetterInfoOuterClass.AvatarFetterInfo parseFrom(
    ...
    public static AvatarFetterInfoOuterClass.AvatarFetterInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static AvatarFetterInfoOuterClass.AvatarFetterInfo parseFrom(
    ...
    public static AvatarFetterInfoOuterClass.AvatarFetterInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static AvatarFetterInfoOuterClass.AvatarFetterInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static AvatarFetterInfoOuterClass.AvatarFetterInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(AvatarFetterInfoOuterClass.AvatarFetterInfo prototype) {
    ...
    public static final class Builder extends
        ...
        AvatarFetterInfoOuterClass.AvatarFetterInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return AvatarFetterInfoOuterClass.internal_static_AvatarFetterInfo_descriptor;
      }
      ...
      // Construct using AvatarFetterInfoOuterClass.AvatarFetterInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public AvatarFetterInfoOuterClass.AvatarFetterInfo getDefaultInstanceForType() {
        return AvatarFetterInfoOuterClass.AvatarFetterInfo.getDefaultInstance();
      }

      @java.lang.Override
      public AvatarFetterInfoOuterClass.AvatarFetterInfo build() {
        AvatarFetterInfoOuterClass.AvatarFetterInfo result = buildPartial();
      ...
      @java.lang.Override
      public AvatarFetterInfoOuterClass.AvatarFetterInfo buildPartial() {
        AvatarFetterInfoOuterClass.AvatarFetterInfo result = new AvatarFetterInfoOuterClass.AvatarFetterInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof AvatarFetterInfoOuterClass.AvatarFetterInfo) {
          return mergeFrom((AvatarFetterInfoOuterClass.AvatarFetterInfo)other);
        } else {
      ...
      public Builder mergeFrom(AvatarFetterInfoOuterClass.AvatarFetterInfo other) {
        if (other == AvatarFetterInfoOuterClass.AvatarFetterInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        AvatarFetterInfoOuterClass.AvatarFetterInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (AvatarFetterInfoOuterClass.AvatarFetterInfo) e.getUnfinishedMessage();
      ...
      private void ensureFetterListIsMutable() {
        if (!((bitField0_ & 0x00000008) != 0)) {
          fetterList_ = new java.util.ArrayList<FetterDataOuterClass.FetterData>(fetterList_);
          bitField0_ |= 0x00000008;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          FetterDataOuterClass.FetterData, FetterDataOuterClass.FetterData.Builder, FetterDataOuterClass.FetterDataOrBuilder> fetterListBuilder_;
      ...
      public Builder setFetterList(
          int index, FetterDataOuterClass.FetterData value) {
        if (fetterListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setFetterList(
          int index, FetterDataOuterClass.FetterData.Builder builderForValue) {
        if (fetterListBuilder_ == null) {
          ensureFetterListIsMutable();
       ...
       */
      public Builder addFetterList(
          FetterDataOuterClass.FetterData.Builder builderForValue) {
        if (fetterListBuilder_ == null) {
          ensureFetterListIsMutable();
      ...
      public Builder addAllFetterList(
          java.lang.Iterable<? extends FetterDataOuterClass.FetterData> values) {
        if (fetterListBuilder_ == null) {
          ensureFetterListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, fetterList_);
       ...
       * <code>repeated .FetterData fetterList = 6;</code>
       */
      public FetterDataOuterClass.FetterData.Builder getFetterListBuilder(
          int index) {
      ...
      public FetterDataOuterClass.FetterData.Builder addFetterListBuilder() {
        return getFetterListFieldBuilder().addBuilder(
            FetterDataOuterClass.FetterData.getDefaultInstance());
      }
      /**
       * <code>repeated .FetterData fetterList = 6;</code>
       */
      public FetterDataOuterClass.FetterData.Builder addFetterListBuilder(
          int index) {
        return getFetterListFieldBuilder().addBuilder(
            index, FetterDataOuterClass.FetterData.getDefaultInstance());
      }
      /**
       * <code>repeated .FetterData fetterList = 6;</code>
       */
      public java.util.List<FetterDataOuterClass.FetterData.Builder> 
           getFetterListBuilderList() {
        return getFetterListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          FetterDataOuterClass.FetterData, FetterDataOuterClass.FetterData.Builder, FetterDataOuterClass.FetterDataOrBuilder> 
          getFetterListFieldBuilder() {
        if (fetterListBuilder_ == null) {
    ...
    private static final AvatarFetterInfoOuterClass.AvatarFetterInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new AvatarFetterInfoOuterClass.AvatarFetterInfo();
    }

    public static AvatarFetterInfoOuterClass.AvatarFetterInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "to\"\243\001\n\020AvatarFetterInfo\022\021\n\texpNumber\030\001 \001" +
      "(\r\022\020\n\010expLevel\030\002 \001(\r\022\022\n\nopenIdList\030\003 \003(\r" +
      "\022\024\n\014finishIdList\030\004 \003(\r\022\037\n\027rewardedFetter" +
      "LevelList\030\005 \003(\r\022\037\n\nfetterList\030\006 \003(\0132\013.Fe" +
      "tterDatab\006proto3"
    };
