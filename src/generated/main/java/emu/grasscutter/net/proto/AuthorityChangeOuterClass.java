...
public final class AuthorityChangeOuterClass {
  ...
  public interface AuthorityChangeOrBuilder extends
    ...
    /**
     * <code>uint32 authorityPeerId = 2;</code>
     * @return The authorityPeerId.
     */
    int getAuthorityPeerId();

    /**
     * <code>.EntityAuthorityInfo entityAuthorityInfo = 4;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return AuthorityChangeOuterClass.internal_static_AuthorityChange_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return AuthorityChangeOuterClass.internal_static_AuthorityChange_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              AuthorityChangeOuterClass.AuthorityChange.class, AuthorityChangeOuterClass.AuthorityChange.Builder.class);
    }

    public static final int AUTHORITYPEERID_FIELD_NUMBER = 2;
    ...
    public static final int ENTITYAUTHORITYINFO_FIELD_NUMBER = 4;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (entityAuthorityInfo_ != null) {
        output.writeMessage(4, getEntityAuthorityInfo());
      }
      if (entityId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (entityAuthorityInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, getEntityAuthorityInfo());
      }
      if (entityId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof AuthorityChangeOuterClass.AuthorityChange)) {
        return super.equals(obj);
      }
      AuthorityChangeOuterClass.AuthorityChange other = (AuthorityChangeOuterClass.AuthorityChange) obj;
    ...
    public static AuthorityChangeOuterClass.AuthorityChange parseFrom(
    ...
    public static AuthorityChangeOuterClass.AuthorityChange parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static AuthorityChangeOuterClass.AuthorityChange parseFrom(
    ...
    public static AuthorityChangeOuterClass.AuthorityChange parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static AuthorityChangeOuterClass.AuthorityChange parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static AuthorityChangeOuterClass.AuthorityChange parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(AuthorityChangeOuterClass.AuthorityChange prototype) {
    ...
    public static final class Builder extends
        ...
        AuthorityChangeOuterClass.AuthorityChangeOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return AuthorityChangeOuterClass.internal_static_AuthorityChange_descriptor;
      }
      ...
      // Construct using AuthorityChangeOuterClass.AuthorityChange.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public AuthorityChangeOuterClass.AuthorityChange getDefaultInstanceForType() {
        return AuthorityChangeOuterClass.AuthorityChange.getDefaultInstance();
      }

      @java.lang.Override
      public AuthorityChangeOuterClass.AuthorityChange build() {
        AuthorityChangeOuterClass.AuthorityChange result = buildPartial();
      ...
      @java.lang.Override
      public AuthorityChangeOuterClass.AuthorityChange buildPartial() {
        AuthorityChangeOuterClass.AuthorityChange result = new AuthorityChangeOuterClass.AuthorityChange(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof AuthorityChangeOuterClass.AuthorityChange) {
          return mergeFrom((AuthorityChangeOuterClass.AuthorityChange)other);
        } else {
      ...
      public Builder mergeFrom(AuthorityChangeOuterClass.AuthorityChange other) {
        if (other == AuthorityChangeOuterClass.AuthorityChange.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        AuthorityChangeOuterClass.AuthorityChange parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (AuthorityChangeOuterClass.AuthorityChange) e.getUnfinishedMessage();
    ...
    private static final AuthorityChangeOuterClass.AuthorityChange DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new AuthorityChangeOuterClass.AuthorityChange();
    }

    public static AuthorityChangeOuterClass.AuthorityChange getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "Info.proto\"o\n\017AuthorityChange\022\027\n\017authori" +
      "tyPeerId\030\002 \001(\r\0221\n\023entityAuthorityInfo\030\004 " +
      "\001(\0132\024.EntityAuthorityInfo\022\020\n\010entityId\030\016 " +
      "\001(\rb\006proto3"
    };
