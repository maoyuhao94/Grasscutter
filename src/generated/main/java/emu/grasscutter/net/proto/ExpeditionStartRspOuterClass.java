...
public final class ExpeditionStartRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return ExpeditionStartRspOuterClass.internal_static_ExpeditionStartRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return ExpeditionStartRspOuterClass.internal_static_ExpeditionStartRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ExpeditionStartRspOuterClass.ExpeditionStartRsp.class, ExpeditionStartRspOuterClass.ExpeditionStartRsp.Builder.class);
    }

    /**
     * Protobuf enum {@code ExpeditionStartRsp.HJCFHHNKFEF}
     */
    public enum HJCFHHNKFEF
       ...
       */
      public static final HJCFHHNKFEF DCDNILFDFLB = NONE;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 2157;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 2157;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static HJCFHHNKFEF valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static HJCFHHNKFEF forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 2157: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<HJCFHHNKFEF>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          HJCFHHNKFEF> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<HJCFHHNKFEF>() {
              public HJCFHHNKFEF findValueByNumber(int number) {
                return HJCFHHNKFEF.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return ExpeditionStartRspOuterClass.ExpeditionStartRsp.getDescriptor().getEnumTypes().get(0);
      }

      private static final HJCFHHNKFEF[] VALUES = getStaticValuesArray();
      private static HJCFHHNKFEF[] getStaticValuesArray() {
        return new HJCFHHNKFEF[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, 
        };
      }
      public static HJCFHHNKFEF valueOf(
      ...
      private HJCFHHNKFEF(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:ExpeditionStartRsp.HJCFHHNKFEF)
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof ExpeditionStartRspOuterClass.ExpeditionStartRsp)) {
        return super.equals(obj);
      }
      ExpeditionStartRspOuterClass.ExpeditionStartRsp other = (ExpeditionStartRspOuterClass.ExpeditionStartRsp) obj;
    ...
    public static ExpeditionStartRspOuterClass.ExpeditionStartRsp parseFrom(
    ...
    public static ExpeditionStartRspOuterClass.ExpeditionStartRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ExpeditionStartRspOuterClass.ExpeditionStartRsp parseFrom(
    ...
    public static ExpeditionStartRspOuterClass.ExpeditionStartRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ExpeditionStartRspOuterClass.ExpeditionStartRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static ExpeditionStartRspOuterClass.ExpeditionStartRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(ExpeditionStartRspOuterClass.ExpeditionStartRsp prototype) {
    ...
    public static final class Builder extends
        ...
        ExpeditionStartRspOuterClass.ExpeditionStartRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ExpeditionStartRspOuterClass.internal_static_ExpeditionStartRsp_descriptor;
      }
      ...
      // Construct using ExpeditionStartRspOuterClass.ExpeditionStartRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public ExpeditionStartRspOuterClass.ExpeditionStartRsp getDefaultInstanceForType() {
        return ExpeditionStartRspOuterClass.ExpeditionStartRsp.getDefaultInstance();
      }

      @java.lang.Override
      public ExpeditionStartRspOuterClass.ExpeditionStartRsp build() {
        ExpeditionStartRspOuterClass.ExpeditionStartRsp result = buildPartial();
      ...
      @java.lang.Override
      public ExpeditionStartRspOuterClass.ExpeditionStartRsp buildPartial() {
        ExpeditionStartRspOuterClass.ExpeditionStartRsp result = new ExpeditionStartRspOuterClass.ExpeditionStartRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ExpeditionStartRspOuterClass.ExpeditionStartRsp) {
          return mergeFrom((ExpeditionStartRspOuterClass.ExpeditionStartRsp)other);
        } else {
      ...
      public Builder mergeFrom(ExpeditionStartRspOuterClass.ExpeditionStartRsp other) {
        if (other == ExpeditionStartRspOuterClass.ExpeditionStartRsp.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ExpeditionStartRspOuterClass.ExpeditionStartRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ExpeditionStartRspOuterClass.ExpeditionStartRsp) e.getUnfinishedMessage();
    ...
    private static final ExpeditionStartRspOuterClass.ExpeditionStartRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ExpeditionStartRspOuterClass.ExpeditionStartRsp();
    }

    public static ExpeditionStartRspOuterClass.ExpeditionStartRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\030ExpeditionStartRsp.proto\"\326\001\n\022Expeditio" +
      ...
      "(\r\"O\n\013HJCFHHNKFEF\022\010\n\004NONE\020\000\022\020\n\013PEPPOHPHJ" +
      "OJ\020\355\020\022\017\n\013DCDNILFDFLB\020\000\022\017\n\013NNBKOLMPOEA\020\001\032" +
