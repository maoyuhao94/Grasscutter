...
public final class GCGLevelChallengeFinishNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return GCGLevelChallengeFinishNotifyOuterClass.internal_static_GCGLevelChallengeFinishNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return GCGLevelChallengeFinishNotifyOuterClass.internal_static_GCGLevelChallengeFinishNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify.class, GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify.Builder.class);
    }

    /**
     * Protobuf enum {@code GCGLevelChallengeFinishNotify.JFHPNEMLEIG}
     */
    public enum JFHPNEMLEIG
       ...
       */
      public static final JFHPNEMLEIG DCDNILFDFLB = NONE;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 7127;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 7127;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static JFHPNEMLEIG valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static JFHPNEMLEIG forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 7127: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<JFHPNEMLEIG>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          JFHPNEMLEIG> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<JFHPNEMLEIG>() {
              public JFHPNEMLEIG findValueByNumber(int number) {
                return JFHPNEMLEIG.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify.getDescriptor().getEnumTypes().get(0);
      }

      private static final JFHPNEMLEIG[] VALUES = getStaticValuesArray();
      private static JFHPNEMLEIG[] getStaticValuesArray() {
        return new JFHPNEMLEIG[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, 
        };
      }
      public static JFHPNEMLEIG valueOf(
      ...
      private JFHPNEMLEIG(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:GCGLevelChallengeFinishNotify.JFHPNEMLEIG)
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify)) {
        return super.equals(obj);
      }
      GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify other = (GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify) obj;
    ...
    public static GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify parseFrom(
    ...
    public static GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify parseFrom(
    ...
    public static GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify prototype) {
    ...
    public static final class Builder extends
        ...
        GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return GCGLevelChallengeFinishNotifyOuterClass.internal_static_GCGLevelChallengeFinishNotify_descriptor;
      }
      ...
      // Construct using GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify getDefaultInstanceForType() {
        return GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify.getDefaultInstance();
      }

      @java.lang.Override
      public GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify build() {
        GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify result = buildPartial();
      ...
      @java.lang.Override
      public GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify buildPartial() {
        GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify result = new GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify) {
          return mergeFrom((GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify)other);
        } else {
      ...
      public Builder mergeFrom(GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify other) {
        if (other == GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify) e.getUnfinishedMessage();
    ...
    private static final GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify();
    }

    public static GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "MLEIG\022\010\n\004NONE\020\000\022\020\n\013PEPPOHPHJOJ\020\3277\022\017\n\013DCD" +
