...
public final class SceneEntityAppearNotifyOuterClass {
  ...
  public interface SceneEntityAppearNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .SceneEntityInfo entityList = 10;</code>
     */
    ...
    /**
     * <code>.VisionType appearType = 3;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return SceneEntityAppearNotifyOuterClass.internal_static_SceneEntityAppearNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify.class, SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify.Builder.class);
    }

    /**
     * Protobuf enum {@code SceneEntityAppearNotify.HHOJIPLPJCP}
     */
    public enum HHOJIPLPJCP
       ...
       */
      public static final HHOJIPLPJCP DCDNILFDFLB = NONE;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 274;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 274;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static HHOJIPLPJCP valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static HHOJIPLPJCP forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 274: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<HHOJIPLPJCP>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          HHOJIPLPJCP> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<HHOJIPLPJCP>() {
              public HHOJIPLPJCP findValueByNumber(int number) {
                return HHOJIPLPJCP.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify.getDescriptor().getEnumTypes().get(0);
      }

      private static final HHOJIPLPJCP[] VALUES = getStaticValuesArray();
      private static HHOJIPLPJCP[] getStaticValuesArray() {
        return new HHOJIPLPJCP[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, 
        };
      }
      public static HHOJIPLPJCP valueOf(
      ...
      private HHOJIPLPJCP(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:SceneEntityAppearNotify.HHOJIPLPJCP)
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (appearType_ != VisionTypeOuterClass.VisionType.VISION_TYPE_NONE.getNumber()) {
        output.writeEnum(3, appearType_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify)) {
        return super.equals(obj);
      }
      SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify other = (SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify) obj;
    ...
    public static SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify parseFrom(
    ...
    public static SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify parseFrom(
    ...
    public static SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify prototype) {
    ...
    public static final class Builder extends
        ...
        SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return SceneEntityAppearNotifyOuterClass.internal_static_SceneEntityAppearNotify_descriptor;
      }
      ...
      // Construct using SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify getDefaultInstanceForType() {
        return SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify.getDefaultInstance();
      }

      @java.lang.Override
      public SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify build() {
        SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify result = buildPartial();
      ...
      @java.lang.Override
      public SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify buildPartial() {
        SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify result = new SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify) {
          return mergeFrom((SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify)other);
        } else {
      ...
      public Builder mergeFrom(SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify other) {
        if (other == SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify.getDefaultInstance()) return this;
        if (entityListBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify) e.getUnfinishedMessage();
    ...
    private static final SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify();
    }

    public static SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\035SceneEntityAppearNotify.proto\032\020VisionT" +
      "ype.proto\032\025SceneEntityInfo.proto\"\300\001\n\027Sce" +
      "neEntityAppearNotify\022$\n\nentityList\030\n \003(\013" +
      "2\020.SceneEntityInfo\022\037\n\nappearType\030\003 \001(\0162\013" +
      ".VisionType\022\r\n\005param\030\016 \001(\r\"O\n\013HHOJIPLPJC" +
      "P\022\010\n\004NONE\020\000\022\020\n\013PEPPOHPHJOJ\020\222\002\022\017\n\013DCDNILF" +
