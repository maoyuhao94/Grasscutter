...
public final class AchievementAllDataNotifyOuterClass {
  ...
  public interface AchievementAllDataNotifyOrBuilder extends
    ...
    /**
     * <code>repeated uint32 rewardTakenGoalIdList = 8;</code>
    ...
    /**
     * <code>repeated .Achievement achievementList = 4;</code>
     */
    java.util.List<AchievementOuterClass.Achievement> 
        getAchievementListList();
    /**
     * <code>repeated .Achievement achievementList = 4;</code>
     */
    AchievementOuterClass.Achievement getAchievementList(int index);
    /**
     * <code>repeated .Achievement achievementList = 4;</code>
     */
     ...
     * <code>repeated .Achievement achievementList = 4;</code>
     */
    java.util.List<? extends AchievementOuterClass.AchievementOrBuilder> 
        getAchievementListOrBuilderList();
    /**
     * <code>repeated .Achievement achievementList = 4;</code>
     */
    AchievementOuterClass.AchievementOrBuilder getAchievementListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 34: {
              if (!((mutable_bitField0_ & 0x00000002) != 0)) {
                achievementList_ = new java.util.ArrayList<AchievementOuterClass.Achievement>();
                mutable_bitField0_ |= 0x00000002;
              }
              achievementList_.add(
                  input.readMessage(AchievementOuterClass.Achievement.parser(), extensionRegistry));
              break;
            }
            case 64: {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return AchievementAllDataNotifyOuterClass.internal_static_AchievementAllDataNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return AchievementAllDataNotifyOuterClass.internal_static_AchievementAllDataNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              AchievementAllDataNotifyOuterClass.AchievementAllDataNotify.class, AchievementAllDataNotifyOuterClass.AchievementAllDataNotify.Builder.class);
    }

    /**
     * Protobuf enum {@code AchievementAllDataNotify.BPPEPMJFOPO}
     */
    public enum BPPEPMJFOPO
       ...
       */
      public static final BPPEPMJFOPO DCDNILFDFLB = NONE;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 2688;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 2688;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static BPPEPMJFOPO valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static BPPEPMJFOPO forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 2688: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<BPPEPMJFOPO>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          BPPEPMJFOPO> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<BPPEPMJFOPO>() {
              public BPPEPMJFOPO findValueByNumber(int number) {
                return BPPEPMJFOPO.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return AchievementAllDataNotifyOuterClass.AchievementAllDataNotify.getDescriptor().getEnumTypes().get(0);
      }

      private static final BPPEPMJFOPO[] VALUES = getStaticValuesArray();
      private static BPPEPMJFOPO[] getStaticValuesArray() {
        return new BPPEPMJFOPO[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, 
        };
      }
      public static BPPEPMJFOPO valueOf(
      ...
      private BPPEPMJFOPO(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:AchievementAllDataNotify.BPPEPMJFOPO)
    }

    public static final int REWARDTAKENGOALIDLIST_FIELD_NUMBER = 8;
    ...
    public static final int ACHIEVEMENTLIST_FIELD_NUMBER = 4;
    private java.util.List<AchievementOuterClass.Achievement> achievementList_;
    /**
     * <code>repeated .Achievement achievementList = 4;</code>
     */
    @java.lang.Override
    public java.util.List<AchievementOuterClass.Achievement> getAchievementListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends AchievementOuterClass.AchievementOrBuilder> 
        getAchievementListOrBuilderList() {
      return achievementList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public AchievementOuterClass.Achievement getAchievementList(int index) {
     ...
     */
    @java.lang.Override
    public AchievementOuterClass.AchievementOrBuilder getAchievementListOrBuilder(
        int index) {
      return achievementList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof AchievementAllDataNotifyOuterClass.AchievementAllDataNotify)) {
        return super.equals(obj);
      }
      AchievementAllDataNotifyOuterClass.AchievementAllDataNotify other = (AchievementAllDataNotifyOuterClass.AchievementAllDataNotify) obj;
    ...
    public int hashCode() {
      ...
      if (getRewardTakenGoalIdListCount() > 0) {
        hash = (37 * hash) + REWARDTAKENGOALIDLIST_FIELD_NUMBER;
        hash = (53 * hash) + getRewardTakenGoalIdListList().hashCode();
      }
      if (getAchievementListCount() > 0) {
        hash = (37 * hash) + ACHIEVEMENTLIST_FIELD_NUMBER;
    ...
    public static AchievementAllDataNotifyOuterClass.AchievementAllDataNotify parseFrom(
    ...
    public static AchievementAllDataNotifyOuterClass.AchievementAllDataNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static AchievementAllDataNotifyOuterClass.AchievementAllDataNotify parseFrom(
    ...
    public static AchievementAllDataNotifyOuterClass.AchievementAllDataNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static AchievementAllDataNotifyOuterClass.AchievementAllDataNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static AchievementAllDataNotifyOuterClass.AchievementAllDataNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(AchievementAllDataNotifyOuterClass.AchievementAllDataNotify prototype) {
    ...
    public static final class Builder extends
        ...
        AchievementAllDataNotifyOuterClass.AchievementAllDataNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return AchievementAllDataNotifyOuterClass.internal_static_AchievementAllDataNotify_descriptor;
      }
      ...
      // Construct using AchievementAllDataNotifyOuterClass.AchievementAllDataNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public AchievementAllDataNotifyOuterClass.AchievementAllDataNotify getDefaultInstanceForType() {
        return AchievementAllDataNotifyOuterClass.AchievementAllDataNotify.getDefaultInstance();
      }

      @java.lang.Override
      public AchievementAllDataNotifyOuterClass.AchievementAllDataNotify build() {
        AchievementAllDataNotifyOuterClass.AchievementAllDataNotify result = buildPartial();
      ...
      @java.lang.Override
      public AchievementAllDataNotifyOuterClass.AchievementAllDataNotify buildPartial() {
        AchievementAllDataNotifyOuterClass.AchievementAllDataNotify result = new AchievementAllDataNotifyOuterClass.AchievementAllDataNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof AchievementAllDataNotifyOuterClass.AchievementAllDataNotify) {
          return mergeFrom((AchievementAllDataNotifyOuterClass.AchievementAllDataNotify)other);
        } else {
      ...
      public Builder mergeFrom(AchievementAllDataNotifyOuterClass.AchievementAllDataNotify other) {
        if (other == AchievementAllDataNotifyOuterClass.AchievementAllDataNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        AchievementAllDataNotifyOuterClass.AchievementAllDataNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (AchievementAllDataNotifyOuterClass.AchievementAllDataNotify) e.getUnfinishedMessage();
      ...
      private void ensureAchievementListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          achievementList_ = new java.util.ArrayList<AchievementOuterClass.Achievement>(achievementList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          AchievementOuterClass.Achievement, AchievementOuterClass.Achievement.Builder, AchievementOuterClass.AchievementOrBuilder> achievementListBuilder_;
      ...
      public Builder setAchievementList(
          int index, AchievementOuterClass.Achievement value) {
        if (achievementListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setAchievementList(
          int index, AchievementOuterClass.Achievement.Builder builderForValue) {
        if (achievementListBuilder_ == null) {
          ensureAchievementListIsMutable();
       ...
       * <code>repeated .Achievement achievementList = 4;</code>
       */
      public Builder addAchievementList(AchievementOuterClass.Achievement value) {
        if (achievementListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addAchievementList(
          AchievementOuterClass.Achievement.Builder builderForValue) {
        if (achievementListBuilder_ == null) {
          ensureAchievementListIsMutable();
      ...
      public Builder addAllAchievementList(
          java.lang.Iterable<? extends AchievementOuterClass.Achievement> values) {
        if (achievementListBuilder_ == null) {
          ensureAchievementListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .Achievement achievementList = 4;</code>
       */
      public AchievementOuterClass.Achievement.Builder getAchievementListBuilder(
          int index) {
       ...
       * <code>repeated .Achievement achievementList = 4;</code>
       */
      public AchievementOuterClass.Achievement.Builder addAchievementListBuilder() {
        return getAchievementListFieldBuilder().addBuilder(
            AchievementOuterClass.Achievement.getDefaultInstance());
      }
      /**
       * <code>repeated .Achievement achievementList = 4;</code>
       */
      public AchievementOuterClass.Achievement.Builder addAchievementListBuilder(
          int index) {
        return getAchievementListFieldBuilder().addBuilder(
            index, AchievementOuterClass.Achievement.getDefaultInstance());
      }
      /**
       * <code>repeated .Achievement achievementList = 4;</code>
       */
      public java.util.List<AchievementOuterClass.Achievement.Builder> 
           getAchievementListBuilderList() {
        return getAchievementListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          AchievementOuterClass.Achievement, AchievementOuterClass.Achievement.Builder, AchievementOuterClass.AchievementOrBuilder> 
          getAchievementListFieldBuilder() {
        if (achievementListBuilder_ == null) {
    ...
    private static final AchievementAllDataNotifyOuterClass.AchievementAllDataNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new AchievementAllDataNotifyOuterClass.AchievementAllDataNotify();
    }

    public static AchievementAllDataNotifyOuterClass.AchievementAllDataNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ement.proto\"\261\001\n\030AchievementAllDataNotify" +
      "\022\035\n\025rewardTakenGoalIdList\030\010 \003(\r\022%\n\017achie" +
      "vementList\030\004 \003(\0132\014.Achievement\"O\n\013BPPEPM" +
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          AchievementOuterClass.getDescriptor(),
        });
    internal_static_AchievementAllDataNotify_descriptor =
