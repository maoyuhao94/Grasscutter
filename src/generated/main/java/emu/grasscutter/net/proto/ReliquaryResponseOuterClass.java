...
public final class ReliquaryResponseOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return ReliquaryResponseOuterClass.internal_static_ReliquaryResponse_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ReliquaryResponseOuterClass.ReliquaryResponse.class, ReliquaryResponseOuterClass.ReliquaryResponse.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof ReliquaryResponseOuterClass.ReliquaryResponse)) {
        return super.equals(obj);
      }
      ReliquaryResponseOuterClass.ReliquaryResponse other = (ReliquaryResponseOuterClass.ReliquaryResponse) obj;
    ...
    public static ReliquaryResponseOuterClass.ReliquaryResponse parseFrom(
    ...
    public static ReliquaryResponseOuterClass.ReliquaryResponse parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ReliquaryResponseOuterClass.ReliquaryResponse parseFrom(
    ...
    public static ReliquaryResponseOuterClass.ReliquaryResponse parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ReliquaryResponseOuterClass.ReliquaryResponse parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static ReliquaryResponseOuterClass.ReliquaryResponse parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(ReliquaryResponseOuterClass.ReliquaryResponse prototype) {
    ...
    public static final class Builder extends
        ...
        ReliquaryResponseOuterClass.ReliquaryResponseOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ReliquaryResponseOuterClass.internal_static_ReliquaryResponse_descriptor;
      }
      ...
      // Construct using ReliquaryResponseOuterClass.ReliquaryResponse.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public ReliquaryResponseOuterClass.ReliquaryResponse getDefaultInstanceForType() {
        return ReliquaryResponseOuterClass.ReliquaryResponse.getDefaultInstance();
      }

      @java.lang.Override
      public ReliquaryResponseOuterClass.ReliquaryResponse build() {
        ReliquaryResponseOuterClass.ReliquaryResponse result = buildPartial();
      ...
      @java.lang.Override
      public ReliquaryResponseOuterClass.ReliquaryResponse buildPartial() {
        ReliquaryResponseOuterClass.ReliquaryResponse result = new ReliquaryResponseOuterClass.ReliquaryResponse(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ReliquaryResponseOuterClass.ReliquaryResponse) {
          return mergeFrom((ReliquaryResponseOuterClass.ReliquaryResponse)other);
        } else {
      ...
      public Builder mergeFrom(ReliquaryResponseOuterClass.ReliquaryResponse other) {
        if (other == ReliquaryResponseOuterClass.ReliquaryResponse.getDefaultInstance()) return this;
        if (nbbpegfkpacBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ReliquaryResponseOuterClass.ReliquaryResponse parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ReliquaryResponseOuterClass.ReliquaryResponse) e.getUnfinishedMessage();
    ...
    private static final ReliquaryResponseOuterClass.ReliquaryResponse DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ReliquaryResponseOuterClass.ReliquaryResponse();
    }

    public static ReliquaryResponseOuterClass.ReliquaryResponse getDefaultInstance() {
