...
public final class DelMailRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return DelMailRspOuterClass.internal_static_DelMailRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              DelMailRspOuterClass.DelMailRsp.class, DelMailRspOuterClass.DelMailRsp.Builder.class);
    }
    ...
    public enum MJHOLNPDOKE
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return DelMailRspOuterClass.DelMailRsp.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof DelMailRspOuterClass.DelMailRsp)) {
        return super.equals(obj);
      }
      DelMailRspOuterClass.DelMailRsp other = (DelMailRspOuterClass.DelMailRsp) obj;
    ...
    public static DelMailRspOuterClass.DelMailRsp parseFrom(
    ...
    public static DelMailRspOuterClass.DelMailRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static DelMailRspOuterClass.DelMailRsp parseFrom(
    ...
    public static DelMailRspOuterClass.DelMailRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static DelMailRspOuterClass.DelMailRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static DelMailRspOuterClass.DelMailRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(DelMailRspOuterClass.DelMailRsp prototype) {
    ...
    public static final class Builder extends
        ...
        DelMailRspOuterClass.DelMailRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return DelMailRspOuterClass.internal_static_DelMailRsp_descriptor;
      }
      ...
      // Construct using DelMailRspOuterClass.DelMailRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public DelMailRspOuterClass.DelMailRsp getDefaultInstanceForType() {
        return DelMailRspOuterClass.DelMailRsp.getDefaultInstance();
      }

      @java.lang.Override
      public DelMailRspOuterClass.DelMailRsp build() {
        DelMailRspOuterClass.DelMailRsp result = buildPartial();
      ...
      @java.lang.Override
      public DelMailRspOuterClass.DelMailRsp buildPartial() {
        DelMailRspOuterClass.DelMailRsp result = new DelMailRspOuterClass.DelMailRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof DelMailRspOuterClass.DelMailRsp) {
          return mergeFrom((DelMailRspOuterClass.DelMailRsp)other);
        } else {
      ...
      public Builder mergeFrom(DelMailRspOuterClass.DelMailRsp other) {
        if (other == DelMailRspOuterClass.DelMailRsp.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        DelMailRspOuterClass.DelMailRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (DelMailRspOuterClass.DelMailRsp) e.getUnfinishedMessage();
    ...
    private static final DelMailRspOuterClass.DelMailRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new DelMailRspOuterClass.DelMailRsp();
    }

    public static DelMailRspOuterClass.DelMailRsp getDefaultInstance() {
