...
public final class TowerEnterLevelRspOuterClass {
  ...
  public interface TowerEnterLevelRspOrBuilder extends
    ...
    /**
     * <code>uint32 levelIndex = 15;</code>
     * @return The levelIndex.
     */
    int getLevelIndex();

    /**
     * <code>repeated uint32 towerBuffIdList = 6;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return TowerEnterLevelRspOuterClass.internal_static_TowerEnterLevelRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              TowerEnterLevelRspOuterClass.TowerEnterLevelRsp.class, TowerEnterLevelRspOuterClass.TowerEnterLevelRsp.Builder.class);
    }

    /**
     * Protobuf enum {@code TowerEnterLevelRsp.EHMAHBOHHBD}
     */
    public enum EHMAHBOHHBD
       ...
       */
      public static final EHMAHBOHHBD DCDNILFDFLB = NONE;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 2429;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 2429;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static EHMAHBOHHBD valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static EHMAHBOHHBD forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 2429: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<EHMAHBOHHBD>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          EHMAHBOHHBD> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<EHMAHBOHHBD>() {
              public EHMAHBOHHBD findValueByNumber(int number) {
                return EHMAHBOHHBD.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return TowerEnterLevelRspOuterClass.TowerEnterLevelRsp.getDescriptor().getEnumTypes().get(0);
      }

      private static final EHMAHBOHHBD[] VALUES = getStaticValuesArray();
      private static EHMAHBOHHBD[] getStaticValuesArray() {
        return new EHMAHBOHHBD[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, 
        };
      }
      public static EHMAHBOHHBD valueOf(
      ...
      private EHMAHBOHHBD(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:TowerEnterLevelRsp.EHMAHBOHHBD)
    }

    public static final int LEVELINDEX_FIELD_NUMBER = 15;
    ...
    public static final int TOWERBUFFIDLIST_FIELD_NUMBER = 6;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (levelIndex_ != 0) {
        output.writeUInt32(15, levelIndex_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (levelIndex_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(15, levelIndex_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof TowerEnterLevelRspOuterClass.TowerEnterLevelRsp)) {
        return super.equals(obj);
      }
      TowerEnterLevelRspOuterClass.TowerEnterLevelRsp other = (TowerEnterLevelRspOuterClass.TowerEnterLevelRsp) obj;
    ...
    public int hashCode() {
      ...
      if (getTowerBuffIdListCount() > 0) {
        hash = (37 * hash) + TOWERBUFFIDLIST_FIELD_NUMBER;
    ...
    public static TowerEnterLevelRspOuterClass.TowerEnterLevelRsp parseFrom(
    ...
    public static TowerEnterLevelRspOuterClass.TowerEnterLevelRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static TowerEnterLevelRspOuterClass.TowerEnterLevelRsp parseFrom(
    ...
    public static TowerEnterLevelRspOuterClass.TowerEnterLevelRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static TowerEnterLevelRspOuterClass.TowerEnterLevelRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static TowerEnterLevelRspOuterClass.TowerEnterLevelRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(TowerEnterLevelRspOuterClass.TowerEnterLevelRsp prototype) {
    ...
    public static final class Builder extends
        ...
        TowerEnterLevelRspOuterClass.TowerEnterLevelRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return TowerEnterLevelRspOuterClass.internal_static_TowerEnterLevelRsp_descriptor;
      }
      ...
      // Construct using TowerEnterLevelRspOuterClass.TowerEnterLevelRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public TowerEnterLevelRspOuterClass.TowerEnterLevelRsp getDefaultInstanceForType() {
        return TowerEnterLevelRspOuterClass.TowerEnterLevelRsp.getDefaultInstance();
      }

      @java.lang.Override
      public TowerEnterLevelRspOuterClass.TowerEnterLevelRsp build() {
        TowerEnterLevelRspOuterClass.TowerEnterLevelRsp result = buildPartial();
      ...
      @java.lang.Override
      public TowerEnterLevelRspOuterClass.TowerEnterLevelRsp buildPartial() {
        TowerEnterLevelRspOuterClass.TowerEnterLevelRsp result = new TowerEnterLevelRspOuterClass.TowerEnterLevelRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof TowerEnterLevelRspOuterClass.TowerEnterLevelRsp) {
          return mergeFrom((TowerEnterLevelRspOuterClass.TowerEnterLevelRsp)other);
        } else {
      ...
      public Builder mergeFrom(TowerEnterLevelRspOuterClass.TowerEnterLevelRsp other) {
        if (other == TowerEnterLevelRspOuterClass.TowerEnterLevelRsp.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        TowerEnterLevelRspOuterClass.TowerEnterLevelRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (TowerEnterLevelRspOuterClass.TowerEnterLevelRsp) e.getUnfinishedMessage();
    ...
    private static final TowerEnterLevelRspOuterClass.TowerEnterLevelRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new TowerEnterLevelRspOuterClass.TowerEnterLevelRsp();
    }

    public static TowerEnterLevelRspOuterClass.TowerEnterLevelRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\030TowerEnterLevelRsp.proto\"\264\001\n\022TowerEnte" +
      "rLevelRsp\022\022\n\nlevelIndex\030\017 \001(\r\022\027\n\017towerBu" +
      "ffIdList\030\006 \003(\r\022\017\n\007retcode\030\003 \001(\005\022\017\n\007floor" +
      "Id\030\013 \001(\r\"O\n\013EHMAHBOHHBD\022\010\n\004NONE\020\000\022\020\n\013PEP" +
      "POHPHJOJ\020\375\022\022\017\n\013DCDNILFDFLB\020\000\022\017\n\013NNBKOLMP" +
