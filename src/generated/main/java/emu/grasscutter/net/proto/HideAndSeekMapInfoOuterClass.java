...
public final class HideAndSeekMapInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return HideAndSeekMapInfoOuterClass.internal_static_HideAndSeekMapInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo.class, HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo)) {
        return super.equals(obj);
      }
      HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo other = (HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo) obj;
    ...
    public static HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo parseFrom(
    ...
    public static HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo parseFrom(
    ...
    public static HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo prototype) {
    ...
    public static final class Builder extends
        ...
        HideAndSeekMapInfoOuterClass.HideAndSeekMapInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return HideAndSeekMapInfoOuterClass.internal_static_HideAndSeekMapInfo_descriptor;
      }
      ...
      // Construct using HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo getDefaultInstanceForType() {
        return HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo.getDefaultInstance();
      }

      @java.lang.Override
      public HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo build() {
        HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo result = buildPartial();
      ...
      @java.lang.Override
      public HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo buildPartial() {
        HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo result = new HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo) {
          return mergeFrom((HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo)other);
        } else {
      ...
      public Builder mergeFrom(HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo other) {
        if (other == HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo.getDefaultInstance()) return this;
        if (other.getId() != 0) {
          setId(other.getId());
        }
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo) e.getUnfinishedMessage();
    ...
    private static final HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo();
    }

    public static HideAndSeekMapInfoOuterClass.HideAndSeekMapInfo getDefaultInstance() {
