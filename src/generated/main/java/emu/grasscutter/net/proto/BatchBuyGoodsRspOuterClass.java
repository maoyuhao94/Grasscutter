...
public final class BatchBuyGoodsRspOuterClass {
  ...
  public interface BatchBuyGoodsRspOrBuilder extends
    ...
    /**
     * <code>repeated .ShopGoods goodsList = 11;</code>
     */
    ...
    /**
     * <code>repeated .BuyGoodsParam buyGoodsList = 3;</code>
     */
    java.util.List<BuyGoodsParamOuterClass.BuyGoodsParam> 
        getBuyGoodsListList();
    /**
     * <code>repeated .BuyGoodsParam buyGoodsList = 3;</code>
     */
    BuyGoodsParamOuterClass.BuyGoodsParam getBuyGoodsList(int index);
    /**
     * <code>repeated .BuyGoodsParam buyGoodsList = 3;</code>
     */
     ...
     * <code>repeated .BuyGoodsParam buyGoodsList = 3;</code>
     */
    java.util.List<? extends BuyGoodsParamOuterClass.BuyGoodsParamOrBuilder> 
        getBuyGoodsListOrBuilderList();
    /**
     * <code>repeated .BuyGoodsParam buyGoodsList = 3;</code>
     */
    BuyGoodsParamOuterClass.BuyGoodsParamOrBuilder getBuyGoodsListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 26: {
              if (!((mutable_bitField0_ & 0x00000002) != 0)) {
                buyGoodsList_ = new java.util.ArrayList<BuyGoodsParamOuterClass.BuyGoodsParam>();
                mutable_bitField0_ |= 0x00000002;
              }
              buyGoodsList_.add(
                  input.readMessage(BuyGoodsParamOuterClass.BuyGoodsParam.parser(), extensionRegistry));
              break;
            }
            case 40: {
            ...
            case 90: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                goodsList_ = new java.util.ArrayList<ShopGoodsOuterClass.ShopGoods>();
                mutable_bitField0_ |= 0x00000001;
              }
              goodsList_.add(
                  input.readMessage(ShopGoodsOuterClass.ShopGoods.parser(), extensionRegistry));
              break;
            }
            case 112: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return BatchBuyGoodsRspOuterClass.internal_static_BatchBuyGoodsRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp.class, BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp.Builder.class);
    }

    /**
     * Protobuf enum {@code BatchBuyGoodsRsp.PEONLFKKKFC}
     */
    public enum PEONLFKKKFC
       ...
       */
      public static final PEONLFKKKFC DCDNILFDFLB = NONE;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 714;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 714;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static PEONLFKKKFC valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static PEONLFKKKFC forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 714: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<PEONLFKKKFC>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          PEONLFKKKFC> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<PEONLFKKKFC>() {
              public PEONLFKKKFC findValueByNumber(int number) {
                return PEONLFKKKFC.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp.getDescriptor().getEnumTypes().get(0);
      }

      private static final PEONLFKKKFC[] VALUES = getStaticValuesArray();
      private static PEONLFKKKFC[] getStaticValuesArray() {
        return new PEONLFKKKFC[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, 
        };
      }
      public static PEONLFKKKFC valueOf(
      ...
      private PEONLFKKKFC(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:BatchBuyGoodsRsp.PEONLFKKKFC)
    }
    ...
    public static final int GOODSLIST_FIELD_NUMBER = 11;
    ...
    public static final int BUYGOODSLIST_FIELD_NUMBER = 3;
    private java.util.List<BuyGoodsParamOuterClass.BuyGoodsParam> buyGoodsList_;
    /**
     * <code>repeated .BuyGoodsParam buyGoodsList = 3;</code>
     */
    @java.lang.Override
    public java.util.List<BuyGoodsParamOuterClass.BuyGoodsParam> getBuyGoodsListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends BuyGoodsParamOuterClass.BuyGoodsParamOrBuilder> 
        getBuyGoodsListOrBuilderList() {
      return buyGoodsList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public BuyGoodsParamOuterClass.BuyGoodsParamOrBuilder getBuyGoodsListOrBuilder(
        int index) {
      return buyGoodsList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp)) {
        return super.equals(obj);
      }
      BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp other = (BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp) obj;
    ...
    public static BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp parseFrom(
    ...
    public static BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp parseFrom(
    ...
    public static BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp prototype) {
    ...
    public static final class Builder extends
        ...
        BatchBuyGoodsRspOuterClass.BatchBuyGoodsRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return BatchBuyGoodsRspOuterClass.internal_static_BatchBuyGoodsRsp_descriptor;
      }
      ...
      // Construct using BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp getDefaultInstanceForType() {
        return BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp.getDefaultInstance();
      }

      @java.lang.Override
      public BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp build() {
        BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp result = buildPartial();
      ...
      @java.lang.Override
      public BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp buildPartial() {
        BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp result = new BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp) {
          return mergeFrom((BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp)other);
        } else {
      ...
      public Builder mergeFrom(BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp other) {
        if (other == BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp) e.getUnfinishedMessage();
      ...
      public Builder addAllGoodsList(
          java.lang.Iterable<? extends ShopGoodsOuterClass.ShopGoods> values) {
        if (goodsListBuilder_ == null) {
          ensureGoodsListIsMutable();
      ...
      private void ensureBuyGoodsListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          buyGoodsList_ = new java.util.ArrayList<BuyGoodsParamOuterClass.BuyGoodsParam>(buyGoodsList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          BuyGoodsParamOuterClass.BuyGoodsParam, BuyGoodsParamOuterClass.BuyGoodsParam.Builder, BuyGoodsParamOuterClass.BuyGoodsParamOrBuilder> buyGoodsListBuilder_;
      ...
      public Builder setBuyGoodsList(
          int index, BuyGoodsParamOuterClass.BuyGoodsParam value) {
        if (buyGoodsListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setBuyGoodsList(
          int index, BuyGoodsParamOuterClass.BuyGoodsParam.Builder builderForValue) {
        if (buyGoodsListBuilder_ == null) {
          ensureBuyGoodsListIsMutable();
       ...
       */
      public Builder addBuyGoodsList(
          BuyGoodsParamOuterClass.BuyGoodsParam.Builder builderForValue) {
        if (buyGoodsListBuilder_ == null) {
          ensureBuyGoodsListIsMutable();
      ...
      public Builder addAllBuyGoodsList(
          java.lang.Iterable<? extends BuyGoodsParamOuterClass.BuyGoodsParam> values) {
        if (buyGoodsListBuilder_ == null) {
          ensureBuyGoodsListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .BuyGoodsParam buyGoodsList = 3;</code>
       */
      public BuyGoodsParamOuterClass.BuyGoodsParam.Builder getBuyGoodsListBuilder(
          int index) {
      ...
      public BuyGoodsParamOuterClass.BuyGoodsParam.Builder addBuyGoodsListBuilder() {
        return getBuyGoodsListFieldBuilder().addBuilder(
            BuyGoodsParamOuterClass.BuyGoodsParam.getDefaultInstance());
      }
      /**
       * <code>repeated .BuyGoodsParam buyGoodsList = 3;</code>
       */
      public BuyGoodsParamOuterClass.BuyGoodsParam.Builder addBuyGoodsListBuilder(
          int index) {
        return getBuyGoodsListFieldBuilder().addBuilder(
            index, BuyGoodsParamOuterClass.BuyGoodsParam.getDefaultInstance());
      }
      /**
       * <code>repeated .BuyGoodsParam buyGoodsList = 3;</code>
       */
      public java.util.List<BuyGoodsParamOuterClass.BuyGoodsParam.Builder> 
           getBuyGoodsListBuilderList() {
        return getBuyGoodsListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          BuyGoodsParamOuterClass.BuyGoodsParam, BuyGoodsParamOuterClass.BuyGoodsParam.Builder, BuyGoodsParamOuterClass.BuyGoodsParamOrBuilder> 
          getBuyGoodsListFieldBuilder() {
        if (buyGoodsListBuilder_ == null) {
    ...
    private static final BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp();
    }

    public static BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "o\032\023BuyGoodsParam.proto\"\313\001\n\020BatchBuyGoods" +
      "Rsp\022\017\n\007retcode\030\005 \001(\005\022\035\n\tgoodsList\030\013 \003(\0132" +
      "\n.ShopGoods\022\020\n\010shopType\030\016 \001(\r\022$\n\014buyGood" +
      "sList\030\003 \003(\0132\016.BuyGoodsParam\"O\n\013PEONLFKKK" +
      "FC\022\010\n\004NONE\020\000\022\020\n\013PEPPOHPHJOJ\020\312\005\022\017\n\013DCDNIL" +
    ...
    internal_static_BatchBuyGoodsRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_BatchBuyGoodsRsp_descriptor,
        new java.lang.String[] { "Retcode", "GoodsList", "ShopType", "BuyGoodsList", });
    ShopGoodsOuterClass.getDescriptor();
    BuyGoodsParamOuterClass.getDescriptor();
  }
