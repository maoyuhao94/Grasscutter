...
public final class MusicGameStartRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return MusicGameStartRspOuterClass.internal_static_MusicGameStartRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              MusicGameStartRspOuterClass.MusicGameStartRsp.class, MusicGameStartRspOuterClass.MusicGameStartRsp.Builder.class);
    }
    ...
    public enum PFNNLOBODEB
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return MusicGameStartRspOuterClass.MusicGameStartRsp.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof MusicGameStartRspOuterClass.MusicGameStartRsp)) {
        return super.equals(obj);
      }
      MusicGameStartRspOuterClass.MusicGameStartRsp other = (MusicGameStartRspOuterClass.MusicGameStartRsp) obj;
    ...
    public static MusicGameStartRspOuterClass.MusicGameStartRsp parseFrom(
    ...
    public static MusicGameStartRspOuterClass.MusicGameStartRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static MusicGameStartRspOuterClass.MusicGameStartRsp parseFrom(
    ...
    public static MusicGameStartRspOuterClass.MusicGameStartRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static MusicGameStartRspOuterClass.MusicGameStartRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static MusicGameStartRspOuterClass.MusicGameStartRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(MusicGameStartRspOuterClass.MusicGameStartRsp prototype) {
    ...
    public static final class Builder extends
        ...
        MusicGameStartRspOuterClass.MusicGameStartRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return MusicGameStartRspOuterClass.internal_static_MusicGameStartRsp_descriptor;
      }
      ...
      // Construct using MusicGameStartRspOuterClass.MusicGameStartRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public MusicGameStartRspOuterClass.MusicGameStartRsp getDefaultInstanceForType() {
        return MusicGameStartRspOuterClass.MusicGameStartRsp.getDefaultInstance();
      }

      @java.lang.Override
      public MusicGameStartRspOuterClass.MusicGameStartRsp build() {
        MusicGameStartRspOuterClass.MusicGameStartRsp result = buildPartial();
      ...
      @java.lang.Override
      public MusicGameStartRspOuterClass.MusicGameStartRsp buildPartial() {
        MusicGameStartRspOuterClass.MusicGameStartRsp result = new MusicGameStartRspOuterClass.MusicGameStartRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof MusicGameStartRspOuterClass.MusicGameStartRsp) {
          return mergeFrom((MusicGameStartRspOuterClass.MusicGameStartRsp)other);
        } else {
      ...
      public Builder mergeFrom(MusicGameStartRspOuterClass.MusicGameStartRsp other) {
        if (other == MusicGameStartRspOuterClass.MusicGameStartRsp.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        MusicGameStartRspOuterClass.MusicGameStartRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (MusicGameStartRspOuterClass.MusicGameStartRsp) e.getUnfinishedMessage();
    ...
    private static final MusicGameStartRspOuterClass.MusicGameStartRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new MusicGameStartRspOuterClass.MusicGameStartRsp();
    }

    public static MusicGameStartRspOuterClass.MusicGameStartRsp getDefaultInstance() {
