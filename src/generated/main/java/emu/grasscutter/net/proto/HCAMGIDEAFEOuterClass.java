...
public final class HCAMGIDEAFEOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return HCAMGIDEAFEOuterClass.internal_static_HCAMGIDEAFE_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              HCAMGIDEAFEOuterClass.HCAMGIDEAFE.class, HCAMGIDEAFEOuterClass.HCAMGIDEAFE.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof HCAMGIDEAFEOuterClass.HCAMGIDEAFE)) {
        return super.equals(obj);
      }
      HCAMGIDEAFEOuterClass.HCAMGIDEAFE other = (HCAMGIDEAFEOuterClass.HCAMGIDEAFE) obj;
    ...
    public static HCAMGIDEAFEOuterClass.HCAMGIDEAFE parseFrom(
    ...
    public static HCAMGIDEAFEOuterClass.HCAMGIDEAFE parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static HCAMGIDEAFEOuterClass.HCAMGIDEAFE parseFrom(
    ...
    public static HCAMGIDEAFEOuterClass.HCAMGIDEAFE parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static HCAMGIDEAFEOuterClass.HCAMGIDEAFE parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static HCAMGIDEAFEOuterClass.HCAMGIDEAFE parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(HCAMGIDEAFEOuterClass.HCAMGIDEAFE prototype) {
    ...
    public static final class Builder extends
        ...
        HCAMGIDEAFEOuterClass.HCAMGIDEAFEOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return HCAMGIDEAFEOuterClass.internal_static_HCAMGIDEAFE_descriptor;
      }
      ...
      // Construct using HCAMGIDEAFEOuterClass.HCAMGIDEAFE.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public HCAMGIDEAFEOuterClass.HCAMGIDEAFE getDefaultInstanceForType() {
        return HCAMGIDEAFEOuterClass.HCAMGIDEAFE.getDefaultInstance();
      }

      @java.lang.Override
      public HCAMGIDEAFEOuterClass.HCAMGIDEAFE build() {
        HCAMGIDEAFEOuterClass.HCAMGIDEAFE result = buildPartial();
      ...
      @java.lang.Override
      public HCAMGIDEAFEOuterClass.HCAMGIDEAFE buildPartial() {
        HCAMGIDEAFEOuterClass.HCAMGIDEAFE result = new HCAMGIDEAFEOuterClass.HCAMGIDEAFE(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof HCAMGIDEAFEOuterClass.HCAMGIDEAFE) {
          return mergeFrom((HCAMGIDEAFEOuterClass.HCAMGIDEAFE)other);
        } else {
      ...
      public Builder mergeFrom(HCAMGIDEAFEOuterClass.HCAMGIDEAFE other) {
        if (other == HCAMGIDEAFEOuterClass.HCAMGIDEAFE.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        HCAMGIDEAFEOuterClass.HCAMGIDEAFE parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (HCAMGIDEAFEOuterClass.HCAMGIDEAFE) e.getUnfinishedMessage();
    ...
    private static final HCAMGIDEAFEOuterClass.HCAMGIDEAFE DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new HCAMGIDEAFEOuterClass.HCAMGIDEAFE();
    }

    public static HCAMGIDEAFEOuterClass.HCAMGIDEAFE getDefaultInstance() {
