...
public final class TakeFurnitureMakeReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return TakeFurnitureMakeReqOuterClass.internal_static_TakeFurnitureMakeReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq.class, TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq.Builder.class);
    }
    ...
    public enum JMDDKPFHPPA
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq)) {
        return super.equals(obj);
      }
      TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq other = (TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq) obj;
    ...
    public static TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq parseFrom(
    ...
    public static TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq parseFrom(
    ...
    public static TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq prototype) {
    ...
    public static final class Builder extends
        ...
        TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return TakeFurnitureMakeReqOuterClass.internal_static_TakeFurnitureMakeReq_descriptor;
      }
      ...
      // Construct using TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq getDefaultInstanceForType() {
        return TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq.getDefaultInstance();
      }

      @java.lang.Override
      public TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq build() {
        TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq result = buildPartial();
      ...
      @java.lang.Override
      public TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq buildPartial() {
        TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq result = new TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq) {
          return mergeFrom((TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq)other);
        } else {
      ...
      public Builder mergeFrom(TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq other) {
        if (other == TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq.getDefaultInstance()) return this;
        if (other.getIndex() != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq) e.getUnfinishedMessage();
    ...
    private static final TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq();
    }

    public static TakeFurnitureMakeReqOuterClass.TakeFurnitureMakeReq getDefaultInstance() {
