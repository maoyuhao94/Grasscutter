...
public final class MarkMapReqOuterClass {
  ...
  public interface MarkMapReqOrBuilder extends
     ...
     * @return The op.
     */
    OperationOuterClass.Operation getOp();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 58: {
              ...
              old_ = input.readMessage(MapMarkPointOuterClass.MapMarkPoint.parser(), extensionRegistry);
              if (subBuilder != null) {
            ...
            case 82: {
              ...
              mark_ = input.readMessage(MapMarkPointOuterClass.MapMarkPoint.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return MarkMapReqOuterClass.internal_static_MarkMapReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              MarkMapReqOuterClass.MarkMapReq.class, MarkMapReqOuterClass.MarkMapReq.Builder.class);
    }

    /**
     * Protobuf enum {@code MarkMapReq.LJKBDJKNENE}
     */
    public enum LJKBDJKNENE
       ...
       */
      public static final LJKBDJKNENE DCDNILFDFLB = NONE;
      /**
       * <code>EAJIABGAOCI = 1;</code>
       */
      public static final LJKBDJKNENE EAJIABGAOCI = NNBKOLMPOEA;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 3176;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 3176;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static LJKBDJKNENE valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static LJKBDJKNENE forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 3176: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<LJKBDJKNENE>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          LJKBDJKNENE> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<LJKBDJKNENE>() {
              public LJKBDJKNENE findValueByNumber(int number) {
                return LJKBDJKNENE.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return MarkMapReqOuterClass.MarkMapReq.getDescriptor().getEnumTypes().get(0);
      }

      private static final LJKBDJKNENE[] VALUES = getStaticValuesArray();
      private static LJKBDJKNENE[] getStaticValuesArray() {
        return new LJKBDJKNENE[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, EAJIABGAOCI, 
        };
      }
      public static LJKBDJKNENE valueOf(
      ...
      private LJKBDJKNENE(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:MarkMapReq.LJKBDJKNENE)
    }
     ...
     * @return The op.
     */
    @java.lang.Override public OperationOuterClass.Operation getOp() {
      @SuppressWarnings("deprecation")
      OperationOuterClass.Operation result = OperationOuterClass.Operation.valueOf(op_);
      return result == null ? OperationOuterClass.Operation.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (op_ != OperationOuterClass.Operation.OPERATION_ADD.getNumber()) {
    ...
    public int getSerializedSize() {
      ...
      if (old_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(7, getOld());
      }
      if (mark_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(10, getMark());
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof MarkMapReqOuterClass.MarkMapReq)) {
        return super.equals(obj);
      }
      MarkMapReqOuterClass.MarkMapReq other = (MarkMapReqOuterClass.MarkMapReq) obj;
    ...
    public static MarkMapReqOuterClass.MarkMapReq parseFrom(
    ...
    public static MarkMapReqOuterClass.MarkMapReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static MarkMapReqOuterClass.MarkMapReq parseFrom(
    ...
    public static MarkMapReqOuterClass.MarkMapReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static MarkMapReqOuterClass.MarkMapReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static MarkMapReqOuterClass.MarkMapReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(MarkMapReqOuterClass.MarkMapReq prototype) {
    ...
    public static final class Builder extends
        ...
        MarkMapReqOuterClass.MarkMapReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return MarkMapReqOuterClass.internal_static_MarkMapReq_descriptor;
      }
      ...
      // Construct using MarkMapReqOuterClass.MarkMapReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public MarkMapReqOuterClass.MarkMapReq getDefaultInstanceForType() {
        return MarkMapReqOuterClass.MarkMapReq.getDefaultInstance();
      }

      @java.lang.Override
      public MarkMapReqOuterClass.MarkMapReq build() {
        MarkMapReqOuterClass.MarkMapReq result = buildPartial();
      ...
      @java.lang.Override
      public MarkMapReqOuterClass.MarkMapReq buildPartial() {
        MarkMapReqOuterClass.MarkMapReq result = new MarkMapReqOuterClass.MarkMapReq(this);
        result.op_ = op_;
        if (oldBuilder_ == null) {
          result.old_ = old_;
        } else {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof MarkMapReqOuterClass.MarkMapReq) {
          return mergeFrom((MarkMapReqOuterClass.MarkMapReq)other);
        } else {
      ...
      public Builder mergeFrom(MarkMapReqOuterClass.MarkMapReq other) {
        if (other == MarkMapReqOuterClass.MarkMapReq.getDefaultInstance()) return this;
        if (other.op_ != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        MarkMapReqOuterClass.MarkMapReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (MarkMapReqOuterClass.MarkMapReq) e.getUnfinishedMessage();
       ...
       */
      @java.lang.Override
      public OperationOuterClass.Operation getOp() {
        @SuppressWarnings("deprecation")
        OperationOuterClass.Operation result = OperationOuterClass.Operation.valueOf(op_);
        return result == null ? OperationOuterClass.Operation.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setOp(OperationOuterClass.Operation value) {
        if (value == null) {
      ...
      public Builder mergeOld(MapMarkPointOuterClass.MapMarkPoint value) {
        if (oldBuilder_ == null) {
          if (old_ != null) {
            old_ =
              MapMarkPointOuterClass.MapMarkPoint.newBuilder(old_).mergeFrom(value).buildPartial();
          } else {
            old_ = value;
          }
          onChanged();
      ...
      public Builder mergeMark(MapMarkPointOuterClass.MapMarkPoint value) {
        if (markBuilder_ == null) {
          if (mark_ != null) {
            mark_ =
              MapMarkPointOuterClass.MapMarkPoint.newBuilder(mark_).mergeFrom(value).buildPartial();
          } else {
            mark_ = value;
          }
          onChanged();
    ...
    private static final MarkMapReqOuterClass.MarkMapReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new MarkMapReqOuterClass.MarkMapReq();
    }

    public static MarkMapReqOuterClass.MarkMapReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "MarkPoint.proto\"\277\001\n\nMarkMapReq\022\026\n\002op\030\003 \001" +
      "(\0162\n.Operation\022\032\n\003old\030\007 \001(\0132\r.MapMarkPoi" +
      "nt\022\033\n\004mark\030\n \001(\0132\r.MapMarkPoint\"`\n\013LJKBD" +
      "JKNENE\022\010\n\004NONE\020\000\022\020\n\013PEPPOHPHJOJ\020\350\030\022\017\n\013DC" +
