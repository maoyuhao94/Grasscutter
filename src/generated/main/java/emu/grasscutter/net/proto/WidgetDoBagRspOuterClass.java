...
public final class WidgetDoBagRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return WidgetDoBagRspOuterClass.internal_static_WidgetDoBagRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              WidgetDoBagRspOuterClass.WidgetDoBagRsp.class, WidgetDoBagRspOuterClass.WidgetDoBagRsp.Builder.class);
    }
    ...
    public enum MDHJPMKCGNN
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return WidgetDoBagRspOuterClass.WidgetDoBagRsp.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof WidgetDoBagRspOuterClass.WidgetDoBagRsp)) {
        return super.equals(obj);
      }
      WidgetDoBagRspOuterClass.WidgetDoBagRsp other = (WidgetDoBagRspOuterClass.WidgetDoBagRsp) obj;
    ...
    public static WidgetDoBagRspOuterClass.WidgetDoBagRsp parseFrom(
    ...
    public static WidgetDoBagRspOuterClass.WidgetDoBagRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static WidgetDoBagRspOuterClass.WidgetDoBagRsp parseFrom(
    ...
    public static WidgetDoBagRspOuterClass.WidgetDoBagRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static WidgetDoBagRspOuterClass.WidgetDoBagRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static WidgetDoBagRspOuterClass.WidgetDoBagRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(WidgetDoBagRspOuterClass.WidgetDoBagRsp prototype) {
    ...
    public static final class Builder extends
        ...
        WidgetDoBagRspOuterClass.WidgetDoBagRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return WidgetDoBagRspOuterClass.internal_static_WidgetDoBagRsp_descriptor;
      }
      ...
      // Construct using WidgetDoBagRspOuterClass.WidgetDoBagRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public WidgetDoBagRspOuterClass.WidgetDoBagRsp getDefaultInstanceForType() {
        return WidgetDoBagRspOuterClass.WidgetDoBagRsp.getDefaultInstance();
      }

      @java.lang.Override
      public WidgetDoBagRspOuterClass.WidgetDoBagRsp build() {
        WidgetDoBagRspOuterClass.WidgetDoBagRsp result = buildPartial();
      ...
      @java.lang.Override
      public WidgetDoBagRspOuterClass.WidgetDoBagRsp buildPartial() {
        WidgetDoBagRspOuterClass.WidgetDoBagRsp result = new WidgetDoBagRspOuterClass.WidgetDoBagRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof WidgetDoBagRspOuterClass.WidgetDoBagRsp) {
          return mergeFrom((WidgetDoBagRspOuterClass.WidgetDoBagRsp)other);
        } else {
      ...
      public Builder mergeFrom(WidgetDoBagRspOuterClass.WidgetDoBagRsp other) {
        if (other == WidgetDoBagRspOuterClass.WidgetDoBagRsp.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        WidgetDoBagRspOuterClass.WidgetDoBagRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (WidgetDoBagRspOuterClass.WidgetDoBagRsp) e.getUnfinishedMessage();
    ...
    private static final WidgetDoBagRspOuterClass.WidgetDoBagRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new WidgetDoBagRspOuterClass.WidgetDoBagRsp();
    }

    public static WidgetDoBagRspOuterClass.WidgetDoBagRsp getDefaultInstance() {
