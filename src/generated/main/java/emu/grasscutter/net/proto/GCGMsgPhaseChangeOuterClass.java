...
public final class GCGMsgPhaseChangeOuterClass {
  ...
  public interface GCGMsgPhaseChangeOrBuilder extends
    ...
    /**
     * <code>repeated .Uint32Pair allowControllerMap = 7;</code>
     */
    ...
    /**
     * <code>.GCGPhaseType afterPhase = 13;</code>
     ...
     */
    GCGPhaseTypeOuterClass.GCGPhaseType getAfterPhase();

    /**
     * <code>.GCGPhaseType beforePhase = 8;</code>
     ...
     */
    GCGPhaseTypeOuterClass.GCGPhaseType getBeforePhase();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return GCGMsgPhaseChangeOuterClass.internal_static_GCGMsgPhaseChange_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return GCGMsgPhaseChangeOuterClass.internal_static_GCGMsgPhaseChange_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange.class, GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange.Builder.class);
    }

    public static final int ALLOWCONTROLLERMAP_FIELD_NUMBER = 7;
    ...
    public static final int AFTERPHASE_FIELD_NUMBER = 13;
     ...
     * @return The afterPhase.
     */
    @java.lang.Override public GCGPhaseTypeOuterClass.GCGPhaseType getAfterPhase() {
      @SuppressWarnings("deprecation")
      GCGPhaseTypeOuterClass.GCGPhaseType result = GCGPhaseTypeOuterClass.GCGPhaseType.valueOf(afterPhase_);
      return result == null ? GCGPhaseTypeOuterClass.GCGPhaseType.UNRECOGNIZED : result;
    }

    public static final int BEFOREPHASE_FIELD_NUMBER = 8;
     ...
     * @return The beforePhase.
     */
    @java.lang.Override public GCGPhaseTypeOuterClass.GCGPhaseType getBeforePhase() {
      @SuppressWarnings("deprecation")
      GCGPhaseTypeOuterClass.GCGPhaseType result = GCGPhaseTypeOuterClass.GCGPhaseType.valueOf(beforePhase_);
      return result == null ? GCGPhaseTypeOuterClass.GCGPhaseType.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < allowControllerMap_.size(); i++) {
        output.writeMessage(7, allowControllerMap_.get(i));
      }
      if (beforePhase_ != GCGPhaseTypeOuterClass.GCGPhaseType.GCG_PHASE_TYPE_INVALID.getNumber()) {
        output.writeEnum(8, beforePhase_);
      }
      if (afterPhase_ != GCGPhaseTypeOuterClass.GCGPhaseType.GCG_PHASE_TYPE_INVALID.getNumber()) {
        output.writeEnum(13, afterPhase_);
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < allowControllerMap_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(7, allowControllerMap_.get(i));
      }
      if (beforePhase_ != GCGPhaseTypeOuterClass.GCGPhaseType.GCG_PHASE_TYPE_INVALID.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
          .computeEnumSize(8, beforePhase_);
      }
      if (afterPhase_ != GCGPhaseTypeOuterClass.GCGPhaseType.GCG_PHASE_TYPE_INVALID.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
          .computeEnumSize(13, afterPhase_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange)) {
        return super.equals(obj);
      }
      GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange other = (GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange) obj;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + AFTERPHASE_FIELD_NUMBER;
      hash = (53 * hash) + afterPhase_;
      hash = (37 * hash) + BEFOREPHASE_FIELD_NUMBER;
    ...
    public static GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange parseFrom(
    ...
    public static GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange parseFrom(
    ...
    public static GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange prototype) {
    ...
    public static final class Builder extends
        ...
        GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChangeOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return GCGMsgPhaseChangeOuterClass.internal_static_GCGMsgPhaseChange_descriptor;
      }
      ...
      // Construct using GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange getDefaultInstanceForType() {
        return GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange.getDefaultInstance();
      }

      @java.lang.Override
      public GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange build() {
        GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange result = buildPartial();
      ...
      @java.lang.Override
      public GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange buildPartial() {
        GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange result = new GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange) {
          return mergeFrom((GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange)other);
        } else {
      ...
      public Builder mergeFrom(GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange other) {
        if (other == GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange.getDefaultInstance()) return this;
        if (allowControllerMapBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange) e.getUnfinishedMessage();
       ...
       */
      @java.lang.Override
      public GCGPhaseTypeOuterClass.GCGPhaseType getAfterPhase() {
        @SuppressWarnings("deprecation")
        GCGPhaseTypeOuterClass.GCGPhaseType result = GCGPhaseTypeOuterClass.GCGPhaseType.valueOf(afterPhase_);
        return result == null ? GCGPhaseTypeOuterClass.GCGPhaseType.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setAfterPhase(GCGPhaseTypeOuterClass.GCGPhaseType value) {
        if (value == null) {
          throw new NullPointerException();
        }
       ...
       */
      @java.lang.Override
      public GCGPhaseTypeOuterClass.GCGPhaseType getBeforePhase() {
        @SuppressWarnings("deprecation")
        GCGPhaseTypeOuterClass.GCGPhaseType result = GCGPhaseTypeOuterClass.GCGPhaseType.valueOf(beforePhase_);
        return result == null ? GCGPhaseTypeOuterClass.GCGPhaseType.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setBeforePhase(GCGPhaseTypeOuterClass.GCGPhaseType value) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    private static final GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange();
    }

    public static GCGMsgPhaseChangeOuterClass.GCGMsgPhaseChange getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "proto\032\020Uint32Pair.proto\"\203\001\n\021GCGMsgPhaseC" +
      "hange\022\'\n\022allowControllerMap\030\007 \003(\0132\013.Uint" +
      "32Pair\022!\n\nafterPhase\030\r \001(\0162\r.GCGPhaseTyp" +
      "e\022\"\n\013beforePhase\030\010 \001(\0162\r.GCGPhaseTypeb\006p" +
      "roto3"
    };
    ...
    internal_static_GCGMsgPhaseChange_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_GCGMsgPhaseChange_descriptor,
        new java.lang.String[] { "AllowControllerMap", "AfterPhase", "BeforePhase", });
    GCGPhaseTypeOuterClass.getDescriptor();
    Uint32PairOuterClass.getDescriptor();
  }
