...
public final class HomeEditCustomFurnitureReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 42: {
              HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo.Builder subBuilder = null;
              if (customFurnitureInfo_ != null) {
                subBuilder = customFurnitureInfo_.toBuilder();
              }
              customFurnitureInfo_ = input.readMessage(HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return HomeEditCustomFurnitureReqOuterClass.internal_static_HomeEditCustomFurnitureReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq.class, HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq.Builder.class);
    }
    ...
    public enum OPCOAINIFHP
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo getCustomFurnitureInfo() {
      return customFurnitureInfo_ == null ? HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo.getDefaultInstance() : customFurnitureInfo_;
    }
    /**
     * <code>.HomeCustomFurnitureInfo customFurnitureInfo = 5;</code>
     */
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq)) {
        return super.equals(obj);
      }
      HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq other = (HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq) obj;
    ...
    public static HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq parseFrom(
    ...
    public static HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq parseFrom(
    ...
    public static HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq prototype) {
    ...
    public static final class Builder extends
        ...
        HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return HomeEditCustomFurnitureReqOuterClass.internal_static_HomeEditCustomFurnitureReq_descriptor;
      }
      ...
      // Construct using HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq getDefaultInstanceForType() {
        return HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq.getDefaultInstance();
      }

      @java.lang.Override
      public HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq build() {
        HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq result = buildPartial();
      ...
      @java.lang.Override
      public HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq buildPartial() {
        HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq result = new HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq(this);
        if (customFurnitureInfoBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq) {
          return mergeFrom((HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq)other);
        } else {
      ...
      public Builder mergeFrom(HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq other) {
        if (other == HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq) e.getUnfinishedMessage();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo, HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo.Builder, HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfoOrBuilder> customFurnitureInfoBuilder_;
      /**
       * <code>.HomeCustomFurnitureInfo customFurnitureInfo = 5;</code>
       * @return Whether the customFurnitureInfo field is set.
       */
        ...
        if (customFurnitureInfoBuilder_ == null) {
          if (customFurnitureInfo_ != null) {
            customFurnitureInfo_ =
              HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo.newBuilder(customFurnitureInfo_).mergeFrom(value).buildPartial();
          } else {
            customFurnitureInfo_ = value;
          }
          onChanged();
      ...
      public HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfoOrBuilder getCustomFurnitureInfoOrBuilder() {
        if (customFurnitureInfoBuilder_ != null) {
          ...
          return customFurnitureInfo_ == null ?
              HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo.getDefaultInstance() : customFurnitureInfo_;
        }
      }
      /**
       * <code>.HomeCustomFurnitureInfo customFurnitureInfo = 5;</code>
    ...
    private static final HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq();
    }

    public static HomeEditCustomFurnitureReqOuterClass.HomeEditCustomFurnitureReq getDefaultInstance() {
