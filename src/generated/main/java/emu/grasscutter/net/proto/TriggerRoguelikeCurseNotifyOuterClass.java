...
public final class TriggerRoguelikeCurseNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return TriggerRoguelikeCurseNotifyOuterClass.internal_static_TriggerRoguelikeCurseNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return TriggerRoguelikeCurseNotifyOuterClass.internal_static_TriggerRoguelikeCurseNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify.class, TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify.Builder.class);
    }

    /**
     * Protobuf enum {@code TriggerRoguelikeCurseNotify.IGPBIGLKIEI}
     */
    public enum IGPBIGLKIEI
       ...
       */
      public static final IGPBIGLKIEI DCDNILFDFLB = NONE;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 8642;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 8642;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static IGPBIGLKIEI valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static IGPBIGLKIEI forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 8642: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<IGPBIGLKIEI>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          IGPBIGLKIEI> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<IGPBIGLKIEI>() {
              public IGPBIGLKIEI findValueByNumber(int number) {
                return IGPBIGLKIEI.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify.getDescriptor().getEnumTypes().get(0);
      }

      private static final IGPBIGLKIEI[] VALUES = getStaticValuesArray();
      private static IGPBIGLKIEI[] getStaticValuesArray() {
        return new IGPBIGLKIEI[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, 
        };
      }
      public static IGPBIGLKIEI valueOf(
      ...
      private IGPBIGLKIEI(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:TriggerRoguelikeCurseNotify.IGPBIGLKIEI)
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify)) {
        return super.equals(obj);
      }
      TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify other = (TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify) obj;
    ...
    public static TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify parseFrom(
    ...
    public static TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify parseFrom(
    ...
    public static TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify prototype) {
    ...
    public static final class Builder extends
        ...
        TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return TriggerRoguelikeCurseNotifyOuterClass.internal_static_TriggerRoguelikeCurseNotify_descriptor;
      }
      ...
      // Construct using TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify getDefaultInstanceForType() {
        return TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify.getDefaultInstance();
      }

      @java.lang.Override
      public TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify build() {
        TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify result = buildPartial();
      ...
      @java.lang.Override
      public TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify buildPartial() {
        TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify result = new TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify) {
          return mergeFrom((TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify)other);
        } else {
      ...
      public Builder mergeFrom(TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify other) {
        if (other == TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify) e.getUnfinishedMessage();
    ...
    private static final TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify();
    }

    public static TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n!TriggerRoguelikeCurseNotify.proto\"\331\001\n\033" +
      ...
      "JIBDPBBC\030\005 \001(\r\"O\n\013IGPBIGLKIEI\022\010\n\004NONE\020\000\022" +
      "\020\n\013PEPPOHPHJOJ\020\302C\022\017\n\013DCDNILFDFLB\020\000\022\017\n\013NN" +
