...
public final class DeleteFriendRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return DeleteFriendRspOuterClass.internal_static_DeleteFriendRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              DeleteFriendRspOuterClass.DeleteFriendRsp.class, DeleteFriendRspOuterClass.DeleteFriendRsp.Builder.class);
    }
    ...
    public enum HJECHGCDNFI
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return DeleteFriendRspOuterClass.DeleteFriendRsp.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof DeleteFriendRspOuterClass.DeleteFriendRsp)) {
        return super.equals(obj);
      }
      DeleteFriendRspOuterClass.DeleteFriendRsp other = (DeleteFriendRspOuterClass.DeleteFriendRsp) obj;
    ...
    public static DeleteFriendRspOuterClass.DeleteFriendRsp parseFrom(
    ...
    public static DeleteFriendRspOuterClass.DeleteFriendRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static DeleteFriendRspOuterClass.DeleteFriendRsp parseFrom(
    ...
    public static DeleteFriendRspOuterClass.DeleteFriendRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static DeleteFriendRspOuterClass.DeleteFriendRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static DeleteFriendRspOuterClass.DeleteFriendRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(DeleteFriendRspOuterClass.DeleteFriendRsp prototype) {
    ...
    public static final class Builder extends
        ...
        DeleteFriendRspOuterClass.DeleteFriendRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return DeleteFriendRspOuterClass.internal_static_DeleteFriendRsp_descriptor;
      }
      ...
      // Construct using DeleteFriendRspOuterClass.DeleteFriendRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public DeleteFriendRspOuterClass.DeleteFriendRsp getDefaultInstanceForType() {
        return DeleteFriendRspOuterClass.DeleteFriendRsp.getDefaultInstance();
      }

      @java.lang.Override
      public DeleteFriendRspOuterClass.DeleteFriendRsp build() {
        DeleteFriendRspOuterClass.DeleteFriendRsp result = buildPartial();
      ...
      @java.lang.Override
      public DeleteFriendRspOuterClass.DeleteFriendRsp buildPartial() {
        DeleteFriendRspOuterClass.DeleteFriendRsp result = new DeleteFriendRspOuterClass.DeleteFriendRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof DeleteFriendRspOuterClass.DeleteFriendRsp) {
          return mergeFrom((DeleteFriendRspOuterClass.DeleteFriendRsp)other);
        } else {
      ...
      public Builder mergeFrom(DeleteFriendRspOuterClass.DeleteFriendRsp other) {
        if (other == DeleteFriendRspOuterClass.DeleteFriendRsp.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        DeleteFriendRspOuterClass.DeleteFriendRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (DeleteFriendRspOuterClass.DeleteFriendRsp) e.getUnfinishedMessage();
    ...
    private static final DeleteFriendRspOuterClass.DeleteFriendRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new DeleteFriendRspOuterClass.DeleteFriendRsp();
    }

    public static DeleteFriendRspOuterClass.DeleteFriendRsp getDefaultInstance() {
