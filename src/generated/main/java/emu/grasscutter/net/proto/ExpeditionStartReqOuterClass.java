...
public final class ExpeditionStartReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return ExpeditionStartReqOuterClass.internal_static_ExpeditionStartReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return ExpeditionStartReqOuterClass.internal_static_ExpeditionStartReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ExpeditionStartReqOuterClass.ExpeditionStartReq.class, ExpeditionStartReqOuterClass.ExpeditionStartReq.Builder.class);
    }

    /**
     * Protobuf enum {@code ExpeditionStartReq.CJLHEKIMJCC}
     */
    public enum CJLHEKIMJCC
       ...
       */
      public static final CJLHEKIMJCC DCDNILFDFLB = NONE;
      /**
       * <code>EAJIABGAOCI = 1;</code>
       */
      public static final CJLHEKIMJCC EAJIABGAOCI = NNBKOLMPOEA;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 2020;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 2020;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static CJLHEKIMJCC valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static CJLHEKIMJCC forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 2020: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<CJLHEKIMJCC>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          CJLHEKIMJCC> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<CJLHEKIMJCC>() {
              public CJLHEKIMJCC findValueByNumber(int number) {
                return CJLHEKIMJCC.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return ExpeditionStartReqOuterClass.ExpeditionStartReq.getDescriptor().getEnumTypes().get(0);
      }

      private static final CJLHEKIMJCC[] VALUES = getStaticValuesArray();
      private static CJLHEKIMJCC[] getStaticValuesArray() {
        return new CJLHEKIMJCC[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, EAJIABGAOCI, 
        };
      }
      public static CJLHEKIMJCC valueOf(
      ...
      private CJLHEKIMJCC(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:ExpeditionStartReq.CJLHEKIMJCC)
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof ExpeditionStartReqOuterClass.ExpeditionStartReq)) {
        return super.equals(obj);
      }
      ExpeditionStartReqOuterClass.ExpeditionStartReq other = (ExpeditionStartReqOuterClass.ExpeditionStartReq) obj;
    ...
    public static ExpeditionStartReqOuterClass.ExpeditionStartReq parseFrom(
    ...
    public static ExpeditionStartReqOuterClass.ExpeditionStartReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ExpeditionStartReqOuterClass.ExpeditionStartReq parseFrom(
    ...
    public static ExpeditionStartReqOuterClass.ExpeditionStartReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ExpeditionStartReqOuterClass.ExpeditionStartReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static ExpeditionStartReqOuterClass.ExpeditionStartReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(ExpeditionStartReqOuterClass.ExpeditionStartReq prototype) {
    ...
    public static final class Builder extends
        ...
        ExpeditionStartReqOuterClass.ExpeditionStartReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ExpeditionStartReqOuterClass.internal_static_ExpeditionStartReq_descriptor;
      }
      ...
      // Construct using ExpeditionStartReqOuterClass.ExpeditionStartReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public ExpeditionStartReqOuterClass.ExpeditionStartReq getDefaultInstanceForType() {
        return ExpeditionStartReqOuterClass.ExpeditionStartReq.getDefaultInstance();
      }

      @java.lang.Override
      public ExpeditionStartReqOuterClass.ExpeditionStartReq build() {
        ExpeditionStartReqOuterClass.ExpeditionStartReq result = buildPartial();
      ...
      @java.lang.Override
      public ExpeditionStartReqOuterClass.ExpeditionStartReq buildPartial() {
        ExpeditionStartReqOuterClass.ExpeditionStartReq result = new ExpeditionStartReqOuterClass.ExpeditionStartReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ExpeditionStartReqOuterClass.ExpeditionStartReq) {
          return mergeFrom((ExpeditionStartReqOuterClass.ExpeditionStartReq)other);
        } else {
      ...
      public Builder mergeFrom(ExpeditionStartReqOuterClass.ExpeditionStartReq other) {
        if (other == ExpeditionStartReqOuterClass.ExpeditionStartReq.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ExpeditionStartReqOuterClass.ExpeditionStartReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ExpeditionStartReqOuterClass.ExpeditionStartReq) e.getUnfinishedMessage();
    ...
    private static final ExpeditionStartReqOuterClass.ExpeditionStartReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ExpeditionStartReqOuterClass.ExpeditionStartReq();
    }

    public static ExpeditionStartReqOuterClass.ExpeditionStartReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\030ExpeditionStartReq.proto\"\326\001\n\022Expeditio" +
      "nStartReq\022\033\n\023Unk3300_AIEJKADFLKG\030\004 \001(\r\022\016" +
      "\n\006pathId\030\n \001(\r\022\024\n\014avatarIdList\030\010 \003(\r\022\033\n\023" +
      "Unk3300_AFGPGIIGAKA\030\007 \001(\r\"`\n\013CJLHEKIMJCC" +
      "\022\010\n\004NONE\020\000\022\020\n\013PEPPOHPHJOJ\020\344\017\022\017\n\013DCDNILFD" +
