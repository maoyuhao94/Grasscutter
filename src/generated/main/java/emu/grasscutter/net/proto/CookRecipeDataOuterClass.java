...
public final class CookRecipeDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return CookRecipeDataOuterClass.internal_static_CookRecipeData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              CookRecipeDataOuterClass.CookRecipeData.class, CookRecipeDataOuterClass.CookRecipeData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof CookRecipeDataOuterClass.CookRecipeData)) {
        return super.equals(obj);
      }
      CookRecipeDataOuterClass.CookRecipeData other = (CookRecipeDataOuterClass.CookRecipeData) obj;
    ...
    public static CookRecipeDataOuterClass.CookRecipeData parseFrom(
    ...
    public static CookRecipeDataOuterClass.CookRecipeData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static CookRecipeDataOuterClass.CookRecipeData parseFrom(
    ...
    public static CookRecipeDataOuterClass.CookRecipeData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static CookRecipeDataOuterClass.CookRecipeData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static CookRecipeDataOuterClass.CookRecipeData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(CookRecipeDataOuterClass.CookRecipeData prototype) {
    ...
    public static final class Builder extends
        ...
        CookRecipeDataOuterClass.CookRecipeDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return CookRecipeDataOuterClass.internal_static_CookRecipeData_descriptor;
      }
      ...
      // Construct using CookRecipeDataOuterClass.CookRecipeData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public CookRecipeDataOuterClass.CookRecipeData getDefaultInstanceForType() {
        return CookRecipeDataOuterClass.CookRecipeData.getDefaultInstance();
      }

      @java.lang.Override
      public CookRecipeDataOuterClass.CookRecipeData build() {
        CookRecipeDataOuterClass.CookRecipeData result = buildPartial();
      ...
      @java.lang.Override
      public CookRecipeDataOuterClass.CookRecipeData buildPartial() {
        CookRecipeDataOuterClass.CookRecipeData result = new CookRecipeDataOuterClass.CookRecipeData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof CookRecipeDataOuterClass.CookRecipeData) {
          return mergeFrom((CookRecipeDataOuterClass.CookRecipeData)other);
        } else {
      ...
      public Builder mergeFrom(CookRecipeDataOuterClass.CookRecipeData other) {
        if (other == CookRecipeDataOuterClass.CookRecipeData.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        CookRecipeDataOuterClass.CookRecipeData parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (CookRecipeDataOuterClass.CookRecipeData) e.getUnfinishedMessage();
    ...
    private static final CookRecipeDataOuterClass.CookRecipeData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new CookRecipeDataOuterClass.CookRecipeData();
    }

    public static CookRecipeDataOuterClass.CookRecipeData getDefaultInstance() {
