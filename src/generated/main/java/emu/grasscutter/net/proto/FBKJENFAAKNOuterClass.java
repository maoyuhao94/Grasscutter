...
public final class FBKJENFAAKNOuterClass {
  ...
  public interface FBKJENFAAKNOrBuilder extends
     ...
     */
    java.util.List<EIBBNBEBHGDOuterClass.EIBBNBEBHGD> 
        getAvatarInfoListList();
    /**
     * <code>repeated .EIBBNBEBHGD avatarInfoList = 6;</code>
     */
    EIBBNBEBHGDOuterClass.EIBBNBEBHGD getAvatarInfoList(int index);
    /**
     * <code>repeated .EIBBNBEBHGD avatarInfoList = 6;</code>
     */
     ...
     * <code>repeated .EIBBNBEBHGD avatarInfoList = 6;</code>
     */
    java.util.List<? extends EIBBNBEBHGDOuterClass.EIBBNBEBHGDOrBuilder> 
        getAvatarInfoListOrBuilderList();
    /**
     * <code>repeated .EIBBNBEBHGD avatarInfoList = 6;</code>
     */
    EIBBNBEBHGDOuterClass.EIBBNBEBHGDOrBuilder getAvatarInfoListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 50: {
              if (!((mutable_bitField0_ & 0x00000002) != 0)) {
                avatarInfoList_ = new java.util.ArrayList<EIBBNBEBHGDOuterClass.EIBBNBEBHGD>();
                mutable_bitField0_ |= 0x00000002;
              }
              avatarInfoList_.add(
                  input.readMessage(EIBBNBEBHGDOuterClass.EIBBNBEBHGD.parser(), extensionRegistry));
              break;
            }
            case 96: {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return FBKJENFAAKNOuterClass.internal_static_FBKJENFAAKN_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return FBKJENFAAKNOuterClass.internal_static_FBKJENFAAKN_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              FBKJENFAAKNOuterClass.FBKJENFAAKN.class, FBKJENFAAKNOuterClass.FBKJENFAAKN.Builder.class);
    }
    ...
    private java.util.List<EIBBNBEBHGDOuterClass.EIBBNBEBHGD> avatarInfoList_;
    /**
     * <code>repeated .EIBBNBEBHGD avatarInfoList = 6;</code>
     */
    @java.lang.Override
    public java.util.List<EIBBNBEBHGDOuterClass.EIBBNBEBHGD> getAvatarInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends EIBBNBEBHGDOuterClass.EIBBNBEBHGDOrBuilder> 
        getAvatarInfoListOrBuilderList() {
      return avatarInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public EIBBNBEBHGDOuterClass.EIBBNBEBHGD getAvatarInfoList(int index) {
     ...
     */
    @java.lang.Override
    public EIBBNBEBHGDOuterClass.EIBBNBEBHGDOrBuilder getAvatarInfoListOrBuilder(
        int index) {
      return avatarInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof FBKJENFAAKNOuterClass.FBKJENFAAKN)) {
        return super.equals(obj);
      }
      FBKJENFAAKNOuterClass.FBKJENFAAKN other = (FBKJENFAAKNOuterClass.FBKJENFAAKN) obj;
    ...
    public static FBKJENFAAKNOuterClass.FBKJENFAAKN parseFrom(
    ...
    public static FBKJENFAAKNOuterClass.FBKJENFAAKN parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static FBKJENFAAKNOuterClass.FBKJENFAAKN parseFrom(
    ...
    public static FBKJENFAAKNOuterClass.FBKJENFAAKN parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static FBKJENFAAKNOuterClass.FBKJENFAAKN parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static FBKJENFAAKNOuterClass.FBKJENFAAKN parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(FBKJENFAAKNOuterClass.FBKJENFAAKN prototype) {
    ...
    public static final class Builder extends
        ...
        FBKJENFAAKNOuterClass.FBKJENFAAKNOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return FBKJENFAAKNOuterClass.internal_static_FBKJENFAAKN_descriptor;
      }
      ...
      // Construct using FBKJENFAAKNOuterClass.FBKJENFAAKN.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public FBKJENFAAKNOuterClass.FBKJENFAAKN getDefaultInstanceForType() {
        return FBKJENFAAKNOuterClass.FBKJENFAAKN.getDefaultInstance();
      }

      @java.lang.Override
      public FBKJENFAAKNOuterClass.FBKJENFAAKN build() {
        FBKJENFAAKNOuterClass.FBKJENFAAKN result = buildPartial();
      ...
      @java.lang.Override
      public FBKJENFAAKNOuterClass.FBKJENFAAKN buildPartial() {
        FBKJENFAAKNOuterClass.FBKJENFAAKN result = new FBKJENFAAKNOuterClass.FBKJENFAAKN(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof FBKJENFAAKNOuterClass.FBKJENFAAKN) {
          return mergeFrom((FBKJENFAAKNOuterClass.FBKJENFAAKN)other);
        } else {
      ...
      public Builder mergeFrom(FBKJENFAAKNOuterClass.FBKJENFAAKN other) {
        if (other == FBKJENFAAKNOuterClass.FBKJENFAAKN.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        FBKJENFAAKNOuterClass.FBKJENFAAKN parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (FBKJENFAAKNOuterClass.FBKJENFAAKN) e.getUnfinishedMessage();
      ...
      private void ensureAvatarInfoListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          avatarInfoList_ = new java.util.ArrayList<EIBBNBEBHGDOuterClass.EIBBNBEBHGD>(avatarInfoList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          EIBBNBEBHGDOuterClass.EIBBNBEBHGD, EIBBNBEBHGDOuterClass.EIBBNBEBHGD.Builder, EIBBNBEBHGDOuterClass.EIBBNBEBHGDOrBuilder> avatarInfoListBuilder_;
      ...
      public Builder setAvatarInfoList(
          int index, EIBBNBEBHGDOuterClass.EIBBNBEBHGD value) {
        if (avatarInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setAvatarInfoList(
          int index, EIBBNBEBHGDOuterClass.EIBBNBEBHGD.Builder builderForValue) {
        if (avatarInfoListBuilder_ == null) {
          ensureAvatarInfoListIsMutable();
       ...
       * <code>repeated .EIBBNBEBHGD avatarInfoList = 6;</code>
       */
      public Builder addAvatarInfoList(EIBBNBEBHGDOuterClass.EIBBNBEBHGD value) {
        if (avatarInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addAvatarInfoList(
          EIBBNBEBHGDOuterClass.EIBBNBEBHGD.Builder builderForValue) {
        if (avatarInfoListBuilder_ == null) {
          ensureAvatarInfoListIsMutable();
      ...
      public Builder addAllAvatarInfoList(
          java.lang.Iterable<? extends EIBBNBEBHGDOuterClass.EIBBNBEBHGD> values) {
        if (avatarInfoListBuilder_ == null) {
          ensureAvatarInfoListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .EIBBNBEBHGD avatarInfoList = 6;</code>
       */
      public EIBBNBEBHGDOuterClass.EIBBNBEBHGD.Builder getAvatarInfoListBuilder(
          int index) {
       ...
       * <code>repeated .EIBBNBEBHGD avatarInfoList = 6;</code>
       */
      public EIBBNBEBHGDOuterClass.EIBBNBEBHGD.Builder addAvatarInfoListBuilder() {
        return getAvatarInfoListFieldBuilder().addBuilder(
            EIBBNBEBHGDOuterClass.EIBBNBEBHGD.getDefaultInstance());
      }
      /**
       * <code>repeated .EIBBNBEBHGD avatarInfoList = 6;</code>
       */
      public EIBBNBEBHGDOuterClass.EIBBNBEBHGD.Builder addAvatarInfoListBuilder(
          int index) {
        return getAvatarInfoListFieldBuilder().addBuilder(
            index, EIBBNBEBHGDOuterClass.EIBBNBEBHGD.getDefaultInstance());
      }
      /**
       * <code>repeated .EIBBNBEBHGD avatarInfoList = 6;</code>
       */
      public java.util.List<EIBBNBEBHGDOuterClass.EIBBNBEBHGD.Builder> 
           getAvatarInfoListBuilderList() {
        return getAvatarInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          EIBBNBEBHGDOuterClass.EIBBNBEBHGD, EIBBNBEBHGDOuterClass.EIBBNBEBHGD.Builder, EIBBNBEBHGDOuterClass.EIBBNBEBHGDOrBuilder> 
          getAvatarInfoListFieldBuilder() {
        if (avatarInfoListBuilder_ == null) {
    ...
    private static final FBKJENFAAKNOuterClass.FBKJENFAAKN DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new FBKJENFAAKNOuterClass.FBKJENFAAKN();
    }

    public static FBKJENFAAKNOuterClass.FBKJENFAAKN getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "atarInfoList\030\006 \003(\0132\014.EIBBNBEBHGDb\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          EIBBNBEBHGDOuterClass.getDescriptor(),
        });
    internal_static_FBKJENFAAKN_descriptor =
