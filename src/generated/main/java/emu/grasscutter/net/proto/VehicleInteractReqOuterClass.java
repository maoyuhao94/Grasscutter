...
public final class VehicleInteractReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return VehicleInteractReqOuterClass.internal_static_VehicleInteractReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              VehicleInteractReqOuterClass.VehicleInteractReq.class, VehicleInteractReqOuterClass.VehicleInteractReq.Builder.class);
    }
    ...
    public enum HFFFNNLCHDH
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return VehicleInteractReqOuterClass.VehicleInteractReq.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof VehicleInteractReqOuterClass.VehicleInteractReq)) {
        return super.equals(obj);
      }
      VehicleInteractReqOuterClass.VehicleInteractReq other = (VehicleInteractReqOuterClass.VehicleInteractReq) obj;
    ...
    public static VehicleInteractReqOuterClass.VehicleInteractReq parseFrom(
    ...
    public static VehicleInteractReqOuterClass.VehicleInteractReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static VehicleInteractReqOuterClass.VehicleInteractReq parseFrom(
    ...
    public static VehicleInteractReqOuterClass.VehicleInteractReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static VehicleInteractReqOuterClass.VehicleInteractReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static VehicleInteractReqOuterClass.VehicleInteractReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(VehicleInteractReqOuterClass.VehicleInteractReq prototype) {
    ...
    public static final class Builder extends
        ...
        VehicleInteractReqOuterClass.VehicleInteractReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return VehicleInteractReqOuterClass.internal_static_VehicleInteractReq_descriptor;
      }
      ...
      // Construct using VehicleInteractReqOuterClass.VehicleInteractReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public VehicleInteractReqOuterClass.VehicleInteractReq getDefaultInstanceForType() {
        return VehicleInteractReqOuterClass.VehicleInteractReq.getDefaultInstance();
      }

      @java.lang.Override
      public VehicleInteractReqOuterClass.VehicleInteractReq build() {
        VehicleInteractReqOuterClass.VehicleInteractReq result = buildPartial();
      ...
      @java.lang.Override
      public VehicleInteractReqOuterClass.VehicleInteractReq buildPartial() {
        VehicleInteractReqOuterClass.VehicleInteractReq result = new VehicleInteractReqOuterClass.VehicleInteractReq(this);
        result.pos_ = pos_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof VehicleInteractReqOuterClass.VehicleInteractReq) {
          return mergeFrom((VehicleInteractReqOuterClass.VehicleInteractReq)other);
        } else {
      ...
      public Builder mergeFrom(VehicleInteractReqOuterClass.VehicleInteractReq other) {
        if (other == VehicleInteractReqOuterClass.VehicleInteractReq.getDefaultInstance()) return this;
        if (other.getPos() != 0) {
          setPos(other.getPos());
        }
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        VehicleInteractReqOuterClass.VehicleInteractReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (VehicleInteractReqOuterClass.VehicleInteractReq) e.getUnfinishedMessage();
    ...
    private static final VehicleInteractReqOuterClass.VehicleInteractReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new VehicleInteractReqOuterClass.VehicleInteractReq();
    }

    public static VehicleInteractReqOuterClass.VehicleInteractReq getDefaultInstance() {
