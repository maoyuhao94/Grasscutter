...
public final class EntityFightPropChangeReasonNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return EntityFightPropChangeReasonNotifyOuterClass.internal_static_EntityFightPropChangeReasonNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify.class, EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify.Builder.class);
    }
    ...
    public enum LMACOGPGNDH
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify.getDescriptor().getEnumTypes().get(0);
      }
     ...
     * @return The reason.
     */
    @java.lang.Override public PropChangeReasonOuterClass.PropChangeReason getReason() {
      @SuppressWarnings("deprecation")
      PropChangeReasonOuterClass.PropChangeReason result = PropChangeReasonOuterClass.PropChangeReason.valueOf(reason_);
     ...
     * @return The changeHpReason.
     */
    @java.lang.Override public ChangeHpReasonOuterClass.ChangeHpReason getChangeHpReason() {
      @SuppressWarnings("deprecation")
      ChangeHpReasonOuterClass.ChangeHpReason result = ChangeHpReasonOuterClass.ChangeHpReason.valueOf(changeHpReason_);
     ...
     * @return The changeEnergyReason.
     */
    @java.lang.Override public ChangeEnergyReasonOuterClass.ChangeEnergyReason getChangeEnergyReason() {
      @SuppressWarnings("deprecation")
      ChangeEnergyReasonOuterClass.ChangeEnergyReason result = ChangeEnergyReasonOuterClass.ChangeEnergyReason.valueOf(changeEnergyReason_);
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (changeEnergyReason_ != ChangeEnergyReasonOuterClass.ChangeEnergyReason.CHANGE_ENERGY_REASON_NONE.getNumber()) {
        output.writeEnum(3, changeEnergyReason_);
      }
      if (java.lang.Float.floatToRawIntBits(propDelta_) != 0) {
        output.writeFloat(4, propDelta_);
      }
      if (changeHpReason_ != ChangeHpReasonOuterClass.ChangeHpReason.CHANGE_HP_REASON_NONE.getNumber()) {
        output.writeEnum(6, changeHpReason_);
      }
      if (entityId_ != 0) {
        output.writeUInt32(12, entityId_);
      }
      if (reason_ != PropChangeReasonOuterClass.PropChangeReason.PROP_CHANGE_REASON_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify)) {
        return super.equals(obj);
      }
      EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify other = (EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify) obj;
    ...
    public static EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify parseFrom(
    ...
    public static EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify parseFrom(
    ...
    public static EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify prototype) {
    ...
    public static final class Builder extends
        ...
        EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return EntityFightPropChangeReasonNotifyOuterClass.internal_static_EntityFightPropChangeReasonNotify_descriptor;
      }
      ...
      // Construct using EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify getDefaultInstanceForType() {
        return EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify.getDefaultInstance();
      }

      @java.lang.Override
      public EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify build() {
        EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify result = buildPartial();
      ...
      @java.lang.Override
      public EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify buildPartial() {
        EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify result = new EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify) {
          return mergeFrom((EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify)other);
        } else {
      ...
      public Builder mergeFrom(EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify other) {
        if (other == EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify) e.getUnfinishedMessage();
    ...
    private static final EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify();
    }

    public static EntityFightPropChangeReasonNotifyOuterClass.EntityFightPropChangeReasonNotify getDefaultInstance() {
