...
public final class HomePlantSubFieldDataOuterClass {
  ...
  public interface HomePlantSubFieldDataOrBuilder extends
    ...
    /**
     * <code>repeated uint32 entityIdList = 4;</code>
    ...
    /**
     * <code>uint32 homeGatherId = 10;</code>
     * @return The homeGatherId.
     */
    int getHomeGatherId();

    /**
     * <code>.HomePlantFieldStatus fieldStatus = 8;</code>
     ...
     */
    HomePlantFieldStatusOuterClass.HomePlantFieldStatus getFieldStatus();

    /**
     * <code>uint32 seedId = 6;</code>
     * @return The seedId.
     */
    int getSeedId();
  }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return HomePlantSubFieldDataOuterClass.internal_static_HomePlantSubFieldData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return HomePlantSubFieldDataOuterClass.internal_static_HomePlantSubFieldData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              HomePlantSubFieldDataOuterClass.HomePlantSubFieldData.class, HomePlantSubFieldDataOuterClass.HomePlantSubFieldData.Builder.class);
    }
    ...
    public static final int ENTITYIDLIST_FIELD_NUMBER = 4;
    ...
    public static final int HOMEGATHERID_FIELD_NUMBER = 10;
    ...
    public static final int FIELDSTATUS_FIELD_NUMBER = 8;
     ...
     * @return The fieldStatus.
     */
    @java.lang.Override public HomePlantFieldStatusOuterClass.HomePlantFieldStatus getFieldStatus() {
      @SuppressWarnings("deprecation")
      HomePlantFieldStatusOuterClass.HomePlantFieldStatus result = HomePlantFieldStatusOuterClass.HomePlantFieldStatus.valueOf(fieldStatus_);
      return result == null ? HomePlantFieldStatusOuterClass.HomePlantFieldStatus.UNRECOGNIZED : result;
    }

    public static final int SEEDID_FIELD_NUMBER = 6;
    private int seedId_;
    /**
     * <code>uint32 seedId = 6;</code>
     * @return The seedId.
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (seedId_ != 0) {
        output.writeUInt32(6, seedId_);
      }
      if (fieldStatus_ != HomePlantFieldStatusOuterClass.HomePlantFieldStatus.HOME_PLANT_FIELD_STATUS_STATUE_NONE.getNumber()) {
        output.writeEnum(8, fieldStatus_);
      }
      if (homeGatherId_ != 0) {
        output.writeUInt32(10, homeGatherId_);
      }
      if (endTime_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (homeGatherId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(10, homeGatherId_);
      }
      if (endTime_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof HomePlantSubFieldDataOuterClass.HomePlantSubFieldData)) {
        return super.equals(obj);
      }
      HomePlantSubFieldDataOuterClass.HomePlantSubFieldData other = (HomePlantSubFieldDataOuterClass.HomePlantSubFieldData) obj;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + HOMEGATHERID_FIELD_NUMBER;
      hash = (53 * hash) + getHomeGatherId();
      hash = (37 * hash) + FIELDSTATUS_FIELD_NUMBER;
    ...
    public static HomePlantSubFieldDataOuterClass.HomePlantSubFieldData parseFrom(
    ...
    public static HomePlantSubFieldDataOuterClass.HomePlantSubFieldData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static HomePlantSubFieldDataOuterClass.HomePlantSubFieldData parseFrom(
    ...
    public static HomePlantSubFieldDataOuterClass.HomePlantSubFieldData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static HomePlantSubFieldDataOuterClass.HomePlantSubFieldData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static HomePlantSubFieldDataOuterClass.HomePlantSubFieldData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(HomePlantSubFieldDataOuterClass.HomePlantSubFieldData prototype) {
    ...
    public static final class Builder extends
        ...
        HomePlantSubFieldDataOuterClass.HomePlantSubFieldDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return HomePlantSubFieldDataOuterClass.internal_static_HomePlantSubFieldData_descriptor;
      }
      ...
      // Construct using HomePlantSubFieldDataOuterClass.HomePlantSubFieldData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public HomePlantSubFieldDataOuterClass.HomePlantSubFieldData getDefaultInstanceForType() {
        return HomePlantSubFieldDataOuterClass.HomePlantSubFieldData.getDefaultInstance();
      }

      @java.lang.Override
      public HomePlantSubFieldDataOuterClass.HomePlantSubFieldData build() {
        HomePlantSubFieldDataOuterClass.HomePlantSubFieldData result = buildPartial();
      ...
      @java.lang.Override
      public HomePlantSubFieldDataOuterClass.HomePlantSubFieldData buildPartial() {
        HomePlantSubFieldDataOuterClass.HomePlantSubFieldData result = new HomePlantSubFieldDataOuterClass.HomePlantSubFieldData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof HomePlantSubFieldDataOuterClass.HomePlantSubFieldData) {
          return mergeFrom((HomePlantSubFieldDataOuterClass.HomePlantSubFieldData)other);
        } else {
      ...
      public Builder mergeFrom(HomePlantSubFieldDataOuterClass.HomePlantSubFieldData other) {
        if (other == HomePlantSubFieldDataOuterClass.HomePlantSubFieldData.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        HomePlantSubFieldDataOuterClass.HomePlantSubFieldData parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (HomePlantSubFieldDataOuterClass.HomePlantSubFieldData) e.getUnfinishedMessage();
       ...
       */
      @java.lang.Override
      public HomePlantFieldStatusOuterClass.HomePlantFieldStatus getFieldStatus() {
        @SuppressWarnings("deprecation")
        HomePlantFieldStatusOuterClass.HomePlantFieldStatus result = HomePlantFieldStatusOuterClass.HomePlantFieldStatus.valueOf(fieldStatus_);
        return result == null ? HomePlantFieldStatusOuterClass.HomePlantFieldStatus.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setFieldStatus(HomePlantFieldStatusOuterClass.HomePlantFieldStatus value) {
        if (value == null) {
    ...
    private static final HomePlantSubFieldDataOuterClass.HomePlantSubFieldData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new HomePlantSubFieldDataOuterClass.HomePlantSubFieldData();
    }

    public static HomePlantSubFieldDataOuterClass.HomePlantSubFieldData getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "FieldStatus.proto\"\220\001\n\025HomePlantSubFieldD" +
      "ata\022\017\n\007endTime\030\017 \001(\r\022\024\n\014entityIdList\030\004 \003" +
      "(\r\022\024\n\014homeGatherId\030\n \001(\r\022*\n\013fieldStatus\030" +
      "\010 \001(\0162\025.HomePlantFieldStatus\022\016\n\006seedId\030\006" +
      " \001(\rb\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          HomePlantFieldStatusOuterClass.getDescriptor(),
        });
    internal_static_HomePlantSubFieldData_descriptor =
    ...
    internal_static_HomePlantSubFieldData_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_HomePlantSubFieldData_descriptor,
        new java.lang.String[] { "EndTime", "EntityIdList", "HomeGatherId", "FieldStatus", "SeedId", });
    HomePlantFieldStatusOuterClass.getDescriptor();
  }
