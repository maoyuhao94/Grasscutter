...
public final class SetUpLunchBoxWidgetReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return SetUpLunchBoxWidgetReqOuterClass.internal_static_SetUpLunchBoxWidgetReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq.class, SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq.Builder.class);
    }
    ...
    public enum HFHLKGOKGOE
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq)) {
        return super.equals(obj);
      }
      SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq other = (SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq) obj;
    ...
    public static SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq parseFrom(
    ...
    public static SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq parseFrom(
    ...
    public static SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq prototype) {
    ...
    public static final class Builder extends
        ...
        SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return SetUpLunchBoxWidgetReqOuterClass.internal_static_SetUpLunchBoxWidgetReq_descriptor;
      }
      ...
      // Construct using SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq getDefaultInstanceForType() {
        return SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq.getDefaultInstance();
      }

      @java.lang.Override
      public SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq build() {
        SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq result = buildPartial();
      ...
      @java.lang.Override
      public SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq buildPartial() {
        SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq result = new SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq(this);
        if (lunchBoxDataBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq) {
          return mergeFrom((SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq)other);
        } else {
      ...
      public Builder mergeFrom(SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq other) {
        if (other == SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq) e.getUnfinishedMessage();
    ...
    private static final SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq();
    }

    public static SetUpLunchBoxWidgetReqOuterClass.SetUpLunchBoxWidgetReq getDefaultInstance() {
