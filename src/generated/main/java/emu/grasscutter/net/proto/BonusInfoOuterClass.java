...
public final class BonusInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return BonusInfoOuterClass.internal_static_BonusInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              BonusInfoOuterClass.BonusInfo.class, BonusInfoOuterClass.BonusInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof BonusInfoOuterClass.BonusInfo)) {
        return super.equals(obj);
      }
      BonusInfoOuterClass.BonusInfo other = (BonusInfoOuterClass.BonusInfo) obj;
    ...
    public static BonusInfoOuterClass.BonusInfo parseFrom(
    ...
    public static BonusInfoOuterClass.BonusInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static BonusInfoOuterClass.BonusInfo parseFrom(
    ...
    public static BonusInfoOuterClass.BonusInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static BonusInfoOuterClass.BonusInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static BonusInfoOuterClass.BonusInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(BonusInfoOuterClass.BonusInfo prototype) {
    ...
    public static final class Builder extends
        ...
        BonusInfoOuterClass.BonusInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return BonusInfoOuterClass.internal_static_BonusInfo_descriptor;
      }
      ...
      // Construct using BonusInfoOuterClass.BonusInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public BonusInfoOuterClass.BonusInfo getDefaultInstanceForType() {
        return BonusInfoOuterClass.BonusInfo.getDefaultInstance();
      }

      @java.lang.Override
      public BonusInfoOuterClass.BonusInfo build() {
        BonusInfoOuterClass.BonusInfo result = buildPartial();
      ...
      @java.lang.Override
      public BonusInfoOuterClass.BonusInfo buildPartial() {
        BonusInfoOuterClass.BonusInfo result = new BonusInfoOuterClass.BonusInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof BonusInfoOuterClass.BonusInfo) {
          return mergeFrom((BonusInfoOuterClass.BonusInfo)other);
        } else {
      ...
      public Builder mergeFrom(BonusInfoOuterClass.BonusInfo other) {
        if (other == BonusInfoOuterClass.BonusInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        BonusInfoOuterClass.BonusInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (BonusInfoOuterClass.BonusInfo) e.getUnfinishedMessage();
    ...
    private static final BonusInfoOuterClass.BonusInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new BonusInfoOuterClass.BonusInfo();
    }

    public static BonusInfoOuterClass.BonusInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\017BonusInfo.proto\"#\n\tBonusInfo\022\026\n\016leftBo" +
      "nusCount\030\r \001(\rb\006proto3"
    };
