...
public final class MpPlayRewardOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return MpPlayRewardOuterClass.internal_static_MpPlayReward_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return MpPlayRewardOuterClass.internal_static_MpPlayReward_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              MpPlayRewardOuterClass.MpPlayReward.class, MpPlayRewardOuterClass.MpPlayReward.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof MpPlayRewardOuterClass.MpPlayReward)) {
        return super.equals(obj);
      }
      MpPlayRewardOuterClass.MpPlayReward other = (MpPlayRewardOuterClass.MpPlayReward) obj;
    ...
    public static MpPlayRewardOuterClass.MpPlayReward parseFrom(
    ...
    public static MpPlayRewardOuterClass.MpPlayReward parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static MpPlayRewardOuterClass.MpPlayReward parseFrom(
    ...
    public static MpPlayRewardOuterClass.MpPlayReward parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static MpPlayRewardOuterClass.MpPlayReward parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static MpPlayRewardOuterClass.MpPlayReward parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(MpPlayRewardOuterClass.MpPlayReward prototype) {
    ...
    public static final class Builder extends
        ...
        MpPlayRewardOuterClass.MpPlayRewardOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return MpPlayRewardOuterClass.internal_static_MpPlayReward_descriptor;
      }
      ...
      // Construct using MpPlayRewardOuterClass.MpPlayReward.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public MpPlayRewardOuterClass.MpPlayReward getDefaultInstanceForType() {
        return MpPlayRewardOuterClass.MpPlayReward.getDefaultInstance();
      }

      @java.lang.Override
      public MpPlayRewardOuterClass.MpPlayReward build() {
        MpPlayRewardOuterClass.MpPlayReward result = buildPartial();
      ...
      @java.lang.Override
      public MpPlayRewardOuterClass.MpPlayReward buildPartial() {
        MpPlayRewardOuterClass.MpPlayReward result = new MpPlayRewardOuterClass.MpPlayReward(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof MpPlayRewardOuterClass.MpPlayReward) {
          return mergeFrom((MpPlayRewardOuterClass.MpPlayReward)other);
        } else {
      ...
      public Builder mergeFrom(MpPlayRewardOuterClass.MpPlayReward other) {
        if (other == MpPlayRewardOuterClass.MpPlayReward.getDefaultInstance()) return this;
        if (other.getResin() != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        MpPlayRewardOuterClass.MpPlayReward parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (MpPlayRewardOuterClass.MpPlayReward) e.getUnfinishedMessage();
    ...
    private static final MpPlayRewardOuterClass.MpPlayReward DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new MpPlayRewardOuterClass.MpPlayReward();
    }

    public static MpPlayRewardOuterClass.MpPlayReward getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "alifyUidList\030\003 \003(\rb\006proto3"
    };
