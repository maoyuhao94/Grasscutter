...
public final class ChildQuestOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return ChildQuestOuterClass.internal_static_ChildQuest_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ChildQuestOuterClass.ChildQuest.class, ChildQuestOuterClass.ChildQuest.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof ChildQuestOuterClass.ChildQuest)) {
        return super.equals(obj);
      }
      ChildQuestOuterClass.ChildQuest other = (ChildQuestOuterClass.ChildQuest) obj;
    ...
    public static ChildQuestOuterClass.ChildQuest parseFrom(
    ...
    public static ChildQuestOuterClass.ChildQuest parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ChildQuestOuterClass.ChildQuest parseFrom(
    ...
    public static ChildQuestOuterClass.ChildQuest parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ChildQuestOuterClass.ChildQuest parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static ChildQuestOuterClass.ChildQuest parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(ChildQuestOuterClass.ChildQuest prototype) {
    ...
    public static final class Builder extends
        ...
        ChildQuestOuterClass.ChildQuestOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ChildQuestOuterClass.internal_static_ChildQuest_descriptor;
      }
      ...
      // Construct using ChildQuestOuterClass.ChildQuest.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public ChildQuestOuterClass.ChildQuest getDefaultInstanceForType() {
        return ChildQuestOuterClass.ChildQuest.getDefaultInstance();
      }

      @java.lang.Override
      public ChildQuestOuterClass.ChildQuest build() {
        ChildQuestOuterClass.ChildQuest result = buildPartial();
      ...
      @java.lang.Override
      public ChildQuestOuterClass.ChildQuest buildPartial() {
        ChildQuestOuterClass.ChildQuest result = new ChildQuestOuterClass.ChildQuest(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ChildQuestOuterClass.ChildQuest) {
          return mergeFrom((ChildQuestOuterClass.ChildQuest)other);
        } else {
      ...
      public Builder mergeFrom(ChildQuestOuterClass.ChildQuest other) {
        if (other == ChildQuestOuterClass.ChildQuest.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ChildQuestOuterClass.ChildQuest parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ChildQuestOuterClass.ChildQuest) e.getUnfinishedMessage();
    ...
    private static final ChildQuestOuterClass.ChildQuest DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ChildQuestOuterClass.ChildQuest();
    }

    public static ChildQuestOuterClass.ChildQuest getDefaultInstance() {
