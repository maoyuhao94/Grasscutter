...
public final class AbilityEmbryoOuterClass {
  ...
  public interface AbilityEmbryoOrBuilder extends
    ...
    /**
     * <code>uint32 abilityNameHash = 2;</code>
     * @return The abilityNameHash.
     */
    int getAbilityNameHash();

    /**
     * <code>uint32 abilityOverrideNameHash = 3;</code>
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 16: {
              ...
              abilityNameHash_ = input.readUInt32();
              break;
            }
            case 24: {

              abilityOverrideNameHash_ = input.readUInt32();
              break;
            }
            default: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return AbilityEmbryoOuterClass.internal_static_AbilityEmbryo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              AbilityEmbryoOuterClass.AbilityEmbryo.class, AbilityEmbryoOuterClass.AbilityEmbryo.Builder.class);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (abilityNameHash_ != 0) {
        output.writeUInt32(2, abilityNameHash_);
      }
      if (abilityOverrideNameHash_ != 0) {
        output.writeUInt32(3, abilityOverrideNameHash_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (abilityNameHash_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(2, abilityNameHash_);
      }
      if (abilityOverrideNameHash_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(3, abilityOverrideNameHash_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof AbilityEmbryoOuterClass.AbilityEmbryo)) {
        return super.equals(obj);
      }
      AbilityEmbryoOuterClass.AbilityEmbryo other = (AbilityEmbryoOuterClass.AbilityEmbryo) obj;
    ...
    public static AbilityEmbryoOuterClass.AbilityEmbryo parseFrom(
    ...
    public static AbilityEmbryoOuterClass.AbilityEmbryo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static AbilityEmbryoOuterClass.AbilityEmbryo parseFrom(
    ...
    public static AbilityEmbryoOuterClass.AbilityEmbryo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static AbilityEmbryoOuterClass.AbilityEmbryo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static AbilityEmbryoOuterClass.AbilityEmbryo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(AbilityEmbryoOuterClass.AbilityEmbryo prototype) {
    ...
    public static final class Builder extends
        ...
        AbilityEmbryoOuterClass.AbilityEmbryoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return AbilityEmbryoOuterClass.internal_static_AbilityEmbryo_descriptor;
      }
      ...
      // Construct using AbilityEmbryoOuterClass.AbilityEmbryo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public AbilityEmbryoOuterClass.AbilityEmbryo getDefaultInstanceForType() {
        return AbilityEmbryoOuterClass.AbilityEmbryo.getDefaultInstance();
      }

      @java.lang.Override
      public AbilityEmbryoOuterClass.AbilityEmbryo build() {
        AbilityEmbryoOuterClass.AbilityEmbryo result = buildPartial();
      ...
      @java.lang.Override
      public AbilityEmbryoOuterClass.AbilityEmbryo buildPartial() {
        AbilityEmbryoOuterClass.AbilityEmbryo result = new AbilityEmbryoOuterClass.AbilityEmbryo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof AbilityEmbryoOuterClass.AbilityEmbryo) {
          return mergeFrom((AbilityEmbryoOuterClass.AbilityEmbryo)other);
        } else {
      ...
      public Builder mergeFrom(AbilityEmbryoOuterClass.AbilityEmbryo other) {
        if (other == AbilityEmbryoOuterClass.AbilityEmbryo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        AbilityEmbryoOuterClass.AbilityEmbryo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (AbilityEmbryoOuterClass.AbilityEmbryo) e.getUnfinishedMessage();
    ...
    private static final AbilityEmbryoOuterClass.AbilityEmbryo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new AbilityEmbryoOuterClass.AbilityEmbryo();
    }

    public static AbilityEmbryoOuterClass.AbilityEmbryo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "(\r\022\037\n\027abilityOverrideNameHash\030\003 \001(\rb\006pro" +
      "to3"
    };
