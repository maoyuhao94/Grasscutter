...
public final class HomeBasicInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 122: {
              ...
              limitedShopInfo_ = input.readMessage(HomeLimitedShopInfoOuterClass.HomeLimitedShopInfo.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return HomeBasicInfoOuterClass.internal_static_HomeBasicInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              HomeBasicInfoOuterClass.HomeBasicInfo.class, HomeBasicInfoOuterClass.HomeBasicInfo.Builder.class);
    }
    ...
    public HomeLimitedShopInfoOuterClass.HomeLimitedShopInfo getLimitedShopInfo() {
      return limitedShopInfo_ == null ? HomeLimitedShopInfoOuterClass.HomeLimitedShopInfo.getDefaultInstance() : limitedShopInfo_;
    }
    /**
     * <code>.HomeLimitedShopInfo limitedShopInfo = 15;</code>
     */
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof HomeBasicInfoOuterClass.HomeBasicInfo)) {
        return super.equals(obj);
      }
      HomeBasicInfoOuterClass.HomeBasicInfo other = (HomeBasicInfoOuterClass.HomeBasicInfo) obj;
    ...
    public static HomeBasicInfoOuterClass.HomeBasicInfo parseFrom(
    ...
    public static HomeBasicInfoOuterClass.HomeBasicInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static HomeBasicInfoOuterClass.HomeBasicInfo parseFrom(
    ...
    public static HomeBasicInfoOuterClass.HomeBasicInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static HomeBasicInfoOuterClass.HomeBasicInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static HomeBasicInfoOuterClass.HomeBasicInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(HomeBasicInfoOuterClass.HomeBasicInfo prototype) {
    ...
    public static final class Builder extends
        ...
        HomeBasicInfoOuterClass.HomeBasicInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return HomeBasicInfoOuterClass.internal_static_HomeBasicInfo_descriptor;
      }
      ...
      // Construct using HomeBasicInfoOuterClass.HomeBasicInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public HomeBasicInfoOuterClass.HomeBasicInfo getDefaultInstanceForType() {
        return HomeBasicInfoOuterClass.HomeBasicInfo.getDefaultInstance();
      }

      @java.lang.Override
      public HomeBasicInfoOuterClass.HomeBasicInfo build() {
        HomeBasicInfoOuterClass.HomeBasicInfo result = buildPartial();
      ...
      @java.lang.Override
      public HomeBasicInfoOuterClass.HomeBasicInfo buildPartial() {
        HomeBasicInfoOuterClass.HomeBasicInfo result = new HomeBasicInfoOuterClass.HomeBasicInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof HomeBasicInfoOuterClass.HomeBasicInfo) {
          return mergeFrom((HomeBasicInfoOuterClass.HomeBasicInfo)other);
        } else {
      ...
      public Builder mergeFrom(HomeBasicInfoOuterClass.HomeBasicInfo other) {
        if (other == HomeBasicInfoOuterClass.HomeBasicInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        HomeBasicInfoOuterClass.HomeBasicInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (HomeBasicInfoOuterClass.HomeBasicInfo) e.getUnfinishedMessage();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          HomeLimitedShopInfoOuterClass.HomeLimitedShopInfo, HomeLimitedShopInfoOuterClass.HomeLimitedShopInfo.Builder, HomeLimitedShopInfoOuterClass.HomeLimitedShopInfoOrBuilder> limitedShopInfoBuilder_;
      /**
       * <code>.HomeLimitedShopInfo limitedShopInfo = 15;</code>
       * @return Whether the limitedShopInfo field is set.
       */
      ...
      public Builder mergeLimitedShopInfo(HomeLimitedShopInfoOuterClass.HomeLimitedShopInfo value) {
        if (limitedShopInfoBuilder_ == null) {
          if (limitedShopInfo_ != null) {
            limitedShopInfo_ =
              HomeLimitedShopInfoOuterClass.HomeLimitedShopInfo.newBuilder(limitedShopInfo_).mergeFrom(value).buildPartial();
          } else {
            limitedShopInfo_ = value;
          }
          onChanged();
      ...
      public HomeLimitedShopInfoOuterClass.HomeLimitedShopInfoOrBuilder getLimitedShopInfoOrBuilder() {
        if (limitedShopInfoBuilder_ != null) {
          ...
          return limitedShopInfo_ == null ?
              HomeLimitedShopInfoOuterClass.HomeLimitedShopInfo.getDefaultInstance() : limitedShopInfo_;
        }
      }
      /**
       * <code>.HomeLimitedShopInfo limitedShopInfo = 15;</code>
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final HomeBasicInfoOuterClass.HomeBasicInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new HomeBasicInfoOuterClass.HomeBasicInfo();
    }

    public static HomeBasicInfoOuterClass.HomeBasicInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022\013\n\003exp\030\r \001(\004b\006proto3"
    };
