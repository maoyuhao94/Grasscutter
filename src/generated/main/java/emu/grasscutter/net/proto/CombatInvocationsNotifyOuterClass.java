  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 90: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                invokeList_ = new java.util.ArrayList<CombatInvokeEntryOuterClass.CombatInvokeEntry>();
                mutable_bitField0_ |= 0x00000001;
              }
              invokeList_.add(
                  input.readMessage(CombatInvokeEntryOuterClass.CombatInvokeEntry.parser(), extensionRegistry));
              break;
            }
            default: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return CombatInvocationsNotifyOuterClass.internal_static_CombatInvocationsNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              CombatInvocationsNotifyOuterClass.CombatInvocationsNotify.class, CombatInvocationsNotifyOuterClass.CombatInvocationsNotify.Builder.class);
    }
    ...
    public enum ENECMIELGCN
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return CombatInvocationsNotifyOuterClass.CombatInvocationsNotify.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof CombatInvocationsNotifyOuterClass.CombatInvocationsNotify)) {
        return super.equals(obj);
      }
      CombatInvocationsNotifyOuterClass.CombatInvocationsNotify other = (CombatInvocationsNotifyOuterClass.CombatInvocationsNotify) obj;
    ...
    public static CombatInvocationsNotifyOuterClass.CombatInvocationsNotify parseFrom(
    ...
    public static CombatInvocationsNotifyOuterClass.CombatInvocationsNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static CombatInvocationsNotifyOuterClass.CombatInvocationsNotify parseFrom(
    ...
    public static CombatInvocationsNotifyOuterClass.CombatInvocationsNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static CombatInvocationsNotifyOuterClass.CombatInvocationsNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static CombatInvocationsNotifyOuterClass.CombatInvocationsNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(CombatInvocationsNotifyOuterClass.CombatInvocationsNotify prototype) {
    ...
    public static final class Builder extends
        ...
        CombatInvocationsNotifyOuterClass.CombatInvocationsNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return CombatInvocationsNotifyOuterClass.internal_static_CombatInvocationsNotify_descriptor;
      }
      ...
      // Construct using CombatInvocationsNotifyOuterClass.CombatInvocationsNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public CombatInvocationsNotifyOuterClass.CombatInvocationsNotify getDefaultInstanceForType() {
        return CombatInvocationsNotifyOuterClass.CombatInvocationsNotify.getDefaultInstance();
      }

      @java.lang.Override
      public CombatInvocationsNotifyOuterClass.CombatInvocationsNotify build() {
        CombatInvocationsNotifyOuterClass.CombatInvocationsNotify result = buildPartial();
      ...
      @java.lang.Override
      public CombatInvocationsNotifyOuterClass.CombatInvocationsNotify buildPartial() {
        CombatInvocationsNotifyOuterClass.CombatInvocationsNotify result = new CombatInvocationsNotifyOuterClass.CombatInvocationsNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof CombatInvocationsNotifyOuterClass.CombatInvocationsNotify) {
          return mergeFrom((CombatInvocationsNotifyOuterClass.CombatInvocationsNotify)other);
        } else {
      ...
      public Builder mergeFrom(CombatInvocationsNotifyOuterClass.CombatInvocationsNotify other) {
        if (other == CombatInvocationsNotifyOuterClass.CombatInvocationsNotify.getDefaultInstance()) return this;
        if (invokeListBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        CombatInvocationsNotifyOuterClass.CombatInvocationsNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (CombatInvocationsNotifyOuterClass.CombatInvocationsNotify) e.getUnfinishedMessage();
      ...
      public Builder addAllInvokeList(
          java.lang.Iterable<? extends CombatInvokeEntryOuterClass.CombatInvokeEntry> values) {
        if (invokeListBuilder_ == null) {
          ensureInvokeListIsMutable();
    ...
    private static final CombatInvocationsNotifyOuterClass.CombatInvocationsNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new CombatInvocationsNotifyOuterClass.CombatInvocationsNotify();
    }

    public static CombatInvocationsNotifyOuterClass.CombatInvocationsNotify getDefaultInstance() {
