...
public final class ScenePlayerInfoNotifyOuterClass {
  ...
  public interface ScenePlayerInfoNotifyOrBuilder extends
     ...
     */
    java.util.List<ScenePlayerInfoOuterClass.ScenePlayerInfo> 
        getPlayerInfoListList();
    /**
     * <code>repeated .ScenePlayerInfo playerInfoList = 11;</code>
     */
    ScenePlayerInfoOuterClass.ScenePlayerInfo getPlayerInfoList(int index);
    /**
     * <code>repeated .ScenePlayerInfo playerInfoList = 11;</code>
     */
     ...
     * <code>repeated .ScenePlayerInfo playerInfoList = 11;</code>
     */
    java.util.List<? extends ScenePlayerInfoOuterClass.ScenePlayerInfoOrBuilder> 
        getPlayerInfoListOrBuilderList();
    /**
     * <code>repeated .ScenePlayerInfo playerInfoList = 11;</code>
     */
    ScenePlayerInfoOuterClass.ScenePlayerInfoOrBuilder getPlayerInfoListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 90: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                playerInfoList_ = new java.util.ArrayList<ScenePlayerInfoOuterClass.ScenePlayerInfo>();
                mutable_bitField0_ |= 0x00000001;
              }
              playerInfoList_.add(
                  input.readMessage(ScenePlayerInfoOuterClass.ScenePlayerInfo.parser(), extensionRegistry));
              break;
            }
            default: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return ScenePlayerInfoNotifyOuterClass.internal_static_ScenePlayerInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify.class, ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify.Builder.class);
    }
    ...
    public enum IOKKMFKCAAI
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify.getDescriptor().getEnumTypes().get(0);
      }
    ...
    private java.util.List<ScenePlayerInfoOuterClass.ScenePlayerInfo> playerInfoList_;
    /**
     * <code>repeated .ScenePlayerInfo playerInfoList = 11;</code>
     */
    @java.lang.Override
    public java.util.List<ScenePlayerInfoOuterClass.ScenePlayerInfo> getPlayerInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends ScenePlayerInfoOuterClass.ScenePlayerInfoOrBuilder> 
        getPlayerInfoListOrBuilderList() {
      return playerInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public ScenePlayerInfoOuterClass.ScenePlayerInfoOrBuilder getPlayerInfoListOrBuilder(
        int index) {
      return playerInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify)) {
        return super.equals(obj);
      }
      ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify other = (ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify) obj;
    ...
    public static ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify parseFrom(
    ...
    public static ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify parseFrom(
    ...
    public static ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ScenePlayerInfoNotifyOuterClass.internal_static_ScenePlayerInfoNotify_descriptor;
      }
      ...
      // Construct using ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify getDefaultInstanceForType() {
        return ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify build() {
        ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify result = buildPartial();
      ...
      @java.lang.Override
      public ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify buildPartial() {
        ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify result = new ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify) {
          return mergeFrom((ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify other) {
        if (other == ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify.getDefaultInstance()) return this;
        if (playerInfoListBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify) e.getUnfinishedMessage();
      ...
      private void ensurePlayerInfoListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          playerInfoList_ = new java.util.ArrayList<ScenePlayerInfoOuterClass.ScenePlayerInfo>(playerInfoList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          ScenePlayerInfoOuterClass.ScenePlayerInfo, ScenePlayerInfoOuterClass.ScenePlayerInfo.Builder, ScenePlayerInfoOuterClass.ScenePlayerInfoOrBuilder> playerInfoListBuilder_;
      ...
      public Builder setPlayerInfoList(
          int index, ScenePlayerInfoOuterClass.ScenePlayerInfo value) {
        if (playerInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setPlayerInfoList(
          int index, ScenePlayerInfoOuterClass.ScenePlayerInfo.Builder builderForValue) {
        if (playerInfoListBuilder_ == null) {
          ensurePlayerInfoListIsMutable();
       ...
       */
      public Builder addPlayerInfoList(
          ScenePlayerInfoOuterClass.ScenePlayerInfo.Builder builderForValue) {
        if (playerInfoListBuilder_ == null) {
          ensurePlayerInfoListIsMutable();
      ...
      public Builder addAllPlayerInfoList(
          java.lang.Iterable<? extends ScenePlayerInfoOuterClass.ScenePlayerInfo> values) {
        if (playerInfoListBuilder_ == null) {
          ensurePlayerInfoListIsMutable();
       ...
       * <code>repeated .ScenePlayerInfo playerInfoList = 11;</code>
       */
      public ScenePlayerInfoOuterClass.ScenePlayerInfo.Builder getPlayerInfoListBuilder(
          int index) {
      ...
      public ScenePlayerInfoOuterClass.ScenePlayerInfo.Builder addPlayerInfoListBuilder() {
        return getPlayerInfoListFieldBuilder().addBuilder(
            ScenePlayerInfoOuterClass.ScenePlayerInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .ScenePlayerInfo playerInfoList = 11;</code>
       */
      public ScenePlayerInfoOuterClass.ScenePlayerInfo.Builder addPlayerInfoListBuilder(
          int index) {
        return getPlayerInfoListFieldBuilder().addBuilder(
            index, ScenePlayerInfoOuterClass.ScenePlayerInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .ScenePlayerInfo playerInfoList = 11;</code>
       */
      public java.util.List<ScenePlayerInfoOuterClass.ScenePlayerInfo.Builder> 
           getPlayerInfoListBuilderList() {
        return getPlayerInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          ScenePlayerInfoOuterClass.ScenePlayerInfo, ScenePlayerInfoOuterClass.ScenePlayerInfo.Builder, ScenePlayerInfoOuterClass.ScenePlayerInfoOrBuilder> 
          getPlayerInfoListFieldBuilder() {
        if (playerInfoListBuilder_ == null) {
    ...
    private static final ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify();
    }

    public static ScenePlayerInfoNotifyOuterClass.ScenePlayerInfoNotify getDefaultInstance() {
