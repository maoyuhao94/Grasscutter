...
public final class BrickBreakerInfoOuterClass {
  ...
  public interface BrickBreakerInfoOrBuilder extends
      // @@protoc_insertion_point(interface_extends:BrickBreakerInfo)
      com.google.protobuf.MessageOrBuilder {

    /**
     * <code>repeated .BrickBreakerLevelInfo dungeonLevelInfoList = 7;</code>
     */
    java.util.List<BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo> 
        getDungeonLevelInfoListList();
    /**
     * <code>repeated .BrickBreakerLevelInfo dungeonLevelInfoList = 7;</code>
     */
    BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo getDungeonLevelInfoList(int index);
    /**
     * <code>repeated .BrickBreakerLevelInfo dungeonLevelInfoList = 7;</code>
     */
     ...
     * <code>repeated .BrickBreakerLevelInfo dungeonLevelInfoList = 7;</code>
     */
    java.util.List<? extends BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfoOrBuilder> 
        getDungeonLevelInfoListOrBuilderList();
    /**
     * <code>repeated .BrickBreakerLevelInfo dungeonLevelInfoList = 7;</code>
     */
    BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfoOrBuilder getDungeonLevelInfoListOrBuilder(
        int index);

    /**
     * <code>repeated .BrickBreakerActivityStageInfo stageInfoList = 9;</code>
     */
    java.util.List<BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo> 
        getStageInfoListList();
    /**
     * <code>repeated .BrickBreakerActivityStageInfo stageInfoList = 9;</code>
     */
    BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo getStageInfoList(int index);
    /**
     * <code>repeated .BrickBreakerActivityStageInfo stageInfoList = 9;</code>
     */
     ...
     * <code>repeated .BrickBreakerActivityStageInfo stageInfoList = 9;</code>
     */
    java.util.List<? extends BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfoOrBuilder> 
        getStageInfoListOrBuilderList();
    /**
     * <code>repeated .BrickBreakerActivityStageInfo stageInfoList = 9;</code>
     */
    BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfoOrBuilder getStageInfoListOrBuilder(
        int index);

    /**
     * <code>repeated .BrickBreakerLevelInfo worldLevelInfoList = 3;</code>
     */
    java.util.List<BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo> 
     ...
     * <code>repeated .BrickBreakerLevelInfo worldLevelInfoList = 3;</code>
     */
    BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo getWorldLevelInfoList(int index);
    /**
     * <code>repeated .BrickBreakerLevelInfo worldLevelInfoList = 3;</code>
     */
     ...
     * <code>repeated .BrickBreakerLevelInfo worldLevelInfoList = 3;</code>
     */
    BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfoOrBuilder getWorldLevelInfoListOrBuilder(
        int index);

    /**
     * <code>map&lt;uint32, uint32&gt; skillInfoMap = 8;</code>
     */
  ...
  /**
   * Protobuf type {@code BrickBreakerInfo}
   */
  public static final class BrickBreakerInfo extends
      com.google.protobuf.GeneratedMessageV3 implements
      // @@protoc_insertion_point(message_implements:BrickBreakerInfo)
      BrickBreakerInfoOrBuilder {
  private static final long serialVersionUID = 0L;
    // Use BrickBreakerInfo.newBuilder() to construct.
    private BrickBreakerInfo(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
      super(builder);
    }
          ...
          switch (tag) {
            ...
            case 26: {
              if (!((mutable_bitField0_ & 0x00000004) != 0)) {
                worldLevelInfoList_ = new java.util.ArrayList<BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo>();
                mutable_bitField0_ |= 0x00000004;
              }
              worldLevelInfoList_.add(
                  input.readMessage(BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.parser(), extensionRegistry));
              break;
            }
            case 58: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                dungeonLevelInfoList_ = new java.util.ArrayList<BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo>();
            ...
            case 74: {
              if (!((mutable_bitField0_ & 0x00000002) != 0)) {
                stageInfoList_ = new java.util.ArrayList<BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo>();
                mutable_bitField0_ |= 0x00000002;
              }
              stageInfoList_.add(
                  input.readMessage(BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo.parser(), extensionRegistry));
              break;
            }
            default: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return BrickBreakerInfoOuterClass.internal_static_BrickBreakerInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              BrickBreakerInfoOuterClass.BrickBreakerInfo.class, BrickBreakerInfoOuterClass.BrickBreakerInfo.Builder.class);
    }

    public static final int DUNGEONLEVELINFOLIST_FIELD_NUMBER = 7;
    private java.util.List<BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo> dungeonLevelInfoList_;
    /**
     * <code>repeated .BrickBreakerLevelInfo dungeonLevelInfoList = 7;</code>
     */
    @java.lang.Override
    public java.util.List<BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo> getDungeonLevelInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfoOrBuilder> 
        getDungeonLevelInfoListOrBuilderList() {
      return dungeonLevelInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfoOrBuilder getDungeonLevelInfoListOrBuilder(
        int index) {
      return dungeonLevelInfoList_.get(index);
    }

    public static final int STAGEINFOLIST_FIELD_NUMBER = 9;
    private java.util.List<BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo> stageInfoList_;
    /**
     * <code>repeated .BrickBreakerActivityStageInfo stageInfoList = 9;</code>
     */
    @java.lang.Override
    public java.util.List<BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo> getStageInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfoOrBuilder> 
        getStageInfoListOrBuilderList() {
      return stageInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfoOrBuilder getStageInfoListOrBuilder(
        int index) {
      return stageInfoList_.get(index);
    }

    public static final int WORLDLEVELINFOLIST_FIELD_NUMBER = 3;
    private java.util.List<BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo> worldLevelInfoList_;
    /**
     * <code>repeated .BrickBreakerLevelInfo worldLevelInfoList = 3;</code>
     */
    @java.lang.Override
    public java.util.List<BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo> getWorldLevelInfoListList() {
     ...
     */
    @java.lang.Override
    public BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfoOrBuilder getWorldLevelInfoListOrBuilder(
        int index) {
      return worldLevelInfoList_.get(index);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  BrickBreakerInfoOuterClass.internal_static_BrickBreakerInfo_SkillInfoMapEntry_descriptor, 
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < worldLevelInfoList_.size(); i++) {
        output.writeMessage(3, worldLevelInfoList_.get(i));
      }
      for (int i = 0; i < dungeonLevelInfoList_.size(); i++) {
        output.writeMessage(7, dungeonLevelInfoList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < worldLevelInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, worldLevelInfoList_.get(i));
      }
      for (int i = 0; i < dungeonLevelInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(7, dungeonLevelInfoList_.get(i));
      }
      for (java.util.Map.Entry<java.lang.Integer, java.lang.Integer> entry
        ...
        skillInfoMap__ = SkillInfoMapDefaultEntryHolder.defaultEntry.newBuilderForType()
            ...
            .build();
        size += com.google.protobuf.CodedOutputStream
            .computeMessageSize(8, skillInfoMap__);
      }
      for (int i = 0; i < stageInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof BrickBreakerInfoOuterClass.BrickBreakerInfo)) {
        return super.equals(obj);
      }
      BrickBreakerInfoOuterClass.BrickBreakerInfo other = (BrickBreakerInfoOuterClass.BrickBreakerInfo) obj;
    ...
    public int hashCode() {
      ...
      if (getDungeonLevelInfoListCount() > 0) {
        hash = (37 * hash) + DUNGEONLEVELINFOLIST_FIELD_NUMBER;
    ...
    public static BrickBreakerInfoOuterClass.BrickBreakerInfo parseFrom(
    ...
    public static BrickBreakerInfoOuterClass.BrickBreakerInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static BrickBreakerInfoOuterClass.BrickBreakerInfo parseFrom(
    ...
    public static BrickBreakerInfoOuterClass.BrickBreakerInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static BrickBreakerInfoOuterClass.BrickBreakerInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static BrickBreakerInfoOuterClass.BrickBreakerInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(BrickBreakerInfoOuterClass.BrickBreakerInfo prototype) {
    ...
    public static final class Builder extends
        ...
        // @@protoc_insertion_point(builder_implements:BrickBreakerInfo)
        BrickBreakerInfoOuterClass.BrickBreakerInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return BrickBreakerInfoOuterClass.internal_static_BrickBreakerInfo_descriptor;
      }
      ...
      // Construct using BrickBreakerInfoOuterClass.BrickBreakerInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public BrickBreakerInfoOuterClass.BrickBreakerInfo getDefaultInstanceForType() {
        return BrickBreakerInfoOuterClass.BrickBreakerInfo.getDefaultInstance();
      }

      @java.lang.Override
      public BrickBreakerInfoOuterClass.BrickBreakerInfo build() {
        BrickBreakerInfoOuterClass.BrickBreakerInfo result = buildPartial();
      ...
      @java.lang.Override
      public BrickBreakerInfoOuterClass.BrickBreakerInfo buildPartial() {
        BrickBreakerInfoOuterClass.BrickBreakerInfo result = new BrickBreakerInfoOuterClass.BrickBreakerInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof BrickBreakerInfoOuterClass.BrickBreakerInfo) {
          return mergeFrom((BrickBreakerInfoOuterClass.BrickBreakerInfo)other);
        } else {
      ...
      public Builder mergeFrom(BrickBreakerInfoOuterClass.BrickBreakerInfo other) {
        if (other == BrickBreakerInfoOuterClass.BrickBreakerInfo.getDefaultInstance()) return this;
        if (dungeonLevelInfoListBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        BrickBreakerInfoOuterClass.BrickBreakerInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (BrickBreakerInfoOuterClass.BrickBreakerInfo) e.getUnfinishedMessage();
      ...
      private void ensureDungeonLevelInfoListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          dungeonLevelInfoList_ = new java.util.ArrayList<BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo>(dungeonLevelInfoList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo, BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.Builder, BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfoOrBuilder> dungeonLevelInfoListBuilder_;
      ...
      public Builder setDungeonLevelInfoList(
          int index, BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo value) {
        if (dungeonLevelInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setDungeonLevelInfoList(
          int index, BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.Builder builderForValue) {
        if (dungeonLevelInfoListBuilder_ == null) {
          ensureDungeonLevelInfoListIsMutable();
       ...
       */
      public Builder addDungeonLevelInfoList(
          BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.Builder builderForValue) {
        if (dungeonLevelInfoListBuilder_ == null) {
          ensureDungeonLevelInfoListIsMutable();
      ...
      public Builder addAllDungeonLevelInfoList(
          java.lang.Iterable<? extends BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo> values) {
        if (dungeonLevelInfoListBuilder_ == null) {
          ensureDungeonLevelInfoListIsMutable();
       ...
       * <code>repeated .BrickBreakerLevelInfo dungeonLevelInfoList = 7;</code>
       */
      public BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.Builder getDungeonLevelInfoListBuilder(
          int index) {
      ...
      public BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.Builder addDungeonLevelInfoListBuilder() {
        return getDungeonLevelInfoListFieldBuilder().addBuilder(
            BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .BrickBreakerLevelInfo dungeonLevelInfoList = 7;</code>
       */
      public BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.Builder addDungeonLevelInfoListBuilder(
          int index) {
        return getDungeonLevelInfoListFieldBuilder().addBuilder(
            index, BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .BrickBreakerLevelInfo dungeonLevelInfoList = 7;</code>
       */
      public java.util.List<BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.Builder> 
           getDungeonLevelInfoListBuilderList() {
        return getDungeonLevelInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo, BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.Builder, BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfoOrBuilder> 
          getDungeonLevelInfoListFieldBuilder() {
        if (dungeonLevelInfoListBuilder_ == null) {
      ...
      private void ensureStageInfoListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          stageInfoList_ = new java.util.ArrayList<BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo>(stageInfoList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo, BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo.Builder, BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfoOrBuilder> stageInfoListBuilder_;
      ...
      public Builder setStageInfoList(
          int index, BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo value) {
        if (stageInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setStageInfoList(
          int index, BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo.Builder builderForValue) {
        if (stageInfoListBuilder_ == null) {
          ensureStageInfoListIsMutable();
       ...
       */
      public Builder addStageInfoList(
          BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo.Builder builderForValue) {
        if (stageInfoListBuilder_ == null) {
          ensureStageInfoListIsMutable();
      ...
      public Builder addAllStageInfoList(
          java.lang.Iterable<? extends BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo> values) {
        if (stageInfoListBuilder_ == null) {
          ensureStageInfoListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .BrickBreakerActivityStageInfo stageInfoList = 9;</code>
       */
      public BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo.Builder getStageInfoListBuilder(
          int index) {
      ...
      public BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo.Builder addStageInfoListBuilder() {
        return getStageInfoListFieldBuilder().addBuilder(
            BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .BrickBreakerActivityStageInfo stageInfoList = 9;</code>
       */
      public BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo.Builder addStageInfoListBuilder(
          int index) {
        return getStageInfoListFieldBuilder().addBuilder(
            index, BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .BrickBreakerActivityStageInfo stageInfoList = 9;</code>
       */
      public java.util.List<BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo.Builder> 
           getStageInfoListBuilderList() {
        return getStageInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo, BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo.Builder, BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfoOrBuilder> 
          getStageInfoListFieldBuilder() {
        if (stageInfoListBuilder_ == null) {
      ...
      private void ensureWorldLevelInfoListIsMutable() {
        if (!((bitField0_ & 0x00000004) != 0)) {
          worldLevelInfoList_ = new java.util.ArrayList<BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo>(worldLevelInfoList_);
          bitField0_ |= 0x00000004;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo, BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.Builder, BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfoOrBuilder> worldLevelInfoListBuilder_;
       ...
       * <code>repeated .BrickBreakerLevelInfo worldLevelInfoList = 3;</code>
       */
      public BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.Builder getWorldLevelInfoListBuilder(
          int index) {
      ...
      // @@protoc_insertion_point(builder_scope:BrickBreakerInfo)
    }

    // @@protoc_insertion_point(class_scope:BrickBreakerInfo)
    private static final BrickBreakerInfoOuterClass.BrickBreakerInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new BrickBreakerInfoOuterClass.BrickBreakerInfo();
    }

    public static BrickBreakerInfoOuterClass.BrickBreakerInfo getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }

    private static final com.google.protobuf.Parser<BrickBreakerInfo>
        PARSER = new com.google.protobuf.AbstractParser<BrickBreakerInfo>() {
      @java.lang.Override
      public BrickBreakerInfo parsePartialFrom(
          com.google.protobuf.CodedInputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws com.google.protobuf.InvalidProtocolBufferException {
    ...
    public static com.google.protobuf.Parser<BrickBreakerInfo> parser() {
      return PARSER;
    }

    @java.lang.Override
    public com.google.protobuf.Parser<BrickBreakerInfo> getParserForType() {
      return PARSER;
    }
  ...
  private static final com.google.protobuf.Descriptors.Descriptor
    internal_static_BrickBreakerInfo_descriptor;
  private static final 
    com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internal_static_BrickBreakerInfo_fieldAccessorTable;
  private static final com.google.protobuf.Descriptors.Descriptor
    internal_static_BrickBreakerInfo_SkillInfoMapEntry_descriptor;
  private static final 
    com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internal_static_BrickBreakerInfo_SkillInfoMapEntry_fieldAccessorTable;
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\026BrickBreakerInfo.proto\032\033BrickBreakerLe" +
      "velInfo.proto\032#BrickBreakerActivityStage" +
      "Info.proto\"\243\002\n\020BrickBreakerInfo\0224\n\024dunge" +
      "onLevelInfoList\030\007 \003(\0132\026.BrickBreakerLeve" +
      "lInfo\0225\n\rstageInfoList\030\t \003(\0132\036.BrickBrea" +
      "kerActivityStageInfo\0222\n\022worldLevelInfoLi" +
      "st\030\003 \003(\0132\026.BrickBreakerLevelInfo\0229\n\014skil" +
      "lInfoMap\030\010 \003(\0132#.BrickBreakerInfo.SkillI" +
    ...
    internal_static_BrickBreakerInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_BrickBreakerInfo_descriptor,
        new java.lang.String[] { "DungeonLevelInfoList", "StageInfoList", "WorldLevelInfoList", "SkillInfoMap", });
    internal_static_BrickBreakerInfo_SkillInfoMapEntry_descriptor =
      internal_static_BrickBreakerInfo_descriptor.getNestedTypes().get(0);
    internal_static_BrickBreakerInfo_SkillInfoMapEntry_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_BrickBreakerInfo_SkillInfoMapEntry_descriptor,
