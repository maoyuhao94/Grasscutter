...
public final class AddFriendNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return AddFriendNotifyOuterClass.internal_static_AddFriendNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return AddFriendNotifyOuterClass.internal_static_AddFriendNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              AddFriendNotifyOuterClass.AddFriendNotify.class, AddFriendNotifyOuterClass.AddFriendNotify.Builder.class);
    }

    /**
     * Protobuf enum {@code AddFriendNotify.JAKBIGICFGI}
     */
    public enum JAKBIGICFGI
       ...
       */
      public static final JAKBIGICFGI DCDNILFDFLB = NONE;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 4092;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 4092;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static JAKBIGICFGI valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static JAKBIGICFGI forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 4092: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<JAKBIGICFGI>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          JAKBIGICFGI> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<JAKBIGICFGI>() {
              public JAKBIGICFGI findValueByNumber(int number) {
                return JAKBIGICFGI.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return AddFriendNotifyOuterClass.AddFriendNotify.getDescriptor().getEnumTypes().get(0);
      }

      private static final JAKBIGICFGI[] VALUES = getStaticValuesArray();
      private static JAKBIGICFGI[] getStaticValuesArray() {
        return new JAKBIGICFGI[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, 
        };
      }
      public static JAKBIGICFGI valueOf(
      ...
      private JAKBIGICFGI(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:AddFriendNotify.JAKBIGICFGI)
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof AddFriendNotifyOuterClass.AddFriendNotify)) {
        return super.equals(obj);
      }
      AddFriendNotifyOuterClass.AddFriendNotify other = (AddFriendNotifyOuterClass.AddFriendNotify) obj;
    ...
    public static AddFriendNotifyOuterClass.AddFriendNotify parseFrom(
    ...
    public static AddFriendNotifyOuterClass.AddFriendNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static AddFriendNotifyOuterClass.AddFriendNotify parseFrom(
    ...
    public static AddFriendNotifyOuterClass.AddFriendNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static AddFriendNotifyOuterClass.AddFriendNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static AddFriendNotifyOuterClass.AddFriendNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(AddFriendNotifyOuterClass.AddFriendNotify prototype) {
    ...
    public static final class Builder extends
        ...
        AddFriendNotifyOuterClass.AddFriendNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return AddFriendNotifyOuterClass.internal_static_AddFriendNotify_descriptor;
      }
      ...
      // Construct using AddFriendNotifyOuterClass.AddFriendNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public AddFriendNotifyOuterClass.AddFriendNotify getDefaultInstanceForType() {
        return AddFriendNotifyOuterClass.AddFriendNotify.getDefaultInstance();
      }

      @java.lang.Override
      public AddFriendNotifyOuterClass.AddFriendNotify build() {
        AddFriendNotifyOuterClass.AddFriendNotify result = buildPartial();
      ...
      @java.lang.Override
      public AddFriendNotifyOuterClass.AddFriendNotify buildPartial() {
        AddFriendNotifyOuterClass.AddFriendNotify result = new AddFriendNotifyOuterClass.AddFriendNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof AddFriendNotifyOuterClass.AddFriendNotify) {
          return mergeFrom((AddFriendNotifyOuterClass.AddFriendNotify)other);
        } else {
      ...
      public Builder mergeFrom(AddFriendNotifyOuterClass.AddFriendNotify other) {
        if (other == AddFriendNotifyOuterClass.AddFriendNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        AddFriendNotifyOuterClass.AddFriendNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (AddFriendNotifyOuterClass.AddFriendNotify) e.getUnfinishedMessage();
    ...
    private static final AddFriendNotifyOuterClass.AddFriendNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new AddFriendNotifyOuterClass.AddFriendNotify();
    }

    public static AddFriendNotifyOuterClass.AddFriendNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "to\"\236\001\n\017AddFriendNotify\022\021\n\ttargetUid\030\004 \001(" +
      "\r\022\'\n\021targetFriendBrief\030\014 \001(\0132\014.FriendBri" +
      "ef\"O\n\013JAKBIGICFGI\022\010\n\004NONE\020\000\022\020\n\013PEPPOHPHJ" +
      "OJ\020\374\037\022\017\n\013DCDNILFDFLB\020\000\022\017\n\013NNBKOLMPOEA\020\001\032" +
