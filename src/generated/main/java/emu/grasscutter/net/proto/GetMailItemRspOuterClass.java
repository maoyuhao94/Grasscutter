...
public final class GetMailItemRspOuterClass {
  ...
  public interface GetMailItemRspOrBuilder extends
    ...
    /**
     * <code>repeated uint32 mailIdList = 6;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return GetMailItemRspOuterClass.internal_static_GetMailItemRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              GetMailItemRspOuterClass.GetMailItemRsp.class, GetMailItemRspOuterClass.GetMailItemRsp.Builder.class);
    }

    /**
     * Protobuf enum {@code GetMailItemRsp.KFIFNFHEFBO}
     */
    public enum KFIFNFHEFBO
       ...
       */
      public static final KFIFNFHEFBO DCDNILFDFLB = NONE;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 1420;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 1420;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static KFIFNFHEFBO valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static KFIFNFHEFBO forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 1420: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<KFIFNFHEFBO>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          KFIFNFHEFBO> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<KFIFNFHEFBO>() {
              public KFIFNFHEFBO findValueByNumber(int number) {
                return KFIFNFHEFBO.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return GetMailItemRspOuterClass.GetMailItemRsp.getDescriptor().getEnumTypes().get(0);
      }

      private static final KFIFNFHEFBO[] VALUES = getStaticValuesArray();
      private static KFIFNFHEFBO[] getStaticValuesArray() {
        return new KFIFNFHEFBO[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, 
        };
      }
      public static KFIFNFHEFBO valueOf(
      ...
      private KFIFNFHEFBO(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:GetMailItemRsp.KFIFNFHEFBO)
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof GetMailItemRspOuterClass.GetMailItemRsp)) {
        return super.equals(obj);
      }
      GetMailItemRspOuterClass.GetMailItemRsp other = (GetMailItemRspOuterClass.GetMailItemRsp) obj;
    ...
    public static GetMailItemRspOuterClass.GetMailItemRsp parseFrom(
    ...
    public static GetMailItemRspOuterClass.GetMailItemRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static GetMailItemRspOuterClass.GetMailItemRsp parseFrom(
    ...
    public static GetMailItemRspOuterClass.GetMailItemRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static GetMailItemRspOuterClass.GetMailItemRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static GetMailItemRspOuterClass.GetMailItemRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(GetMailItemRspOuterClass.GetMailItemRsp prototype) {
    ...
    public static final class Builder extends
        ...
        GetMailItemRspOuterClass.GetMailItemRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return GetMailItemRspOuterClass.internal_static_GetMailItemRsp_descriptor;
      }
      ...
      // Construct using GetMailItemRspOuterClass.GetMailItemRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public GetMailItemRspOuterClass.GetMailItemRsp getDefaultInstanceForType() {
        return GetMailItemRspOuterClass.GetMailItemRsp.getDefaultInstance();
      }

      @java.lang.Override
      public GetMailItemRspOuterClass.GetMailItemRsp build() {
        GetMailItemRspOuterClass.GetMailItemRsp result = buildPartial();
      ...
      @java.lang.Override
      public GetMailItemRspOuterClass.GetMailItemRsp buildPartial() {
        GetMailItemRspOuterClass.GetMailItemRsp result = new GetMailItemRspOuterClass.GetMailItemRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof GetMailItemRspOuterClass.GetMailItemRsp) {
          return mergeFrom((GetMailItemRspOuterClass.GetMailItemRsp)other);
        } else {
      ...
      public Builder mergeFrom(GetMailItemRspOuterClass.GetMailItemRsp other) {
        if (other == GetMailItemRspOuterClass.GetMailItemRsp.getDefaultInstance()) return this;
        if (itemListBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        GetMailItemRspOuterClass.GetMailItemRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (GetMailItemRspOuterClass.GetMailItemRsp) e.getUnfinishedMessage();
    ...
    private static final GetMailItemRspOuterClass.GetMailItemRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new GetMailItemRspOuterClass.GetMailItemRsp();
    }

    public static GetMailItemRspOuterClass.GetMailItemRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\"\245\001\n\016GetMailItemRsp\022\035\n\010itemList\030\t \003(\0132\013." +
      "EquipParam\022\022\n\nmailIdList\030\006 \003(\r\022\017\n\007retcod" +
      "e\030\014 \001(\005\"O\n\013KFIFNFHEFBO\022\010\n\004NONE\020\000\022\020\n\013PEPP" +
      "OHPHJOJ\020\214\013\022\017\n\013DCDNILFDFLB\020\000\022\017\n\013NNBKOLMPO" +
