...
public final class OpSelectOnStageOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return OpSelectOnStageOuterClass.internal_static_OpSelectOnStage_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return OpSelectOnStageOuterClass.internal_static_OpSelectOnStage_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              OpSelectOnStageOuterClass.OpSelectOnStage.class, OpSelectOnStageOuterClass.OpSelectOnStage.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof OpSelectOnStageOuterClass.OpSelectOnStage)) {
        return super.equals(obj);
      }
      OpSelectOnStageOuterClass.OpSelectOnStage other = (OpSelectOnStageOuterClass.OpSelectOnStage) obj;
    ...
    public static OpSelectOnStageOuterClass.OpSelectOnStage parseFrom(
    ...
    public static OpSelectOnStageOuterClass.OpSelectOnStage parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static OpSelectOnStageOuterClass.OpSelectOnStage parseFrom(
    ...
    public static OpSelectOnStageOuterClass.OpSelectOnStage parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static OpSelectOnStageOuterClass.OpSelectOnStage parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static OpSelectOnStageOuterClass.OpSelectOnStage parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(OpSelectOnStageOuterClass.OpSelectOnStage prototype) {
    ...
    public static final class Builder extends
        ...
        OpSelectOnStageOuterClass.OpSelectOnStageOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return OpSelectOnStageOuterClass.internal_static_OpSelectOnStage_descriptor;
      }
      ...
      // Construct using OpSelectOnStageOuterClass.OpSelectOnStage.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public OpSelectOnStageOuterClass.OpSelectOnStage getDefaultInstanceForType() {
        return OpSelectOnStageOuterClass.OpSelectOnStage.getDefaultInstance();
      }

      @java.lang.Override
      public OpSelectOnStageOuterClass.OpSelectOnStage build() {
        OpSelectOnStageOuterClass.OpSelectOnStage result = buildPartial();
      ...
      @java.lang.Override
      public OpSelectOnStageOuterClass.OpSelectOnStage buildPartial() {
        OpSelectOnStageOuterClass.OpSelectOnStage result = new OpSelectOnStageOuterClass.OpSelectOnStage(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof OpSelectOnStageOuterClass.OpSelectOnStage) {
          return mergeFrom((OpSelectOnStageOuterClass.OpSelectOnStage)other);
        } else {
      ...
      public Builder mergeFrom(OpSelectOnStageOuterClass.OpSelectOnStage other) {
        if (other == OpSelectOnStageOuterClass.OpSelectOnStage.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        OpSelectOnStageOuterClass.OpSelectOnStage parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (OpSelectOnStageOuterClass.OpSelectOnStage) e.getUnfinishedMessage();
    ...
    private static final OpSelectOnStageOuterClass.OpSelectOnStage DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new OpSelectOnStageOuterClass.OpSelectOnStage();
    }

    public static OpSelectOnStageOuterClass.OpSelectOnStage getDefaultInstance() {
