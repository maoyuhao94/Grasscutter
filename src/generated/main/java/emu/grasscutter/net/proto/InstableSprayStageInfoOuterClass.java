...
public final class InstableSprayStageInfoOuterClass {
  ...
  public interface InstableSprayStageInfoOrBuilder extends
    ...
    /**
     * <code>uint32 maxScore = 2;</code>
     * @return The maxScore.
     */
    int getMaxScore();

    /**
     * <code>repeated .InstableSprayTeamInfo teamInfoList = 3;</code>
     */
    java.util.List<InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo> 
        getTeamInfoListList();
    /**
     * <code>repeated .InstableSprayTeamInfo teamInfoList = 3;</code>
     */
    InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo getTeamInfoList(int index);
    /**
     * <code>repeated .InstableSprayTeamInfo teamInfoList = 3;</code>
     */
     ...
     * <code>repeated .InstableSprayTeamInfo teamInfoList = 3;</code>
     */
    java.util.List<? extends InstableSprayTeamInfoOuterClass.InstableSprayTeamInfoOrBuilder> 
        getTeamInfoListOrBuilderList();
    /**
     * <code>repeated .InstableSprayTeamInfo teamInfoList = 3;</code>
     */
    InstableSprayTeamInfoOuterClass.InstableSprayTeamInfoOrBuilder getTeamInfoListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 26: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                teamInfoList_ = new java.util.ArrayList<InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo>();
                mutable_bitField0_ |= 0x00000001;
              }
              teamInfoList_.add(
                  input.readMessage(InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo.parser(), extensionRegistry));
              break;
            }
            case 64: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return InstableSprayStageInfoOuterClass.internal_static_InstableSprayStageInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              InstableSprayStageInfoOuterClass.InstableSprayStageInfo.class, InstableSprayStageInfoOuterClass.InstableSprayStageInfo.Builder.class);
    }

    public static final int MAXSCORE_FIELD_NUMBER = 2;
    ...
    public static final int TEAMINFOLIST_FIELD_NUMBER = 3;
    private java.util.List<InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo> teamInfoList_;
    /**
     * <code>repeated .InstableSprayTeamInfo teamInfoList = 3;</code>
     */
    @java.lang.Override
    public java.util.List<InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo> getTeamInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends InstableSprayTeamInfoOuterClass.InstableSprayTeamInfoOrBuilder> 
        getTeamInfoListOrBuilderList() {
      return teamInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public InstableSprayTeamInfoOuterClass.InstableSprayTeamInfoOrBuilder getTeamInfoListOrBuilder(
        int index) {
      return teamInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof InstableSprayStageInfoOuterClass.InstableSprayStageInfo)) {
        return super.equals(obj);
      }
      InstableSprayStageInfoOuterClass.InstableSprayStageInfo other = (InstableSprayStageInfoOuterClass.InstableSprayStageInfo) obj;
    ...
    public static InstableSprayStageInfoOuterClass.InstableSprayStageInfo parseFrom(
    ...
    public static InstableSprayStageInfoOuterClass.InstableSprayStageInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static InstableSprayStageInfoOuterClass.InstableSprayStageInfo parseFrom(
    ...
    public static InstableSprayStageInfoOuterClass.InstableSprayStageInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static InstableSprayStageInfoOuterClass.InstableSprayStageInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static InstableSprayStageInfoOuterClass.InstableSprayStageInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(InstableSprayStageInfoOuterClass.InstableSprayStageInfo prototype) {
    ...
    public static final class Builder extends
        ...
        InstableSprayStageInfoOuterClass.InstableSprayStageInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return InstableSprayStageInfoOuterClass.internal_static_InstableSprayStageInfo_descriptor;
      }
      ...
      // Construct using InstableSprayStageInfoOuterClass.InstableSprayStageInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public InstableSprayStageInfoOuterClass.InstableSprayStageInfo getDefaultInstanceForType() {
        return InstableSprayStageInfoOuterClass.InstableSprayStageInfo.getDefaultInstance();
      }

      @java.lang.Override
      public InstableSprayStageInfoOuterClass.InstableSprayStageInfo build() {
        InstableSprayStageInfoOuterClass.InstableSprayStageInfo result = buildPartial();
      ...
      @java.lang.Override
      public InstableSprayStageInfoOuterClass.InstableSprayStageInfo buildPartial() {
        InstableSprayStageInfoOuterClass.InstableSprayStageInfo result = new InstableSprayStageInfoOuterClass.InstableSprayStageInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof InstableSprayStageInfoOuterClass.InstableSprayStageInfo) {
          return mergeFrom((InstableSprayStageInfoOuterClass.InstableSprayStageInfo)other);
        } else {
      ...
      public Builder mergeFrom(InstableSprayStageInfoOuterClass.InstableSprayStageInfo other) {
        if (other == InstableSprayStageInfoOuterClass.InstableSprayStageInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        InstableSprayStageInfoOuterClass.InstableSprayStageInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (InstableSprayStageInfoOuterClass.InstableSprayStageInfo) e.getUnfinishedMessage();
      ...
      private void ensureTeamInfoListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          teamInfoList_ = new java.util.ArrayList<InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo>(teamInfoList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo, InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo.Builder, InstableSprayTeamInfoOuterClass.InstableSprayTeamInfoOrBuilder> teamInfoListBuilder_;
      ...
      public Builder setTeamInfoList(
          int index, InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo value) {
        if (teamInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setTeamInfoList(
          int index, InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo.Builder builderForValue) {
        if (teamInfoListBuilder_ == null) {
          ensureTeamInfoListIsMutable();
       ...
       */
      public Builder addTeamInfoList(
          InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo.Builder builderForValue) {
        if (teamInfoListBuilder_ == null) {
          ensureTeamInfoListIsMutable();
      ...
      public Builder addAllTeamInfoList(
          java.lang.Iterable<? extends InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo> values) {
        if (teamInfoListBuilder_ == null) {
          ensureTeamInfoListIsMutable();
       ...
       * <code>repeated .InstableSprayTeamInfo teamInfoList = 3;</code>
       */
      public InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo.Builder getTeamInfoListBuilder(
          int index) {
      ...
      public InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo.Builder addTeamInfoListBuilder() {
        return getTeamInfoListFieldBuilder().addBuilder(
            InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .InstableSprayTeamInfo teamInfoList = 3;</code>
       */
      public InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo.Builder addTeamInfoListBuilder(
          int index) {
        return getTeamInfoListFieldBuilder().addBuilder(
            index, InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .InstableSprayTeamInfo teamInfoList = 3;</code>
       */
      public java.util.List<InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo.Builder> 
           getTeamInfoListBuilderList() {
        return getTeamInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo, InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo.Builder, InstableSprayTeamInfoOuterClass.InstableSprayTeamInfoOrBuilder> 
          getTeamInfoListFieldBuilder() {
        if (teamInfoListBuilder_ == null) {
    ...
    private static final InstableSprayStageInfoOuterClass.InstableSprayStageInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new InstableSprayStageInfoOuterClass.InstableSprayStageInfo();
    }

    public static InstableSprayStageInfoOuterClass.InstableSprayStageInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "SprayTeamInfo.proto\"}\n\026InstableSprayStag" +
      "eInfo\022\020\n\010maxScore\030\002 \001(\r\022,\n\014teamInfoList\030" +
      "\003 \003(\0132\026.InstableSprayTeamInfo\022\022\n\nisFinis" +
      "hed\030\r \001(\010\022\017\n\007stageId\030\010 \001(\rb\006proto3"
    };
