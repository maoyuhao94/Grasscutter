...
public final class AvatarSatiationDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return AvatarSatiationDataOuterClass.internal_static_AvatarSatiationData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              AvatarSatiationDataOuterClass.AvatarSatiationData.class, AvatarSatiationDataOuterClass.AvatarSatiationData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof AvatarSatiationDataOuterClass.AvatarSatiationData)) {
        return super.equals(obj);
      }
      AvatarSatiationDataOuterClass.AvatarSatiationData other = (AvatarSatiationDataOuterClass.AvatarSatiationData) obj;
    ...
    public static AvatarSatiationDataOuterClass.AvatarSatiationData parseFrom(
    ...
    public static AvatarSatiationDataOuterClass.AvatarSatiationData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static AvatarSatiationDataOuterClass.AvatarSatiationData parseFrom(
    ...
    public static AvatarSatiationDataOuterClass.AvatarSatiationData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static AvatarSatiationDataOuterClass.AvatarSatiationData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static AvatarSatiationDataOuterClass.AvatarSatiationData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(AvatarSatiationDataOuterClass.AvatarSatiationData prototype) {
    ...
    public static final class Builder extends
        ...
        AvatarSatiationDataOuterClass.AvatarSatiationDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return AvatarSatiationDataOuterClass.internal_static_AvatarSatiationData_descriptor;
      }
      ...
      // Construct using AvatarSatiationDataOuterClass.AvatarSatiationData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public AvatarSatiationDataOuterClass.AvatarSatiationData getDefaultInstanceForType() {
        return AvatarSatiationDataOuterClass.AvatarSatiationData.getDefaultInstance();
      }

      @java.lang.Override
      public AvatarSatiationDataOuterClass.AvatarSatiationData build() {
        AvatarSatiationDataOuterClass.AvatarSatiationData result = buildPartial();
      ...
      @java.lang.Override
      public AvatarSatiationDataOuterClass.AvatarSatiationData buildPartial() {
        AvatarSatiationDataOuterClass.AvatarSatiationData result = new AvatarSatiationDataOuterClass.AvatarSatiationData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof AvatarSatiationDataOuterClass.AvatarSatiationData) {
          return mergeFrom((AvatarSatiationDataOuterClass.AvatarSatiationData)other);
        } else {
      ...
      public Builder mergeFrom(AvatarSatiationDataOuterClass.AvatarSatiationData other) {
        if (other == AvatarSatiationDataOuterClass.AvatarSatiationData.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        AvatarSatiationDataOuterClass.AvatarSatiationData parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (AvatarSatiationDataOuterClass.AvatarSatiationData) e.getUnfinishedMessage();
    ...
    private static final AvatarSatiationDataOuterClass.AvatarSatiationData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new AvatarSatiationDataOuterClass.AvatarSatiationData();
    }

    public static AvatarSatiationDataOuterClass.AvatarSatiationData getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "Time\030\017 \001(\002\022\031\n\021penaltyFinishTime\030\014 \001(\002b\006p" +
      "roto3"
    };
