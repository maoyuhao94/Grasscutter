...
public final class ActivityReadPushTipsReqOuterClass {
  ...
  public interface ActivityReadPushTipsReqOrBuilder extends
    ...
    /**
     * <code>repeated uint32 activityPushTipsIdList = 11;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return ActivityReadPushTipsReqOuterClass.internal_static_ActivityReadPushTipsReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return ActivityReadPushTipsReqOuterClass.internal_static_ActivityReadPushTipsReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq.class, ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq.Builder.class);
    }

    /**
     * Protobuf enum {@code ActivityReadPushTipsReq.DLNMIJEFDKL}
     */
    public enum DLNMIJEFDKL
       ...
       */
      public static final DLNMIJEFDKL DCDNILFDFLB = NONE;
      /**
       * <code>EAJIABGAOCI = 1;</code>
       */
      public static final DLNMIJEFDKL EAJIABGAOCI = NNBKOLMPOEA;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 8896;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 8896;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static DLNMIJEFDKL valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static DLNMIJEFDKL forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 8896: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<DLNMIJEFDKL>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          DLNMIJEFDKL> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<DLNMIJEFDKL>() {
              public DLNMIJEFDKL findValueByNumber(int number) {
                return DLNMIJEFDKL.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq.getDescriptor().getEnumTypes().get(0);
      }

      private static final DLNMIJEFDKL[] VALUES = getStaticValuesArray();
      private static DLNMIJEFDKL[] getStaticValuesArray() {
        return new DLNMIJEFDKL[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, EAJIABGAOCI, 
        };
      }
      public static DLNMIJEFDKL valueOf(
      ...
      private DLNMIJEFDKL(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:ActivityReadPushTipsReq.DLNMIJEFDKL)
    }

    public static final int ACTIVITYPUSHTIPSIDLIST_FIELD_NUMBER = 11;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq)) {
        return super.equals(obj);
      }
      ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq other = (ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq) obj;
    ...
    public int hashCode() {
      ...
      if (getActivityPushTipsIdListCount() > 0) {
        hash = (37 * hash) + ACTIVITYPUSHTIPSIDLIST_FIELD_NUMBER;
    ...
    public static ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq parseFrom(
    ...
    public static ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq parseFrom(
    ...
    public static ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq prototype) {
    ...
    public static final class Builder extends
        ...
        ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ActivityReadPushTipsReqOuterClass.internal_static_ActivityReadPushTipsReq_descriptor;
      }
      ...
      // Construct using ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq getDefaultInstanceForType() {
        return ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq.getDefaultInstance();
      }

      @java.lang.Override
      public ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq build() {
        ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq result = buildPartial();
      ...
      @java.lang.Override
      public ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq buildPartial() {
        ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq result = new ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq) {
          return mergeFrom((ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq)other);
        } else {
      ...
      public Builder mergeFrom(ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq other) {
        if (other == ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq) e.getUnfinishedMessage();
    ...
    private static final ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq();
    }

    public static ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\035ActivityReadPushTipsReq.proto\"\257\001\n\027Acti" +
      "vityReadPushTipsReq\022\036\n\026activityPushTipsI" +
      "dList\030\013 \003(\r\022\022\n\nactivityId\030\016 \001(\r\"`\n\013DLNMI" +
      "JEFDKL\022\010\n\004NONE\020\000\022\020\n\013PEPPOHPHJOJ\020\300E\022\017\n\013DC" +
