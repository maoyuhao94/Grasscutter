...
public final class HomeCustomFurnitureInfoOuterClass {
  ...
  public interface HomeCustomFurnitureInfoOrBuilder extends
    ...
    /**
     * <code>repeated .CustomCommonNodeInfo subFurnitureList = 5;</code>
     */
     ...
     * <code>repeated .CustomCommonNodeInfo subFurnitureList = 5;</code>
     */
    CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo getSubFurnitureList(int index);
    /**
     * <code>repeated .CustomCommonNodeInfo subFurnitureList = 5;</code>
     */
     ...
     * <code>repeated .CustomCommonNodeInfo subFurnitureList = 5;</code>
     */
    CustomCommonNodeInfoOuterClass.CustomCommonNodeInfoOrBuilder getSubFurnitureListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 42: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                subFurnitureList_ = new java.util.ArrayList<CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo>();
                mutable_bitField0_ |= 0x00000001;
              }
              subFurnitureList_.add(
                  input.readMessage(CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo.parser(), extensionRegistry));
              break;
            }
            case 64: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return HomeCustomFurnitureInfoOuterClass.internal_static_HomeCustomFurnitureInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo.class, HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo.Builder.class);
    }
    ...
    private java.util.List<CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo> subFurnitureList_;
    /**
     * <code>repeated .CustomCommonNodeInfo subFurnitureList = 5;</code>
     */
    @java.lang.Override
    public java.util.List<CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo> getSubFurnitureListList() {
     ...
     */
    @java.lang.Override
    public CustomCommonNodeInfoOuterClass.CustomCommonNodeInfoOrBuilder getSubFurnitureListOrBuilder(
        int index) {
      return subFurnitureList_.get(index);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < subFurnitureList_.size(); i++) {
        output.writeMessage(5, subFurnitureList_.get(i));
      }
      if (guid_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < subFurnitureList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(5, subFurnitureList_.get(i));
      }
      if (guid_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo)) {
        return super.equals(obj);
      }
      HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo other = (HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo) obj;
    ...
    public int hashCode() {
      ...
      if (getSubFurnitureListCount() > 0) {
        hash = (37 * hash) + SUBFURNITURELIST_FIELD_NUMBER;
    ...
    public static HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo parseFrom(
    ...
    public static HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo parseFrom(
    ...
    public static HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo prototype) {
    ...
    public static final class Builder extends
        ...
        HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return HomeCustomFurnitureInfoOuterClass.internal_static_HomeCustomFurnitureInfo_descriptor;
      }
      ...
      // Construct using HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo getDefaultInstanceForType() {
        return HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo.getDefaultInstance();
      }

      @java.lang.Override
      public HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo build() {
        HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo result = buildPartial();
      ...
      @java.lang.Override
      public HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo buildPartial() {
        HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo result = new HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo) {
          return mergeFrom((HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo)other);
        } else {
      ...
      public Builder mergeFrom(HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo other) {
        if (other == HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo.getDefaultInstance()) return this;
        if (other.getGuid() != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo) e.getUnfinishedMessage();
      ...
      private void ensureSubFurnitureListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          subFurnitureList_ = new java.util.ArrayList<CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo>(subFurnitureList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo, CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo.Builder, CustomCommonNodeInfoOuterClass.CustomCommonNodeInfoOrBuilder> subFurnitureListBuilder_;
      ...
      public Builder addAllSubFurnitureList(
          java.lang.Iterable<? extends CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo> values) {
        if (subFurnitureListBuilder_ == null) {
          ensureSubFurnitureListIsMutable();
       ...
       * <code>repeated .CustomCommonNodeInfo subFurnitureList = 5;</code>
       */
      public CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo.Builder getSubFurnitureListBuilder(
          int index) {
    ...
    private static final HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo();
    }

    public static HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ommonNodeInfo.proto\"X\n\027HomeCustomFurnitu" +
      "reInfo\022\014\n\004guid\030\010 \001(\r\022/\n\020subFurnitureList" +
      "\030\005 \003(\0132\025.CustomCommonNodeInfob\006proto3"
    };
