...
public final class AbilityAppliedAbilityOuterClass {
  ...
  public interface AbilityAppliedAbilityOrBuilder extends
    ...
    /**
     * <code>.AbilityString abilityName = 1;</code>
    ...
    /**
     * <code>.AbilityString abilityOverride = 2;</code>
    ...
    /**
     * <code>repeated .AbilityScalarValueEntry overrideMap = 3;</code>
     */
    ...
    /**
     * <code>uint32 instancedAbilityId = 4;</code>
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              ...
              abilityOverride_ = input.readMessage(AbilityStringOuterClass.AbilityString.parser(), extensionRegistry);
              if (subBuilder != null) {
            ...
            case 26: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                overrideMap_ = new java.util.ArrayList<AbilityScalarValueEntryOuterClass.AbilityScalarValueEntry>();
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return AbilityAppliedAbilityOuterClass.internal_static_AbilityAppliedAbility_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              AbilityAppliedAbilityOuterClass.AbilityAppliedAbility.class, AbilityAppliedAbilityOuterClass.AbilityAppliedAbility.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof AbilityAppliedAbilityOuterClass.AbilityAppliedAbility)) {
        return super.equals(obj);
      }
      AbilityAppliedAbilityOuterClass.AbilityAppliedAbility other = (AbilityAppliedAbilityOuterClass.AbilityAppliedAbility) obj;
    ...
    public int hashCode() {
      ...
      if (getOverrideMapCount() > 0) {
        hash = (37 * hash) + OVERRIDEMAP_FIELD_NUMBER;
    ...
    public static AbilityAppliedAbilityOuterClass.AbilityAppliedAbility parseFrom(
    ...
    public static AbilityAppliedAbilityOuterClass.AbilityAppliedAbility parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static AbilityAppliedAbilityOuterClass.AbilityAppliedAbility parseFrom(
    ...
    public static AbilityAppliedAbilityOuterClass.AbilityAppliedAbility parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static AbilityAppliedAbilityOuterClass.AbilityAppliedAbility parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static AbilityAppliedAbilityOuterClass.AbilityAppliedAbility parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(AbilityAppliedAbilityOuterClass.AbilityAppliedAbility prototype) {
    ...
    public static final class Builder extends
        ...
        AbilityAppliedAbilityOuterClass.AbilityAppliedAbilityOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return AbilityAppliedAbilityOuterClass.internal_static_AbilityAppliedAbility_descriptor;
      }
      ...
      // Construct using AbilityAppliedAbilityOuterClass.AbilityAppliedAbility.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public AbilityAppliedAbilityOuterClass.AbilityAppliedAbility getDefaultInstanceForType() {
        return AbilityAppliedAbilityOuterClass.AbilityAppliedAbility.getDefaultInstance();
      }

      @java.lang.Override
      public AbilityAppliedAbilityOuterClass.AbilityAppliedAbility build() {
        AbilityAppliedAbilityOuterClass.AbilityAppliedAbility result = buildPartial();
      ...
      @java.lang.Override
      public AbilityAppliedAbilityOuterClass.AbilityAppliedAbility buildPartial() {
        AbilityAppliedAbilityOuterClass.AbilityAppliedAbility result = new AbilityAppliedAbilityOuterClass.AbilityAppliedAbility(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof AbilityAppliedAbilityOuterClass.AbilityAppliedAbility) {
          return mergeFrom((AbilityAppliedAbilityOuterClass.AbilityAppliedAbility)other);
        } else {
      ...
      public Builder mergeFrom(AbilityAppliedAbilityOuterClass.AbilityAppliedAbility other) {
        if (other == AbilityAppliedAbilityOuterClass.AbilityAppliedAbility.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        AbilityAppliedAbilityOuterClass.AbilityAppliedAbility parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (AbilityAppliedAbilityOuterClass.AbilityAppliedAbility) e.getUnfinishedMessage();
      ...
      public Builder mergeAbilityOverride(AbilityStringOuterClass.AbilityString value) {
        if (abilityOverrideBuilder_ == null) {
          if (abilityOverride_ != null) {
            abilityOverride_ =
              AbilityStringOuterClass.AbilityString.newBuilder(abilityOverride_).mergeFrom(value).buildPartial();
          } else {
            abilityOverride_ = value;
          }
          onChanged();
    ...
    private static final AbilityAppliedAbilityOuterClass.AbilityAppliedAbility DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new AbilityAppliedAbilityOuterClass.AbilityAppliedAbility();
    }

    public static AbilityAppliedAbilityOuterClass.AbilityAppliedAbility getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "me\030\001 \001(\0132\016.AbilityString\022\'\n\017abilityOverr" +
      "ide\030\002 \001(\0132\016.AbilityString\022-\n\013overrideMap" +
      "\030\003 \003(\0132\030.AbilityScalarValueEntry\022\032\n\022inst" +
      "ancedAbilityId\030\004 \001(\rb\006proto3"
    };
