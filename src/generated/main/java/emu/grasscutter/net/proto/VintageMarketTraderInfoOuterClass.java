...
public final class VintageMarketTraderInfoOuterClass {
  ...
  public interface VintageMarketTraderInfoOrBuilder extends
     ...
     * <code>repeated .ItemParam hiiflfhdkkg = 10;</code>
     */
    ItemParamOuterClass.ItemParam getHiiflfhdkkg(int index);
    /**
     * <code>repeated .ItemParam hiiflfhdkkg = 10;</code>
     */
     ...
     * <code>repeated .ItemParam hiiflfhdkkg = 10;</code>
     */
    ItemParamOuterClass.ItemParamOrBuilder getHiiflfhdkkgOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 82: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                hiiflfhdkkg_ = new java.util.ArrayList<ItemParamOuterClass.ItemParam>();
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return VintageMarketTraderInfoOuterClass.internal_static_VintageMarketTraderInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo.class, VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo.Builder.class);
    }

    public static final int HIIFLFHDKKG_FIELD_NUMBER = 10;
    private java.util.List<ItemParamOuterClass.ItemParam> hiiflfhdkkg_;
    /**
     * <code>repeated .ItemParam hiiflfhdkkg = 10;</code>
     */
    @java.lang.Override
    public java.util.List<ItemParamOuterClass.ItemParam> getHiiflfhdkkgList() {
      return hiiflfhdkkg_;
    }
    /**
     * <code>repeated .ItemParam hiiflfhdkkg = 10;</code>
     ...
     */
    @java.lang.Override
    public ItemParamOuterClass.ItemParamOrBuilder getHiiflfhdkkgOrBuilder(
        int index) {
      return hiiflfhdkkg_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo)) {
        return super.equals(obj);
      }
      VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo other = (VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo) obj;
    ...
    public static VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo parseFrom(
    ...
    public static VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo parseFrom(
    ...
    public static VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo prototype) {
    ...
    public static final class Builder extends
        ...
        VintageMarketTraderInfoOuterClass.VintageMarketTraderInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return VintageMarketTraderInfoOuterClass.internal_static_VintageMarketTraderInfo_descriptor;
      }
      ...
      // Construct using VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo getDefaultInstanceForType() {
        return VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo.getDefaultInstance();
      }

      @java.lang.Override
      public VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo build() {
        VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo result = buildPartial();
      ...
      @java.lang.Override
      public VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo buildPartial() {
        VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo result = new VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo) {
          return mergeFrom((VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo)other);
        } else {
      ...
      public Builder mergeFrom(VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo other) {
        if (other == VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo.getDefaultInstance()) return this;
        if (hiiflfhdkkgBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo) e.getUnfinishedMessage();
      ...
      private void ensureHiiflfhdkkgIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          hiiflfhdkkg_ = new java.util.ArrayList<ItemParamOuterClass.ItemParam>(hiiflfhdkkg_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          ItemParamOuterClass.ItemParam, ItemParamOuterClass.ItemParam.Builder, ItemParamOuterClass.ItemParamOrBuilder> hiiflfhdkkgBuilder_;
       ...
       * <code>repeated .ItemParam hiiflfhdkkg = 10;</code>
       */
      public ItemParamOuterClass.ItemParam.Builder getHiiflfhdkkgBuilder(
          int index) {
    ...
    private static final VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo();
    }

    public static VintageMarketTraderInfoOuterClass.VintageMarketTraderInfo getDefaultInstance() {
