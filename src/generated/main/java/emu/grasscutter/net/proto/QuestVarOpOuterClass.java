...
public final class QuestVarOpOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return QuestVarOpOuterClass.internal_static_QuestVarOp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              QuestVarOpOuterClass.QuestVarOp.class, QuestVarOpOuterClass.QuestVarOp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof QuestVarOpOuterClass.QuestVarOp)) {
        return super.equals(obj);
      }
      QuestVarOpOuterClass.QuestVarOp other = (QuestVarOpOuterClass.QuestVarOp) obj;
    ...
    public static QuestVarOpOuterClass.QuestVarOp parseFrom(
    ...
    public static QuestVarOpOuterClass.QuestVarOp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static QuestVarOpOuterClass.QuestVarOp parseFrom(
    ...
    public static QuestVarOpOuterClass.QuestVarOp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static QuestVarOpOuterClass.QuestVarOp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static QuestVarOpOuterClass.QuestVarOp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(QuestVarOpOuterClass.QuestVarOp prototype) {
    ...
    public static final class Builder extends
        ...
        QuestVarOpOuterClass.QuestVarOpOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return QuestVarOpOuterClass.internal_static_QuestVarOp_descriptor;
      }
      ...
      // Construct using QuestVarOpOuterClass.QuestVarOp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public QuestVarOpOuterClass.QuestVarOp getDefaultInstanceForType() {
        return QuestVarOpOuterClass.QuestVarOp.getDefaultInstance();
      }

      @java.lang.Override
      public QuestVarOpOuterClass.QuestVarOp build() {
        QuestVarOpOuterClass.QuestVarOp result = buildPartial();
      ...
      @java.lang.Override
      public QuestVarOpOuterClass.QuestVarOp buildPartial() {
        QuestVarOpOuterClass.QuestVarOp result = new QuestVarOpOuterClass.QuestVarOp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof QuestVarOpOuterClass.QuestVarOp) {
          return mergeFrom((QuestVarOpOuterClass.QuestVarOp)other);
        } else {
      ...
      public Builder mergeFrom(QuestVarOpOuterClass.QuestVarOp other) {
        if (other == QuestVarOpOuterClass.QuestVarOp.getDefaultInstance()) return this;
        if (other.getIndex() != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        QuestVarOpOuterClass.QuestVarOp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (QuestVarOpOuterClass.QuestVarOp) e.getUnfinishedMessage();
    ...
    private static final QuestVarOpOuterClass.QuestVarOp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new QuestVarOpOuterClass.QuestVarOp();
    }

    public static QuestVarOpOuterClass.QuestVarOp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "x\030\016 \001(\r\022\r\n\005value\030\006 \001(\005\022\r\n\005isAdd\030\005 \001(\010b\006p" +
      "roto3"
    };
