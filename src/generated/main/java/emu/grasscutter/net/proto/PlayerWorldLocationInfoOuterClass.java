...
public final class PlayerWorldLocationInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              ...
              playerLoc_ = input.readMessage(PlayerLocationInfoOuterClass.PlayerLocationInfo.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return PlayerWorldLocationInfoOuterClass.internal_static_PlayerWorldLocationInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo.class, PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo.Builder.class);
    }
    ...
    public PlayerLocationInfoOuterClass.PlayerLocationInfo getPlayerLoc() {
      return playerLoc_ == null ? PlayerLocationInfoOuterClass.PlayerLocationInfo.getDefaultInstance() : playerLoc_;
    }
    /**
     * <code>.PlayerLocationInfo playerLoc = 1;</code>
     */
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo)) {
        return super.equals(obj);
      }
      PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo other = (PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo) obj;
    ...
    public static PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo parseFrom(
    ...
    public static PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo parseFrom(
    ...
    public static PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo prototype) {
    ...
    public static final class Builder extends
        ...
        PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return PlayerWorldLocationInfoOuterClass.internal_static_PlayerWorldLocationInfo_descriptor;
      }
      ...
      // Construct using PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo getDefaultInstanceForType() {
        return PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo.getDefaultInstance();
      }

      @java.lang.Override
      public PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo build() {
        PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo result = buildPartial();
      ...
      @java.lang.Override
      public PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo buildPartial() {
        PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo result = new PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo) {
          return mergeFrom((PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo)other);
        } else {
      ...
      public Builder mergeFrom(PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo other) {
        if (other == PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo) e.getUnfinishedMessage();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          PlayerLocationInfoOuterClass.PlayerLocationInfo, PlayerLocationInfoOuterClass.PlayerLocationInfo.Builder, PlayerLocationInfoOuterClass.PlayerLocationInfoOrBuilder> playerLocBuilder_;
      /**
       * <code>.PlayerLocationInfo playerLoc = 1;</code>
       * @return Whether the playerLoc field is set.
       */
      ...
      public Builder mergePlayerLoc(PlayerLocationInfoOuterClass.PlayerLocationInfo value) {
        if (playerLocBuilder_ == null) {
          if (playerLoc_ != null) {
            playerLoc_ =
              PlayerLocationInfoOuterClass.PlayerLocationInfo.newBuilder(playerLoc_).mergeFrom(value).buildPartial();
          } else {
            playerLoc_ = value;
          }
          onChanged();
      ...
      public PlayerLocationInfoOuterClass.PlayerLocationInfoOrBuilder getPlayerLocOrBuilder() {
        if (playerLocBuilder_ != null) {
          ...
          return playerLoc_ == null ?
              PlayerLocationInfoOuterClass.PlayerLocationInfo.getDefaultInstance() : playerLoc_;
        }
      }
      /**
       * <code>.PlayerLocationInfo playerLoc = 1;</code>
    ...
    private static final PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo();
    }

    public static PlayerWorldLocationInfoOuterClass.PlayerWorldLocationInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "2\023.PlayerLocationInfob\006proto3"
    };
