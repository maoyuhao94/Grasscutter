...
public final class GetAllMailResultNotifyOuterClass {
  ...
  public interface GetAllMailResultNotifyOrBuilder extends
    ...
    /**
     * <code>bool isCollected = 12;</code>
     * @return The isCollected.
     */
    boolean getIsCollected();

    /**
     * <code>repeated .MailData mailList = 1;</code>
     */
    ...
    /**
     * <code>uint32 totalPageCount = 7;</code>
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                mailList_ = new java.util.ArrayList<MailDataOuterClass.MailData>();
                mutable_bitField0_ |= 0x00000001;
              }
              mailList_.add(
                  input.readMessage(MailDataOuterClass.MailData.parser(), extensionRegistry));
              break;
            }
            case 48: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return GetAllMailResultNotifyOuterClass.internal_static_GetAllMailResultNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              GetAllMailResultNotifyOuterClass.GetAllMailResultNotify.class, GetAllMailResultNotifyOuterClass.GetAllMailResultNotify.Builder.class);
    }

    /**
     * Protobuf enum {@code GetAllMailResultNotify.IGKIIEJOOAC}
     */
    public enum IGKIIEJOOAC
       ...
       */
      public static final IGKIIEJOOAC DCDNILFDFLB = NONE;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 1413;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 1413;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static IGKIIEJOOAC valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static IGKIIEJOOAC forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 1413: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<IGKIIEJOOAC>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          IGKIIEJOOAC> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<IGKIIEJOOAC>() {
              public IGKIIEJOOAC findValueByNumber(int number) {
                return IGKIIEJOOAC.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return GetAllMailResultNotifyOuterClass.GetAllMailResultNotify.getDescriptor().getEnumTypes().get(0);
      }

      private static final IGKIIEJOOAC[] VALUES = getStaticValuesArray();
      private static IGKIIEJOOAC[] getStaticValuesArray() {
        return new IGKIIEJOOAC[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, 
        };
      }
      public static IGKIIEJOOAC valueOf(
      ...
      private IGKIIEJOOAC(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:GetAllMailResultNotify.IGKIIEJOOAC)
    }

    public static final int ISCOLLECTED_FIELD_NUMBER = 12;
    ...
    public static final int TOTALPAGECOUNT_FIELD_NUMBER = 7;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (totalPageCount_ != 0) {
        output.writeUInt32(7, totalPageCount_);
      }
      if (retcode_ != 0) {
      ...
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(transaction_)) {
        com.google.protobuf.GeneratedMessageV3.writeString(output, 15, transaction_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (totalPageCount_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(7, totalPageCount_);
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(transaction_)) {
        size += com.google.protobuf.GeneratedMessageV3.computeStringSize(15, transaction_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof GetAllMailResultNotifyOuterClass.GetAllMailResultNotify)) {
        return super.equals(obj);
      }
      GetAllMailResultNotifyOuterClass.GetAllMailResultNotify other = (GetAllMailResultNotifyOuterClass.GetAllMailResultNotify) obj;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + TOTALPAGECOUNT_FIELD_NUMBER;
    ...
    public static GetAllMailResultNotifyOuterClass.GetAllMailResultNotify parseFrom(
    ...
    public static GetAllMailResultNotifyOuterClass.GetAllMailResultNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static GetAllMailResultNotifyOuterClass.GetAllMailResultNotify parseFrom(
    ...
    public static GetAllMailResultNotifyOuterClass.GetAllMailResultNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static GetAllMailResultNotifyOuterClass.GetAllMailResultNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static GetAllMailResultNotifyOuterClass.GetAllMailResultNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(GetAllMailResultNotifyOuterClass.GetAllMailResultNotify prototype) {
    ...
    public static final class Builder extends
        ...
        GetAllMailResultNotifyOuterClass.GetAllMailResultNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return GetAllMailResultNotifyOuterClass.internal_static_GetAllMailResultNotify_descriptor;
      }
      ...
      // Construct using GetAllMailResultNotifyOuterClass.GetAllMailResultNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public GetAllMailResultNotifyOuterClass.GetAllMailResultNotify getDefaultInstanceForType() {
        return GetAllMailResultNotifyOuterClass.GetAllMailResultNotify.getDefaultInstance();
      }

      @java.lang.Override
      public GetAllMailResultNotifyOuterClass.GetAllMailResultNotify build() {
        GetAllMailResultNotifyOuterClass.GetAllMailResultNotify result = buildPartial();
      ...
      @java.lang.Override
      public GetAllMailResultNotifyOuterClass.GetAllMailResultNotify buildPartial() {
        GetAllMailResultNotifyOuterClass.GetAllMailResultNotify result = new GetAllMailResultNotifyOuterClass.GetAllMailResultNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof GetAllMailResultNotifyOuterClass.GetAllMailResultNotify) {
          return mergeFrom((GetAllMailResultNotifyOuterClass.GetAllMailResultNotify)other);
        } else {
      ...
      public Builder mergeFrom(GetAllMailResultNotifyOuterClass.GetAllMailResultNotify other) {
        if (other == GetAllMailResultNotifyOuterClass.GetAllMailResultNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        GetAllMailResultNotifyOuterClass.GetAllMailResultNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (GetAllMailResultNotifyOuterClass.GetAllMailResultNotify) e.getUnfinishedMessage();
      ...
      public Builder addAllMailList(
          java.lang.Iterable<? extends MailDataOuterClass.MailData> values) {
        if (mailListBuilder_ == null) {
          ensureMailListIsMutable();
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final GetAllMailResultNotifyOuterClass.GetAllMailResultNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new GetAllMailResultNotifyOuterClass.GetAllMailResultNotify();
    }

    public static GetAllMailResultNotifyOuterClass.GetAllMailResultNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ollected\030\014 \001(\010\022\033\n\010mailList\030\001 \003(\0132\t.MailD" +
      "ata\022\026\n\016totalPageCount\030\007 \001(\r\022\017\n\007retcode\030\010" +
      " \001(\005\022\021\n\tpageIndex\030\006 \001(\r\022\023\n\013transaction\030\017" +
      " \001(\t\"O\n\013IGKIIEJOOAC\022\010\n\004NONE\020\000\022\020\n\013PEPPOHP" +
      "HJOJ\020\205\013\022\017\n\013DCDNILFDFLB\020\000\022\017\n\013NNBKOLMPOEA\020" +
    ...
    internal_static_GetAllMailResultNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_GetAllMailResultNotify_descriptor,
        new java.lang.String[] { "IsCollected", "MailList", "TotalPageCount", "Retcode", "PageIndex", "Transaction", });
    MailDataOuterClass.getDescriptor();
  }
