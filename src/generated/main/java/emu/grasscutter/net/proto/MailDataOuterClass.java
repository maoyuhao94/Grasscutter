...
public final class MailDataOuterClass {
  ...
  public interface MailDataOrBuilder extends
    ...
    /**
     * <code>.MailTextContent mailTextContent = 4;</code>
    ...
    /**
     * <code>repeated .MailItem itemList = 7;</code>
     */
    java.util.List<MailItemOuterClass.MailItem> 
        getItemListList();
    /**
     * <code>repeated .MailItem itemList = 7;</code>
     */
    MailItemOuterClass.MailItem getItemList(int index);
    /**
     * <code>repeated .MailItem itemList = 7;</code>
     */
     ...
     * <code>repeated .MailItem itemList = 7;</code>
     */
    java.util.List<? extends MailItemOuterClass.MailItemOrBuilder> 
        getItemListOrBuilderList();
    /**
     * <code>repeated .MailItem itemList = 7;</code>
     */
    MailItemOuterClass.MailItemOrBuilder getItemListOrBuilder(
        int index);

    /**
     * <code>uint32 sendTime = 8;</code>
     * @return The sendTime.
     */
    int getSendTime();

    /**
     * <code>uint32 expireTime = 9;</code>
    ...
    /**
     * <code>bool isRead = 11;</code>
     * @return The isRead.
     */
    boolean getIsRead();

    /**
     * <code>bool isAttachmentGot = 12;</code>
    ...
    /**
     * <code>repeated string argumentList = 14;</code>
    ...
    /**
     * <code>.MailCollectState collectState = 15;</code>
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              ...
              mailTextContent_ = input.readMessage(MailTextContentOuterClass.MailTextContent.parser(), extensionRegistry);
              if (subBuilder != null) {
            ...
            case 58: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                itemList_ = new java.util.ArrayList<MailItemOuterClass.MailItem>();
                mutable_bitField0_ |= 0x00000001;
              }
              itemList_.add(
                  input.readMessage(MailItemOuterClass.MailItem.parser(), extensionRegistry));
              break;
            }
            case 64: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return MailDataOuterClass.internal_static_MailData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              MailDataOuterClass.MailData.class, MailDataOuterClass.MailData.Builder.class);
    }
    ...
    public MailTextContentOuterClass.MailTextContent getMailTextContent() {
      return mailTextContent_ == null ? MailTextContentOuterClass.MailTextContent.getDefaultInstance() : mailTextContent_;
    }
    /**
     * <code>.MailTextContent mailTextContent = 4;</code>
     */
    ...
    private java.util.List<MailItemOuterClass.MailItem> itemList_;
    /**
     * <code>repeated .MailItem itemList = 7;</code>
     */
    @java.lang.Override
    public java.util.List<MailItemOuterClass.MailItem> getItemListList() {
      return itemList_;
    }
    /**
     * <code>repeated .MailItem itemList = 7;</code>
     */
    @java.lang.Override
    public java.util.List<? extends MailItemOuterClass.MailItemOrBuilder> 
        getItemListOrBuilderList() {
      return itemList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public MailItemOuterClass.MailItemOrBuilder getItemListOrBuilder(
        int index) {
      return itemList_.get(index);
    }
     ...
     * @return The collectState.
     */
    @java.lang.Override public MailCollectStateOuterClass.MailCollectState getCollectState() {
      @SuppressWarnings("deprecation")
      MailCollectStateOuterClass.MailCollectState result = MailCollectStateOuterClass.MailCollectState.valueOf(collectState_);
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (collectState_ != MailCollectStateOuterClass.MailCollectState.MAIL_COLLECT_STATE_COLLECTIBLE_UNKNOWN.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof MailDataOuterClass.MailData)) {
        return super.equals(obj);
      }
      MailDataOuterClass.MailData other = (MailDataOuterClass.MailData) obj;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + COLLECTSTATE_FIELD_NUMBER;
    ...
    public static MailDataOuterClass.MailData parseFrom(
    ...
    public static MailDataOuterClass.MailData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static MailDataOuterClass.MailData parseFrom(
    ...
    public static MailDataOuterClass.MailData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static MailDataOuterClass.MailData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static MailDataOuterClass.MailData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(MailDataOuterClass.MailData prototype) {
    ...
    public static final class Builder extends
        ...
        MailDataOuterClass.MailDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return MailDataOuterClass.internal_static_MailData_descriptor;
      }
      ...
      // Construct using MailDataOuterClass.MailData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public MailDataOuterClass.MailData getDefaultInstanceForType() {
        return MailDataOuterClass.MailData.getDefaultInstance();
      }

      @java.lang.Override
      public MailDataOuterClass.MailData build() {
        MailDataOuterClass.MailData result = buildPartial();
      ...
      @java.lang.Override
      public MailDataOuterClass.MailData buildPartial() {
        MailDataOuterClass.MailData result = new MailDataOuterClass.MailData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof MailDataOuterClass.MailData) {
          return mergeFrom((MailDataOuterClass.MailData)other);
        } else {
      ...
      public Builder mergeFrom(MailDataOuterClass.MailData other) {
        if (other == MailDataOuterClass.MailData.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        MailDataOuterClass.MailData parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (MailDataOuterClass.MailData) e.getUnfinishedMessage();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          MailTextContentOuterClass.MailTextContent, MailTextContentOuterClass.MailTextContent.Builder, MailTextContentOuterClass.MailTextContentOrBuilder> mailTextContentBuilder_;
      /**
       * <code>.MailTextContent mailTextContent = 4;</code>
       * @return Whether the mailTextContent field is set.
       */
      ...
      public Builder setMailTextContent(
          MailTextContentOuterClass.MailTextContent.Builder builderForValue) {
        if (mailTextContentBuilder_ == null) {
      ...
      public Builder mergeMailTextContent(MailTextContentOuterClass.MailTextContent value) {
        if (mailTextContentBuilder_ == null) {
          if (mailTextContent_ != null) {
            mailTextContent_ =
              MailTextContentOuterClass.MailTextContent.newBuilder(mailTextContent_).mergeFrom(value).buildPartial();
          } else {
            mailTextContent_ = value;
          }
          onChanged();
      ...
      public MailTextContentOuterClass.MailTextContentOrBuilder getMailTextContentOrBuilder() {
        if (mailTextContentBuilder_ != null) {
          ...
          return mailTextContent_ == null ?
              MailTextContentOuterClass.MailTextContent.getDefaultInstance() : mailTextContent_;
        }
      }
      /**
       * <code>.MailTextContent mailTextContent = 4;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          MailTextContentOuterClass.MailTextContent, MailTextContentOuterClass.MailTextContent.Builder, MailTextContentOuterClass.MailTextContentOrBuilder> 
      ...
      private void ensureItemListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          itemList_ = new java.util.ArrayList<MailItemOuterClass.MailItem>(itemList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          MailItemOuterClass.MailItem, MailItemOuterClass.MailItem.Builder, MailItemOuterClass.MailItemOrBuilder> itemListBuilder_;
      ...
      public Builder setItemList(
          int index, MailItemOuterClass.MailItem value) {
        if (itemListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setItemList(
          int index, MailItemOuterClass.MailItem.Builder builderForValue) {
        if (itemListBuilder_ == null) {
          ensureItemListIsMutable();
       ...
       */
      public Builder addItemList(
          MailItemOuterClass.MailItem.Builder builderForValue) {
        if (itemListBuilder_ == null) {
          ensureItemListIsMutable();
      ...
      public Builder addAllItemList(
          java.lang.Iterable<? extends MailItemOuterClass.MailItem> values) {
        if (itemListBuilder_ == null) {
          ensureItemListIsMutable();
       ...
       * <code>repeated .MailItem itemList = 7;</code>
       */
      public MailItemOuterClass.MailItem.Builder getItemListBuilder(
          int index) {
      ...
      public MailItemOuterClass.MailItem.Builder addItemListBuilder() {
        return getItemListFieldBuilder().addBuilder(
            MailItemOuterClass.MailItem.getDefaultInstance());
      }
      /**
       * <code>repeated .MailItem itemList = 7;</code>
       */
      public MailItemOuterClass.MailItem.Builder addItemListBuilder(
          int index) {
        return getItemListFieldBuilder().addBuilder(
            index, MailItemOuterClass.MailItem.getDefaultInstance());
      }
      /**
       * <code>repeated .MailItem itemList = 7;</code>
       */
      public java.util.List<MailItemOuterClass.MailItem.Builder> 
           getItemListBuilderList() {
        return getItemListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          MailItemOuterClass.MailItem, MailItemOuterClass.MailItem.Builder, MailItemOuterClass.MailItemOrBuilder> 
          getItemListFieldBuilder() {
        if (itemListBuilder_ == null) {
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final MailDataOuterClass.MailData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new MailDataOuterClass.MailData();
    }

    public static MailDataOuterClass.MailData getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "Content\030\004 \001(\0132\020.MailTextContent\022\033\n\010itemL" +
      "ist\030\007 \003(\0132\t.MailItem\022\020\n\010sendTime\030\010 \001(\r\022\022" +
      "\n\nexpireTime\030\t \001(\r\022\022\n\nimportance\030\n \001(\r\022\016" +
      "\n\006isRead\030\013 \001(\010\022\027\n\017isAttachmentGot\030\014 \001(\010\022" +
      "\020\n\010configId\030\r \001(\r\022\024\n\014argumentList\030\016 \003(\t\022" +
      "\'\n\014collectState\030\017 \001(\0162\021.MailCollectState" +
      "b\006proto3"
    };
