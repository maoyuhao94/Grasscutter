...
public final class HostPlayerNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return HostPlayerNotifyOuterClass.internal_static_HostPlayerNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              HostPlayerNotifyOuterClass.HostPlayerNotify.class, HostPlayerNotifyOuterClass.HostPlayerNotify.Builder.class);
    }
    ...
    public enum AJDCLIKNOLN
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return HostPlayerNotifyOuterClass.HostPlayerNotify.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof HostPlayerNotifyOuterClass.HostPlayerNotify)) {
        return super.equals(obj);
      }
      HostPlayerNotifyOuterClass.HostPlayerNotify other = (HostPlayerNotifyOuterClass.HostPlayerNotify) obj;
    ...
    public static HostPlayerNotifyOuterClass.HostPlayerNotify parseFrom(
    ...
    public static HostPlayerNotifyOuterClass.HostPlayerNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static HostPlayerNotifyOuterClass.HostPlayerNotify parseFrom(
    ...
    public static HostPlayerNotifyOuterClass.HostPlayerNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static HostPlayerNotifyOuterClass.HostPlayerNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static HostPlayerNotifyOuterClass.HostPlayerNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(HostPlayerNotifyOuterClass.HostPlayerNotify prototype) {
    ...
    public static final class Builder extends
        ...
        HostPlayerNotifyOuterClass.HostPlayerNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return HostPlayerNotifyOuterClass.internal_static_HostPlayerNotify_descriptor;
      }
      ...
      // Construct using HostPlayerNotifyOuterClass.HostPlayerNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public HostPlayerNotifyOuterClass.HostPlayerNotify getDefaultInstanceForType() {
        return HostPlayerNotifyOuterClass.HostPlayerNotify.getDefaultInstance();
      }

      @java.lang.Override
      public HostPlayerNotifyOuterClass.HostPlayerNotify build() {
        HostPlayerNotifyOuterClass.HostPlayerNotify result = buildPartial();
      ...
      @java.lang.Override
      public HostPlayerNotifyOuterClass.HostPlayerNotify buildPartial() {
        HostPlayerNotifyOuterClass.HostPlayerNotify result = new HostPlayerNotifyOuterClass.HostPlayerNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof HostPlayerNotifyOuterClass.HostPlayerNotify) {
          return mergeFrom((HostPlayerNotifyOuterClass.HostPlayerNotify)other);
        } else {
      ...
      public Builder mergeFrom(HostPlayerNotifyOuterClass.HostPlayerNotify other) {
        if (other == HostPlayerNotifyOuterClass.HostPlayerNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        HostPlayerNotifyOuterClass.HostPlayerNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (HostPlayerNotifyOuterClass.HostPlayerNotify) e.getUnfinishedMessage();
    ...
    private static final HostPlayerNotifyOuterClass.HostPlayerNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new HostPlayerNotifyOuterClass.HostPlayerNotify();
    }

    public static HostPlayerNotifyOuterClass.HostPlayerNotify getDefaultInstance() {
