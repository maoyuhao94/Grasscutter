...
public final class HuntingGiveUpReqOuterClass {
  ...
  public interface HuntingGiveUpReqOrBuilder extends
    ...
    /**
     * <code>.HuntingPair huntingPair = 13;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return HuntingGiveUpReqOuterClass.internal_static_HuntingGiveUpReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return HuntingGiveUpReqOuterClass.internal_static_HuntingGiveUpReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              HuntingGiveUpReqOuterClass.HuntingGiveUpReq.class, HuntingGiveUpReqOuterClass.HuntingGiveUpReq.Builder.class);
    }

    /**
     * Protobuf enum {@code HuntingGiveUpReq.AIEHOPHFBGP}
     */
    public enum AIEHOPHFBGP
       ...
       */
      public static final AIEHOPHFBGP DCDNILFDFLB = NONE;
      /**
       * <code>EAJIABGAOCI = 1;</code>
       */
      public static final AIEHOPHFBGP EAJIABGAOCI = NNBKOLMPOEA;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 4337;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 4337;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static AIEHOPHFBGP valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static AIEHOPHFBGP forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 4337: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<AIEHOPHFBGP>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          AIEHOPHFBGP> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<AIEHOPHFBGP>() {
              public AIEHOPHFBGP findValueByNumber(int number) {
                return AIEHOPHFBGP.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return HuntingGiveUpReqOuterClass.HuntingGiveUpReq.getDescriptor().getEnumTypes().get(0);
      }

      private static final AIEHOPHFBGP[] VALUES = getStaticValuesArray();
      private static AIEHOPHFBGP[] getStaticValuesArray() {
        return new AIEHOPHFBGP[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, EAJIABGAOCI, 
        };
      }
      public static AIEHOPHFBGP valueOf(
      ...
      private AIEHOPHFBGP(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:HuntingGiveUpReq.AIEHOPHFBGP)
    }

    public static final int HUNTINGPAIR_FIELD_NUMBER = 13;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof HuntingGiveUpReqOuterClass.HuntingGiveUpReq)) {
        return super.equals(obj);
      }
      HuntingGiveUpReqOuterClass.HuntingGiveUpReq other = (HuntingGiveUpReqOuterClass.HuntingGiveUpReq) obj;
    ...
    public static HuntingGiveUpReqOuterClass.HuntingGiveUpReq parseFrom(
    ...
    public static HuntingGiveUpReqOuterClass.HuntingGiveUpReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static HuntingGiveUpReqOuterClass.HuntingGiveUpReq parseFrom(
    ...
    public static HuntingGiveUpReqOuterClass.HuntingGiveUpReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static HuntingGiveUpReqOuterClass.HuntingGiveUpReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static HuntingGiveUpReqOuterClass.HuntingGiveUpReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(HuntingGiveUpReqOuterClass.HuntingGiveUpReq prototype) {
    ...
    public static final class Builder extends
        ...
        HuntingGiveUpReqOuterClass.HuntingGiveUpReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return HuntingGiveUpReqOuterClass.internal_static_HuntingGiveUpReq_descriptor;
      }
      ...
      // Construct using HuntingGiveUpReqOuterClass.HuntingGiveUpReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public HuntingGiveUpReqOuterClass.HuntingGiveUpReq getDefaultInstanceForType() {
        return HuntingGiveUpReqOuterClass.HuntingGiveUpReq.getDefaultInstance();
      }

      @java.lang.Override
      public HuntingGiveUpReqOuterClass.HuntingGiveUpReq build() {
        HuntingGiveUpReqOuterClass.HuntingGiveUpReq result = buildPartial();
      ...
      @java.lang.Override
      public HuntingGiveUpReqOuterClass.HuntingGiveUpReq buildPartial() {
        HuntingGiveUpReqOuterClass.HuntingGiveUpReq result = new HuntingGiveUpReqOuterClass.HuntingGiveUpReq(this);
        if (huntingPairBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof HuntingGiveUpReqOuterClass.HuntingGiveUpReq) {
          return mergeFrom((HuntingGiveUpReqOuterClass.HuntingGiveUpReq)other);
        } else {
      ...
      public Builder mergeFrom(HuntingGiveUpReqOuterClass.HuntingGiveUpReq other) {
        if (other == HuntingGiveUpReqOuterClass.HuntingGiveUpReq.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        HuntingGiveUpReqOuterClass.HuntingGiveUpReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (HuntingGiveUpReqOuterClass.HuntingGiveUpReq) e.getUnfinishedMessage();
    ...
    private static final HuntingGiveUpReqOuterClass.HuntingGiveUpReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new HuntingGiveUpReqOuterClass.HuntingGiveUpReq();
    }

    public static HuntingGiveUpReqOuterClass.HuntingGiveUpReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\r \001(\0132\014.HuntingPair\"`\n\013AIEHOPHFBGP\022\010\n\004NO" +
