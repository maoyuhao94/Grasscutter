  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return AvatarAddNotifyOuterClass.internal_static_AvatarAddNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              AvatarAddNotifyOuterClass.AvatarAddNotify.class, AvatarAddNotifyOuterClass.AvatarAddNotify.Builder.class);
    }
    ...
    public enum APNKIMFCJIH
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return AvatarAddNotifyOuterClass.AvatarAddNotify.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof AvatarAddNotifyOuterClass.AvatarAddNotify)) {
        return super.equals(obj);
      }
      AvatarAddNotifyOuterClass.AvatarAddNotify other = (AvatarAddNotifyOuterClass.AvatarAddNotify) obj;
    ...
    public static AvatarAddNotifyOuterClass.AvatarAddNotify parseFrom(
    ...
    public static AvatarAddNotifyOuterClass.AvatarAddNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static AvatarAddNotifyOuterClass.AvatarAddNotify parseFrom(
    ...
    public static AvatarAddNotifyOuterClass.AvatarAddNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static AvatarAddNotifyOuterClass.AvatarAddNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static AvatarAddNotifyOuterClass.AvatarAddNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(AvatarAddNotifyOuterClass.AvatarAddNotify prototype) {
    ...
    public static final class Builder extends
        ...
        AvatarAddNotifyOuterClass.AvatarAddNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return AvatarAddNotifyOuterClass.internal_static_AvatarAddNotify_descriptor;
      }
      ...
      // Construct using AvatarAddNotifyOuterClass.AvatarAddNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public AvatarAddNotifyOuterClass.AvatarAddNotify getDefaultInstanceForType() {
        return AvatarAddNotifyOuterClass.AvatarAddNotify.getDefaultInstance();
      }

      @java.lang.Override
      public AvatarAddNotifyOuterClass.AvatarAddNotify build() {
        AvatarAddNotifyOuterClass.AvatarAddNotify result = buildPartial();
      ...
      @java.lang.Override
      public AvatarAddNotifyOuterClass.AvatarAddNotify buildPartial() {
        AvatarAddNotifyOuterClass.AvatarAddNotify result = new AvatarAddNotifyOuterClass.AvatarAddNotify(this);
        if (avatarBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof AvatarAddNotifyOuterClass.AvatarAddNotify) {
          return mergeFrom((AvatarAddNotifyOuterClass.AvatarAddNotify)other);
        } else {
      ...
      public Builder mergeFrom(AvatarAddNotifyOuterClass.AvatarAddNotify other) {
        if (other == AvatarAddNotifyOuterClass.AvatarAddNotify.getDefaultInstance()) return this;
        if (other.hasAvatar()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        AvatarAddNotifyOuterClass.AvatarAddNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (AvatarAddNotifyOuterClass.AvatarAddNotify) e.getUnfinishedMessage();
    ...
    private static final AvatarAddNotifyOuterClass.AvatarAddNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new AvatarAddNotifyOuterClass.AvatarAddNotify();
    }

    public static AvatarAddNotifyOuterClass.AvatarAddNotify getDefaultInstance() {
