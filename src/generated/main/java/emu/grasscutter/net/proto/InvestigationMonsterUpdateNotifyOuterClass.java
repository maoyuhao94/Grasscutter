...
public final class InvestigationMonsterUpdateNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 122: {
              InvestigationMonsterOuterClass.InvestigationMonster.Builder subBuilder = null;
              if (investigationMonster_ != null) {
                subBuilder = investigationMonster_.toBuilder();
              }
              investigationMonster_ = input.readMessage(InvestigationMonsterOuterClass.InvestigationMonster.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return InvestigationMonsterUpdateNotifyOuterClass.internal_static_InvestigationMonsterUpdateNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify.class, InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify.Builder.class);
    }
    ...
    public enum PGJKAGCIHFP
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public InvestigationMonsterOuterClass.InvestigationMonster getInvestigationMonster() {
      return investigationMonster_ == null ? InvestigationMonsterOuterClass.InvestigationMonster.getDefaultInstance() : investigationMonster_;
    }
    /**
     * <code>.InvestigationMonster investigationMonster = 15;</code>
     */
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify)) {
        return super.equals(obj);
      }
      InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify other = (InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify) obj;
    ...
    public static InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify parseFrom(
    ...
    public static InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify parseFrom(
    ...
    public static InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify prototype) {
    ...
    public static final class Builder extends
        ...
        InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return InvestigationMonsterUpdateNotifyOuterClass.internal_static_InvestigationMonsterUpdateNotify_descriptor;
      }
      ...
      // Construct using InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify getDefaultInstanceForType() {
        return InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify.getDefaultInstance();
      }

      @java.lang.Override
      public InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify build() {
        InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify result = buildPartial();
      ...
      @java.lang.Override
      public InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify buildPartial() {
        InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify result = new InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify(this);
        if (investigationMonsterBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify) {
          return mergeFrom((InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify)other);
        } else {
      ...
      public Builder mergeFrom(InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify other) {
        if (other == InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify) e.getUnfinishedMessage();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          InvestigationMonsterOuterClass.InvestigationMonster, InvestigationMonsterOuterClass.InvestigationMonster.Builder, InvestigationMonsterOuterClass.InvestigationMonsterOrBuilder> investigationMonsterBuilder_;
      /**
       * <code>.InvestigationMonster investigationMonster = 15;</code>
       * @return Whether the investigationMonster field is set.
       */
        ...
        if (investigationMonsterBuilder_ == null) {
          if (investigationMonster_ != null) {
            investigationMonster_ =
              InvestigationMonsterOuterClass.InvestigationMonster.newBuilder(investigationMonster_).mergeFrom(value).buildPartial();
          } else {
            investigationMonster_ = value;
          }
          onChanged();
      ...
      public InvestigationMonsterOuterClass.InvestigationMonsterOrBuilder getInvestigationMonsterOrBuilder() {
        if (investigationMonsterBuilder_ != null) {
          ...
          return investigationMonster_ == null ?
              InvestigationMonsterOuterClass.InvestigationMonster.getDefaultInstance() : investigationMonster_;
        }
      }
      /**
       * <code>.InvestigationMonster investigationMonster = 15;</code>
    ...
    private static final InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify();
    }

    public static InvestigationMonsterUpdateNotifyOuterClass.InvestigationMonsterUpdateNotify getDefaultInstance() {
