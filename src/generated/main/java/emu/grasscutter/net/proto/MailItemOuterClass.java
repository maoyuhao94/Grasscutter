...
public final class MailItemOuterClass {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              ...
              equipParam_ = input.readMessage(EquipParamOuterClass.EquipParam.parser(), extensionRegistry);
              if (subBuilder != null) {
            ...
            case 18: {
              ...
              deleteInfo_ = input.readMessage(MaterialDeleteInfoOuterClass.MaterialDeleteInfo.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return MailItemOuterClass.internal_static_MailItem_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              MailItemOuterClass.MailItem.class, MailItemOuterClass.MailItem.Builder.class);
    }
    ...
    public EquipParamOuterClass.EquipParam getEquipParam() {
      return equipParam_ == null ? EquipParamOuterClass.EquipParam.getDefaultInstance() : equipParam_;
    }
    /**
     * <code>.EquipParam equipParam = 1;</code>
     */
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof MailItemOuterClass.MailItem)) {
        return super.equals(obj);
      }
      MailItemOuterClass.MailItem other = (MailItemOuterClass.MailItem) obj;
    ...
    public static MailItemOuterClass.MailItem parseFrom(
    ...
    public static MailItemOuterClass.MailItem parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static MailItemOuterClass.MailItem parseFrom(
    ...
    public static MailItemOuterClass.MailItem parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static MailItemOuterClass.MailItem parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static MailItemOuterClass.MailItem parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(MailItemOuterClass.MailItem prototype) {
    ...
    public static final class Builder extends
        ...
        MailItemOuterClass.MailItemOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return MailItemOuterClass.internal_static_MailItem_descriptor;
      }
      ...
      // Construct using MailItemOuterClass.MailItem.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public MailItemOuterClass.MailItem getDefaultInstanceForType() {
        return MailItemOuterClass.MailItem.getDefaultInstance();
      }

      @java.lang.Override
      public MailItemOuterClass.MailItem build() {
        MailItemOuterClass.MailItem result = buildPartial();
      ...
      @java.lang.Override
      public MailItemOuterClass.MailItem buildPartial() {
        MailItemOuterClass.MailItem result = new MailItemOuterClass.MailItem(this);
        if (equipParamBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof MailItemOuterClass.MailItem) {
          return mergeFrom((MailItemOuterClass.MailItem)other);
        } else {
      ...
      public Builder mergeFrom(MailItemOuterClass.MailItem other) {
        if (other == MailItemOuterClass.MailItem.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        MailItemOuterClass.MailItem parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (MailItemOuterClass.MailItem) e.getUnfinishedMessage();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          EquipParamOuterClass.EquipParam, EquipParamOuterClass.EquipParam.Builder, EquipParamOuterClass.EquipParamOrBuilder> equipParamBuilder_;
      /**
       * <code>.EquipParam equipParam = 1;</code>
       * @return Whether the equipParam field is set.
       */
      ...
      public Builder mergeEquipParam(EquipParamOuterClass.EquipParam value) {
        if (equipParamBuilder_ == null) {
          if (equipParam_ != null) {
            equipParam_ =
              EquipParamOuterClass.EquipParam.newBuilder(equipParam_).mergeFrom(value).buildPartial();
          } else {
            equipParam_ = value;
          }
          onChanged();
      ...
      public EquipParamOuterClass.EquipParamOrBuilder getEquipParamOrBuilder() {
        if (equipParamBuilder_ != null) {
          ...
          return equipParam_ == null ?
              EquipParamOuterClass.EquipParam.getDefaultInstance() : equipParam_;
        }
      }
      /**
       * <code>.EquipParam equipParam = 1;</code>
      ...
      public Builder mergeDeleteInfo(MaterialDeleteInfoOuterClass.MaterialDeleteInfo value) {
        if (deleteInfoBuilder_ == null) {
          if (deleteInfo_ != null) {
            deleteInfo_ =
              MaterialDeleteInfoOuterClass.MaterialDeleteInfo.newBuilder(deleteInfo_).mergeFrom(value).buildPartial();
          } else {
            deleteInfo_ = value;
          }
          onChanged();
    ...
    private static final MailItemOuterClass.MailItem DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new MailItemOuterClass.MailItem();
    }

    public static MailItemOuterClass.MailItem getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\002 \001(\0132\023.MaterialDeleteInfob\006proto3"
    };
