...
public final class BuoyantCombatInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return BuoyantCombatInfoOuterClass.internal_static_BuoyantCombatInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              BuoyantCombatInfoOuterClass.BuoyantCombatInfo.class, BuoyantCombatInfoOuterClass.BuoyantCombatInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof BuoyantCombatInfoOuterClass.BuoyantCombatInfo)) {
        return super.equals(obj);
      }
      BuoyantCombatInfoOuterClass.BuoyantCombatInfo other = (BuoyantCombatInfoOuterClass.BuoyantCombatInfo) obj;
    ...
    public static BuoyantCombatInfoOuterClass.BuoyantCombatInfo parseFrom(
    ...
    public static BuoyantCombatInfoOuterClass.BuoyantCombatInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static BuoyantCombatInfoOuterClass.BuoyantCombatInfo parseFrom(
    ...
    public static BuoyantCombatInfoOuterClass.BuoyantCombatInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static BuoyantCombatInfoOuterClass.BuoyantCombatInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static BuoyantCombatInfoOuterClass.BuoyantCombatInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(BuoyantCombatInfoOuterClass.BuoyantCombatInfo prototype) {
    ...
    public static final class Builder extends
        ...
        BuoyantCombatInfoOuterClass.BuoyantCombatInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return BuoyantCombatInfoOuterClass.internal_static_BuoyantCombatInfo_descriptor;
      }
      ...
      // Construct using BuoyantCombatInfoOuterClass.BuoyantCombatInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public BuoyantCombatInfoOuterClass.BuoyantCombatInfo getDefaultInstanceForType() {
        return BuoyantCombatInfoOuterClass.BuoyantCombatInfo.getDefaultInstance();
      }

      @java.lang.Override
      public BuoyantCombatInfoOuterClass.BuoyantCombatInfo build() {
        BuoyantCombatInfoOuterClass.BuoyantCombatInfo result = buildPartial();
      ...
      @java.lang.Override
      public BuoyantCombatInfoOuterClass.BuoyantCombatInfo buildPartial() {
        BuoyantCombatInfoOuterClass.BuoyantCombatInfo result = new BuoyantCombatInfoOuterClass.BuoyantCombatInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof BuoyantCombatInfoOuterClass.BuoyantCombatInfo) {
          return mergeFrom((BuoyantCombatInfoOuterClass.BuoyantCombatInfo)other);
        } else {
      ...
      public Builder mergeFrom(BuoyantCombatInfoOuterClass.BuoyantCombatInfo other) {
        if (other == BuoyantCombatInfoOuterClass.BuoyantCombatInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        BuoyantCombatInfoOuterClass.BuoyantCombatInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (BuoyantCombatInfoOuterClass.BuoyantCombatInfo) e.getUnfinishedMessage();
    ...
    private static final BuoyantCombatInfoOuterClass.BuoyantCombatInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new BuoyantCombatInfoOuterClass.BuoyantCombatInfo();
    }

    public static BuoyantCombatInfoOuterClass.BuoyantCombatInfo getDefaultInstance() {
