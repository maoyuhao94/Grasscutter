...
public final class HomeModuleSeenRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return HomeModuleSeenRspOuterClass.internal_static_HomeModuleSeenRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              HomeModuleSeenRspOuterClass.HomeModuleSeenRsp.class, HomeModuleSeenRspOuterClass.HomeModuleSeenRsp.Builder.class);
    }

    /**
     * Protobuf enum {@code HomeModuleSeenRsp.DBDAOAGDKOJ}
     */
    public enum DBDAOAGDKOJ
       ...
       */
      public static final DBDAOAGDKOJ DCDNILFDFLB = NONE;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 4516;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 4516;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static DBDAOAGDKOJ valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static DBDAOAGDKOJ forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 4516: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<DBDAOAGDKOJ>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          DBDAOAGDKOJ> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<DBDAOAGDKOJ>() {
              public DBDAOAGDKOJ findValueByNumber(int number) {
                return DBDAOAGDKOJ.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return HomeModuleSeenRspOuterClass.HomeModuleSeenRsp.getDescriptor().getEnumTypes().get(0);
      }

      private static final DBDAOAGDKOJ[] VALUES = getStaticValuesArray();
      private static DBDAOAGDKOJ[] getStaticValuesArray() {
        return new DBDAOAGDKOJ[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, 
        };
      }
      public static DBDAOAGDKOJ valueOf(
      ...
      private DBDAOAGDKOJ(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:HomeModuleSeenRsp.DBDAOAGDKOJ)
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof HomeModuleSeenRspOuterClass.HomeModuleSeenRsp)) {
        return super.equals(obj);
      }
      HomeModuleSeenRspOuterClass.HomeModuleSeenRsp other = (HomeModuleSeenRspOuterClass.HomeModuleSeenRsp) obj;
    ...
    public static HomeModuleSeenRspOuterClass.HomeModuleSeenRsp parseFrom(
    ...
    public static HomeModuleSeenRspOuterClass.HomeModuleSeenRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static HomeModuleSeenRspOuterClass.HomeModuleSeenRsp parseFrom(
    ...
    public static HomeModuleSeenRspOuterClass.HomeModuleSeenRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static HomeModuleSeenRspOuterClass.HomeModuleSeenRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static HomeModuleSeenRspOuterClass.HomeModuleSeenRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(HomeModuleSeenRspOuterClass.HomeModuleSeenRsp prototype) {
    ...
    public static final class Builder extends
        ...
        HomeModuleSeenRspOuterClass.HomeModuleSeenRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return HomeModuleSeenRspOuterClass.internal_static_HomeModuleSeenRsp_descriptor;
      }
      ...
      // Construct using HomeModuleSeenRspOuterClass.HomeModuleSeenRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public HomeModuleSeenRspOuterClass.HomeModuleSeenRsp getDefaultInstanceForType() {
        return HomeModuleSeenRspOuterClass.HomeModuleSeenRsp.getDefaultInstance();
      }

      @java.lang.Override
      public HomeModuleSeenRspOuterClass.HomeModuleSeenRsp build() {
        HomeModuleSeenRspOuterClass.HomeModuleSeenRsp result = buildPartial();
      ...
      @java.lang.Override
      public HomeModuleSeenRspOuterClass.HomeModuleSeenRsp buildPartial() {
        HomeModuleSeenRspOuterClass.HomeModuleSeenRsp result = new HomeModuleSeenRspOuterClass.HomeModuleSeenRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof HomeModuleSeenRspOuterClass.HomeModuleSeenRsp) {
          return mergeFrom((HomeModuleSeenRspOuterClass.HomeModuleSeenRsp)other);
        } else {
      ...
      public Builder mergeFrom(HomeModuleSeenRspOuterClass.HomeModuleSeenRsp other) {
        if (other == HomeModuleSeenRspOuterClass.HomeModuleSeenRsp.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        HomeModuleSeenRspOuterClass.HomeModuleSeenRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (HomeModuleSeenRspOuterClass.HomeModuleSeenRsp) e.getUnfinishedMessage();
    ...
    private static final HomeModuleSeenRspOuterClass.HomeModuleSeenRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new HomeModuleSeenRspOuterClass.HomeModuleSeenRsp();
    }

    public static HomeModuleSeenRspOuterClass.HomeModuleSeenRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\027HomeModuleSeenRsp.proto\"\217\001\n\021HomeModule" +
      "SeenRsp\022\017\n\007retcode\030\t \001(\005\022\030\n\020seenModuleId" +
      "List\030\014 \003(\r\"O\n\013DBDAOAGDKOJ\022\010\n\004NONE\020\000\022\020\n\013P" +
      "EPPOHPHJOJ\020\244#\022\017\n\013DCDNILFDFLB\020\000\022\017\n\013NNBKOL" +
