...
public final class GetAllMailRspOuterClass {
  ...
  public interface GetAllMailRspOrBuilder extends
    ...
    /**
     * <code>repeated .MailData mailList = 7;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return GetAllMailRspOuterClass.internal_static_GetAllMailRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              GetAllMailRspOuterClass.GetAllMailRsp.class, GetAllMailRspOuterClass.GetAllMailRsp.Builder.class);
    }

    /**
     * Protobuf enum {@code GetAllMailRsp.FNCKKDMEJGP}
     */
    public enum FNCKKDMEJGP
       ...
       */
      public static final FNCKKDMEJGP DCDNILFDFLB = NONE;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 1429;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 1429;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static FNCKKDMEJGP valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static FNCKKDMEJGP forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 1429: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<FNCKKDMEJGP>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          FNCKKDMEJGP> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<FNCKKDMEJGP>() {
              public FNCKKDMEJGP findValueByNumber(int number) {
                return FNCKKDMEJGP.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return GetAllMailRspOuterClass.GetAllMailRsp.getDescriptor().getEnumTypes().get(0);
      }

      private static final FNCKKDMEJGP[] VALUES = getStaticValuesArray();
      private static FNCKKDMEJGP[] getStaticValuesArray() {
        return new FNCKKDMEJGP[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, 
        };
      }
      public static FNCKKDMEJGP valueOf(
      ...
      private FNCKKDMEJGP(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:GetAllMailRsp.FNCKKDMEJGP)
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < mailList_.size(); i++) {
        output.writeMessage(7, mailList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < mailList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(7, mailList_.get(i));
      }
      if (isTruncated_ != false) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof GetAllMailRspOuterClass.GetAllMailRsp)) {
        return super.equals(obj);
      }
      GetAllMailRspOuterClass.GetAllMailRsp other = (GetAllMailRspOuterClass.GetAllMailRsp) obj;
    ...
    public static GetAllMailRspOuterClass.GetAllMailRsp parseFrom(
    ...
    public static GetAllMailRspOuterClass.GetAllMailRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static GetAllMailRspOuterClass.GetAllMailRsp parseFrom(
    ...
    public static GetAllMailRspOuterClass.GetAllMailRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static GetAllMailRspOuterClass.GetAllMailRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static GetAllMailRspOuterClass.GetAllMailRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(GetAllMailRspOuterClass.GetAllMailRsp prototype) {
    ...
    public static final class Builder extends
        ...
        GetAllMailRspOuterClass.GetAllMailRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return GetAllMailRspOuterClass.internal_static_GetAllMailRsp_descriptor;
      }
      ...
      // Construct using GetAllMailRspOuterClass.GetAllMailRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public GetAllMailRspOuterClass.GetAllMailRsp getDefaultInstanceForType() {
        return GetAllMailRspOuterClass.GetAllMailRsp.getDefaultInstance();
      }

      @java.lang.Override
      public GetAllMailRspOuterClass.GetAllMailRsp build() {
        GetAllMailRspOuterClass.GetAllMailRsp result = buildPartial();
      ...
      @java.lang.Override
      public GetAllMailRspOuterClass.GetAllMailRsp buildPartial() {
        GetAllMailRspOuterClass.GetAllMailRsp result = new GetAllMailRspOuterClass.GetAllMailRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof GetAllMailRspOuterClass.GetAllMailRsp) {
          return mergeFrom((GetAllMailRspOuterClass.GetAllMailRsp)other);
        } else {
      ...
      public Builder mergeFrom(GetAllMailRspOuterClass.GetAllMailRsp other) {
        if (other == GetAllMailRspOuterClass.GetAllMailRsp.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        GetAllMailRspOuterClass.GetAllMailRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (GetAllMailRspOuterClass.GetAllMailRsp) e.getUnfinishedMessage();
    ...
    private static final GetAllMailRspOuterClass.GetAllMailRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new GetAllMailRspOuterClass.GetAllMailRsp();
    }

    public static GetAllMailRspOuterClass.GetAllMailRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\023GetAllMailRsp.proto\032\016MailData.proto\"\270\001" +
      "\n\rGetAllMailRsp\022\023\n\013isCollected\030\005 \001(\010\022\017\n\007" +
      "retcode\030\t \001(\005\022\033\n\010mailList\030\007 \003(\0132\t.MailDa" +
      "ta\022\023\n\013isTruncated\030\010 \001(\010\"O\n\013FNCKKDMEJGP\022\010" +
      "\n\004NONE\020\000\022\020\n\013PEPPOHPHJOJ\020\225\013\022\017\n\013DCDNILFDFL" +
    ...
    internal_static_GetAllMailRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_GetAllMailRsp_descriptor,
        new java.lang.String[] { "IsCollected", "Retcode", "MailList", "IsTruncated", });
    MailDataOuterClass.getDescriptor();
  }
