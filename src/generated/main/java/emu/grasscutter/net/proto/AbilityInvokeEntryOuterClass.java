...
public final class AbilityInvokeEntryOuterClass {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 106: {
              ...
              head_ = input.readMessage(AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return AbilityInvokeEntryOuterClass.internal_static_AbilityInvokeEntry_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              AbilityInvokeEntryOuterClass.AbilityInvokeEntry.class, AbilityInvokeEntryOuterClass.AbilityInvokeEntry.Builder.class);
    }
    ...
    public AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead getHead() {
      return head_ == null ? AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead.getDefaultInstance() : head_;
    }
    /**
     * <code>.AbilityInvokeEntryHead head = 13;</code>
     */
     ...
     * @return The argumentType.
     */
    @java.lang.Override public AbilityInvokeArgumentOuterClass.AbilityInvokeArgument getArgumentType() {
      @SuppressWarnings("deprecation")
      AbilityInvokeArgumentOuterClass.AbilityInvokeArgument result = AbilityInvokeArgumentOuterClass.AbilityInvokeArgument.valueOf(argumentType_);
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (argumentType_ != AbilityInvokeArgumentOuterClass.AbilityInvokeArgument.ABILITY_INVOKE_ARGUMENT_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof AbilityInvokeEntryOuterClass.AbilityInvokeEntry)) {
        return super.equals(obj);
      }
      AbilityInvokeEntryOuterClass.AbilityInvokeEntry other = (AbilityInvokeEntryOuterClass.AbilityInvokeEntry) obj;
    ...
    public static AbilityInvokeEntryOuterClass.AbilityInvokeEntry parseFrom(
    ...
    public static AbilityInvokeEntryOuterClass.AbilityInvokeEntry parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static AbilityInvokeEntryOuterClass.AbilityInvokeEntry parseFrom(
    ...
    public static AbilityInvokeEntryOuterClass.AbilityInvokeEntry parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static AbilityInvokeEntryOuterClass.AbilityInvokeEntry parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static AbilityInvokeEntryOuterClass.AbilityInvokeEntry parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(AbilityInvokeEntryOuterClass.AbilityInvokeEntry prototype) {
    ...
    public static final class Builder extends
        ...
        AbilityInvokeEntryOuterClass.AbilityInvokeEntryOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return AbilityInvokeEntryOuterClass.internal_static_AbilityInvokeEntry_descriptor;
      }
      ...
      // Construct using AbilityInvokeEntryOuterClass.AbilityInvokeEntry.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public AbilityInvokeEntryOuterClass.AbilityInvokeEntry getDefaultInstanceForType() {
        return AbilityInvokeEntryOuterClass.AbilityInvokeEntry.getDefaultInstance();
      }

      @java.lang.Override
      public AbilityInvokeEntryOuterClass.AbilityInvokeEntry build() {
        AbilityInvokeEntryOuterClass.AbilityInvokeEntry result = buildPartial();
      ...
      @java.lang.Override
      public AbilityInvokeEntryOuterClass.AbilityInvokeEntry buildPartial() {
        AbilityInvokeEntryOuterClass.AbilityInvokeEntry result = new AbilityInvokeEntryOuterClass.AbilityInvokeEntry(this);
        if (headBuilder_ == null) {
          result.head_ = head_;
        } else {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof AbilityInvokeEntryOuterClass.AbilityInvokeEntry) {
          return mergeFrom((AbilityInvokeEntryOuterClass.AbilityInvokeEntry)other);
        } else {
      ...
      public Builder mergeFrom(AbilityInvokeEntryOuterClass.AbilityInvokeEntry other) {
        if (other == AbilityInvokeEntryOuterClass.AbilityInvokeEntry.getDefaultInstance()) return this;
        if (other.hasHead()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        AbilityInvokeEntryOuterClass.AbilityInvokeEntry parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (AbilityInvokeEntryOuterClass.AbilityInvokeEntry) e.getUnfinishedMessage();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead, AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead.Builder, AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHeadOrBuilder> headBuilder_;
      /**
       * <code>.AbilityInvokeEntryHead head = 13;</code>
       * @return Whether the head field is set.
       */
      ...
      public Builder setHead(
          AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead.Builder builderForValue) {
        if (headBuilder_ == null) {
      ...
      public Builder mergeHead(AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead value) {
        if (headBuilder_ == null) {
          if (head_ != null) {
            head_ =
              AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead.newBuilder(head_).mergeFrom(value).buildPartial();
          } else {
            head_ = value;
          }
          onChanged();
      ...
      public AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHeadOrBuilder getHeadOrBuilder() {
        if (headBuilder_ != null) {
          ...
          return head_ == null ?
              AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead.getDefaultInstance() : head_;
        }
      }
      /**
       * <code>.AbilityInvokeEntryHead head = 13;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead, AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead.Builder, AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHeadOrBuilder> 
          getHeadFieldBuilder() {
        if (headBuilder_ == null) {
    ...
    private static final AbilityInvokeEntryOuterClass.AbilityInvokeEntry DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new AbilityInvokeEntryOuterClass.AbilityInvokeEntry();
    }

    public static AbilityInvokeEntryOuterClass.AbilityInvokeEntry getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022\024\n\014isIgnoreAuth\030\006 \001(\010b\006proto3"
    };
