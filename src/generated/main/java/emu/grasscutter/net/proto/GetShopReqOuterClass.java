  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return GetShopReqOuterClass.internal_static_GetShopReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              GetShopReqOuterClass.GetShopReq.class, GetShopReqOuterClass.GetShopReq.Builder.class);
    }
    ...
    public enum OBCAEPEACBM
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return GetShopReqOuterClass.GetShopReq.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof GetShopReqOuterClass.GetShopReq)) {
        return super.equals(obj);
      }
      GetShopReqOuterClass.GetShopReq other = (GetShopReqOuterClass.GetShopReq) obj;
    ...
    public static GetShopReqOuterClass.GetShopReq parseFrom(
    ...
    public static GetShopReqOuterClass.GetShopReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static GetShopReqOuterClass.GetShopReq parseFrom(
    ...
    public static GetShopReqOuterClass.GetShopReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static GetShopReqOuterClass.GetShopReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static GetShopReqOuterClass.GetShopReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(GetShopReqOuterClass.GetShopReq prototype) {
    ...
    public static final class Builder extends
        ...
        GetShopReqOuterClass.GetShopReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return GetShopReqOuterClass.internal_static_GetShopReq_descriptor;
      }
      ...
      // Construct using GetShopReqOuterClass.GetShopReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public GetShopReqOuterClass.GetShopReq getDefaultInstanceForType() {
        return GetShopReqOuterClass.GetShopReq.getDefaultInstance();
      }

      @java.lang.Override
      public GetShopReqOuterClass.GetShopReq build() {
        GetShopReqOuterClass.GetShopReq result = buildPartial();
      ...
      @java.lang.Override
      public GetShopReqOuterClass.GetShopReq buildPartial() {
        GetShopReqOuterClass.GetShopReq result = new GetShopReqOuterClass.GetShopReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof GetShopReqOuterClass.GetShopReq) {
          return mergeFrom((GetShopReqOuterClass.GetShopReq)other);
        } else {
      ...
      public Builder mergeFrom(GetShopReqOuterClass.GetShopReq other) {
        if (other == GetShopReqOuterClass.GetShopReq.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        GetShopReqOuterClass.GetShopReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (GetShopReqOuterClass.GetShopReq) e.getUnfinishedMessage();
    ...
    private static final GetShopReqOuterClass.GetShopReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new GetShopReqOuterClass.GetShopReq();
    }

    public static GetShopReqOuterClass.GetShopReq getDefaultInstance() {
