...
public final class UseItemReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return UseItemReqOuterClass.internal_static_UseItemReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              UseItemReqOuterClass.UseItemReq.class, UseItemReqOuterClass.UseItemReq.Builder.class);
    }
    ...
    public enum KKOIGEBPCBE
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return UseItemReqOuterClass.UseItemReq.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof UseItemReqOuterClass.UseItemReq)) {
        return super.equals(obj);
      }
      UseItemReqOuterClass.UseItemReq other = (UseItemReqOuterClass.UseItemReq) obj;
    ...
    public static UseItemReqOuterClass.UseItemReq parseFrom(
    ...
    public static UseItemReqOuterClass.UseItemReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static UseItemReqOuterClass.UseItemReq parseFrom(
    ...
    public static UseItemReqOuterClass.UseItemReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static UseItemReqOuterClass.UseItemReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static UseItemReqOuterClass.UseItemReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(UseItemReqOuterClass.UseItemReq prototype) {
    ...
    public static final class Builder extends
        ...
        UseItemReqOuterClass.UseItemReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return UseItemReqOuterClass.internal_static_UseItemReq_descriptor;
      }
      ...
      // Construct using UseItemReqOuterClass.UseItemReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public UseItemReqOuterClass.UseItemReq getDefaultInstanceForType() {
        return UseItemReqOuterClass.UseItemReq.getDefaultInstance();
      }

      @java.lang.Override
      public UseItemReqOuterClass.UseItemReq build() {
        UseItemReqOuterClass.UseItemReq result = buildPartial();
      ...
      @java.lang.Override
      public UseItemReqOuterClass.UseItemReq buildPartial() {
        UseItemReqOuterClass.UseItemReq result = new UseItemReqOuterClass.UseItemReq(this);
        result.guid_ = guid_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof UseItemReqOuterClass.UseItemReq) {
          return mergeFrom((UseItemReqOuterClass.UseItemReq)other);
        } else {
      ...
      public Builder mergeFrom(UseItemReqOuterClass.UseItemReq other) {
        if (other == UseItemReqOuterClass.UseItemReq.getDefaultInstance()) return this;
        if (other.getGuid() != 0L) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        UseItemReqOuterClass.UseItemReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (UseItemReqOuterClass.UseItemReq) e.getUnfinishedMessage();
    ...
    private static final UseItemReqOuterClass.UseItemReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new UseItemReqOuterClass.UseItemReq();
    }

    public static UseItemReqOuterClass.UseItemReq getDefaultInstance() {
