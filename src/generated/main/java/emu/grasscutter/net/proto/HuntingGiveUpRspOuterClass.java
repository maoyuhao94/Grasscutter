...
public final class HuntingGiveUpRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return HuntingGiveUpRspOuterClass.internal_static_HuntingGiveUpRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return HuntingGiveUpRspOuterClass.internal_static_HuntingGiveUpRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              HuntingGiveUpRspOuterClass.HuntingGiveUpRsp.class, HuntingGiveUpRspOuterClass.HuntingGiveUpRsp.Builder.class);
    }

    /**
     * Protobuf enum {@code HuntingGiveUpRsp.BABNEGNCIOJ}
     */
    public enum BABNEGNCIOJ
       ...
       */
      public static final BABNEGNCIOJ DCDNILFDFLB = NONE;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 4314;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 4314;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static BABNEGNCIOJ valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static BABNEGNCIOJ forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 4314: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<BABNEGNCIOJ>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          BABNEGNCIOJ> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<BABNEGNCIOJ>() {
              public BABNEGNCIOJ findValueByNumber(int number) {
                return BABNEGNCIOJ.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return HuntingGiveUpRspOuterClass.HuntingGiveUpRsp.getDescriptor().getEnumTypes().get(0);
      }

      private static final BABNEGNCIOJ[] VALUES = getStaticValuesArray();
      private static BABNEGNCIOJ[] getStaticValuesArray() {
        return new BABNEGNCIOJ[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, 
        };
      }
      public static BABNEGNCIOJ valueOf(
      ...
      private BABNEGNCIOJ(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:HuntingGiveUpRsp.BABNEGNCIOJ)
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof HuntingGiveUpRspOuterClass.HuntingGiveUpRsp)) {
        return super.equals(obj);
      }
      HuntingGiveUpRspOuterClass.HuntingGiveUpRsp other = (HuntingGiveUpRspOuterClass.HuntingGiveUpRsp) obj;
    ...
    public static HuntingGiveUpRspOuterClass.HuntingGiveUpRsp parseFrom(
    ...
    public static HuntingGiveUpRspOuterClass.HuntingGiveUpRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static HuntingGiveUpRspOuterClass.HuntingGiveUpRsp parseFrom(
    ...
    public static HuntingGiveUpRspOuterClass.HuntingGiveUpRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static HuntingGiveUpRspOuterClass.HuntingGiveUpRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static HuntingGiveUpRspOuterClass.HuntingGiveUpRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(HuntingGiveUpRspOuterClass.HuntingGiveUpRsp prototype) {
    ...
    public static final class Builder extends
        ...
        HuntingGiveUpRspOuterClass.HuntingGiveUpRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return HuntingGiveUpRspOuterClass.internal_static_HuntingGiveUpRsp_descriptor;
      }
      ...
      // Construct using HuntingGiveUpRspOuterClass.HuntingGiveUpRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public HuntingGiveUpRspOuterClass.HuntingGiveUpRsp getDefaultInstanceForType() {
        return HuntingGiveUpRspOuterClass.HuntingGiveUpRsp.getDefaultInstance();
      }

      @java.lang.Override
      public HuntingGiveUpRspOuterClass.HuntingGiveUpRsp build() {
        HuntingGiveUpRspOuterClass.HuntingGiveUpRsp result = buildPartial();
      ...
      @java.lang.Override
      public HuntingGiveUpRspOuterClass.HuntingGiveUpRsp buildPartial() {
        HuntingGiveUpRspOuterClass.HuntingGiveUpRsp result = new HuntingGiveUpRspOuterClass.HuntingGiveUpRsp(this);
        if (huntingPairBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof HuntingGiveUpRspOuterClass.HuntingGiveUpRsp) {
          return mergeFrom((HuntingGiveUpRspOuterClass.HuntingGiveUpRsp)other);
        } else {
      ...
      public Builder mergeFrom(HuntingGiveUpRspOuterClass.HuntingGiveUpRsp other) {
        if (other == HuntingGiveUpRspOuterClass.HuntingGiveUpRsp.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        HuntingGiveUpRspOuterClass.HuntingGiveUpRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (HuntingGiveUpRspOuterClass.HuntingGiveUpRsp) e.getUnfinishedMessage();
    ...
    private static final HuntingGiveUpRspOuterClass.HuntingGiveUpRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new HuntingGiveUpRspOuterClass.HuntingGiveUpRsp();
    }

    public static HuntingGiveUpRspOuterClass.HuntingGiveUpRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "oto\"\227\001\n\020HuntingGiveUpRsp\022!\n\013huntingPair\030" +
      "\004 \001(\0132\014.HuntingPair\022\017\n\007retcode\030\016 \001(\005\"O\n\013" +
      "BABNEGNCIOJ\022\010\n\004NONE\020\000\022\020\n\013PEPPOHPHJOJ\020\332!\022" +
    ...
    internal_static_HuntingGiveUpRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_HuntingGiveUpRsp_descriptor,
        new java.lang.String[] { "HuntingPair", "Retcode", });
    HuntingPairOuterClass.getDescriptor();
  }
