...
public final class HomeFurnitureGroupDataOuterClass {
  ...
  public interface HomeFurnitureGroupDataOrBuilder extends
     ...
     * <code>repeated .HomeFurnitureData virtualFurnitureList = 12;</code>
     */
    HomeFurnitureDataOuterClass.HomeFurnitureData getVirtualFurnitureList(int index);
    /**
     * <code>repeated .HomeFurnitureData virtualFurnitureList = 12;</code>
     */
     ...
     * <code>repeated .HomeFurnitureData virtualFurnitureList = 12;</code>
     */
    HomeFurnitureDataOuterClass.HomeFurnitureDataOrBuilder getVirtualFurnitureListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 98: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                virtualFurnitureList_ = new java.util.ArrayList<HomeFurnitureDataOuterClass.HomeFurnitureData>();
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return HomeFurnitureGroupDataOuterClass.internal_static_HomeFurnitureGroupData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData.class, HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData.Builder.class);
    }

    public static final int VIRTUALFURNITURELIST_FIELD_NUMBER = 12;
    private java.util.List<HomeFurnitureDataOuterClass.HomeFurnitureData> virtualFurnitureList_;
    /**
     * <code>repeated .HomeFurnitureData virtualFurnitureList = 12;</code>
     */
    @java.lang.Override
    public java.util.List<HomeFurnitureDataOuterClass.HomeFurnitureData> getVirtualFurnitureListList() {
     ...
     */
    @java.lang.Override
    public HomeFurnitureDataOuterClass.HomeFurnitureDataOrBuilder getVirtualFurnitureListOrBuilder(
        int index) {
      return virtualFurnitureList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData)) {
        return super.equals(obj);
      }
      HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData other = (HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData) obj;
    ...
    public static HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData parseFrom(
    ...
    public static HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData parseFrom(
    ...
    public static HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData prototype) {
    ...
    public static final class Builder extends
        ...
        HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return HomeFurnitureGroupDataOuterClass.internal_static_HomeFurnitureGroupData_descriptor;
      }
      ...
      // Construct using HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData getDefaultInstanceForType() {
        return HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData.getDefaultInstance();
      }

      @java.lang.Override
      public HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData build() {
        HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData result = buildPartial();
      ...
      @java.lang.Override
      public HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData buildPartial() {
        HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData result = new HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData) {
          return mergeFrom((HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData)other);
        } else {
      ...
      public Builder mergeFrom(HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData other) {
        if (other == HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData.getDefaultInstance()) return this;
        if (virtualFurnitureListBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData) e.getUnfinishedMessage();
      ...
      private void ensureVirtualFurnitureListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          virtualFurnitureList_ = new java.util.ArrayList<HomeFurnitureDataOuterClass.HomeFurnitureData>(virtualFurnitureList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          HomeFurnitureDataOuterClass.HomeFurnitureData, HomeFurnitureDataOuterClass.HomeFurnitureData.Builder, HomeFurnitureDataOuterClass.HomeFurnitureDataOrBuilder> virtualFurnitureListBuilder_;
       ...
       * <code>repeated .HomeFurnitureData virtualFurnitureList = 12;</code>
       */
      public HomeFurnitureDataOuterClass.HomeFurnitureData.Builder getVirtualFurnitureListBuilder(
          int index) {
    ...
    private static final HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData();
    }

    public static HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData getDefaultInstance() {
