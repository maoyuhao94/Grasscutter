...
public final class EntityRendererChangedInfoOuterClass {
  ...
  public interface EntityRendererChangedInfoOrBuilder extends
    ...
    /**
     * <code>map&lt;string, uint32&gt; changedRenderers = 1;</code>
     */
    ...
    /**
     * <code>uint32 visibilityCount = 2;</code>
     * @return The visibilityCount.
     */
    int getVisibilityCount();

    /**
     * <code>bool isCached = 3;</code>
     * @return The isCached.
     */
    boolean getIsCached();
  }
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return EntityRendererChangedInfoOuterClass.internal_static_EntityRendererChangedInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo.class, EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo)) {
        return super.equals(obj);
      }
      EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo other = (EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo) obj;
    ...
    public int hashCode() {
      ...
      if (!internalGetChangedRenderers().getMap().isEmpty()) {
        hash = (37 * hash) + CHANGEDRENDERERS_FIELD_NUMBER;
        hash = (53 * hash) + internalGetChangedRenderers().hashCode();
      }
      hash = (37 * hash) + VISIBILITYCOUNT_FIELD_NUMBER;
    ...
    public static EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo parseFrom(
    ...
    public static EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo parseFrom(
    ...
    public static EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo prototype) {
    ...
    public static final class Builder extends
        ...
        EntityRendererChangedInfoOuterClass.EntityRendererChangedInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return EntityRendererChangedInfoOuterClass.internal_static_EntityRendererChangedInfo_descriptor;
      }
      ...
      // Construct using EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo getDefaultInstanceForType() {
        return EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo.getDefaultInstance();
      }

      @java.lang.Override
      public EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo build() {
        EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo result = buildPartial();
      ...
      @java.lang.Override
      public EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo buildPartial() {
        EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo result = new EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo) {
          return mergeFrom((EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo)other);
        } else {
      ...
      public Builder mergeFrom(EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo other) {
        if (other == EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo) e.getUnfinishedMessage();
    ...
    private static final EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo();
    }

    public static EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "tityRendererChangedInfo\022J\n\020changedRender" +
      "ers\030\001 \003(\01320.EntityRendererChangedInfo.Ch" +
      "angedRenderersEntry\022\027\n\017visibilityCount\030\002" +
