...
public final class SyncScenePlayTeamEntityNotifyOuterClass {
  ...
  public interface SyncScenePlayTeamEntityNotifyOrBuilder extends
     ...
     */
    java.util.List<PlayTeamEntityInfoOuterClass.PlayTeamEntityInfo> 
        getEntityInfoListList();
    /**
     * <code>repeated .PlayTeamEntityInfo entityInfoList = 14;</code>
     */
    PlayTeamEntityInfoOuterClass.PlayTeamEntityInfo getEntityInfoList(int index);
    /**
     * <code>repeated .PlayTeamEntityInfo entityInfoList = 14;</code>
     */
     ...
     * <code>repeated .PlayTeamEntityInfo entityInfoList = 14;</code>
     */
    java.util.List<? extends PlayTeamEntityInfoOuterClass.PlayTeamEntityInfoOrBuilder> 
        getEntityInfoListOrBuilderList();
    /**
     * <code>repeated .PlayTeamEntityInfo entityInfoList = 14;</code>
     */
    PlayTeamEntityInfoOuterClass.PlayTeamEntityInfoOrBuilder getEntityInfoListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 114: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                entityInfoList_ = new java.util.ArrayList<PlayTeamEntityInfoOuterClass.PlayTeamEntityInfo>();
                mutable_bitField0_ |= 0x00000001;
              }
              entityInfoList_.add(
                  input.readMessage(PlayTeamEntityInfoOuterClass.PlayTeamEntityInfo.parser(), extensionRegistry));
              break;
            }
            default: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return SyncScenePlayTeamEntityNotifyOuterClass.internal_static_SyncScenePlayTeamEntityNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify.class, SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify.Builder.class);
    }
    ...
    public enum NNDMFHOFFGI
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify.getDescriptor().getEnumTypes().get(0);
      }
    ...
    private java.util.List<PlayTeamEntityInfoOuterClass.PlayTeamEntityInfo> entityInfoList_;
    /**
     * <code>repeated .PlayTeamEntityInfo entityInfoList = 14;</code>
     */
    @java.lang.Override
    public java.util.List<PlayTeamEntityInfoOuterClass.PlayTeamEntityInfo> getEntityInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends PlayTeamEntityInfoOuterClass.PlayTeamEntityInfoOrBuilder> 
        getEntityInfoListOrBuilderList() {
      return entityInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public PlayTeamEntityInfoOuterClass.PlayTeamEntityInfoOrBuilder getEntityInfoListOrBuilder(
        int index) {
      return entityInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify)) {
        return super.equals(obj);
      }
      SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify other = (SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify) obj;
    ...
    public static SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify parseFrom(
    ...
    public static SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify parseFrom(
    ...
    public static SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify prototype) {
    ...
    public static final class Builder extends
        ...
        SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return SyncScenePlayTeamEntityNotifyOuterClass.internal_static_SyncScenePlayTeamEntityNotify_descriptor;
      }
      ...
      // Construct using SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify getDefaultInstanceForType() {
        return SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify.getDefaultInstance();
      }

      @java.lang.Override
      public SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify build() {
        SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify result = buildPartial();
      ...
      @java.lang.Override
      public SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify buildPartial() {
        SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify result = new SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify) {
          return mergeFrom((SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify)other);
        } else {
      ...
      public Builder mergeFrom(SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify other) {
        if (other == SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify) e.getUnfinishedMessage();
      ...
      private void ensureEntityInfoListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          entityInfoList_ = new java.util.ArrayList<PlayTeamEntityInfoOuterClass.PlayTeamEntityInfo>(entityInfoList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          PlayTeamEntityInfoOuterClass.PlayTeamEntityInfo, PlayTeamEntityInfoOuterClass.PlayTeamEntityInfo.Builder, PlayTeamEntityInfoOuterClass.PlayTeamEntityInfoOrBuilder> entityInfoListBuilder_;
      ...
      public Builder setEntityInfoList(
          int index, PlayTeamEntityInfoOuterClass.PlayTeamEntityInfo value) {
        if (entityInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setEntityInfoList(
          int index, PlayTeamEntityInfoOuterClass.PlayTeamEntityInfo.Builder builderForValue) {
        if (entityInfoListBuilder_ == null) {
          ensureEntityInfoListIsMutable();
       ...
       */
      public Builder addEntityInfoList(
          PlayTeamEntityInfoOuterClass.PlayTeamEntityInfo.Builder builderForValue) {
        if (entityInfoListBuilder_ == null) {
          ensureEntityInfoListIsMutable();
      ...
      public Builder addAllEntityInfoList(
          java.lang.Iterable<? extends PlayTeamEntityInfoOuterClass.PlayTeamEntityInfo> values) {
        if (entityInfoListBuilder_ == null) {
          ensureEntityInfoListIsMutable();
       ...
       * <code>repeated .PlayTeamEntityInfo entityInfoList = 14;</code>
       */
      public PlayTeamEntityInfoOuterClass.PlayTeamEntityInfo.Builder getEntityInfoListBuilder(
          int index) {
      ...
      public PlayTeamEntityInfoOuterClass.PlayTeamEntityInfo.Builder addEntityInfoListBuilder() {
        return getEntityInfoListFieldBuilder().addBuilder(
            PlayTeamEntityInfoOuterClass.PlayTeamEntityInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .PlayTeamEntityInfo entityInfoList = 14;</code>
       */
      public PlayTeamEntityInfoOuterClass.PlayTeamEntityInfo.Builder addEntityInfoListBuilder(
          int index) {
        return getEntityInfoListFieldBuilder().addBuilder(
            index, PlayTeamEntityInfoOuterClass.PlayTeamEntityInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .PlayTeamEntityInfo entityInfoList = 14;</code>
       */
      public java.util.List<PlayTeamEntityInfoOuterClass.PlayTeamEntityInfo.Builder> 
           getEntityInfoListBuilderList() {
        return getEntityInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          PlayTeamEntityInfoOuterClass.PlayTeamEntityInfo, PlayTeamEntityInfoOuterClass.PlayTeamEntityInfo.Builder, PlayTeamEntityInfoOuterClass.PlayTeamEntityInfoOrBuilder> 
          getEntityInfoListFieldBuilder() {
        if (entityInfoListBuilder_ == null) {
    ...
    private static final SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify();
    }

    public static SyncScenePlayTeamEntityNotifyOuterClass.SyncScenePlayTeamEntityNotify getDefaultInstance() {
