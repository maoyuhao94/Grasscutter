...
public final class McoinExchangeHcoinRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return McoinExchangeHcoinRspOuterClass.internal_static_McoinExchangeHcoinRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp.class, McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp.Builder.class);
    }
    ...
    public enum MKBLJNJFLIA
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp)) {
        return super.equals(obj);
      }
      McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp other = (McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp) obj;
    ...
    public static McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp parseFrom(
    ...
    public static McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp parseFrom(
    ...
    public static McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp prototype) {
    ...
    public static final class Builder extends
        ...
        McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return McoinExchangeHcoinRspOuterClass.internal_static_McoinExchangeHcoinRsp_descriptor;
      }
      ...
      // Construct using McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp getDefaultInstanceForType() {
        return McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp.getDefaultInstance();
      }

      @java.lang.Override
      public McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp build() {
        McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp result = buildPartial();
      ...
      @java.lang.Override
      public McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp buildPartial() {
        McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp result = new McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp) {
          return mergeFrom((McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp)other);
        } else {
      ...
      public Builder mergeFrom(McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp other) {
        if (other == McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp) e.getUnfinishedMessage();
    ...
    private static final McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp();
    }

    public static McoinExchangeHcoinRspOuterClass.McoinExchangeHcoinRsp getDefaultInstance() {
