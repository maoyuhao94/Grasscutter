...
public final class ShowEquipOuterClass {
  ...
  public interface ShowEquipOrBuilder extends
    ...
    public ShowEquipOuterClass.ShowEquip.DCMMPEONFNECase getDCMMPEONFNECase();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 18: {
              ...
              if (dCMMPEONFNECase_ == 2) {
                subBuilder = ((ReliquaryOuterClass.Reliquary) dCMMPEONFNE_).toBuilder();
              }
              dCMMPEONFNE_ =
                  input.readMessage(ReliquaryOuterClass.Reliquary.parser(), extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom((ReliquaryOuterClass.Reliquary) dCMMPEONFNE_);
            ...
            case 26: {
              ...
              if (dCMMPEONFNECase_ == 3) {
                subBuilder = ((WeaponOuterClass.Weapon) dCMMPEONFNE_).toBuilder();
              }
              dCMMPEONFNE_ =
                  input.readMessage(WeaponOuterClass.Weapon.parser(), extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom((WeaponOuterClass.Weapon) dCMMPEONFNE_);
                dCMMPEONFNE_ = subBuilder.buildPartial();
              }
              dCMMPEONFNECase_ = 3;
              break;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return ShowEquipOuterClass.internal_static_ShowEquip_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ShowEquipOuterClass.ShowEquip.class, ShowEquipOuterClass.ShowEquip.Builder.class);
    }
    ...
    public ReliquaryOuterClass.Reliquary getReliquary() {
      if (dCMMPEONFNECase_ == 2) {
         return (ReliquaryOuterClass.Reliquary) dCMMPEONFNE_;
      }
    ...
    public WeaponOuterClass.Weapon getWeapon() {
      if (dCMMPEONFNECase_ == 3) {
         return (WeaponOuterClass.Weapon) dCMMPEONFNE_;
      }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (dCMMPEONFNECase_ == 2) {
        output.writeMessage(2, (ReliquaryOuterClass.Reliquary) dCMMPEONFNE_);
      }
      if (dCMMPEONFNECase_ == 3) {
        output.writeMessage(3, (WeaponOuterClass.Weapon) dCMMPEONFNE_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (dCMMPEONFNECase_ == 2) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, (ReliquaryOuterClass.Reliquary) dCMMPEONFNE_);
      }
      if (dCMMPEONFNECase_ == 3) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, (WeaponOuterClass.Weapon) dCMMPEONFNE_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof ShowEquipOuterClass.ShowEquip)) {
        return super.equals(obj);
      }
      ShowEquipOuterClass.ShowEquip other = (ShowEquipOuterClass.ShowEquip) obj;
    ...
    public static ShowEquipOuterClass.ShowEquip parseFrom(
    ...
    public static ShowEquipOuterClass.ShowEquip parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ShowEquipOuterClass.ShowEquip parseFrom(
    ...
    public static ShowEquipOuterClass.ShowEquip parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ShowEquipOuterClass.ShowEquip parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static ShowEquipOuterClass.ShowEquip parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(ShowEquipOuterClass.ShowEquip prototype) {
    ...
    public static final class Builder extends
        ...
        ShowEquipOuterClass.ShowEquipOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ShowEquipOuterClass.internal_static_ShowEquip_descriptor;
      }
      ...
      // Construct using ShowEquipOuterClass.ShowEquip.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public ShowEquipOuterClass.ShowEquip getDefaultInstanceForType() {
        return ShowEquipOuterClass.ShowEquip.getDefaultInstance();
      }

      @java.lang.Override
      public ShowEquipOuterClass.ShowEquip build() {
        ShowEquipOuterClass.ShowEquip result = buildPartial();
      ...
      @java.lang.Override
      public ShowEquipOuterClass.ShowEquip buildPartial() {
        ShowEquipOuterClass.ShowEquip result = new ShowEquipOuterClass.ShowEquip(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ShowEquipOuterClass.ShowEquip) {
          return mergeFrom((ShowEquipOuterClass.ShowEquip)other);
        } else {
      ...
      public Builder mergeFrom(ShowEquipOuterClass.ShowEquip other) {
        if (other == ShowEquipOuterClass.ShowEquip.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ShowEquipOuterClass.ShowEquip parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ShowEquipOuterClass.ShowEquip) e.getUnfinishedMessage();
      ...
      public Builder mergeReliquary(ReliquaryOuterClass.Reliquary value) {
        if (reliquaryBuilder_ == null) {
          if (dCMMPEONFNECase_ == 2 &&
              dCMMPEONFNE_ != ReliquaryOuterClass.Reliquary.getDefaultInstance()) {
            dCMMPEONFNE_ = ReliquaryOuterClass.Reliquary.newBuilder((ReliquaryOuterClass.Reliquary) dCMMPEONFNE_)
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
        ...
        if (reliquaryBuilder_ == null) {
          ...
          reliquaryBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              ReliquaryOuterClass.Reliquary, ReliquaryOuterClass.Reliquary.Builder, ReliquaryOuterClass.ReliquaryOrBuilder>(
                  (ReliquaryOuterClass.Reliquary) dCMMPEONFNE_,
      ...
      public Builder mergeWeapon(WeaponOuterClass.Weapon value) {
        if (weaponBuilder_ == null) {
          if (dCMMPEONFNECase_ == 3 &&
              dCMMPEONFNE_ != WeaponOuterClass.Weapon.getDefaultInstance()) {
            dCMMPEONFNE_ = WeaponOuterClass.Weapon.newBuilder((WeaponOuterClass.Weapon) dCMMPEONFNE_)
                .mergeFrom(value).buildPartial();
          } else {
            dCMMPEONFNE_ = value;
          }
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
        ...
        if (weaponBuilder_ == null) {
          ...
          weaponBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              WeaponOuterClass.Weapon, WeaponOuterClass.Weapon.Builder, WeaponOuterClass.WeaponOrBuilder>(
                  (WeaponOuterClass.Weapon) dCMMPEONFNE_,
                  getParentForChildren(),
                  isClean());
          dCMMPEONFNE_ = null;
        }
    ...
    private static final ShowEquipOuterClass.ShowEquip DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ShowEquipOuterClass.ShowEquip();
    }

    public static ShowEquipOuterClass.ShowEquip getDefaultInstance() {
