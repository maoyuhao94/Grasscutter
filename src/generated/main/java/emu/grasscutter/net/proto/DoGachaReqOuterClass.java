...
public final class DoGachaReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return DoGachaReqOuterClass.internal_static_DoGachaReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              DoGachaReqOuterClass.DoGachaReq.class, DoGachaReqOuterClass.DoGachaReq.Builder.class);
    }
    ...
    public enum PCEMGEJGMDI
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return DoGachaReqOuterClass.DoGachaReq.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof DoGachaReqOuterClass.DoGachaReq)) {
        return super.equals(obj);
      }
      DoGachaReqOuterClass.DoGachaReq other = (DoGachaReqOuterClass.DoGachaReq) obj;
    ...
    public static DoGachaReqOuterClass.DoGachaReq parseFrom(
    ...
    public static DoGachaReqOuterClass.DoGachaReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static DoGachaReqOuterClass.DoGachaReq parseFrom(
    ...
    public static DoGachaReqOuterClass.DoGachaReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static DoGachaReqOuterClass.DoGachaReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static DoGachaReqOuterClass.DoGachaReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(DoGachaReqOuterClass.DoGachaReq prototype) {
    ...
    public static final class Builder extends
        ...
        DoGachaReqOuterClass.DoGachaReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return DoGachaReqOuterClass.internal_static_DoGachaReq_descriptor;
      }
      ...
      // Construct using DoGachaReqOuterClass.DoGachaReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public DoGachaReqOuterClass.DoGachaReq getDefaultInstanceForType() {
        return DoGachaReqOuterClass.DoGachaReq.getDefaultInstance();
      }

      @java.lang.Override
      public DoGachaReqOuterClass.DoGachaReq build() {
        DoGachaReqOuterClass.DoGachaReq result = buildPartial();
      ...
      @java.lang.Override
      public DoGachaReqOuterClass.DoGachaReq buildPartial() {
        DoGachaReqOuterClass.DoGachaReq result = new DoGachaReqOuterClass.DoGachaReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof DoGachaReqOuterClass.DoGachaReq) {
          return mergeFrom((DoGachaReqOuterClass.DoGachaReq)other);
        } else {
      ...
      public Builder mergeFrom(DoGachaReqOuterClass.DoGachaReq other) {
        if (other == DoGachaReqOuterClass.DoGachaReq.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        DoGachaReqOuterClass.DoGachaReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (DoGachaReqOuterClass.DoGachaReq) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final DoGachaReqOuterClass.DoGachaReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new DoGachaReqOuterClass.DoGachaReq();
    }

    public static DoGachaReqOuterClass.DoGachaReq getDefaultInstance() {
