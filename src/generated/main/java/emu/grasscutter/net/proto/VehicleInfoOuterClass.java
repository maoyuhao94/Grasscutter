...
public final class VehicleInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                memberList_ = new java.util.ArrayList<VehicleMemberOuterClass.VehicleMember>();
                mutable_bitField0_ |= 0x00000001;
              }
              memberList_.add(
                  input.readMessage(VehicleMemberOuterClass.VehicleMember.parser(), extensionRegistry));
              break;
            }
            case 16: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return VehicleInfoOuterClass.internal_static_VehicleInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              VehicleInfoOuterClass.VehicleInfo.class, VehicleInfoOuterClass.VehicleInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof VehicleInfoOuterClass.VehicleInfo)) {
        return super.equals(obj);
      }
      VehicleInfoOuterClass.VehicleInfo other = (VehicleInfoOuterClass.VehicleInfo) obj;
    ...
    public static VehicleInfoOuterClass.VehicleInfo parseFrom(
    ...
    public static VehicleInfoOuterClass.VehicleInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static VehicleInfoOuterClass.VehicleInfo parseFrom(
    ...
    public static VehicleInfoOuterClass.VehicleInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static VehicleInfoOuterClass.VehicleInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static VehicleInfoOuterClass.VehicleInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(VehicleInfoOuterClass.VehicleInfo prototype) {
    ...
    public static final class Builder extends
        ...
        VehicleInfoOuterClass.VehicleInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return VehicleInfoOuterClass.internal_static_VehicleInfo_descriptor;
      }
      ...
      // Construct using VehicleInfoOuterClass.VehicleInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public VehicleInfoOuterClass.VehicleInfo getDefaultInstanceForType() {
        return VehicleInfoOuterClass.VehicleInfo.getDefaultInstance();
      }

      @java.lang.Override
      public VehicleInfoOuterClass.VehicleInfo build() {
        VehicleInfoOuterClass.VehicleInfo result = buildPartial();
      ...
      @java.lang.Override
      public VehicleInfoOuterClass.VehicleInfo buildPartial() {
        VehicleInfoOuterClass.VehicleInfo result = new VehicleInfoOuterClass.VehicleInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof VehicleInfoOuterClass.VehicleInfo) {
          return mergeFrom((VehicleInfoOuterClass.VehicleInfo)other);
        } else {
      ...
      public Builder mergeFrom(VehicleInfoOuterClass.VehicleInfo other) {
        if (other == VehicleInfoOuterClass.VehicleInfo.getDefaultInstance()) return this;
        if (memberListBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        VehicleInfoOuterClass.VehicleInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (VehicleInfoOuterClass.VehicleInfo) e.getUnfinishedMessage();
      ...
      public Builder addAllMemberList(
          java.lang.Iterable<? extends VehicleMemberOuterClass.VehicleMember> values) {
        if (memberListBuilder_ == null) {
          ensureMemberListIsMutable();
    ...
    private static final VehicleInfoOuterClass.VehicleInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new VehicleInfoOuterClass.VehicleInfo();
    }

    public static VehicleInfoOuterClass.VehicleInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ina\030\003 \001(\002b\006proto3"
    };
