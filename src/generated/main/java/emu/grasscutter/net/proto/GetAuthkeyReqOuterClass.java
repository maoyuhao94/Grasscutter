...
public final class GetAuthkeyReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return GetAuthkeyReqOuterClass.internal_static_GetAuthkeyReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              GetAuthkeyReqOuterClass.GetAuthkeyReq.class, GetAuthkeyReqOuterClass.GetAuthkeyReq.Builder.class);
    }
    ...
    public enum DIGIIBPFOBE
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return GetAuthkeyReqOuterClass.GetAuthkeyReq.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof GetAuthkeyReqOuterClass.GetAuthkeyReq)) {
        return super.equals(obj);
      }
      GetAuthkeyReqOuterClass.GetAuthkeyReq other = (GetAuthkeyReqOuterClass.GetAuthkeyReq) obj;
    ...
    public static GetAuthkeyReqOuterClass.GetAuthkeyReq parseFrom(
    ...
    public static GetAuthkeyReqOuterClass.GetAuthkeyReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static GetAuthkeyReqOuterClass.GetAuthkeyReq parseFrom(
    ...
    public static GetAuthkeyReqOuterClass.GetAuthkeyReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static GetAuthkeyReqOuterClass.GetAuthkeyReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static GetAuthkeyReqOuterClass.GetAuthkeyReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(GetAuthkeyReqOuterClass.GetAuthkeyReq prototype) {
    ...
    public static final class Builder extends
        ...
        GetAuthkeyReqOuterClass.GetAuthkeyReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return GetAuthkeyReqOuterClass.internal_static_GetAuthkeyReq_descriptor;
      }
      ...
      // Construct using GetAuthkeyReqOuterClass.GetAuthkeyReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public GetAuthkeyReqOuterClass.GetAuthkeyReq getDefaultInstanceForType() {
        return GetAuthkeyReqOuterClass.GetAuthkeyReq.getDefaultInstance();
      }

      @java.lang.Override
      public GetAuthkeyReqOuterClass.GetAuthkeyReq build() {
        GetAuthkeyReqOuterClass.GetAuthkeyReq result = buildPartial();
      ...
      @java.lang.Override
      public GetAuthkeyReqOuterClass.GetAuthkeyReq buildPartial() {
        GetAuthkeyReqOuterClass.GetAuthkeyReq result = new GetAuthkeyReqOuterClass.GetAuthkeyReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof GetAuthkeyReqOuterClass.GetAuthkeyReq) {
          return mergeFrom((GetAuthkeyReqOuterClass.GetAuthkeyReq)other);
        } else {
      ...
      public Builder mergeFrom(GetAuthkeyReqOuterClass.GetAuthkeyReq other) {
        if (other == GetAuthkeyReqOuterClass.GetAuthkeyReq.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        GetAuthkeyReqOuterClass.GetAuthkeyReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (GetAuthkeyReqOuterClass.GetAuthkeyReq) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final GetAuthkeyReqOuterClass.GetAuthkeyReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new GetAuthkeyReqOuterClass.GetAuthkeyReq();
    }

    public static GetAuthkeyReqOuterClass.GetAuthkeyReq getDefaultInstance() {
