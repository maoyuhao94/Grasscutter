...
public final class RogueDiaryStageInfoOuterClass {
  ...
  public interface RogueDiaryStageInfoOrBuilder extends
    ...
    /**
     * <code>.RogueDiaryDungeonRecord bestRecord = 4;</code>
  ...
  private static final long serialVersionUID = 0L;
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              RogueDiaryDungeonRecordOuterClass.RogueDiaryDungeonRecord.Builder subBuilder = null;
              if (bestRecord_ != null) {
                subBuilder = bestRecord_.toBuilder();
              }
              bestRecord_ = input.readMessage(RogueDiaryDungeonRecordOuterClass.RogueDiaryDungeonRecord.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return RogueDiaryStageInfoOuterClass.internal_static_RogueDiaryStageInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo.class, RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo.Builder.class);
    }
    ...
    public RogueDiaryDungeonRecordOuterClass.RogueDiaryDungeonRecord getBestRecord() {
      return bestRecord_ == null ? RogueDiaryDungeonRecordOuterClass.RogueDiaryDungeonRecord.getDefaultInstance() : bestRecord_;
    }
    /**
     * <code>.RogueDiaryDungeonRecord bestRecord = 4;</code>
     */
    ...
    public static final int ISHAVETRY_FIELD_NUMBER = 9;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (bestRecord_ != null) {
        output.writeMessage(4, getBestRecord());
      }
      if (isHaveTry_ != false) {
        output.writeBool(9, isHaveTry_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (bestRecord_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, getBestRecord());
      }
      if (isHaveTry_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(9, isHaveTry_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo)) {
        return super.equals(obj);
      }
      RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo other = (RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo) obj;
    ...
    public static RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo parseFrom(
    ...
    public static RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo parseFrom(
    ...
    public static RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo prototype) {
    ...
    public static final class Builder extends
        ...
        RogueDiaryStageInfoOuterClass.RogueDiaryStageInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return RogueDiaryStageInfoOuterClass.internal_static_RogueDiaryStageInfo_descriptor;
      }
      ...
      // Construct using RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo getDefaultInstanceForType() {
        return RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo.getDefaultInstance();
      }

      @java.lang.Override
      public RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo build() {
        RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo result = buildPartial();
      ...
      @java.lang.Override
      public RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo buildPartial() {
        RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo result = new RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo) {
          return mergeFrom((RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo)other);
        } else {
      ...
      public Builder mergeFrom(RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo other) {
        if (other == RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo) e.getUnfinishedMessage();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          RogueDiaryDungeonRecordOuterClass.RogueDiaryDungeonRecord, RogueDiaryDungeonRecordOuterClass.RogueDiaryDungeonRecord.Builder, RogueDiaryDungeonRecordOuterClass.RogueDiaryDungeonRecordOrBuilder> bestRecordBuilder_;
      /**
       * <code>.RogueDiaryDungeonRecord bestRecord = 4;</code>
       * @return Whether the bestRecord field is set.
       */
      ...
      public Builder setBestRecord(
          RogueDiaryDungeonRecordOuterClass.RogueDiaryDungeonRecord.Builder builderForValue) {
        if (bestRecordBuilder_ == null) {
      ...
      public Builder mergeBestRecord(RogueDiaryDungeonRecordOuterClass.RogueDiaryDungeonRecord value) {
        if (bestRecordBuilder_ == null) {
          if (bestRecord_ != null) {
            bestRecord_ =
              RogueDiaryDungeonRecordOuterClass.RogueDiaryDungeonRecord.newBuilder(bestRecord_).mergeFrom(value).buildPartial();
          } else {
            bestRecord_ = value;
          }
          onChanged();
      ...
      public RogueDiaryDungeonRecordOuterClass.RogueDiaryDungeonRecordOrBuilder getBestRecordOrBuilder() {
        if (bestRecordBuilder_ != null) {
          ...
          return bestRecord_ == null ?
              RogueDiaryDungeonRecordOuterClass.RogueDiaryDungeonRecord.getDefaultInstance() : bestRecord_;
        }
      }
      /**
       * <code>.RogueDiaryDungeonRecord bestRecord = 4;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          RogueDiaryDungeonRecordOuterClass.RogueDiaryDungeonRecord, RogueDiaryDungeonRecordOuterClass.RogueDiaryDungeonRecord.Builder, RogueDiaryDungeonRecordOuterClass.RogueDiaryDungeonRecordOrBuilder> 
    ...
    private static final RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo();
    }

    public static RogueDiaryStageInfoOuterClass.RogueDiaryStageInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ungeonRecord.proto\"g\n\023RogueDiaryStageInf" +
      "o\022\017\n\007stageId\030\003 \001(\r\022,\n\nbestRecord\030\004 \001(\0132\030" +
      ".RogueDiaryDungeonRecord\022\021\n\tisHaveTry\030\t " +
      "\001(\010b\006proto3"
    };
