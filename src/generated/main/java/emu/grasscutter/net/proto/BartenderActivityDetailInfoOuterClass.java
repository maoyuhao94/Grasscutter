...
public final class BartenderActivityDetailInfoOuterClass {
  ...
  public interface BartenderActivityDetailInfoOrBuilder extends
     ...
     */
    java.util.List<BartenderTaskInfoOuterClass.BartenderTaskInfo> 
        getUnlockTaskListList();
    /**
     * <code>repeated .BartenderTaskInfo unlockTaskList = 15;</code>
     */
    BartenderTaskInfoOuterClass.BartenderTaskInfo getUnlockTaskList(int index);
    /**
     * <code>repeated .BartenderTaskInfo unlockTaskList = 15;</code>
     */
     ...
     * <code>repeated .BartenderTaskInfo unlockTaskList = 15;</code>
     */
    java.util.List<? extends BartenderTaskInfoOuterClass.BartenderTaskInfoOrBuilder> 
        getUnlockTaskListOrBuilderList();
    /**
     * <code>repeated .BartenderTaskInfo unlockTaskList = 15;</code>
     */
    BartenderTaskInfoOuterClass.BartenderTaskInfoOrBuilder getUnlockTaskListOrBuilder(
        int index);
     ...
     */
    java.util.List<BartenderLevelInfoOuterClass.BartenderLevelInfo> 
        getUnlockLevelListList();
    /**
     * <code>repeated .BartenderLevelInfo unlockLevelList = 4;</code>
     */
    BartenderLevelInfoOuterClass.BartenderLevelInfo getUnlockLevelList(int index);
    /**
     * <code>repeated .BartenderLevelInfo unlockLevelList = 4;</code>
     */
     ...
     * <code>repeated .BartenderLevelInfo unlockLevelList = 4;</code>
     */
    java.util.List<? extends BartenderLevelInfoOuterClass.BartenderLevelInfoOrBuilder> 
        getUnlockLevelListOrBuilderList();
    /**
     * <code>repeated .BartenderLevelInfo unlockLevelList = 4;</code>
     */
    BartenderLevelInfoOuterClass.BartenderLevelInfoOrBuilder getUnlockLevelListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 34: {
              if (!((mutable_bitField0_ & 0x00000008) != 0)) {
                unlockLevelList_ = new java.util.ArrayList<BartenderLevelInfoOuterClass.BartenderLevelInfo>();
                mutable_bitField0_ |= 0x00000008;
              }
              unlockLevelList_.add(
                  input.readMessage(BartenderLevelInfoOuterClass.BartenderLevelInfo.parser(), extensionRegistry));
              break;
            }
            case 64: {
            ...
            case 122: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                unlockTaskList_ = new java.util.ArrayList<BartenderTaskInfoOuterClass.BartenderTaskInfo>();
                mutable_bitField0_ |= 0x00000001;
              }
              unlockTaskList_.add(
                  input.readMessage(BartenderTaskInfoOuterClass.BartenderTaskInfo.parser(), extensionRegistry));
              break;
            }
            default: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return BartenderActivityDetailInfoOuterClass.internal_static_BartenderActivityDetailInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo.class, BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo.Builder.class);
    }

    public static final int UNLOCKTASKLIST_FIELD_NUMBER = 15;
    private java.util.List<BartenderTaskInfoOuterClass.BartenderTaskInfo> unlockTaskList_;
    /**
     * <code>repeated .BartenderTaskInfo unlockTaskList = 15;</code>
     */
    @java.lang.Override
    public java.util.List<BartenderTaskInfoOuterClass.BartenderTaskInfo> getUnlockTaskListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends BartenderTaskInfoOuterClass.BartenderTaskInfoOrBuilder> 
        getUnlockTaskListOrBuilderList() {
      return unlockTaskList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public BartenderTaskInfoOuterClass.BartenderTaskInfoOrBuilder getUnlockTaskListOrBuilder(
        int index) {
      return unlockTaskList_.get(index);
    }
    ...
    private java.util.List<BartenderLevelInfoOuterClass.BartenderLevelInfo> unlockLevelList_;
    /**
     * <code>repeated .BartenderLevelInfo unlockLevelList = 4;</code>
     */
    @java.lang.Override
    public java.util.List<BartenderLevelInfoOuterClass.BartenderLevelInfo> getUnlockLevelListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends BartenderLevelInfoOuterClass.BartenderLevelInfoOrBuilder> 
        getUnlockLevelListOrBuilderList() {
      return unlockLevelList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public BartenderLevelInfoOuterClass.BartenderLevelInfoOrBuilder getUnlockLevelListOrBuilder(
        int index) {
      return unlockLevelList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo)) {
        return super.equals(obj);
      }
      BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo other = (BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo) obj;
    ...
    public static BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo parseFrom(
    ...
    public static BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo parseFrom(
    ...
    public static BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo prototype) {
    ...
    public static final class Builder extends
        ...
        BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return BartenderActivityDetailInfoOuterClass.internal_static_BartenderActivityDetailInfo_descriptor;
      }
      ...
      // Construct using BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo getDefaultInstanceForType() {
        return BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo.getDefaultInstance();
      }

      @java.lang.Override
      public BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo build() {
        BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo result = buildPartial();
      ...
      @java.lang.Override
      public BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo buildPartial() {
        BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo result = new BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo) {
          return mergeFrom((BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo)other);
        } else {
      ...
      public Builder mergeFrom(BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo other) {
        if (other == BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo.getDefaultInstance()) return this;
        if (unlockTaskListBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo) e.getUnfinishedMessage();
      ...
      private void ensureUnlockTaskListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          unlockTaskList_ = new java.util.ArrayList<BartenderTaskInfoOuterClass.BartenderTaskInfo>(unlockTaskList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          BartenderTaskInfoOuterClass.BartenderTaskInfo, BartenderTaskInfoOuterClass.BartenderTaskInfo.Builder, BartenderTaskInfoOuterClass.BartenderTaskInfoOrBuilder> unlockTaskListBuilder_;
      ...
      public Builder setUnlockTaskList(
          int index, BartenderTaskInfoOuterClass.BartenderTaskInfo value) {
        if (unlockTaskListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setUnlockTaskList(
          int index, BartenderTaskInfoOuterClass.BartenderTaskInfo.Builder builderForValue) {
        if (unlockTaskListBuilder_ == null) {
          ensureUnlockTaskListIsMutable();
       ...
       */
      public Builder addUnlockTaskList(
          BartenderTaskInfoOuterClass.BartenderTaskInfo.Builder builderForValue) {
        if (unlockTaskListBuilder_ == null) {
          ensureUnlockTaskListIsMutable();
      ...
      public Builder addAllUnlockTaskList(
          java.lang.Iterable<? extends BartenderTaskInfoOuterClass.BartenderTaskInfo> values) {
        if (unlockTaskListBuilder_ == null) {
          ensureUnlockTaskListIsMutable();
       ...
       * <code>repeated .BartenderTaskInfo unlockTaskList = 15;</code>
       */
      public BartenderTaskInfoOuterClass.BartenderTaskInfo.Builder getUnlockTaskListBuilder(
          int index) {
      ...
      public BartenderTaskInfoOuterClass.BartenderTaskInfo.Builder addUnlockTaskListBuilder() {
        return getUnlockTaskListFieldBuilder().addBuilder(
            BartenderTaskInfoOuterClass.BartenderTaskInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .BartenderTaskInfo unlockTaskList = 15;</code>
       */
      public BartenderTaskInfoOuterClass.BartenderTaskInfo.Builder addUnlockTaskListBuilder(
          int index) {
        return getUnlockTaskListFieldBuilder().addBuilder(
            index, BartenderTaskInfoOuterClass.BartenderTaskInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .BartenderTaskInfo unlockTaskList = 15;</code>
       */
      public java.util.List<BartenderTaskInfoOuterClass.BartenderTaskInfo.Builder> 
           getUnlockTaskListBuilderList() {
        return getUnlockTaskListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          BartenderTaskInfoOuterClass.BartenderTaskInfo, BartenderTaskInfoOuterClass.BartenderTaskInfo.Builder, BartenderTaskInfoOuterClass.BartenderTaskInfoOrBuilder> 
          getUnlockTaskListFieldBuilder() {
        if (unlockTaskListBuilder_ == null) {
      ...
      private void ensureUnlockLevelListIsMutable() {
        if (!((bitField0_ & 0x00000008) != 0)) {
          unlockLevelList_ = new java.util.ArrayList<BartenderLevelInfoOuterClass.BartenderLevelInfo>(unlockLevelList_);
          bitField0_ |= 0x00000008;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          BartenderLevelInfoOuterClass.BartenderLevelInfo, BartenderLevelInfoOuterClass.BartenderLevelInfo.Builder, BartenderLevelInfoOuterClass.BartenderLevelInfoOrBuilder> unlockLevelListBuilder_;
      ...
      public Builder setUnlockLevelList(
          int index, BartenderLevelInfoOuterClass.BartenderLevelInfo value) {
        if (unlockLevelListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setUnlockLevelList(
          int index, BartenderLevelInfoOuterClass.BartenderLevelInfo.Builder builderForValue) {
        if (unlockLevelListBuilder_ == null) {
          ensureUnlockLevelListIsMutable();
       ...
       */
      public Builder addUnlockLevelList(
          BartenderLevelInfoOuterClass.BartenderLevelInfo.Builder builderForValue) {
        if (unlockLevelListBuilder_ == null) {
          ensureUnlockLevelListIsMutable();
      ...
      public Builder addAllUnlockLevelList(
          java.lang.Iterable<? extends BartenderLevelInfoOuterClass.BartenderLevelInfo> values) {
        if (unlockLevelListBuilder_ == null) {
          ensureUnlockLevelListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .BartenderLevelInfo unlockLevelList = 4;</code>
       */
      public BartenderLevelInfoOuterClass.BartenderLevelInfo.Builder getUnlockLevelListBuilder(
          int index) {
      ...
      public BartenderLevelInfoOuterClass.BartenderLevelInfo.Builder addUnlockLevelListBuilder() {
        return getUnlockLevelListFieldBuilder().addBuilder(
            BartenderLevelInfoOuterClass.BartenderLevelInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .BartenderLevelInfo unlockLevelList = 4;</code>
       */
      public BartenderLevelInfoOuterClass.BartenderLevelInfo.Builder addUnlockLevelListBuilder(
          int index) {
        return getUnlockLevelListFieldBuilder().addBuilder(
            index, BartenderLevelInfoOuterClass.BartenderLevelInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .BartenderLevelInfo unlockLevelList = 4;</code>
       */
      public java.util.List<BartenderLevelInfoOuterClass.BartenderLevelInfo.Builder> 
           getUnlockLevelListBuilderList() {
        return getUnlockLevelListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          BartenderLevelInfoOuterClass.BartenderLevelInfo, BartenderLevelInfoOuterClass.BartenderLevelInfo.Builder, BartenderLevelInfoOuterClass.BartenderLevelInfoOrBuilder> 
          getUnlockLevelListFieldBuilder() {
        if (unlockLevelListBuilder_ == null) {
    ...
    private static final BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo();
    }

    public static BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\016unlockTaskList\030\017 \003(\0132\022.BartenderTaskIn" +
      "fo\022\033\n\023isDevelopModuleOpen\030\n \001(\010\022\026\n\016unloc" +
      "kItemList\030\010 \003(\r\022\031\n\021unlockFormulaList\030\016 \003" +
      "(\r\022\024\n\014leftMonsters\030\002 \001(\010\022,\n\017unlockLevelL" +
      "ist\030\004 \003(\0132\023.BartenderLevelInfob\006proto3"
    };
