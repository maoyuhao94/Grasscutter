...
public final class IrodoriChessDataOuterClass {
  ...
  public interface IrodoriChessDataOrBuilder extends
     ...
     */
    java.util.List<IrodoriChessLevelDataOuterClass.IrodoriChessLevelData> 
        getLevelDataListList();
    /**
     * <code>repeated .IrodoriChessLevelData levelDataList = 9;</code>
     */
    IrodoriChessLevelDataOuterClass.IrodoriChessLevelData getLevelDataList(int index);
    /**
     * <code>repeated .IrodoriChessLevelData levelDataList = 9;</code>
     */
     ...
     * <code>repeated .IrodoriChessLevelData levelDataList = 9;</code>
     */
    java.util.List<? extends IrodoriChessLevelDataOuterClass.IrodoriChessLevelDataOrBuilder> 
        getLevelDataListOrBuilderList();
    /**
     * <code>repeated .IrodoriChessLevelData levelDataList = 9;</code>
     */
    IrodoriChessLevelDataOuterClass.IrodoriChessLevelDataOrBuilder getLevelDataListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 74: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                levelDataList_ = new java.util.ArrayList<IrodoriChessLevelDataOuterClass.IrodoriChessLevelData>();
                mutable_bitField0_ |= 0x00000001;
              }
              levelDataList_.add(
                  input.readMessage(IrodoriChessLevelDataOuterClass.IrodoriChessLevelData.parser(), extensionRegistry));
              break;
            }
            default: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return IrodoriChessDataOuterClass.internal_static_IrodoriChessData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              IrodoriChessDataOuterClass.IrodoriChessData.class, IrodoriChessDataOuterClass.IrodoriChessData.Builder.class);
    }

    public static final int LEVELDATALIST_FIELD_NUMBER = 9;
    private java.util.List<IrodoriChessLevelDataOuterClass.IrodoriChessLevelData> levelDataList_;
    /**
     * <code>repeated .IrodoriChessLevelData levelDataList = 9;</code>
     */
    @java.lang.Override
    public java.util.List<IrodoriChessLevelDataOuterClass.IrodoriChessLevelData> getLevelDataListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends IrodoriChessLevelDataOuterClass.IrodoriChessLevelDataOrBuilder> 
        getLevelDataListOrBuilderList() {
      return levelDataList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public IrodoriChessLevelDataOuterClass.IrodoriChessLevelDataOrBuilder getLevelDataListOrBuilder(
        int index) {
      return levelDataList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof IrodoriChessDataOuterClass.IrodoriChessData)) {
        return super.equals(obj);
      }
      IrodoriChessDataOuterClass.IrodoriChessData other = (IrodoriChessDataOuterClass.IrodoriChessData) obj;
    ...
    public static IrodoriChessDataOuterClass.IrodoriChessData parseFrom(
    ...
    public static IrodoriChessDataOuterClass.IrodoriChessData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static IrodoriChessDataOuterClass.IrodoriChessData parseFrom(
    ...
    public static IrodoriChessDataOuterClass.IrodoriChessData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static IrodoriChessDataOuterClass.IrodoriChessData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static IrodoriChessDataOuterClass.IrodoriChessData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(IrodoriChessDataOuterClass.IrodoriChessData prototype) {
    ...
    public static final class Builder extends
        ...
        IrodoriChessDataOuterClass.IrodoriChessDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return IrodoriChessDataOuterClass.internal_static_IrodoriChessData_descriptor;
      }
      ...
      // Construct using IrodoriChessDataOuterClass.IrodoriChessData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public IrodoriChessDataOuterClass.IrodoriChessData getDefaultInstanceForType() {
        return IrodoriChessDataOuterClass.IrodoriChessData.getDefaultInstance();
      }

      @java.lang.Override
      public IrodoriChessDataOuterClass.IrodoriChessData build() {
        IrodoriChessDataOuterClass.IrodoriChessData result = buildPartial();
      ...
      @java.lang.Override
      public IrodoriChessDataOuterClass.IrodoriChessData buildPartial() {
        IrodoriChessDataOuterClass.IrodoriChessData result = new IrodoriChessDataOuterClass.IrodoriChessData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof IrodoriChessDataOuterClass.IrodoriChessData) {
          return mergeFrom((IrodoriChessDataOuterClass.IrodoriChessData)other);
        } else {
      ...
      public Builder mergeFrom(IrodoriChessDataOuterClass.IrodoriChessData other) {
        if (other == IrodoriChessDataOuterClass.IrodoriChessData.getDefaultInstance()) return this;
        if (levelDataListBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        IrodoriChessDataOuterClass.IrodoriChessData parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (IrodoriChessDataOuterClass.IrodoriChessData) e.getUnfinishedMessage();
      ...
      private void ensureLevelDataListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          levelDataList_ = new java.util.ArrayList<IrodoriChessLevelDataOuterClass.IrodoriChessLevelData>(levelDataList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          IrodoriChessLevelDataOuterClass.IrodoriChessLevelData, IrodoriChessLevelDataOuterClass.IrodoriChessLevelData.Builder, IrodoriChessLevelDataOuterClass.IrodoriChessLevelDataOrBuilder> levelDataListBuilder_;
      ...
      public Builder setLevelDataList(
          int index, IrodoriChessLevelDataOuterClass.IrodoriChessLevelData value) {
        if (levelDataListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setLevelDataList(
          int index, IrodoriChessLevelDataOuterClass.IrodoriChessLevelData.Builder builderForValue) {
        if (levelDataListBuilder_ == null) {
          ensureLevelDataListIsMutable();
       ...
       */
      public Builder addLevelDataList(
          IrodoriChessLevelDataOuterClass.IrodoriChessLevelData.Builder builderForValue) {
        if (levelDataListBuilder_ == null) {
          ensureLevelDataListIsMutable();
      ...
      public Builder addAllLevelDataList(
          java.lang.Iterable<? extends IrodoriChessLevelDataOuterClass.IrodoriChessLevelData> values) {
        if (levelDataListBuilder_ == null) {
          ensureLevelDataListIsMutable();
       ...
       * <code>repeated .IrodoriChessLevelData levelDataList = 9;</code>
       */
      public IrodoriChessLevelDataOuterClass.IrodoriChessLevelData.Builder getLevelDataListBuilder(
          int index) {
      ...
      public IrodoriChessLevelDataOuterClass.IrodoriChessLevelData.Builder addLevelDataListBuilder() {
        return getLevelDataListFieldBuilder().addBuilder(
            IrodoriChessLevelDataOuterClass.IrodoriChessLevelData.getDefaultInstance());
      }
      /**
       * <code>repeated .IrodoriChessLevelData levelDataList = 9;</code>
       */
      public IrodoriChessLevelDataOuterClass.IrodoriChessLevelData.Builder addLevelDataListBuilder(
          int index) {
        return getLevelDataListFieldBuilder().addBuilder(
            index, IrodoriChessLevelDataOuterClass.IrodoriChessLevelData.getDefaultInstance());
      }
      /**
       * <code>repeated .IrodoriChessLevelData levelDataList = 9;</code>
       */
      public java.util.List<IrodoriChessLevelDataOuterClass.IrodoriChessLevelData.Builder> 
           getLevelDataListBuilderList() {
        return getLevelDataListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          IrodoriChessLevelDataOuterClass.IrodoriChessLevelData, IrodoriChessLevelDataOuterClass.IrodoriChessLevelData.Builder, IrodoriChessLevelDataOuterClass.IrodoriChessLevelDataOrBuilder> 
          getLevelDataListFieldBuilder() {
        if (levelDataListBuilder_ == null) {
    ...
    private static final IrodoriChessDataOuterClass.IrodoriChessData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new IrodoriChessDataOuterClass.IrodoriChessData();
    }

    public static IrodoriChessDataOuterClass.IrodoriChessData getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022\016\n\006isOpen\030\007 \001(\010b\006proto3"
    };
