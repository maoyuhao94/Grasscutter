...
public final class KANKJCACPOJOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return KANKJCACPOJOuterClass.internal_static_KANKJCACPOJ_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return KANKJCACPOJOuterClass.internal_static_KANKJCACPOJ_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              KANKJCACPOJOuterClass.KANKJCACPOJ.class, KANKJCACPOJOuterClass.KANKJCACPOJ.Builder.class);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (java.lang.Float.floatToRawIntBits(dfadhemafpn_) != 0) {
        output.writeFloat(3, dfadhemafpn_);
      }
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(bleallaejce_)) {
        com.google.protobuf.GeneratedMessageV3.writeString(output, 5, bleallaejce_);
      }
      if (java.lang.Float.floatToRawIntBits(oidmkpmeonj_) != 0) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof KANKJCACPOJOuterClass.KANKJCACPOJ)) {
        return super.equals(obj);
      }
      KANKJCACPOJOuterClass.KANKJCACPOJ other = (KANKJCACPOJOuterClass.KANKJCACPOJ) obj;
    ...
    public static KANKJCACPOJOuterClass.KANKJCACPOJ parseFrom(
    ...
    public static KANKJCACPOJOuterClass.KANKJCACPOJ parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static KANKJCACPOJOuterClass.KANKJCACPOJ parseFrom(
    ...
    public static KANKJCACPOJOuterClass.KANKJCACPOJ parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static KANKJCACPOJOuterClass.KANKJCACPOJ parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static KANKJCACPOJOuterClass.KANKJCACPOJ parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(KANKJCACPOJOuterClass.KANKJCACPOJ prototype) {
    ...
    public static final class Builder extends
        ...
        KANKJCACPOJOuterClass.KANKJCACPOJOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return KANKJCACPOJOuterClass.internal_static_KANKJCACPOJ_descriptor;
      }
      ...
      // Construct using KANKJCACPOJOuterClass.KANKJCACPOJ.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public KANKJCACPOJOuterClass.KANKJCACPOJ getDefaultInstanceForType() {
        return KANKJCACPOJOuterClass.KANKJCACPOJ.getDefaultInstance();
      }

      @java.lang.Override
      public KANKJCACPOJOuterClass.KANKJCACPOJ build() {
        KANKJCACPOJOuterClass.KANKJCACPOJ result = buildPartial();
      ...
      @java.lang.Override
      public KANKJCACPOJOuterClass.KANKJCACPOJ buildPartial() {
        KANKJCACPOJOuterClass.KANKJCACPOJ result = new KANKJCACPOJOuterClass.KANKJCACPOJ(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof KANKJCACPOJOuterClass.KANKJCACPOJ) {
          return mergeFrom((KANKJCACPOJOuterClass.KANKJCACPOJ)other);
        } else {
      ...
      public Builder mergeFrom(KANKJCACPOJOuterClass.KANKJCACPOJ other) {
        if (other == KANKJCACPOJOuterClass.KANKJCACPOJ.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        KANKJCACPOJOuterClass.KANKJCACPOJ parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (KANKJCACPOJOuterClass.KANKJCACPOJ) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final KANKJCACPOJOuterClass.KANKJCACPOJ DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new KANKJCACPOJOuterClass.KANKJCACPOJ();
    }

    public static KANKJCACPOJOuterClass.KANKJCACPOJ getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "bleallaejce\030\005 \001(\t\022\023\n\013dfadhemafpn\030\003 \001(\002b\006" +
      "proto3"
    };
