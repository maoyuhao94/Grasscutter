...
public final class TreasureMapRegionInfoNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 50: {
              TreasureMapRegionInfoOuterClass.TreasureMapRegionInfo.Builder subBuilder = null;
              if (regionInfo_ != null) {
                subBuilder = regionInfo_.toBuilder();
              }
              regionInfo_ = input.readMessage(TreasureMapRegionInfoOuterClass.TreasureMapRegionInfo.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return TreasureMapRegionInfoNotifyOuterClass.internal_static_TreasureMapRegionInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify.class, TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify.Builder.class);
    }
    ...
    public enum ADDFACKEHCF
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public TreasureMapRegionInfoOuterClass.TreasureMapRegionInfo getRegionInfo() {
      return regionInfo_ == null ? TreasureMapRegionInfoOuterClass.TreasureMapRegionInfo.getDefaultInstance() : regionInfo_;
    }
    /**
     * <code>.TreasureMapRegionInfo regionInfo = 6;</code>
     */
    ...
    public int getSerializedSize() {
      ...
      if (regionInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(6, getRegionInfo());
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify)) {
        return super.equals(obj);
      }
      TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify other = (TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify) obj;
    ...
    public static TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify parseFrom(
    ...
    public static TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify parseFrom(
    ...
    public static TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return TreasureMapRegionInfoNotifyOuterClass.internal_static_TreasureMapRegionInfoNotify_descriptor;
      }
      ...
      // Construct using TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify getDefaultInstanceForType() {
        return TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify build() {
        TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify result = buildPartial();
      ...
      @java.lang.Override
      public TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify buildPartial() {
        TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify result = new TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify(this);
        if (regionInfoBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify) {
          return mergeFrom((TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify other) {
        if (other == TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify) e.getUnfinishedMessage();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          TreasureMapRegionInfoOuterClass.TreasureMapRegionInfo, TreasureMapRegionInfoOuterClass.TreasureMapRegionInfo.Builder, TreasureMapRegionInfoOuterClass.TreasureMapRegionInfoOrBuilder> regionInfoBuilder_;
      /**
       * <code>.TreasureMapRegionInfo regionInfo = 6;</code>
       * @return Whether the regionInfo field is set.
       */
      ...
      public Builder mergeRegionInfo(TreasureMapRegionInfoOuterClass.TreasureMapRegionInfo value) {
        if (regionInfoBuilder_ == null) {
          if (regionInfo_ != null) {
            regionInfo_ =
              TreasureMapRegionInfoOuterClass.TreasureMapRegionInfo.newBuilder(regionInfo_).mergeFrom(value).buildPartial();
          } else {
            regionInfo_ = value;
          }
          onChanged();
      ...
      public TreasureMapRegionInfoOuterClass.TreasureMapRegionInfoOrBuilder getRegionInfoOrBuilder() {
        if (regionInfoBuilder_ != null) {
          ...
          return regionInfo_ == null ?
              TreasureMapRegionInfoOuterClass.TreasureMapRegionInfo.getDefaultInstance() : regionInfo_;
        }
      }
      /**
       * <code>.TreasureMapRegionInfo regionInfo = 6;</code>
    ...
    private static final TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify();
    }

    public static TreasureMapRegionInfoNotifyOuterClass.TreasureMapRegionInfoNotify getDefaultInstance() {
