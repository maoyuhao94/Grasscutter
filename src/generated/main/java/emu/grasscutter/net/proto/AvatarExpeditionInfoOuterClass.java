...
public final class AvatarExpeditionInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return AvatarExpeditionInfoOuterClass.internal_static_AvatarExpeditionInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo.class, AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo.Builder.class);
    }
     ...
     * @return The state.
     */
    @java.lang.Override public AvatarExpeditionStateOuterClass.AvatarExpeditionState getState() {
      @SuppressWarnings("deprecation")
      AvatarExpeditionStateOuterClass.AvatarExpeditionState result = AvatarExpeditionStateOuterClass.AvatarExpeditionState.valueOf(state_);
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (state_ != AvatarExpeditionStateOuterClass.AvatarExpeditionState.AVATAR_EXPEDITION_STATE_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo)) {
        return super.equals(obj);
      }
      AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo other = (AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo) obj;
    ...
    public static AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo parseFrom(
    ...
    public static AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo parseFrom(
    ...
    public static AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo prototype) {
    ...
    public static final class Builder extends
        ...
        AvatarExpeditionInfoOuterClass.AvatarExpeditionInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return AvatarExpeditionInfoOuterClass.internal_static_AvatarExpeditionInfo_descriptor;
      }
      ...
      // Construct using AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo getDefaultInstanceForType() {
        return AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo.getDefaultInstance();
      }

      @java.lang.Override
      public AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo build() {
        AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo result = buildPartial();
      ...
      @java.lang.Override
      public AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo buildPartial() {
        AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo result = new AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo) {
          return mergeFrom((AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo)other);
        } else {
      ...
      public Builder mergeFrom(AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo other) {
        if (other == AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo.getDefaultInstance()) return this;
        if (other.state_ != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo) e.getUnfinishedMessage();
    ...
    private static final AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo();
    }

    public static AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "artTime\030\004 \001(\r\022\024\n\014shortenRatio\030\005 \001(\002b\006pro" +
      "to3"
    };
