...
public final class UgcMusicTrackOuterClass {
  ...
  public interface UgcMusicTrackOrBuilder extends
    ...
    /**
     * <code>repeated .UgcMusicNote musicNoteList = 13;</code>
     */
    java.util.List<UgcMusicNoteOuterClass.UgcMusicNote> 
        getMusicNoteListList();
    /**
     * <code>repeated .UgcMusicNote musicNoteList = 13;</code>
     */
    UgcMusicNoteOuterClass.UgcMusicNote getMusicNoteList(int index);
    /**
     * <code>repeated .UgcMusicNote musicNoteList = 13;</code>
     */
     ...
     * <code>repeated .UgcMusicNote musicNoteList = 13;</code>
     */
    java.util.List<? extends UgcMusicNoteOuterClass.UgcMusicNoteOrBuilder> 
        getMusicNoteListOrBuilderList();
    /**
     * <code>repeated .UgcMusicNote musicNoteList = 13;</code>
     */
    UgcMusicNoteOuterClass.UgcMusicNoteOrBuilder getMusicNoteListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 106: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                musicNoteList_ = new java.util.ArrayList<UgcMusicNoteOuterClass.UgcMusicNote>();
                mutable_bitField0_ |= 0x00000001;
              }
              musicNoteList_.add(
                  input.readMessage(UgcMusicNoteOuterClass.UgcMusicNote.parser(), extensionRegistry));
              break;
            }
            default: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return UgcMusicTrackOuterClass.internal_static_UgcMusicTrack_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              UgcMusicTrackOuterClass.UgcMusicTrack.class, UgcMusicTrackOuterClass.UgcMusicTrack.Builder.class);
    }

    public static final int MUSICNOTELIST_FIELD_NUMBER = 13;
    private java.util.List<UgcMusicNoteOuterClass.UgcMusicNote> musicNoteList_;
    /**
     * <code>repeated .UgcMusicNote musicNoteList = 13;</code>
     */
    @java.lang.Override
    public java.util.List<UgcMusicNoteOuterClass.UgcMusicNote> getMusicNoteListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends UgcMusicNoteOuterClass.UgcMusicNoteOrBuilder> 
        getMusicNoteListOrBuilderList() {
      return musicNoteList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public UgcMusicNoteOuterClass.UgcMusicNoteOrBuilder getMusicNoteListOrBuilder(
        int index) {
      return musicNoteList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof UgcMusicTrackOuterClass.UgcMusicTrack)) {
        return super.equals(obj);
      }
      UgcMusicTrackOuterClass.UgcMusicTrack other = (UgcMusicTrackOuterClass.UgcMusicTrack) obj;
    ...
    public int hashCode() {
      ...
      if (getMusicNoteListCount() > 0) {
        hash = (37 * hash) + MUSICNOTELIST_FIELD_NUMBER;
    ...
    public static UgcMusicTrackOuterClass.UgcMusicTrack parseFrom(
    ...
    public static UgcMusicTrackOuterClass.UgcMusicTrack parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static UgcMusicTrackOuterClass.UgcMusicTrack parseFrom(
    ...
    public static UgcMusicTrackOuterClass.UgcMusicTrack parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static UgcMusicTrackOuterClass.UgcMusicTrack parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static UgcMusicTrackOuterClass.UgcMusicTrack parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(UgcMusicTrackOuterClass.UgcMusicTrack prototype) {
    ...
    public static final class Builder extends
        ...
        UgcMusicTrackOuterClass.UgcMusicTrackOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return UgcMusicTrackOuterClass.internal_static_UgcMusicTrack_descriptor;
      }
      ...
      // Construct using UgcMusicTrackOuterClass.UgcMusicTrack.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public UgcMusicTrackOuterClass.UgcMusicTrack getDefaultInstanceForType() {
        return UgcMusicTrackOuterClass.UgcMusicTrack.getDefaultInstance();
      }

      @java.lang.Override
      public UgcMusicTrackOuterClass.UgcMusicTrack build() {
        UgcMusicTrackOuterClass.UgcMusicTrack result = buildPartial();
      ...
      @java.lang.Override
      public UgcMusicTrackOuterClass.UgcMusicTrack buildPartial() {
        UgcMusicTrackOuterClass.UgcMusicTrack result = new UgcMusicTrackOuterClass.UgcMusicTrack(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof UgcMusicTrackOuterClass.UgcMusicTrack) {
          return mergeFrom((UgcMusicTrackOuterClass.UgcMusicTrack)other);
        } else {
      ...
      public Builder mergeFrom(UgcMusicTrackOuterClass.UgcMusicTrack other) {
        if (other == UgcMusicTrackOuterClass.UgcMusicTrack.getDefaultInstance()) return this;
        if (musicNoteListBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        UgcMusicTrackOuterClass.UgcMusicTrack parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (UgcMusicTrackOuterClass.UgcMusicTrack) e.getUnfinishedMessage();
      ...
      private void ensureMusicNoteListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          musicNoteList_ = new java.util.ArrayList<UgcMusicNoteOuterClass.UgcMusicNote>(musicNoteList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          UgcMusicNoteOuterClass.UgcMusicNote, UgcMusicNoteOuterClass.UgcMusicNote.Builder, UgcMusicNoteOuterClass.UgcMusicNoteOrBuilder> musicNoteListBuilder_;
      ...
      public Builder setMusicNoteList(
          int index, UgcMusicNoteOuterClass.UgcMusicNote value) {
        if (musicNoteListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setMusicNoteList(
          int index, UgcMusicNoteOuterClass.UgcMusicNote.Builder builderForValue) {
        if (musicNoteListBuilder_ == null) {
          ensureMusicNoteListIsMutable();
       ...
       */
      public Builder addMusicNoteList(
          UgcMusicNoteOuterClass.UgcMusicNote.Builder builderForValue) {
        if (musicNoteListBuilder_ == null) {
          ensureMusicNoteListIsMutable();
      ...
      public Builder addAllMusicNoteList(
          java.lang.Iterable<? extends UgcMusicNoteOuterClass.UgcMusicNote> values) {
        if (musicNoteListBuilder_ == null) {
          ensureMusicNoteListIsMutable();
       ...
       * <code>repeated .UgcMusicNote musicNoteList = 13;</code>
       */
      public UgcMusicNoteOuterClass.UgcMusicNote.Builder getMusicNoteListBuilder(
          int index) {
      ...
      public UgcMusicNoteOuterClass.UgcMusicNote.Builder addMusicNoteListBuilder() {
        return getMusicNoteListFieldBuilder().addBuilder(
            UgcMusicNoteOuterClass.UgcMusicNote.getDefaultInstance());
      }
      /**
       * <code>repeated .UgcMusicNote musicNoteList = 13;</code>
       */
      public UgcMusicNoteOuterClass.UgcMusicNote.Builder addMusicNoteListBuilder(
          int index) {
        return getMusicNoteListFieldBuilder().addBuilder(
            index, UgcMusicNoteOuterClass.UgcMusicNote.getDefaultInstance());
      }
      /**
       * <code>repeated .UgcMusicNote musicNoteList = 13;</code>
       */
      public java.util.List<UgcMusicNoteOuterClass.UgcMusicNote.Builder> 
           getMusicNoteListBuilderList() {
        return getMusicNoteListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          UgcMusicNoteOuterClass.UgcMusicNote, UgcMusicNoteOuterClass.UgcMusicNote.Builder, UgcMusicNoteOuterClass.UgcMusicNoteOrBuilder> 
          getMusicNoteListFieldBuilder() {
        if (musicNoteListBuilder_ == null) {
    ...
    private static final UgcMusicTrackOuterClass.UgcMusicTrack DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new UgcMusicTrackOuterClass.UgcMusicTrack();
    }

    public static UgcMusicTrackOuterClass.UgcMusicTrack getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "o\"5\n\rUgcMusicTrack\022$\n\rmusicNoteList\030\r \003(" +
      "\0132\r.UgcMusicNoteb\006proto3"
    };
