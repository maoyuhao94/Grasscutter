...
public final class WinterCampAcceptAllGiveItemRspOuterClass {
  ...
  public interface WinterCampAcceptAllGiveItemRspOrBuilder extends
     ...
     */
    java.util.List<WinterCampAcceptItemResultInfoOuterClass.WinterCampAcceptItemResultInfo> 
        getAcceptItemResultInfoList();
    /**
     * <code>repeated .WinterCampAcceptItemResultInfo acceptItemResultInfo = 1;</code>
     */
    WinterCampAcceptItemResultInfoOuterClass.WinterCampAcceptItemResultInfo getAcceptItemResultInfo(int index);
    /**
     * <code>repeated .WinterCampAcceptItemResultInfo acceptItemResultInfo = 1;</code>
     */
     ...
     * <code>repeated .WinterCampAcceptItemResultInfo acceptItemResultInfo = 1;</code>
     */
    java.util.List<? extends WinterCampAcceptItemResultInfoOuterClass.WinterCampAcceptItemResultInfoOrBuilder> 
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                acceptItemResultInfo_ = new java.util.ArrayList<WinterCampAcceptItemResultInfoOuterClass.WinterCampAcceptItemResultInfo>();
                mutable_bitField0_ |= 0x00000001;
              }
              acceptItemResultInfo_.add(
                  input.readMessage(WinterCampAcceptItemResultInfoOuterClass.WinterCampAcceptItemResultInfo.parser(), extensionRegistry));
              break;
            }
            case 48: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return WinterCampAcceptAllGiveItemRspOuterClass.internal_static_WinterCampAcceptAllGiveItemRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp.class, WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp.Builder.class);
    }
    ...
    public enum BHNIIAAOKOK
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp.getDescriptor().getEnumTypes().get(0);
      }
    ...
    private java.util.List<WinterCampAcceptItemResultInfoOuterClass.WinterCampAcceptItemResultInfo> acceptItemResultInfo_;
    /**
     * <code>repeated .WinterCampAcceptItemResultInfo acceptItemResultInfo = 1;</code>
     */
    @java.lang.Override
    public java.util.List<WinterCampAcceptItemResultInfoOuterClass.WinterCampAcceptItemResultInfo> getAcceptItemResultInfoList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends WinterCampAcceptItemResultInfoOuterClass.WinterCampAcceptItemResultInfoOrBuilder> 
        getAcceptItemResultInfoOrBuilderList() {
      return acceptItemResultInfo_;
    }
    /**
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp)) {
        return super.equals(obj);
      }
      WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp other = (WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp) obj;
    ...
    public static WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp parseFrom(
    ...
    public static WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp parseFrom(
    ...
    public static WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp prototype) {
    ...
    public static final class Builder extends
        ...
        WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return WinterCampAcceptAllGiveItemRspOuterClass.internal_static_WinterCampAcceptAllGiveItemRsp_descriptor;
      }
      ...
      // Construct using WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp getDefaultInstanceForType() {
        return WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp.getDefaultInstance();
      }

      @java.lang.Override
      public WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp build() {
        WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp result = buildPartial();
      ...
      @java.lang.Override
      public WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp buildPartial() {
        WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp result = new WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp) {
          return mergeFrom((WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp)other);
        } else {
      ...
      public Builder mergeFrom(WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp other) {
        if (other == WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp.getDefaultInstance()) return this;
        if (acceptItemResultInfoBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp) e.getUnfinishedMessage();
      ...
      private void ensureAcceptItemResultInfoIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          acceptItemResultInfo_ = new java.util.ArrayList<WinterCampAcceptItemResultInfoOuterClass.WinterCampAcceptItemResultInfo>(acceptItemResultInfo_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          WinterCampAcceptItemResultInfoOuterClass.WinterCampAcceptItemResultInfo, WinterCampAcceptItemResultInfoOuterClass.WinterCampAcceptItemResultInfo.Builder, WinterCampAcceptItemResultInfoOuterClass.WinterCampAcceptItemResultInfoOrBuilder> acceptItemResultInfoBuilder_;
      ...
      public Builder setAcceptItemResultInfo(
          int index, WinterCampAcceptItemResultInfoOuterClass.WinterCampAcceptItemResultInfo value) {
        if (acceptItemResultInfoBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setAcceptItemResultInfo(
          int index, WinterCampAcceptItemResultInfoOuterClass.WinterCampAcceptItemResultInfo.Builder builderForValue) {
        if (acceptItemResultInfoBuilder_ == null) {
          ensureAcceptItemResultInfoIsMutable();
       ...
       */
      public Builder addAcceptItemResultInfo(
          WinterCampAcceptItemResultInfoOuterClass.WinterCampAcceptItemResultInfo.Builder builderForValue) {
        if (acceptItemResultInfoBuilder_ == null) {
          ensureAcceptItemResultInfoIsMutable();
      ...
      public Builder addAllAcceptItemResultInfo(
          java.lang.Iterable<? extends WinterCampAcceptItemResultInfoOuterClass.WinterCampAcceptItemResultInfo> values) {
        if (acceptItemResultInfoBuilder_ == null) {
          ensureAcceptItemResultInfoIsMutable();
      ...
      public WinterCampAcceptItemResultInfoOuterClass.WinterCampAcceptItemResultInfo.Builder addAcceptItemResultInfoBuilder() {
        return getAcceptItemResultInfoFieldBuilder().addBuilder(
            WinterCampAcceptItemResultInfoOuterClass.WinterCampAcceptItemResultInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .WinterCampAcceptItemResultInfo acceptItemResultInfo = 1;</code>
       */
      public WinterCampAcceptItemResultInfoOuterClass.WinterCampAcceptItemResultInfo.Builder addAcceptItemResultInfoBuilder(
          int index) {
        return getAcceptItemResultInfoFieldBuilder().addBuilder(
            index, WinterCampAcceptItemResultInfoOuterClass.WinterCampAcceptItemResultInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .WinterCampAcceptItemResultInfo acceptItemResultInfo = 1;</code>
       */
      public java.util.List<WinterCampAcceptItemResultInfoOuterClass.WinterCampAcceptItemResultInfo.Builder> 
           getAcceptItemResultInfoBuilderList() {
        return getAcceptItemResultInfoFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          WinterCampAcceptItemResultInfoOuterClass.WinterCampAcceptItemResultInfo, WinterCampAcceptItemResultInfoOuterClass.WinterCampAcceptItemResultInfo.Builder, WinterCampAcceptItemResultInfoOuterClass.WinterCampAcceptItemResultInfoOrBuilder> 
          getAcceptItemResultInfoFieldBuilder() {
        if (acceptItemResultInfoBuilder_ == null) {
    ...
    private static final WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp();
    }

    public static WinterCampAcceptAllGiveItemRspOuterClass.WinterCampAcceptAllGiveItemRsp getDefaultInstance() {
