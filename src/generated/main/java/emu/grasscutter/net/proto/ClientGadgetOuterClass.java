...
public final class ClientGadgetOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return ClientGadgetOuterClass.internal_static_ClientGadget_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return ClientGadgetOuterClass.internal_static_ClientGadget_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ClientGadgetOuterClass.ClientGadget.class, ClientGadgetOuterClass.ClientGadget.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof ClientGadgetOuterClass.ClientGadget)) {
        return super.equals(obj);
      }
      ClientGadgetOuterClass.ClientGadget other = (ClientGadgetOuterClass.ClientGadget) obj;
    ...
    public static ClientGadgetOuterClass.ClientGadget parseFrom(
    ...
    public static ClientGadgetOuterClass.ClientGadget parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ClientGadgetOuterClass.ClientGadget parseFrom(
    ...
    public static ClientGadgetOuterClass.ClientGadget parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ClientGadgetOuterClass.ClientGadget parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static ClientGadgetOuterClass.ClientGadget parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(ClientGadgetOuterClass.ClientGadget prototype) {
    ...
    public static final class Builder extends
        ...
        ClientGadgetOuterClass.ClientGadgetOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ClientGadgetOuterClass.internal_static_ClientGadget_descriptor;
      }
      ...
      // Construct using ClientGadgetOuterClass.ClientGadget.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public ClientGadgetOuterClass.ClientGadget getDefaultInstanceForType() {
        return ClientGadgetOuterClass.ClientGadget.getDefaultInstance();
      }

      @java.lang.Override
      public ClientGadgetOuterClass.ClientGadget build() {
        ClientGadgetOuterClass.ClientGadget result = buildPartial();
      ...
      @java.lang.Override
      public ClientGadgetOuterClass.ClientGadget buildPartial() {
        ClientGadgetOuterClass.ClientGadget result = new ClientGadgetOuterClass.ClientGadget(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ClientGadgetOuterClass.ClientGadget) {
          return mergeFrom((ClientGadgetOuterClass.ClientGadget)other);
        } else {
      ...
      public Builder mergeFrom(ClientGadgetOuterClass.ClientGadget other) {
        if (other == ClientGadgetOuterClass.ClientGadget.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ClientGadgetOuterClass.ClientGadget parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ClientGadgetOuterClass.ClientGadget) e.getUnfinishedMessage();
    ...
    private static final ClientGadgetOuterClass.ClientGadget DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ClientGadgetOuterClass.ClientGadget();
    }

    public static ClientGadgetOuterClass.ClientGadget getDefaultInstance() {
