...
public final class ScenePlayerInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              ...
              onlinePlayerInfo_ = input.readMessage(OnlinePlayerInfoOuterClass.OnlinePlayerInfo.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return ScenePlayerInfoOuterClass.internal_static_ScenePlayerInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ScenePlayerInfoOuterClass.ScenePlayerInfo.class, ScenePlayerInfoOuterClass.ScenePlayerInfo.Builder.class);
    }
    ...
    public OnlinePlayerInfoOuterClass.OnlinePlayerInfo getOnlinePlayerInfo() {
      return onlinePlayerInfo_ == null ? OnlinePlayerInfoOuterClass.OnlinePlayerInfo.getDefaultInstance() : onlinePlayerInfo_;
    }
    /**
     * <code>.OnlinePlayerInfo onlinePlayerInfo = 2;</code>
     */
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof ScenePlayerInfoOuterClass.ScenePlayerInfo)) {
        return super.equals(obj);
      }
      ScenePlayerInfoOuterClass.ScenePlayerInfo other = (ScenePlayerInfoOuterClass.ScenePlayerInfo) obj;
    ...
    public static ScenePlayerInfoOuterClass.ScenePlayerInfo parseFrom(
    ...
    public static ScenePlayerInfoOuterClass.ScenePlayerInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ScenePlayerInfoOuterClass.ScenePlayerInfo parseFrom(
    ...
    public static ScenePlayerInfoOuterClass.ScenePlayerInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ScenePlayerInfoOuterClass.ScenePlayerInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static ScenePlayerInfoOuterClass.ScenePlayerInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(ScenePlayerInfoOuterClass.ScenePlayerInfo prototype) {
    ...
    public static final class Builder extends
        ...
        ScenePlayerInfoOuterClass.ScenePlayerInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ScenePlayerInfoOuterClass.internal_static_ScenePlayerInfo_descriptor;
      }
      ...
      // Construct using ScenePlayerInfoOuterClass.ScenePlayerInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public ScenePlayerInfoOuterClass.ScenePlayerInfo getDefaultInstanceForType() {
        return ScenePlayerInfoOuterClass.ScenePlayerInfo.getDefaultInstance();
      }

      @java.lang.Override
      public ScenePlayerInfoOuterClass.ScenePlayerInfo build() {
        ScenePlayerInfoOuterClass.ScenePlayerInfo result = buildPartial();
      ...
      @java.lang.Override
      public ScenePlayerInfoOuterClass.ScenePlayerInfo buildPartial() {
        ScenePlayerInfoOuterClass.ScenePlayerInfo result = new ScenePlayerInfoOuterClass.ScenePlayerInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ScenePlayerInfoOuterClass.ScenePlayerInfo) {
          return mergeFrom((ScenePlayerInfoOuterClass.ScenePlayerInfo)other);
        } else {
      ...
      public Builder mergeFrom(ScenePlayerInfoOuterClass.ScenePlayerInfo other) {
        if (other == ScenePlayerInfoOuterClass.ScenePlayerInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ScenePlayerInfoOuterClass.ScenePlayerInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ScenePlayerInfoOuterClass.ScenePlayerInfo) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          OnlinePlayerInfoOuterClass.OnlinePlayerInfo, OnlinePlayerInfoOuterClass.OnlinePlayerInfo.Builder, OnlinePlayerInfoOuterClass.OnlinePlayerInfoOrBuilder> onlinePlayerInfoBuilder_;
      /**
       * <code>.OnlinePlayerInfo onlinePlayerInfo = 2;</code>
       * @return Whether the onlinePlayerInfo field is set.
       */
      ...
      public Builder mergeOnlinePlayerInfo(OnlinePlayerInfoOuterClass.OnlinePlayerInfo value) {
        if (onlinePlayerInfoBuilder_ == null) {
          if (onlinePlayerInfo_ != null) {
            onlinePlayerInfo_ =
              OnlinePlayerInfoOuterClass.OnlinePlayerInfo.newBuilder(onlinePlayerInfo_).mergeFrom(value).buildPartial();
          } else {
            onlinePlayerInfo_ = value;
          }
          onChanged();
      ...
      public OnlinePlayerInfoOuterClass.OnlinePlayerInfoOrBuilder getOnlinePlayerInfoOrBuilder() {
        if (onlinePlayerInfoBuilder_ != null) {
          ...
          return onlinePlayerInfo_ == null ?
              OnlinePlayerInfoOuterClass.OnlinePlayerInfo.getDefaultInstance() : onlinePlayerInfo_;
        }
      }
      /**
       * <code>.OnlinePlayerInfo onlinePlayerInfo = 2;</code>
    ...
    private static final ScenePlayerInfoOuterClass.ScenePlayerInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ScenePlayerInfoOuterClass.ScenePlayerInfo();
    }

    public static ScenePlayerInfoOuterClass.ScenePlayerInfo getDefaultInstance() {
