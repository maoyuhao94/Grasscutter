...
public final class QuestRenameAvatarRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return QuestRenameAvatarRspOuterClass.internal_static_QuestRenameAvatarRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp.class, QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp.Builder.class);
    }

    /**
     * Protobuf enum {@code QuestRenameAvatarRsp.LLGBKAMNLLC}
     */
    public enum LLGBKAMNLLC
       ...
       */
      public static final LLGBKAMNLLC DCDNILFDFLB = NONE;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 401;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 401;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static LLGBKAMNLLC valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static LLGBKAMNLLC forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 401: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<LLGBKAMNLLC>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          LLGBKAMNLLC> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<LLGBKAMNLLC>() {
              public LLGBKAMNLLC findValueByNumber(int number) {
                return LLGBKAMNLLC.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp.getDescriptor().getEnumTypes().get(0);
      }

      private static final LLGBKAMNLLC[] VALUES = getStaticValuesArray();
      private static LLGBKAMNLLC[] getStaticValuesArray() {
        return new LLGBKAMNLLC[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, 
        };
      }
      public static LLGBKAMNLLC valueOf(
      ...
      private LLGBKAMNLLC(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:QuestRenameAvatarRsp.LLGBKAMNLLC)
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp)) {
        return super.equals(obj);
      }
      QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp other = (QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp) obj;
    ...
    public static QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp parseFrom(
    ...
    public static QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp parseFrom(
    ...
    public static QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp prototype) {
    ...
    public static final class Builder extends
        ...
        QuestRenameAvatarRspOuterClass.QuestRenameAvatarRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return QuestRenameAvatarRspOuterClass.internal_static_QuestRenameAvatarRsp_descriptor;
      }
      ...
      // Construct using QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp getDefaultInstanceForType() {
        return QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp.getDefaultInstance();
      }

      @java.lang.Override
      public QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp build() {
        QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp result = buildPartial();
      ...
      @java.lang.Override
      public QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp buildPartial() {
        QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp result = new QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp) {
          return mergeFrom((QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp)other);
        } else {
      ...
      public Builder mergeFrom(QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp other) {
        if (other == QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp();
    }

    public static QuestRenameAvatarRspOuterClass.QuestRenameAvatarRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\032QuestRenameAvatarRsp.proto\"\257\001\n\024QuestRe" +
      "nameAvatarRsp\022\022\n\navatarName\030\017 \001(\t\022\017\n\007isC" +
      "heck\030\002 \001(\010\022\020\n\010renameId\030\r \001(\r\022\017\n\007retcode\030" +
      "\n \001(\005\"O\n\013LLGBKAMNLLC\022\010\n\004NONE\020\000\022\020\n\013PEPPOH" +
      "PHJOJ\020\221\003\022\017\n\013DCDNILFDFLB\020\000\022\017\n\013NNBKOLMPOEA" +
