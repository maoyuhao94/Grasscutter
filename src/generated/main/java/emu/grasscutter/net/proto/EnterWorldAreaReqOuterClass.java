...
public final class EnterWorldAreaReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return EnterWorldAreaReqOuterClass.internal_static_EnterWorldAreaReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              EnterWorldAreaReqOuterClass.EnterWorldAreaReq.class, EnterWorldAreaReqOuterClass.EnterWorldAreaReq.Builder.class);
    }
    ...
    public enum GNDHGLBEFEL
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return EnterWorldAreaReqOuterClass.EnterWorldAreaReq.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof EnterWorldAreaReqOuterClass.EnterWorldAreaReq)) {
        return super.equals(obj);
      }
      EnterWorldAreaReqOuterClass.EnterWorldAreaReq other = (EnterWorldAreaReqOuterClass.EnterWorldAreaReq) obj;
    ...
    public static EnterWorldAreaReqOuterClass.EnterWorldAreaReq parseFrom(
    ...
    public static EnterWorldAreaReqOuterClass.EnterWorldAreaReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static EnterWorldAreaReqOuterClass.EnterWorldAreaReq parseFrom(
    ...
    public static EnterWorldAreaReqOuterClass.EnterWorldAreaReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static EnterWorldAreaReqOuterClass.EnterWorldAreaReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static EnterWorldAreaReqOuterClass.EnterWorldAreaReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(EnterWorldAreaReqOuterClass.EnterWorldAreaReq prototype) {
    ...
    public static final class Builder extends
        ...
        EnterWorldAreaReqOuterClass.EnterWorldAreaReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return EnterWorldAreaReqOuterClass.internal_static_EnterWorldAreaReq_descriptor;
      }
      ...
      // Construct using EnterWorldAreaReqOuterClass.EnterWorldAreaReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public EnterWorldAreaReqOuterClass.EnterWorldAreaReq getDefaultInstanceForType() {
        return EnterWorldAreaReqOuterClass.EnterWorldAreaReq.getDefaultInstance();
      }

      @java.lang.Override
      public EnterWorldAreaReqOuterClass.EnterWorldAreaReq build() {
        EnterWorldAreaReqOuterClass.EnterWorldAreaReq result = buildPartial();
      ...
      @java.lang.Override
      public EnterWorldAreaReqOuterClass.EnterWorldAreaReq buildPartial() {
        EnterWorldAreaReqOuterClass.EnterWorldAreaReq result = new EnterWorldAreaReqOuterClass.EnterWorldAreaReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof EnterWorldAreaReqOuterClass.EnterWorldAreaReq) {
          return mergeFrom((EnterWorldAreaReqOuterClass.EnterWorldAreaReq)other);
        } else {
      ...
      public Builder mergeFrom(EnterWorldAreaReqOuterClass.EnterWorldAreaReq other) {
        if (other == EnterWorldAreaReqOuterClass.EnterWorldAreaReq.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        EnterWorldAreaReqOuterClass.EnterWorldAreaReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (EnterWorldAreaReqOuterClass.EnterWorldAreaReq) e.getUnfinishedMessage();
    ...
    private static final EnterWorldAreaReqOuterClass.EnterWorldAreaReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new EnterWorldAreaReqOuterClass.EnterWorldAreaReq();
    }

    public static EnterWorldAreaReqOuterClass.EnterWorldAreaReq getDefaultInstance() {
