...
public final class SetPlayerNameRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return SetPlayerNameRspOuterClass.internal_static_SetPlayerNameRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              SetPlayerNameRspOuterClass.SetPlayerNameRsp.class, SetPlayerNameRspOuterClass.SetPlayerNameRsp.Builder.class);
    }
    ...
    public enum BIHLPOPNHMC
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return SetPlayerNameRspOuterClass.SetPlayerNameRsp.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof SetPlayerNameRspOuterClass.SetPlayerNameRsp)) {
        return super.equals(obj);
      }
      SetPlayerNameRspOuterClass.SetPlayerNameRsp other = (SetPlayerNameRspOuterClass.SetPlayerNameRsp) obj;
    ...
    public static SetPlayerNameRspOuterClass.SetPlayerNameRsp parseFrom(
    ...
    public static SetPlayerNameRspOuterClass.SetPlayerNameRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static SetPlayerNameRspOuterClass.SetPlayerNameRsp parseFrom(
    ...
    public static SetPlayerNameRspOuterClass.SetPlayerNameRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static SetPlayerNameRspOuterClass.SetPlayerNameRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static SetPlayerNameRspOuterClass.SetPlayerNameRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(SetPlayerNameRspOuterClass.SetPlayerNameRsp prototype) {
    ...
    public static final class Builder extends
        ...
        SetPlayerNameRspOuterClass.SetPlayerNameRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return SetPlayerNameRspOuterClass.internal_static_SetPlayerNameRsp_descriptor;
      }
      ...
      // Construct using SetPlayerNameRspOuterClass.SetPlayerNameRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public SetPlayerNameRspOuterClass.SetPlayerNameRsp getDefaultInstanceForType() {
        return SetPlayerNameRspOuterClass.SetPlayerNameRsp.getDefaultInstance();
      }

      @java.lang.Override
      public SetPlayerNameRspOuterClass.SetPlayerNameRsp build() {
        SetPlayerNameRspOuterClass.SetPlayerNameRsp result = buildPartial();
      ...
      @java.lang.Override
      public SetPlayerNameRspOuterClass.SetPlayerNameRsp buildPartial() {
        SetPlayerNameRspOuterClass.SetPlayerNameRsp result = new SetPlayerNameRspOuterClass.SetPlayerNameRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof SetPlayerNameRspOuterClass.SetPlayerNameRsp) {
          return mergeFrom((SetPlayerNameRspOuterClass.SetPlayerNameRsp)other);
        } else {
      ...
      public Builder mergeFrom(SetPlayerNameRspOuterClass.SetPlayerNameRsp other) {
        if (other == SetPlayerNameRspOuterClass.SetPlayerNameRsp.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        SetPlayerNameRspOuterClass.SetPlayerNameRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (SetPlayerNameRspOuterClass.SetPlayerNameRsp) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final SetPlayerNameRspOuterClass.SetPlayerNameRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new SetPlayerNameRspOuterClass.SetPlayerNameRsp();
    }

    public static SetPlayerNameRspOuterClass.SetPlayerNameRsp getDefaultInstance() {
