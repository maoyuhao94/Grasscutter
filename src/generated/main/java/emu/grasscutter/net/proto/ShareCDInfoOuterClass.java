...
public final class ShareCDInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return ShareCDInfoOuterClass.internal_static_ShareCDInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return ShareCDInfoOuterClass.internal_static_ShareCDInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ShareCDInfoOuterClass.ShareCDInfo.class, ShareCDInfoOuterClass.ShareCDInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof ShareCDInfoOuterClass.ShareCDInfo)) {
        return super.equals(obj);
      }
      ShareCDInfoOuterClass.ShareCDInfo other = (ShareCDInfoOuterClass.ShareCDInfo) obj;
    ...
    public static ShareCDInfoOuterClass.ShareCDInfo parseFrom(
    ...
    public static ShareCDInfoOuterClass.ShareCDInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ShareCDInfoOuterClass.ShareCDInfo parseFrom(
    ...
    public static ShareCDInfoOuterClass.ShareCDInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ShareCDInfoOuterClass.ShareCDInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static ShareCDInfoOuterClass.ShareCDInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(ShareCDInfoOuterClass.ShareCDInfo prototype) {
    ...
    public static final class Builder extends
        ...
        ShareCDInfoOuterClass.ShareCDInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ShareCDInfoOuterClass.internal_static_ShareCDInfo_descriptor;
      }
      ...
      // Construct using ShareCDInfoOuterClass.ShareCDInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public ShareCDInfoOuterClass.ShareCDInfo getDefaultInstanceForType() {
        return ShareCDInfoOuterClass.ShareCDInfo.getDefaultInstance();
      }

      @java.lang.Override
      public ShareCDInfoOuterClass.ShareCDInfo build() {
        ShareCDInfoOuterClass.ShareCDInfo result = buildPartial();
      ...
      @java.lang.Override
      public ShareCDInfoOuterClass.ShareCDInfo buildPartial() {
        ShareCDInfoOuterClass.ShareCDInfo result = new ShareCDInfoOuterClass.ShareCDInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ShareCDInfoOuterClass.ShareCDInfo) {
          return mergeFrom((ShareCDInfoOuterClass.ShareCDInfo)other);
        } else {
      ...
      public Builder mergeFrom(ShareCDInfoOuterClass.ShareCDInfo other) {
        if (other == ShareCDInfoOuterClass.ShareCDInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ShareCDInfoOuterClass.ShareCDInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ShareCDInfoOuterClass.ShareCDInfo) e.getUnfinishedMessage();
    ...
    private static final ShareCDInfoOuterClass.ShareCDInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ShareCDInfoOuterClass.ShareCDInfo();
    }

    public static ShareCDInfoOuterClass.ShareCDInfo getDefaultInstance() {
