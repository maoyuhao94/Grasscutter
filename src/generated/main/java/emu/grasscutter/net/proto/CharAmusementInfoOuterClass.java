...
public final class CharAmusementInfoOuterClass {
  ...
  public interface CharAmusementInfoOrBuilder extends
     ...
     */
    java.util.List<CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo> 
        getAvatarInfoListList();
    /**
     * <code>repeated .CharAmusementAvatarInfo avatarInfoList = 11;</code>
     */
    CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo getAvatarInfoList(int index);
    /**
     * <code>repeated .CharAmusementAvatarInfo avatarInfoList = 11;</code>
     */
     ...
     * <code>repeated .CharAmusementAvatarInfo avatarInfoList = 11;</code>
     */
    java.util.List<? extends CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfoOrBuilder> 
        getAvatarInfoListOrBuilderList();
    /**
     * <code>repeated .CharAmusementAvatarInfo avatarInfoList = 11;</code>
     */
    CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfoOrBuilder getAvatarInfoListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 90: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                avatarInfoList_ = new java.util.ArrayList<CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo>();
                mutable_bitField0_ |= 0x00000001;
              }
              avatarInfoList_.add(
                  input.readMessage(CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo.parser(), extensionRegistry));
              break;
            }
            default: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return CharAmusementInfoOuterClass.internal_static_CharAmusementInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              CharAmusementInfoOuterClass.CharAmusementInfo.class, CharAmusementInfoOuterClass.CharAmusementInfo.Builder.class);
    }

    public static final int AVATARINFOLIST_FIELD_NUMBER = 11;
    private java.util.List<CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo> avatarInfoList_;
    /**
     * <code>repeated .CharAmusementAvatarInfo avatarInfoList = 11;</code>
     */
    @java.lang.Override
    public java.util.List<CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo> getAvatarInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfoOrBuilder> 
        getAvatarInfoListOrBuilderList() {
      return avatarInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfoOrBuilder getAvatarInfoListOrBuilder(
        int index) {
      return avatarInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof CharAmusementInfoOuterClass.CharAmusementInfo)) {
        return super.equals(obj);
      }
      CharAmusementInfoOuterClass.CharAmusementInfo other = (CharAmusementInfoOuterClass.CharAmusementInfo) obj;
    ...
    public static CharAmusementInfoOuterClass.CharAmusementInfo parseFrom(
    ...
    public static CharAmusementInfoOuterClass.CharAmusementInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static CharAmusementInfoOuterClass.CharAmusementInfo parseFrom(
    ...
    public static CharAmusementInfoOuterClass.CharAmusementInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static CharAmusementInfoOuterClass.CharAmusementInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static CharAmusementInfoOuterClass.CharAmusementInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(CharAmusementInfoOuterClass.CharAmusementInfo prototype) {
    ...
    public static final class Builder extends
        ...
        CharAmusementInfoOuterClass.CharAmusementInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return CharAmusementInfoOuterClass.internal_static_CharAmusementInfo_descriptor;
      }
      ...
      // Construct using CharAmusementInfoOuterClass.CharAmusementInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public CharAmusementInfoOuterClass.CharAmusementInfo getDefaultInstanceForType() {
        return CharAmusementInfoOuterClass.CharAmusementInfo.getDefaultInstance();
      }

      @java.lang.Override
      public CharAmusementInfoOuterClass.CharAmusementInfo build() {
        CharAmusementInfoOuterClass.CharAmusementInfo result = buildPartial();
      ...
      @java.lang.Override
      public CharAmusementInfoOuterClass.CharAmusementInfo buildPartial() {
        CharAmusementInfoOuterClass.CharAmusementInfo result = new CharAmusementInfoOuterClass.CharAmusementInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof CharAmusementInfoOuterClass.CharAmusementInfo) {
          return mergeFrom((CharAmusementInfoOuterClass.CharAmusementInfo)other);
        } else {
      ...
      public Builder mergeFrom(CharAmusementInfoOuterClass.CharAmusementInfo other) {
        if (other == CharAmusementInfoOuterClass.CharAmusementInfo.getDefaultInstance()) return this;
        if (avatarInfoListBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        CharAmusementInfoOuterClass.CharAmusementInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (CharAmusementInfoOuterClass.CharAmusementInfo) e.getUnfinishedMessage();
      ...
      private void ensureAvatarInfoListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          avatarInfoList_ = new java.util.ArrayList<CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo>(avatarInfoList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo, CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo.Builder, CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfoOrBuilder> avatarInfoListBuilder_;
      ...
      public Builder setAvatarInfoList(
          int index, CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo value) {
        if (avatarInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setAvatarInfoList(
          int index, CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo.Builder builderForValue) {
        if (avatarInfoListBuilder_ == null) {
          ensureAvatarInfoListIsMutable();
       ...
       */
      public Builder addAvatarInfoList(
          CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo.Builder builderForValue) {
        if (avatarInfoListBuilder_ == null) {
          ensureAvatarInfoListIsMutable();
      ...
      public Builder addAllAvatarInfoList(
          java.lang.Iterable<? extends CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo> values) {
        if (avatarInfoListBuilder_ == null) {
          ensureAvatarInfoListIsMutable();
       ...
       * <code>repeated .CharAmusementAvatarInfo avatarInfoList = 11;</code>
       */
      public CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo.Builder getAvatarInfoListBuilder(
          int index) {
      ...
      public CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo.Builder addAvatarInfoListBuilder() {
        return getAvatarInfoListFieldBuilder().addBuilder(
            CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .CharAmusementAvatarInfo avatarInfoList = 11;</code>
       */
      public CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo.Builder addAvatarInfoListBuilder(
          int index) {
        return getAvatarInfoListFieldBuilder().addBuilder(
            index, CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .CharAmusementAvatarInfo avatarInfoList = 11;</code>
       */
      public java.util.List<CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo.Builder> 
           getAvatarInfoListBuilderList() {
        return getAvatarInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo, CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo.Builder, CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfoOrBuilder> 
          getAvatarInfoListFieldBuilder() {
        if (avatarInfoListBuilder_ == null) {
    ...
    private static final CharAmusementInfoOuterClass.CharAmusementInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new CharAmusementInfoOuterClass.CharAmusementInfo();
    }

    public static CharAmusementInfoOuterClass.CharAmusementInfo getDefaultInstance() {
