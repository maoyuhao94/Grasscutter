...
public final class FetterDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return FetterDataOuterClass.internal_static_FetterData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              FetterDataOuterClass.FetterData.class, FetterDataOuterClass.FetterData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof FetterDataOuterClass.FetterData)) {
        return super.equals(obj);
      }
      FetterDataOuterClass.FetterData other = (FetterDataOuterClass.FetterData) obj;
    ...
    public static FetterDataOuterClass.FetterData parseFrom(
    ...
    public static FetterDataOuterClass.FetterData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static FetterDataOuterClass.FetterData parseFrom(
    ...
    public static FetterDataOuterClass.FetterData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static FetterDataOuterClass.FetterData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static FetterDataOuterClass.FetterData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(FetterDataOuterClass.FetterData prototype) {
    ...
    public static final class Builder extends
        ...
        FetterDataOuterClass.FetterDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return FetterDataOuterClass.internal_static_FetterData_descriptor;
      }
      ...
      // Construct using FetterDataOuterClass.FetterData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public FetterDataOuterClass.FetterData getDefaultInstanceForType() {
        return FetterDataOuterClass.FetterData.getDefaultInstance();
      }

      @java.lang.Override
      public FetterDataOuterClass.FetterData build() {
        FetterDataOuterClass.FetterData result = buildPartial();
      ...
      @java.lang.Override
      public FetterDataOuterClass.FetterData buildPartial() {
        FetterDataOuterClass.FetterData result = new FetterDataOuterClass.FetterData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof FetterDataOuterClass.FetterData) {
          return mergeFrom((FetterDataOuterClass.FetterData)other);
        } else {
      ...
      public Builder mergeFrom(FetterDataOuterClass.FetterData other) {
        if (other == FetterDataOuterClass.FetterData.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        FetterDataOuterClass.FetterData parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (FetterDataOuterClass.FetterData) e.getUnfinishedMessage();
    ...
    private static final FetterDataOuterClass.FetterData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new FetterDataOuterClass.FetterData();
    }

    public static FetterDataOuterClass.FetterData getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ndexList\030\003 \003(\rb\006proto3"
    };
