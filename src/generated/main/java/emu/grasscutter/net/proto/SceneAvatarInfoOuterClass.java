...
public final class SceneAvatarInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return SceneAvatarInfoOuterClass.internal_static_SceneAvatarInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              SceneAvatarInfoOuterClass.SceneAvatarInfo.class, SceneAvatarInfoOuterClass.SceneAvatarInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof SceneAvatarInfoOuterClass.SceneAvatarInfo)) {
        return super.equals(obj);
      }
      SceneAvatarInfoOuterClass.SceneAvatarInfo other = (SceneAvatarInfoOuterClass.SceneAvatarInfo) obj;
    ...
    public static SceneAvatarInfoOuterClass.SceneAvatarInfo parseFrom(
    ...
    public static SceneAvatarInfoOuterClass.SceneAvatarInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static SceneAvatarInfoOuterClass.SceneAvatarInfo parseFrom(
    ...
    public static SceneAvatarInfoOuterClass.SceneAvatarInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static SceneAvatarInfoOuterClass.SceneAvatarInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static SceneAvatarInfoOuterClass.SceneAvatarInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(SceneAvatarInfoOuterClass.SceneAvatarInfo prototype) {
    ...
    public static final class Builder extends
        ...
        SceneAvatarInfoOuterClass.SceneAvatarInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return SceneAvatarInfoOuterClass.internal_static_SceneAvatarInfo_descriptor;
      }
      ...
      // Construct using SceneAvatarInfoOuterClass.SceneAvatarInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public SceneAvatarInfoOuterClass.SceneAvatarInfo getDefaultInstanceForType() {
        return SceneAvatarInfoOuterClass.SceneAvatarInfo.getDefaultInstance();
      }

      @java.lang.Override
      public SceneAvatarInfoOuterClass.SceneAvatarInfo build() {
        SceneAvatarInfoOuterClass.SceneAvatarInfo result = buildPartial();
      ...
      @java.lang.Override
      public SceneAvatarInfoOuterClass.SceneAvatarInfo buildPartial() {
        SceneAvatarInfoOuterClass.SceneAvatarInfo result = new SceneAvatarInfoOuterClass.SceneAvatarInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof SceneAvatarInfoOuterClass.SceneAvatarInfo) {
          return mergeFrom((SceneAvatarInfoOuterClass.SceneAvatarInfo)other);
        } else {
      ...
      public Builder mergeFrom(SceneAvatarInfoOuterClass.SceneAvatarInfo other) {
        if (other == SceneAvatarInfoOuterClass.SceneAvatarInfo.getDefaultInstance()) return this;
        if (other.getUid() != 0) {
          setUid(other.getUid());
        }
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        SceneAvatarInfoOuterClass.SceneAvatarInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (SceneAvatarInfoOuterClass.SceneAvatarInfo) e.getUnfinishedMessage();
    ...
    private static final SceneAvatarInfoOuterClass.SceneAvatarInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new SceneAvatarInfoOuterClass.SceneAvatarInfo();
    }

    public static SceneAvatarInfoOuterClass.SceneAvatarInfo getDefaultInstance() {
