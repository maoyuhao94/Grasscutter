...
public final class RogueSwitchAvatarReqOuterClass {
  ...
  public interface RogueSwitchAvatarReqOrBuilder extends
    ...
    /**
     * <code>uint64 curAvatarGuid = 15;</code>
     * @return The curAvatarGuid.
     */
    long getCurAvatarGuid();

    /**
     * <code>repeated uint64 onstageAvatarGuidList = 14;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return RogueSwitchAvatarReqOuterClass.internal_static_RogueSwitchAvatarReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return RogueSwitchAvatarReqOuterClass.internal_static_RogueSwitchAvatarReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq.class, RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq.Builder.class);
    }

    /**
     * Protobuf enum {@code RogueSwitchAvatarReq.ILOKDHFKNLC}
     */
    public enum ILOKDHFKNLC
       ...
       */
      public static final ILOKDHFKNLC DCDNILFDFLB = NONE;
      /**
       * <code>EAJIABGAOCI = 1;</code>
       */
      public static final ILOKDHFKNLC EAJIABGAOCI = NNBKOLMPOEA;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 8262;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 8262;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static ILOKDHFKNLC valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static ILOKDHFKNLC forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 8262: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<ILOKDHFKNLC>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          ILOKDHFKNLC> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<ILOKDHFKNLC>() {
              public ILOKDHFKNLC findValueByNumber(int number) {
                return ILOKDHFKNLC.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq.getDescriptor().getEnumTypes().get(0);
      }

      private static final ILOKDHFKNLC[] VALUES = getStaticValuesArray();
      private static ILOKDHFKNLC[] getStaticValuesArray() {
        return new ILOKDHFKNLC[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, EAJIABGAOCI, 
        };
      }
      public static ILOKDHFKNLC valueOf(
      ...
      private ILOKDHFKNLC(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:RogueSwitchAvatarReq.ILOKDHFKNLC)
    }

    public static final int CURAVATARGUID_FIELD_NUMBER = 15;
    ...
    public static final int ONSTAGEAVATARGUIDLIST_FIELD_NUMBER = 14;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq)) {
        return super.equals(obj);
      }
      RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq other = (RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq) obj;
    ...
    public static RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq parseFrom(
    ...
    public static RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq parseFrom(
    ...
    public static RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq prototype) {
    ...
    public static final class Builder extends
        ...
        RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return RogueSwitchAvatarReqOuterClass.internal_static_RogueSwitchAvatarReq_descriptor;
      }
      ...
      // Construct using RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq getDefaultInstanceForType() {
        return RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq.getDefaultInstance();
      }

      @java.lang.Override
      public RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq build() {
        RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq result = buildPartial();
      ...
      @java.lang.Override
      public RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq buildPartial() {
        RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq result = new RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq) {
          return mergeFrom((RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq)other);
        } else {
      ...
      public Builder mergeFrom(RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq other) {
        if (other == RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq) e.getUnfinishedMessage();
    ...
    private static final RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq();
    }

    public static RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\032RogueSwitchAvatarReq.proto\"\321\001\n\024RogueSw" +
      "itchAvatarReq\022\025\n\rcurAvatarGuid\030\017 \001(\004\022\035\n\025" +
      "onstageAvatarGuidList\030\016 \003(\004\022\016\n\006cellId\030\010 " +
      "\001(\r\022\021\n\tdungeonId\030\001 \001(\r\"`\n\013ILOKDHFKNLC\022\010\n" +
