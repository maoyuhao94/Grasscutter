...
public final class QuestGlobalVarNotifyOuterClass {
  ...
  public interface QuestGlobalVarNotifyOrBuilder extends
     ...
     */
    java.util.List<QuestGlobalVarOuterClass.QuestGlobalVar> 
        getVarListList();
    /**
     * <code>repeated .QuestGlobalVar varList = 12;</code>
     */
    QuestGlobalVarOuterClass.QuestGlobalVar getVarList(int index);
    /**
     * <code>repeated .QuestGlobalVar varList = 12;</code>
     */
    int getVarListCount();
     ...
     * <code>repeated .QuestGlobalVar varList = 12;</code>
     */
    java.util.List<? extends QuestGlobalVarOuterClass.QuestGlobalVarOrBuilder> 
        getVarListOrBuilderList();
    /**
     * <code>repeated .QuestGlobalVar varList = 12;</code>
     */
    QuestGlobalVarOuterClass.QuestGlobalVarOrBuilder getVarListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 98: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                varList_ = new java.util.ArrayList<QuestGlobalVarOuterClass.QuestGlobalVar>();
                mutable_bitField0_ |= 0x00000001;
              }
              varList_.add(
                  input.readMessage(QuestGlobalVarOuterClass.QuestGlobalVar.parser(), extensionRegistry));
              break;
            }
            default: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return QuestGlobalVarNotifyOuterClass.internal_static_QuestGlobalVarNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify.class, QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify.Builder.class);
    }
    ...
    public enum JPMJBPBHBDK
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify.getDescriptor().getEnumTypes().get(0);
      }
    ...
    private java.util.List<QuestGlobalVarOuterClass.QuestGlobalVar> varList_;
    /**
     * <code>repeated .QuestGlobalVar varList = 12;</code>
     */
    @java.lang.Override
    public java.util.List<QuestGlobalVarOuterClass.QuestGlobalVar> getVarListList() {
      return varList_;
    }
    /**
     * <code>repeated .QuestGlobalVar varList = 12;</code>
     */
    @java.lang.Override
    public java.util.List<? extends QuestGlobalVarOuterClass.QuestGlobalVarOrBuilder> 
        getVarListOrBuilderList() {
      return varList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public QuestGlobalVarOuterClass.QuestGlobalVarOrBuilder getVarListOrBuilder(
        int index) {
      return varList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify)) {
        return super.equals(obj);
      }
      QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify other = (QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify) obj;
    ...
    public static QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify parseFrom(
    ...
    public static QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify parseFrom(
    ...
    public static QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify prototype) {
    ...
    public static final class Builder extends
        ...
        QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return QuestGlobalVarNotifyOuterClass.internal_static_QuestGlobalVarNotify_descriptor;
      }
      ...
      // Construct using QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify getDefaultInstanceForType() {
        return QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify.getDefaultInstance();
      }

      @java.lang.Override
      public QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify build() {
        QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify result = buildPartial();
      ...
      @java.lang.Override
      public QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify buildPartial() {
        QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify result = new QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify) {
          return mergeFrom((QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify)other);
        } else {
      ...
      public Builder mergeFrom(QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify other) {
        if (other == QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify.getDefaultInstance()) return this;
        if (varListBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify) e.getUnfinishedMessage();
      ...
      private void ensureVarListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          varList_ = new java.util.ArrayList<QuestGlobalVarOuterClass.QuestGlobalVar>(varList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          QuestGlobalVarOuterClass.QuestGlobalVar, QuestGlobalVarOuterClass.QuestGlobalVar.Builder, QuestGlobalVarOuterClass.QuestGlobalVarOrBuilder> varListBuilder_;
      ...
      public Builder setVarList(
          int index, QuestGlobalVarOuterClass.QuestGlobalVar value) {
        if (varListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setVarList(
          int index, QuestGlobalVarOuterClass.QuestGlobalVar.Builder builderForValue) {
        if (varListBuilder_ == null) {
          ensureVarListIsMutable();
       ...
       */
      public Builder addVarList(
          QuestGlobalVarOuterClass.QuestGlobalVar.Builder builderForValue) {
        if (varListBuilder_ == null) {
          ensureVarListIsMutable();
      ...
      public Builder addAllVarList(
          java.lang.Iterable<? extends QuestGlobalVarOuterClass.QuestGlobalVar> values) {
        if (varListBuilder_ == null) {
          ensureVarListIsMutable();
       ...
       * <code>repeated .QuestGlobalVar varList = 12;</code>
       */
      public QuestGlobalVarOuterClass.QuestGlobalVar.Builder getVarListBuilder(
          int index) {
      ...
      public QuestGlobalVarOuterClass.QuestGlobalVar.Builder addVarListBuilder() {
        return getVarListFieldBuilder().addBuilder(
            QuestGlobalVarOuterClass.QuestGlobalVar.getDefaultInstance());
      }
      /**
       * <code>repeated .QuestGlobalVar varList = 12;</code>
       */
      public QuestGlobalVarOuterClass.QuestGlobalVar.Builder addVarListBuilder(
          int index) {
        return getVarListFieldBuilder().addBuilder(
            index, QuestGlobalVarOuterClass.QuestGlobalVar.getDefaultInstance());
      }
      /**
       * <code>repeated .QuestGlobalVar varList = 12;</code>
       */
      public java.util.List<QuestGlobalVarOuterClass.QuestGlobalVar.Builder> 
           getVarListBuilderList() {
        return getVarListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          QuestGlobalVarOuterClass.QuestGlobalVar, QuestGlobalVarOuterClass.QuestGlobalVar.Builder, QuestGlobalVarOuterClass.QuestGlobalVarOrBuilder> 
          getVarListFieldBuilder() {
        if (varListBuilder_ == null) {
    ...
    private static final QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify();
    }

    public static QuestGlobalVarNotifyOuterClass.QuestGlobalVarNotify getDefaultInstance() {
