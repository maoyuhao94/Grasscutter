  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return SetPlayerBirthdayReqOuterClass.internal_static_SetPlayerBirthdayReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq.class, SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq.Builder.class);
    }
    ...
    public enum HIPLJKMFJAC
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq)) {
        return super.equals(obj);
      }
      SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq other = (SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq) obj;
    ...
    public static SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq parseFrom(
    ...
    public static SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq parseFrom(
    ...
    public static SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq prototype) {
    ...
    public static final class Builder extends
        ...
        SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return SetPlayerBirthdayReqOuterClass.internal_static_SetPlayerBirthdayReq_descriptor;
      }
      ...
      // Construct using SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq getDefaultInstanceForType() {
        return SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq.getDefaultInstance();
      }

      @java.lang.Override
      public SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq build() {
        SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq result = buildPartial();
      ...
      @java.lang.Override
      public SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq buildPartial() {
        SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq result = new SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq(this);
        if (birthdayBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq) {
          return mergeFrom((SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq)other);
        } else {
      ...
      public Builder mergeFrom(SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq other) {
        if (other == SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq) e.getUnfinishedMessage();
    ...
    private static final SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq();
    }

    public static SetPlayerBirthdayReqOuterClass.SetPlayerBirthdayReq getDefaultInstance() {
