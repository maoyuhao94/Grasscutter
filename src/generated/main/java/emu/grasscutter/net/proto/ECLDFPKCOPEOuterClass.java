...
public final class ECLDFPKCOPEOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return ECLDFPKCOPEOuterClass.internal_static_ECLDFPKCOPE_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return ECLDFPKCOPEOuterClass.internal_static_ECLDFPKCOPE_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ECLDFPKCOPEOuterClass.ECLDFPKCOPE.class, ECLDFPKCOPEOuterClass.ECLDFPKCOPE.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof ECLDFPKCOPEOuterClass.ECLDFPKCOPE)) {
        return super.equals(obj);
      }
      ECLDFPKCOPEOuterClass.ECLDFPKCOPE other = (ECLDFPKCOPEOuterClass.ECLDFPKCOPE) obj;
    ...
    public static ECLDFPKCOPEOuterClass.ECLDFPKCOPE parseFrom(
    ...
    public static ECLDFPKCOPEOuterClass.ECLDFPKCOPE parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ECLDFPKCOPEOuterClass.ECLDFPKCOPE parseFrom(
    ...
    public static ECLDFPKCOPEOuterClass.ECLDFPKCOPE parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ECLDFPKCOPEOuterClass.ECLDFPKCOPE parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static ECLDFPKCOPEOuterClass.ECLDFPKCOPE parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(ECLDFPKCOPEOuterClass.ECLDFPKCOPE prototype) {
    ...
    public static final class Builder extends
        ...
        ECLDFPKCOPEOuterClass.ECLDFPKCOPEOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ECLDFPKCOPEOuterClass.internal_static_ECLDFPKCOPE_descriptor;
      }
      ...
      // Construct using ECLDFPKCOPEOuterClass.ECLDFPKCOPE.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public ECLDFPKCOPEOuterClass.ECLDFPKCOPE getDefaultInstanceForType() {
        return ECLDFPKCOPEOuterClass.ECLDFPKCOPE.getDefaultInstance();
      }

      @java.lang.Override
      public ECLDFPKCOPEOuterClass.ECLDFPKCOPE build() {
        ECLDFPKCOPEOuterClass.ECLDFPKCOPE result = buildPartial();
      ...
      @java.lang.Override
      public ECLDFPKCOPEOuterClass.ECLDFPKCOPE buildPartial() {
        ECLDFPKCOPEOuterClass.ECLDFPKCOPE result = new ECLDFPKCOPEOuterClass.ECLDFPKCOPE(this);
        if (attackResultBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ECLDFPKCOPEOuterClass.ECLDFPKCOPE) {
          return mergeFrom((ECLDFPKCOPEOuterClass.ECLDFPKCOPE)other);
        } else {
      ...
      public Builder mergeFrom(ECLDFPKCOPEOuterClass.ECLDFPKCOPE other) {
        if (other == ECLDFPKCOPEOuterClass.ECLDFPKCOPE.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ECLDFPKCOPEOuterClass.ECLDFPKCOPE parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ECLDFPKCOPEOuterClass.ECLDFPKCOPE) e.getUnfinishedMessage();
    ...
    private static final ECLDFPKCOPEOuterClass.ECLDFPKCOPE DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ECLDFPKCOPEOuterClass.ECLDFPKCOPE();
    }

    public static ECLDFPKCOPEOuterClass.ECLDFPKCOPE getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ttackResult\022\016\n\006peerId\030\003 \001(\rb\006proto3"
    };
