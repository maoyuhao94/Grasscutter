...
public final class DelMailReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return DelMailReqOuterClass.internal_static_DelMailReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              DelMailReqOuterClass.DelMailReq.class, DelMailReqOuterClass.DelMailReq.Builder.class);
    }
    ...
    public enum MNJLNHLDKMG
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return DelMailReqOuterClass.DelMailReq.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof DelMailReqOuterClass.DelMailReq)) {
        return super.equals(obj);
      }
      DelMailReqOuterClass.DelMailReq other = (DelMailReqOuterClass.DelMailReq) obj;
    ...
    public static DelMailReqOuterClass.DelMailReq parseFrom(
    ...
    public static DelMailReqOuterClass.DelMailReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static DelMailReqOuterClass.DelMailReq parseFrom(
    ...
    public static DelMailReqOuterClass.DelMailReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static DelMailReqOuterClass.DelMailReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static DelMailReqOuterClass.DelMailReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(DelMailReqOuterClass.DelMailReq prototype) {
    ...
    public static final class Builder extends
        ...
        DelMailReqOuterClass.DelMailReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return DelMailReqOuterClass.internal_static_DelMailReq_descriptor;
      }
      ...
      // Construct using DelMailReqOuterClass.DelMailReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public DelMailReqOuterClass.DelMailReq getDefaultInstanceForType() {
        return DelMailReqOuterClass.DelMailReq.getDefaultInstance();
      }

      @java.lang.Override
      public DelMailReqOuterClass.DelMailReq build() {
        DelMailReqOuterClass.DelMailReq result = buildPartial();
      ...
      @java.lang.Override
      public DelMailReqOuterClass.DelMailReq buildPartial() {
        DelMailReqOuterClass.DelMailReq result = new DelMailReqOuterClass.DelMailReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof DelMailReqOuterClass.DelMailReq) {
          return mergeFrom((DelMailReqOuterClass.DelMailReq)other);
        } else {
      ...
      public Builder mergeFrom(DelMailReqOuterClass.DelMailReq other) {
        if (other == DelMailReqOuterClass.DelMailReq.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        DelMailReqOuterClass.DelMailReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (DelMailReqOuterClass.DelMailReq) e.getUnfinishedMessage();
    ...
    private static final DelMailReqOuterClass.DelMailReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new DelMailReqOuterClass.DelMailReq();
    }

    public static DelMailReqOuterClass.DelMailReq getDefaultInstance() {
