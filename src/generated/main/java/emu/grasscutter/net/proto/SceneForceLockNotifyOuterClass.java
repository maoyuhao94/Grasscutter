...
public final class SceneForceLockNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return SceneForceLockNotifyOuterClass.internal_static_SceneForceLockNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              SceneForceLockNotifyOuterClass.SceneForceLockNotify.class, SceneForceLockNotifyOuterClass.SceneForceLockNotify.Builder.class);
    }
    ...
    public enum KFGBLLFKPFJ
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return SceneForceLockNotifyOuterClass.SceneForceLockNotify.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof SceneForceLockNotifyOuterClass.SceneForceLockNotify)) {
        return super.equals(obj);
      }
      SceneForceLockNotifyOuterClass.SceneForceLockNotify other = (SceneForceLockNotifyOuterClass.SceneForceLockNotify) obj;
    ...
    public static SceneForceLockNotifyOuterClass.SceneForceLockNotify parseFrom(
    ...
    public static SceneForceLockNotifyOuterClass.SceneForceLockNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static SceneForceLockNotifyOuterClass.SceneForceLockNotify parseFrom(
    ...
    public static SceneForceLockNotifyOuterClass.SceneForceLockNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static SceneForceLockNotifyOuterClass.SceneForceLockNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static SceneForceLockNotifyOuterClass.SceneForceLockNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(SceneForceLockNotifyOuterClass.SceneForceLockNotify prototype) {
    ...
    public static final class Builder extends
        ...
        SceneForceLockNotifyOuterClass.SceneForceLockNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return SceneForceLockNotifyOuterClass.internal_static_SceneForceLockNotify_descriptor;
      }
      ...
      // Construct using SceneForceLockNotifyOuterClass.SceneForceLockNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public SceneForceLockNotifyOuterClass.SceneForceLockNotify getDefaultInstanceForType() {
        return SceneForceLockNotifyOuterClass.SceneForceLockNotify.getDefaultInstance();
      }

      @java.lang.Override
      public SceneForceLockNotifyOuterClass.SceneForceLockNotify build() {
        SceneForceLockNotifyOuterClass.SceneForceLockNotify result = buildPartial();
      ...
      @java.lang.Override
      public SceneForceLockNotifyOuterClass.SceneForceLockNotify buildPartial() {
        SceneForceLockNotifyOuterClass.SceneForceLockNotify result = new SceneForceLockNotifyOuterClass.SceneForceLockNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof SceneForceLockNotifyOuterClass.SceneForceLockNotify) {
          return mergeFrom((SceneForceLockNotifyOuterClass.SceneForceLockNotify)other);
        } else {
      ...
      public Builder mergeFrom(SceneForceLockNotifyOuterClass.SceneForceLockNotify other) {
        if (other == SceneForceLockNotifyOuterClass.SceneForceLockNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        SceneForceLockNotifyOuterClass.SceneForceLockNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (SceneForceLockNotifyOuterClass.SceneForceLockNotify) e.getUnfinishedMessage();
    ...
    private static final SceneForceLockNotifyOuterClass.SceneForceLockNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new SceneForceLockNotifyOuterClass.SceneForceLockNotify();
    }

    public static SceneForceLockNotifyOuterClass.SceneForceLockNotify getDefaultInstance() {
