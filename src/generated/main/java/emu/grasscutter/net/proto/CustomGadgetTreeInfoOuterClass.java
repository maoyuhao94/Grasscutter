...
public final class CustomGadgetTreeInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                nodeList_ = new java.util.ArrayList<CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo>();
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return CustomGadgetTreeInfoOuterClass.internal_static_CustomGadgetTreeInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo.class, CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo)) {
        return super.equals(obj);
      }
      CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo other = (CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo) obj;
    ...
    public static CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo parseFrom(
    ...
    public static CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo parseFrom(
    ...
    public static CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo prototype) {
    ...
    public static final class Builder extends
        ...
        CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return CustomGadgetTreeInfoOuterClass.internal_static_CustomGadgetTreeInfo_descriptor;
      }
      ...
      // Construct using CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo getDefaultInstanceForType() {
        return CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo.getDefaultInstance();
      }

      @java.lang.Override
      public CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo build() {
        CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo result = buildPartial();
      ...
      @java.lang.Override
      public CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo buildPartial() {
        CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo result = new CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo) {
          return mergeFrom((CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo)other);
        } else {
      ...
      public Builder mergeFrom(CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo other) {
        if (other == CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo.getDefaultInstance()) return this;
        if (nodeListBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo) e.getUnfinishedMessage();
    ...
    private static final CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo();
    }

    public static CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo getDefaultInstance() {
