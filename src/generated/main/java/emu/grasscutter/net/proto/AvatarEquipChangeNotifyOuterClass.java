...
public final class AvatarEquipChangeNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 106: {
              SceneReliquaryInfoOuterClass.SceneReliquaryInfo.Builder subBuilder = null;
              if (reliquary_ != null) {
                subBuilder = reliquary_.toBuilder();
              }
              reliquary_ = input.readMessage(SceneReliquaryInfoOuterClass.SceneReliquaryInfo.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return AvatarEquipChangeNotifyOuterClass.internal_static_AvatarEquipChangeNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify.class, AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify.Builder.class);
    }
    ...
    public enum KBOAEKOMBGL
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public SceneReliquaryInfoOuterClass.SceneReliquaryInfo getReliquary() {
      return reliquary_ == null ? SceneReliquaryInfoOuterClass.SceneReliquaryInfo.getDefaultInstance() : reliquary_;
    }
    /**
     * <code>.SceneReliquaryInfo reliquary = 13;</code>
     */
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify)) {
        return super.equals(obj);
      }
      AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify other = (AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify) obj;
    ...
    public static AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify parseFrom(
    ...
    public static AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify parseFrom(
    ...
    public static AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify prototype) {
    ...
    public static final class Builder extends
        ...
        AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return AvatarEquipChangeNotifyOuterClass.internal_static_AvatarEquipChangeNotify_descriptor;
      }
      ...
      // Construct using AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify getDefaultInstanceForType() {
        return AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify.getDefaultInstance();
      }

      @java.lang.Override
      public AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify build() {
        AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify result = buildPartial();
      ...
      @java.lang.Override
      public AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify buildPartial() {
        AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify result = new AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify) {
          return mergeFrom((AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify)other);
        } else {
      ...
      public Builder mergeFrom(AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify other) {
        if (other == AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify) e.getUnfinishedMessage();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          SceneReliquaryInfoOuterClass.SceneReliquaryInfo, SceneReliquaryInfoOuterClass.SceneReliquaryInfo.Builder, SceneReliquaryInfoOuterClass.SceneReliquaryInfoOrBuilder> reliquaryBuilder_;
      /**
       * <code>.SceneReliquaryInfo reliquary = 13;</code>
       * @return Whether the reliquary field is set.
       */
      ...
      public Builder mergeReliquary(SceneReliquaryInfoOuterClass.SceneReliquaryInfo value) {
        if (reliquaryBuilder_ == null) {
          if (reliquary_ != null) {
            reliquary_ =
              SceneReliquaryInfoOuterClass.SceneReliquaryInfo.newBuilder(reliquary_).mergeFrom(value).buildPartial();
          } else {
            reliquary_ = value;
          }
          onChanged();
      ...
      public SceneReliquaryInfoOuterClass.SceneReliquaryInfoOrBuilder getReliquaryOrBuilder() {
        if (reliquaryBuilder_ != null) {
          ...
          return reliquary_ == null ?
              SceneReliquaryInfoOuterClass.SceneReliquaryInfo.getDefaultInstance() : reliquary_;
        }
      }
      /**
       * <code>.SceneReliquaryInfo reliquary = 13;</code>
    ...
    private static final AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify();
    }

    public static AvatarEquipChangeNotifyOuterClass.AvatarEquipChangeNotify getDefaultInstance() {
