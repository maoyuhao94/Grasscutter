...
public final class HomeModuleComfortInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return HomeModuleComfortInfoOuterClass.internal_static_HomeModuleComfortInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo.class, HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo)) {
        return super.equals(obj);
      }
      HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo other = (HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo) obj;
    ...
    public static HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo parseFrom(
    ...
    public static HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo parseFrom(
    ...
    public static HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo prototype) {
    ...
    public static final class Builder extends
        ...
        HomeModuleComfortInfoOuterClass.HomeModuleComfortInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return HomeModuleComfortInfoOuterClass.internal_static_HomeModuleComfortInfo_descriptor;
      }
      ...
      // Construct using HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo getDefaultInstanceForType() {
        return HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo.getDefaultInstance();
      }

      @java.lang.Override
      public HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo build() {
        HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo result = buildPartial();
      ...
      @java.lang.Override
      public HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo buildPartial() {
        HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo result = new HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo) {
          return mergeFrom((HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo)other);
        } else {
      ...
      public Builder mergeFrom(HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo other) {
        if (other == HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo) e.getUnfinishedMessage();
    ...
    private static final HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo();
    }

    public static HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "mSceneComfortValue\030\002 \001(\rb\006proto3"
    };
