...
public final class SpiceInfoOuterClass {
  ...
  public interface SpiceInfoOrBuilder extends
     ...
     */
    java.util.List<SpiceStageDataOuterClass.SpiceStageData> 
        getSpiceStageDataListList();
    /**
     * <code>repeated .SpiceStageData spiceStageDataList = 11;</code>
     */
    SpiceStageDataOuterClass.SpiceStageData getSpiceStageDataList(int index);
    /**
     * <code>repeated .SpiceStageData spiceStageDataList = 11;</code>
     */
     ...
     * <code>repeated .SpiceStageData spiceStageDataList = 11;</code>
     */
    java.util.List<? extends SpiceStageDataOuterClass.SpiceStageDataOrBuilder> 
        getSpiceStageDataListOrBuilderList();
    /**
     * <code>repeated .SpiceStageData spiceStageDataList = 11;</code>
     */
    SpiceStageDataOuterClass.SpiceStageDataOrBuilder getSpiceStageDataListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 90: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                spiceStageDataList_ = new java.util.ArrayList<SpiceStageDataOuterClass.SpiceStageData>();
                mutable_bitField0_ |= 0x00000001;
              }
              spiceStageDataList_.add(
                  input.readMessage(SpiceStageDataOuterClass.SpiceStageData.parser(), extensionRegistry));
              break;
            }
            case 112: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return SpiceInfoOuterClass.internal_static_SpiceInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              SpiceInfoOuterClass.SpiceInfo.class, SpiceInfoOuterClass.SpiceInfo.Builder.class);
    }
    ...
    private java.util.List<SpiceStageDataOuterClass.SpiceStageData> spiceStageDataList_;
    /**
     * <code>repeated .SpiceStageData spiceStageDataList = 11;</code>
     */
    @java.lang.Override
    public java.util.List<SpiceStageDataOuterClass.SpiceStageData> getSpiceStageDataListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends SpiceStageDataOuterClass.SpiceStageDataOrBuilder> 
        getSpiceStageDataListOrBuilderList() {
      return spiceStageDataList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public SpiceStageDataOuterClass.SpiceStageDataOrBuilder getSpiceStageDataListOrBuilder(
        int index) {
      return spiceStageDataList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof SpiceInfoOuterClass.SpiceInfo)) {
        return super.equals(obj);
      }
      SpiceInfoOuterClass.SpiceInfo other = (SpiceInfoOuterClass.SpiceInfo) obj;
    ...
    public static SpiceInfoOuterClass.SpiceInfo parseFrom(
    ...
    public static SpiceInfoOuterClass.SpiceInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static SpiceInfoOuterClass.SpiceInfo parseFrom(
    ...
    public static SpiceInfoOuterClass.SpiceInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static SpiceInfoOuterClass.SpiceInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static SpiceInfoOuterClass.SpiceInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(SpiceInfoOuterClass.SpiceInfo prototype) {
    ...
    public static final class Builder extends
        ...
        SpiceInfoOuterClass.SpiceInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return SpiceInfoOuterClass.internal_static_SpiceInfo_descriptor;
      }
      ...
      // Construct using SpiceInfoOuterClass.SpiceInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public SpiceInfoOuterClass.SpiceInfo getDefaultInstanceForType() {
        return SpiceInfoOuterClass.SpiceInfo.getDefaultInstance();
      }

      @java.lang.Override
      public SpiceInfoOuterClass.SpiceInfo build() {
        SpiceInfoOuterClass.SpiceInfo result = buildPartial();
      ...
      @java.lang.Override
      public SpiceInfoOuterClass.SpiceInfo buildPartial() {
        SpiceInfoOuterClass.SpiceInfo result = new SpiceInfoOuterClass.SpiceInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof SpiceInfoOuterClass.SpiceInfo) {
          return mergeFrom((SpiceInfoOuterClass.SpiceInfo)other);
        } else {
      ...
      public Builder mergeFrom(SpiceInfoOuterClass.SpiceInfo other) {
        if (other == SpiceInfoOuterClass.SpiceInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        SpiceInfoOuterClass.SpiceInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (SpiceInfoOuterClass.SpiceInfo) e.getUnfinishedMessage();
      ...
      private void ensureSpiceStageDataListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          spiceStageDataList_ = new java.util.ArrayList<SpiceStageDataOuterClass.SpiceStageData>(spiceStageDataList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          SpiceStageDataOuterClass.SpiceStageData, SpiceStageDataOuterClass.SpiceStageData.Builder, SpiceStageDataOuterClass.SpiceStageDataOrBuilder> spiceStageDataListBuilder_;
      ...
      public Builder setSpiceStageDataList(
          int index, SpiceStageDataOuterClass.SpiceStageData value) {
        if (spiceStageDataListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setSpiceStageDataList(
          int index, SpiceStageDataOuterClass.SpiceStageData.Builder builderForValue) {
        if (spiceStageDataListBuilder_ == null) {
          ensureSpiceStageDataListIsMutable();
       ...
       */
      public Builder addSpiceStageDataList(
          SpiceStageDataOuterClass.SpiceStageData.Builder builderForValue) {
        if (spiceStageDataListBuilder_ == null) {
          ensureSpiceStageDataListIsMutable();
      ...
      public Builder addAllSpiceStageDataList(
          java.lang.Iterable<? extends SpiceStageDataOuterClass.SpiceStageData> values) {
        if (spiceStageDataListBuilder_ == null) {
          ensureSpiceStageDataListIsMutable();
       ...
       * <code>repeated .SpiceStageData spiceStageDataList = 11;</code>
       */
      public SpiceStageDataOuterClass.SpiceStageData.Builder getSpiceStageDataListBuilder(
          int index) {
      ...
      public SpiceStageDataOuterClass.SpiceStageData.Builder addSpiceStageDataListBuilder() {
        return getSpiceStageDataListFieldBuilder().addBuilder(
            SpiceStageDataOuterClass.SpiceStageData.getDefaultInstance());
      }
      /**
       * <code>repeated .SpiceStageData spiceStageDataList = 11;</code>
       */
      public SpiceStageDataOuterClass.SpiceStageData.Builder addSpiceStageDataListBuilder(
          int index) {
        return getSpiceStageDataListFieldBuilder().addBuilder(
            index, SpiceStageDataOuterClass.SpiceStageData.getDefaultInstance());
      }
      /**
       * <code>repeated .SpiceStageData spiceStageDataList = 11;</code>
       */
      public java.util.List<SpiceStageDataOuterClass.SpiceStageData.Builder> 
           getSpiceStageDataListBuilderList() {
        return getSpiceStageDataListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          SpiceStageDataOuterClass.SpiceStageData, SpiceStageDataOuterClass.SpiceStageData.Builder, SpiceStageDataOuterClass.SpiceStageDataOrBuilder> 
          getSpiceStageDataListFieldBuilder() {
        if (spiceStageDataListBuilder_ == null) {
    ...
    private static final SpiceInfoOuterClass.SpiceInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new SpiceInfoOuterClass.SpiceInfo();
    }

    public static SpiceInfoOuterClass.SpiceInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "geData\022\033\n\023Unk3300_LAKPMMIPBMI\030\016 \001(\rb\006pro" +
      "to3"
    };
