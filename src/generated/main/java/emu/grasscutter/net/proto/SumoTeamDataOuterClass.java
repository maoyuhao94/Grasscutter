...
public final class SumoTeamDataOuterClass {
  ...
  public interface SumoTeamDataOrBuilder extends
    ...
    /**
     * <code>repeated .SumoAvatarInfo avatarInfoList = 10;</code>
     */
    java.util.List<SumoAvatarInfoOuterClass.SumoAvatarInfo> 
        getAvatarInfoListList();
    /**
     * <code>repeated .SumoAvatarInfo avatarInfoList = 10;</code>
     */
    SumoAvatarInfoOuterClass.SumoAvatarInfo getAvatarInfoList(int index);
    /**
     * <code>repeated .SumoAvatarInfo avatarInfoList = 10;</code>
     */
     ...
     * <code>repeated .SumoAvatarInfo avatarInfoList = 10;</code>
     */
    java.util.List<? extends SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder> 
        getAvatarInfoListOrBuilderList();
    /**
     * <code>repeated .SumoAvatarInfo avatarInfoList = 10;</code>
     */
    SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder getAvatarInfoListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 82: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                avatarInfoList_ = new java.util.ArrayList<SumoAvatarInfoOuterClass.SumoAvatarInfo>();
                mutable_bitField0_ |= 0x00000001;
              }
              avatarInfoList_.add(
                  input.readMessage(SumoAvatarInfoOuterClass.SumoAvatarInfo.parser(), extensionRegistry));
              break;
            }
            default: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return SumoTeamDataOuterClass.internal_static_SumoTeamData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              SumoTeamDataOuterClass.SumoTeamData.class, SumoTeamDataOuterClass.SumoTeamData.Builder.class);
    }

    public static final int AVATARINFOLIST_FIELD_NUMBER = 10;
    private java.util.List<SumoAvatarInfoOuterClass.SumoAvatarInfo> avatarInfoList_;
    /**
     * <code>repeated .SumoAvatarInfo avatarInfoList = 10;</code>
     */
    @java.lang.Override
    public java.util.List<SumoAvatarInfoOuterClass.SumoAvatarInfo> getAvatarInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder> 
        getAvatarInfoListOrBuilderList() {
      return avatarInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder getAvatarInfoListOrBuilder(
        int index) {
      return avatarInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof SumoTeamDataOuterClass.SumoTeamData)) {
        return super.equals(obj);
      }
      SumoTeamDataOuterClass.SumoTeamData other = (SumoTeamDataOuterClass.SumoTeamData) obj;
    ...
    public static SumoTeamDataOuterClass.SumoTeamData parseFrom(
    ...
    public static SumoTeamDataOuterClass.SumoTeamData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static SumoTeamDataOuterClass.SumoTeamData parseFrom(
    ...
    public static SumoTeamDataOuterClass.SumoTeamData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static SumoTeamDataOuterClass.SumoTeamData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static SumoTeamDataOuterClass.SumoTeamData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(SumoTeamDataOuterClass.SumoTeamData prototype) {
    ...
    public static final class Builder extends
        ...
        SumoTeamDataOuterClass.SumoTeamDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return SumoTeamDataOuterClass.internal_static_SumoTeamData_descriptor;
      }
      ...
      // Construct using SumoTeamDataOuterClass.SumoTeamData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public SumoTeamDataOuterClass.SumoTeamData getDefaultInstanceForType() {
        return SumoTeamDataOuterClass.SumoTeamData.getDefaultInstance();
      }

      @java.lang.Override
      public SumoTeamDataOuterClass.SumoTeamData build() {
        SumoTeamDataOuterClass.SumoTeamData result = buildPartial();
      ...
      @java.lang.Override
      public SumoTeamDataOuterClass.SumoTeamData buildPartial() {
        SumoTeamDataOuterClass.SumoTeamData result = new SumoTeamDataOuterClass.SumoTeamData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof SumoTeamDataOuterClass.SumoTeamData) {
          return mergeFrom((SumoTeamDataOuterClass.SumoTeamData)other);
        } else {
      ...
      public Builder mergeFrom(SumoTeamDataOuterClass.SumoTeamData other) {
        if (other == SumoTeamDataOuterClass.SumoTeamData.getDefaultInstance()) return this;
        if (avatarInfoListBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        SumoTeamDataOuterClass.SumoTeamData parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (SumoTeamDataOuterClass.SumoTeamData) e.getUnfinishedMessage();
      ...
      private void ensureAvatarInfoListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          avatarInfoList_ = new java.util.ArrayList<SumoAvatarInfoOuterClass.SumoAvatarInfo>(avatarInfoList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          SumoAvatarInfoOuterClass.SumoAvatarInfo, SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder, SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder> avatarInfoListBuilder_;
      ...
      public Builder setAvatarInfoList(
          int index, SumoAvatarInfoOuterClass.SumoAvatarInfo value) {
        if (avatarInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setAvatarInfoList(
          int index, SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder builderForValue) {
        if (avatarInfoListBuilder_ == null) {
          ensureAvatarInfoListIsMutable();
       ...
       */
      public Builder addAvatarInfoList(
          SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder builderForValue) {
        if (avatarInfoListBuilder_ == null) {
          ensureAvatarInfoListIsMutable();
      ...
      public Builder addAllAvatarInfoList(
          java.lang.Iterable<? extends SumoAvatarInfoOuterClass.SumoAvatarInfo> values) {
        if (avatarInfoListBuilder_ == null) {
          ensureAvatarInfoListIsMutable();
       ...
       * <code>repeated .SumoAvatarInfo avatarInfoList = 10;</code>
       */
      public SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder getAvatarInfoListBuilder(
          int index) {
      ...
      public SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder addAvatarInfoListBuilder() {
        return getAvatarInfoListFieldBuilder().addBuilder(
            SumoAvatarInfoOuterClass.SumoAvatarInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SumoAvatarInfo avatarInfoList = 10;</code>
       */
      public SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder addAvatarInfoListBuilder(
          int index) {
        return getAvatarInfoListFieldBuilder().addBuilder(
            index, SumoAvatarInfoOuterClass.SumoAvatarInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SumoAvatarInfo avatarInfoList = 10;</code>
       */
      public java.util.List<SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder> 
           getAvatarInfoListBuilderList() {
        return getAvatarInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          SumoAvatarInfoOuterClass.SumoAvatarInfo, SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder, SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder> 
          getAvatarInfoListFieldBuilder() {
        if (avatarInfoListBuilder_ == null) {
    ...
    private static final SumoTeamDataOuterClass.SumoTeamData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new SumoTeamDataOuterClass.SumoTeamData();
    }

    public static SumoTeamDataOuterClass.SumoTeamData getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "to\"L\n\014SumoTeamData\022\'\n\016avatarInfoList\030\n \003" +
      "(\0132\017.SumoAvatarInfo\022\023\n\013skillIdList\030\010 \003(\r" +
      "b\006proto3"
    };
