  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return GadgetInteractReqOuterClass.internal_static_GadgetInteractReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              GadgetInteractReqOuterClass.GadgetInteractReq.class, GadgetInteractReqOuterClass.GadgetInteractReq.Builder.class);
    }
    ...
    public enum HNAHFIOGDFG
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return GadgetInteractReqOuterClass.GadgetInteractReq.getDescriptor().getEnumTypes().get(0);
      }
     ...
     * @return The resinCostType.
     */
    @java.lang.Override public ResinCostTypeOuterClass.ResinCostType getResinCostType() {
      @SuppressWarnings("deprecation")
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof GadgetInteractReqOuterClass.GadgetInteractReq)) {
        return super.equals(obj);
      }
      GadgetInteractReqOuterClass.GadgetInteractReq other = (GadgetInteractReqOuterClass.GadgetInteractReq) obj;
    ...
    public static GadgetInteractReqOuterClass.GadgetInteractReq parseFrom(
    ...
    public static GadgetInteractReqOuterClass.GadgetInteractReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static GadgetInteractReqOuterClass.GadgetInteractReq parseFrom(
    ...
    public static GadgetInteractReqOuterClass.GadgetInteractReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static GadgetInteractReqOuterClass.GadgetInteractReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static GadgetInteractReqOuterClass.GadgetInteractReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(GadgetInteractReqOuterClass.GadgetInteractReq prototype) {
    ...
    public static final class Builder extends
        ...
        GadgetInteractReqOuterClass.GadgetInteractReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return GadgetInteractReqOuterClass.internal_static_GadgetInteractReq_descriptor;
      }
      ...
      // Construct using GadgetInteractReqOuterClass.GadgetInteractReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public GadgetInteractReqOuterClass.GadgetInteractReq getDefaultInstanceForType() {
        return GadgetInteractReqOuterClass.GadgetInteractReq.getDefaultInstance();
      }

      @java.lang.Override
      public GadgetInteractReqOuterClass.GadgetInteractReq build() {
        GadgetInteractReqOuterClass.GadgetInteractReq result = buildPartial();
      ...
      @java.lang.Override
      public GadgetInteractReqOuterClass.GadgetInteractReq buildPartial() {
        GadgetInteractReqOuterClass.GadgetInteractReq result = new GadgetInteractReqOuterClass.GadgetInteractReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof GadgetInteractReqOuterClass.GadgetInteractReq) {
          return mergeFrom((GadgetInteractReqOuterClass.GadgetInteractReq)other);
        } else {
      ...
      public Builder mergeFrom(GadgetInteractReqOuterClass.GadgetInteractReq other) {
        if (other == GadgetInteractReqOuterClass.GadgetInteractReq.getDefaultInstance()) return this;
        if (other.opType_ != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        GadgetInteractReqOuterClass.GadgetInteractReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (GadgetInteractReqOuterClass.GadgetInteractReq) e.getUnfinishedMessage();
    ...
    private static final GadgetInteractReqOuterClass.GadgetInteractReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new GadgetInteractReqOuterClass.GadgetInteractReq();
    }

    public static GadgetInteractReqOuterClass.GadgetInteractReq getDefaultInstance() {
