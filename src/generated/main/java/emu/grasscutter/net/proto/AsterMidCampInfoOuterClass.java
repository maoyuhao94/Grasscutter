...
public final class AsterMidCampInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return AsterMidCampInfoOuterClass.internal_static_AsterMidCampInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              AsterMidCampInfoOuterClass.AsterMidCampInfo.class, AsterMidCampInfoOuterClass.AsterMidCampInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof AsterMidCampInfoOuterClass.AsterMidCampInfo)) {
        return super.equals(obj);
      }
      AsterMidCampInfoOuterClass.AsterMidCampInfo other = (AsterMidCampInfoOuterClass.AsterMidCampInfo) obj;
    ...
    public static AsterMidCampInfoOuterClass.AsterMidCampInfo parseFrom(
    ...
    public static AsterMidCampInfoOuterClass.AsterMidCampInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static AsterMidCampInfoOuterClass.AsterMidCampInfo parseFrom(
    ...
    public static AsterMidCampInfoOuterClass.AsterMidCampInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static AsterMidCampInfoOuterClass.AsterMidCampInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static AsterMidCampInfoOuterClass.AsterMidCampInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(AsterMidCampInfoOuterClass.AsterMidCampInfo prototype) {
    ...
    public static final class Builder extends
        ...
        AsterMidCampInfoOuterClass.AsterMidCampInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return AsterMidCampInfoOuterClass.internal_static_AsterMidCampInfo_descriptor;
      }
      ...
      // Construct using AsterMidCampInfoOuterClass.AsterMidCampInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public AsterMidCampInfoOuterClass.AsterMidCampInfo getDefaultInstanceForType() {
        return AsterMidCampInfoOuterClass.AsterMidCampInfo.getDefaultInstance();
      }

      @java.lang.Override
      public AsterMidCampInfoOuterClass.AsterMidCampInfo build() {
        AsterMidCampInfoOuterClass.AsterMidCampInfo result = buildPartial();
      ...
      @java.lang.Override
      public AsterMidCampInfoOuterClass.AsterMidCampInfo buildPartial() {
        AsterMidCampInfoOuterClass.AsterMidCampInfo result = new AsterMidCampInfoOuterClass.AsterMidCampInfo(this);
        if (posBuilder_ == null) {
          result.pos_ = pos_;
        } else {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof AsterMidCampInfoOuterClass.AsterMidCampInfo) {
          return mergeFrom((AsterMidCampInfoOuterClass.AsterMidCampInfo)other);
        } else {
      ...
      public Builder mergeFrom(AsterMidCampInfoOuterClass.AsterMidCampInfo other) {
        if (other == AsterMidCampInfoOuterClass.AsterMidCampInfo.getDefaultInstance()) return this;
        if (other.hasPos()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        AsterMidCampInfoOuterClass.AsterMidCampInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (AsterMidCampInfoOuterClass.AsterMidCampInfo) e.getUnfinishedMessage();
    ...
    private static final AsterMidCampInfoOuterClass.AsterMidCampInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new AsterMidCampInfoOuterClass.AsterMidCampInfo();
    }

    public static AsterMidCampInfoOuterClass.AsterMidCampInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\026AsterMidCampInfo.proto\032\016Rotation.proto" +
      "\":\n\020AsterMidCampInfo\022\026\n\003pos\030\n \001(\0132\t.Rota" +
      "tion\022\016\n\006campId\030\016 \001(\rb\006proto3"
    };
