...
public final class QuestUpdateQuestVarReqOuterClass {
  ...
  public interface QuestUpdateQuestVarReqOrBuilder extends
     ...
     */
    java.util.List<QuestVarOpOuterClass.QuestVarOp> 
        getQuestVarOpListList();
    /**
     * <code>repeated .QuestVarOp questVarOpList = 4;</code>
     */
    QuestVarOpOuterClass.QuestVarOp getQuestVarOpList(int index);
    /**
     * <code>repeated .QuestVarOp questVarOpList = 4;</code>
     */
     ...
     * <code>repeated .QuestVarOp questVarOpList = 4;</code>
     */
    java.util.List<? extends QuestVarOpOuterClass.QuestVarOpOrBuilder> 
        getQuestVarOpListOrBuilderList();
    /**
     * <code>repeated .QuestVarOp questVarOpList = 4;</code>
     */
    QuestVarOpOuterClass.QuestVarOpOrBuilder getQuestVarOpListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 34: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                questVarOpList_ = new java.util.ArrayList<QuestVarOpOuterClass.QuestVarOp>();
                mutable_bitField0_ |= 0x00000001;
              }
              questVarOpList_.add(
                  input.readMessage(QuestVarOpOuterClass.QuestVarOp.parser(), extensionRegistry));
              break;
            }
            case 72: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return QuestUpdateQuestVarReqOuterClass.internal_static_QuestUpdateQuestVarReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq.class, QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq.Builder.class);
    }
    ...
    public enum OAKICGPFBIK
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq.getDescriptor().getEnumTypes().get(0);
      }
    ...
    private java.util.List<QuestVarOpOuterClass.QuestVarOp> questVarOpList_;
    /**
     * <code>repeated .QuestVarOp questVarOpList = 4;</code>
     */
    @java.lang.Override
    public java.util.List<QuestVarOpOuterClass.QuestVarOp> getQuestVarOpListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends QuestVarOpOuterClass.QuestVarOpOrBuilder> 
        getQuestVarOpListOrBuilderList() {
      return questVarOpList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public QuestVarOpOuterClass.QuestVarOpOrBuilder getQuestVarOpListOrBuilder(
        int index) {
      return questVarOpList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq)) {
        return super.equals(obj);
      }
      QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq other = (QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq) obj;
    ...
    public static QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq parseFrom(
    ...
    public static QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq parseFrom(
    ...
    public static QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq prototype) {
    ...
    public static final class Builder extends
        ...
        QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return QuestUpdateQuestVarReqOuterClass.internal_static_QuestUpdateQuestVarReq_descriptor;
      }
      ...
      // Construct using QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq getDefaultInstanceForType() {
        return QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq.getDefaultInstance();
      }

      @java.lang.Override
      public QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq build() {
        QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq result = buildPartial();
      ...
      @java.lang.Override
      public QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq buildPartial() {
        QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq result = new QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq) {
          return mergeFrom((QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq)other);
        } else {
      ...
      public Builder mergeFrom(QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq other) {
        if (other == QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq) e.getUnfinishedMessage();
      ...
      private void ensureQuestVarOpListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          questVarOpList_ = new java.util.ArrayList<QuestVarOpOuterClass.QuestVarOp>(questVarOpList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          QuestVarOpOuterClass.QuestVarOp, QuestVarOpOuterClass.QuestVarOp.Builder, QuestVarOpOuterClass.QuestVarOpOrBuilder> questVarOpListBuilder_;
      ...
      public Builder setQuestVarOpList(
          int index, QuestVarOpOuterClass.QuestVarOp value) {
        if (questVarOpListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setQuestVarOpList(
          int index, QuestVarOpOuterClass.QuestVarOp.Builder builderForValue) {
        if (questVarOpListBuilder_ == null) {
          ensureQuestVarOpListIsMutable();
       ...
       */
      public Builder addQuestVarOpList(
          QuestVarOpOuterClass.QuestVarOp.Builder builderForValue) {
        if (questVarOpListBuilder_ == null) {
          ensureQuestVarOpListIsMutable();
      ...
      public Builder addAllQuestVarOpList(
          java.lang.Iterable<? extends QuestVarOpOuterClass.QuestVarOp> values) {
        if (questVarOpListBuilder_ == null) {
          ensureQuestVarOpListIsMutable();
       ...
       * <code>repeated .QuestVarOp questVarOpList = 4;</code>
       */
      public QuestVarOpOuterClass.QuestVarOp.Builder getQuestVarOpListBuilder(
          int index) {
      ...
      public QuestVarOpOuterClass.QuestVarOp.Builder addQuestVarOpListBuilder() {
        return getQuestVarOpListFieldBuilder().addBuilder(
            QuestVarOpOuterClass.QuestVarOp.getDefaultInstance());
      }
      /**
       * <code>repeated .QuestVarOp questVarOpList = 4;</code>
       */
      public QuestVarOpOuterClass.QuestVarOp.Builder addQuestVarOpListBuilder(
          int index) {
        return getQuestVarOpListFieldBuilder().addBuilder(
            index, QuestVarOpOuterClass.QuestVarOp.getDefaultInstance());
      }
      /**
       * <code>repeated .QuestVarOp questVarOpList = 4;</code>
       */
      public java.util.List<QuestVarOpOuterClass.QuestVarOp.Builder> 
           getQuestVarOpListBuilderList() {
        return getQuestVarOpListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          QuestVarOpOuterClass.QuestVarOp, QuestVarOpOuterClass.QuestVarOp.Builder, QuestVarOpOuterClass.QuestVarOpOrBuilder> 
          getQuestVarOpListFieldBuilder() {
        if (questVarOpListBuilder_ == null) {
    ...
    private static final QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq();
    }

    public static QuestUpdateQuestVarReqOuterClass.QuestUpdateQuestVarReq getDefaultInstance() {
