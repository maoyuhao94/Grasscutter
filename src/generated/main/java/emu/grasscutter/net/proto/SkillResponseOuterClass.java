...
public final class SkillResponseOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return SkillResponseOuterClass.internal_static_SkillResponse_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return SkillResponseOuterClass.internal_static_SkillResponse_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              SkillResponseOuterClass.SkillResponse.class, SkillResponseOuterClass.SkillResponse.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof SkillResponseOuterClass.SkillResponse)) {
        return super.equals(obj);
      }
      SkillResponseOuterClass.SkillResponse other = (SkillResponseOuterClass.SkillResponse) obj;
    ...
    public static SkillResponseOuterClass.SkillResponse parseFrom(
    ...
    public static SkillResponseOuterClass.SkillResponse parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static SkillResponseOuterClass.SkillResponse parseFrom(
    ...
    public static SkillResponseOuterClass.SkillResponse parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static SkillResponseOuterClass.SkillResponse parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static SkillResponseOuterClass.SkillResponse parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(SkillResponseOuterClass.SkillResponse prototype) {
    ...
    public static final class Builder extends
        ...
        SkillResponseOuterClass.SkillResponseOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return SkillResponseOuterClass.internal_static_SkillResponse_descriptor;
      }
      ...
      // Construct using SkillResponseOuterClass.SkillResponse.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public SkillResponseOuterClass.SkillResponse getDefaultInstanceForType() {
        return SkillResponseOuterClass.SkillResponse.getDefaultInstance();
      }

      @java.lang.Override
      public SkillResponseOuterClass.SkillResponse build() {
        SkillResponseOuterClass.SkillResponse result = buildPartial();
      ...
      @java.lang.Override
      public SkillResponseOuterClass.SkillResponse buildPartial() {
        SkillResponseOuterClass.SkillResponse result = new SkillResponseOuterClass.SkillResponse(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof SkillResponseOuterClass.SkillResponse) {
          return mergeFrom((SkillResponseOuterClass.SkillResponse)other);
        } else {
      ...
      public Builder mergeFrom(SkillResponseOuterClass.SkillResponse other) {
        if (other == SkillResponseOuterClass.SkillResponse.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        SkillResponseOuterClass.SkillResponse parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (SkillResponseOuterClass.SkillResponse) e.getUnfinishedMessage();
    ...
    private static final SkillResponseOuterClass.SkillResponse DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new SkillResponseOuterClass.SkillResponse();
    }

    public static SkillResponseOuterClass.SkillResponse getDefaultInstance() {
