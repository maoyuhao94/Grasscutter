...
public final class TakeoffEquipRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return TakeoffEquipRspOuterClass.internal_static_TakeoffEquipRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              TakeoffEquipRspOuterClass.TakeoffEquipRsp.class, TakeoffEquipRspOuterClass.TakeoffEquipRsp.Builder.class);
    }
    ...
    public enum ALEJPJIDAFJ
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return TakeoffEquipRspOuterClass.TakeoffEquipRsp.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof TakeoffEquipRspOuterClass.TakeoffEquipRsp)) {
        return super.equals(obj);
      }
      TakeoffEquipRspOuterClass.TakeoffEquipRsp other = (TakeoffEquipRspOuterClass.TakeoffEquipRsp) obj;
    ...
    public static TakeoffEquipRspOuterClass.TakeoffEquipRsp parseFrom(
    ...
    public static TakeoffEquipRspOuterClass.TakeoffEquipRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static TakeoffEquipRspOuterClass.TakeoffEquipRsp parseFrom(
    ...
    public static TakeoffEquipRspOuterClass.TakeoffEquipRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static TakeoffEquipRspOuterClass.TakeoffEquipRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static TakeoffEquipRspOuterClass.TakeoffEquipRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(TakeoffEquipRspOuterClass.TakeoffEquipRsp prototype) {
    ...
    public static final class Builder extends
        ...
        TakeoffEquipRspOuterClass.TakeoffEquipRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return TakeoffEquipRspOuterClass.internal_static_TakeoffEquipRsp_descriptor;
      }
      ...
      // Construct using TakeoffEquipRspOuterClass.TakeoffEquipRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public TakeoffEquipRspOuterClass.TakeoffEquipRsp getDefaultInstanceForType() {
        return TakeoffEquipRspOuterClass.TakeoffEquipRsp.getDefaultInstance();
      }

      @java.lang.Override
      public TakeoffEquipRspOuterClass.TakeoffEquipRsp build() {
        TakeoffEquipRspOuterClass.TakeoffEquipRsp result = buildPartial();
      ...
      @java.lang.Override
      public TakeoffEquipRspOuterClass.TakeoffEquipRsp buildPartial() {
        TakeoffEquipRspOuterClass.TakeoffEquipRsp result = new TakeoffEquipRspOuterClass.TakeoffEquipRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof TakeoffEquipRspOuterClass.TakeoffEquipRsp) {
          return mergeFrom((TakeoffEquipRspOuterClass.TakeoffEquipRsp)other);
        } else {
      ...
      public Builder mergeFrom(TakeoffEquipRspOuterClass.TakeoffEquipRsp other) {
        if (other == TakeoffEquipRspOuterClass.TakeoffEquipRsp.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        TakeoffEquipRspOuterClass.TakeoffEquipRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (TakeoffEquipRspOuterClass.TakeoffEquipRsp) e.getUnfinishedMessage();
    ...
    private static final TakeoffEquipRspOuterClass.TakeoffEquipRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new TakeoffEquipRspOuterClass.TakeoffEquipRsp();
    }

    public static TakeoffEquipRspOuterClass.TakeoffEquipRsp getDefaultInstance() {
