...
public final class ActivityWatcherInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return ActivityWatcherInfoOuterClass.internal_static_ActivityWatcherInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ActivityWatcherInfoOuterClass.ActivityWatcherInfo.class, ActivityWatcherInfoOuterClass.ActivityWatcherInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof ActivityWatcherInfoOuterClass.ActivityWatcherInfo)) {
        return super.equals(obj);
      }
      ActivityWatcherInfoOuterClass.ActivityWatcherInfo other = (ActivityWatcherInfoOuterClass.ActivityWatcherInfo) obj;
    ...
    public static ActivityWatcherInfoOuterClass.ActivityWatcherInfo parseFrom(
    ...
    public static ActivityWatcherInfoOuterClass.ActivityWatcherInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ActivityWatcherInfoOuterClass.ActivityWatcherInfo parseFrom(
    ...
    public static ActivityWatcherInfoOuterClass.ActivityWatcherInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ActivityWatcherInfoOuterClass.ActivityWatcherInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static ActivityWatcherInfoOuterClass.ActivityWatcherInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(ActivityWatcherInfoOuterClass.ActivityWatcherInfo prototype) {
    ...
    public static final class Builder extends
        ...
        ActivityWatcherInfoOuterClass.ActivityWatcherInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ActivityWatcherInfoOuterClass.internal_static_ActivityWatcherInfo_descriptor;
      }
      ...
      // Construct using ActivityWatcherInfoOuterClass.ActivityWatcherInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public ActivityWatcherInfoOuterClass.ActivityWatcherInfo getDefaultInstanceForType() {
        return ActivityWatcherInfoOuterClass.ActivityWatcherInfo.getDefaultInstance();
      }

      @java.lang.Override
      public ActivityWatcherInfoOuterClass.ActivityWatcherInfo build() {
        ActivityWatcherInfoOuterClass.ActivityWatcherInfo result = buildPartial();
      ...
      @java.lang.Override
      public ActivityWatcherInfoOuterClass.ActivityWatcherInfo buildPartial() {
        ActivityWatcherInfoOuterClass.ActivityWatcherInfo result = new ActivityWatcherInfoOuterClass.ActivityWatcherInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ActivityWatcherInfoOuterClass.ActivityWatcherInfo) {
          return mergeFrom((ActivityWatcherInfoOuterClass.ActivityWatcherInfo)other);
        } else {
      ...
      public Builder mergeFrom(ActivityWatcherInfoOuterClass.ActivityWatcherInfo other) {
        if (other == ActivityWatcherInfoOuterClass.ActivityWatcherInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ActivityWatcherInfoOuterClass.ActivityWatcherInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ActivityWatcherInfoOuterClass.ActivityWatcherInfo) e.getUnfinishedMessage();
    ...
    private static final ActivityWatcherInfoOuterClass.ActivityWatcherInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ActivityWatcherInfoOuterClass.ActivityWatcherInfo();
    }

    public static ActivityWatcherInfoOuterClass.ActivityWatcherInfo getDefaultInstance() {
