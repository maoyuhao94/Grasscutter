...
public final class SetOpenStateReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return SetOpenStateReqOuterClass.internal_static_SetOpenStateReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              SetOpenStateReqOuterClass.SetOpenStateReq.class, SetOpenStateReqOuterClass.SetOpenStateReq.Builder.class);
    }
    ...
    public enum GLFJEJCADED
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return SetOpenStateReqOuterClass.SetOpenStateReq.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof SetOpenStateReqOuterClass.SetOpenStateReq)) {
        return super.equals(obj);
      }
      SetOpenStateReqOuterClass.SetOpenStateReq other = (SetOpenStateReqOuterClass.SetOpenStateReq) obj;
    ...
    public static SetOpenStateReqOuterClass.SetOpenStateReq parseFrom(
    ...
    public static SetOpenStateReqOuterClass.SetOpenStateReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static SetOpenStateReqOuterClass.SetOpenStateReq parseFrom(
    ...
    public static SetOpenStateReqOuterClass.SetOpenStateReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static SetOpenStateReqOuterClass.SetOpenStateReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static SetOpenStateReqOuterClass.SetOpenStateReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(SetOpenStateReqOuterClass.SetOpenStateReq prototype) {
    ...
    public static final class Builder extends
        ...
        SetOpenStateReqOuterClass.SetOpenStateReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return SetOpenStateReqOuterClass.internal_static_SetOpenStateReq_descriptor;
      }
      ...
      // Construct using SetOpenStateReqOuterClass.SetOpenStateReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public SetOpenStateReqOuterClass.SetOpenStateReq getDefaultInstanceForType() {
        return SetOpenStateReqOuterClass.SetOpenStateReq.getDefaultInstance();
      }

      @java.lang.Override
      public SetOpenStateReqOuterClass.SetOpenStateReq build() {
        SetOpenStateReqOuterClass.SetOpenStateReq result = buildPartial();
      ...
      @java.lang.Override
      public SetOpenStateReqOuterClass.SetOpenStateReq buildPartial() {
        SetOpenStateReqOuterClass.SetOpenStateReq result = new SetOpenStateReqOuterClass.SetOpenStateReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof SetOpenStateReqOuterClass.SetOpenStateReq) {
          return mergeFrom((SetOpenStateReqOuterClass.SetOpenStateReq)other);
        } else {
      ...
      public Builder mergeFrom(SetOpenStateReqOuterClass.SetOpenStateReq other) {
        if (other == SetOpenStateReqOuterClass.SetOpenStateReq.getDefaultInstance()) return this;
        if (other.getValue() != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        SetOpenStateReqOuterClass.SetOpenStateReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (SetOpenStateReqOuterClass.SetOpenStateReq) e.getUnfinishedMessage();
    ...
    private static final SetOpenStateReqOuterClass.SetOpenStateReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new SetOpenStateReqOuterClass.SetOpenStateReq();
    }

    public static SetOpenStateReqOuterClass.SetOpenStateReq getDefaultInstance() {
