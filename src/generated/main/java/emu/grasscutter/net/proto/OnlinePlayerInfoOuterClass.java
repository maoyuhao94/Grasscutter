...
public final class OnlinePlayerInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return OnlinePlayerInfoOuterClass.internal_static_OnlinePlayerInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              OnlinePlayerInfoOuterClass.OnlinePlayerInfo.class, OnlinePlayerInfoOuterClass.OnlinePlayerInfo.Builder.class);
    }
     ...
     * @return The mpSettingType.
     */
    @java.lang.Override public MpSettingTypeOuterClass.MpSettingType getMpSettingType() {
      @SuppressWarnings("deprecation")
      MpSettingTypeOuterClass.MpSettingType result = MpSettingTypeOuterClass.MpSettingType.valueOf(mpSettingType_);
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (mpSettingType_ != MpSettingTypeOuterClass.MpSettingType.MP_SETTING_TYPE_NO_ENTER.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof OnlinePlayerInfoOuterClass.OnlinePlayerInfo)) {
        return super.equals(obj);
      }
      OnlinePlayerInfoOuterClass.OnlinePlayerInfo other = (OnlinePlayerInfoOuterClass.OnlinePlayerInfo) obj;
    ...
    public static OnlinePlayerInfoOuterClass.OnlinePlayerInfo parseFrom(
    ...
    public static OnlinePlayerInfoOuterClass.OnlinePlayerInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static OnlinePlayerInfoOuterClass.OnlinePlayerInfo parseFrom(
    ...
    public static OnlinePlayerInfoOuterClass.OnlinePlayerInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static OnlinePlayerInfoOuterClass.OnlinePlayerInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static OnlinePlayerInfoOuterClass.OnlinePlayerInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(OnlinePlayerInfoOuterClass.OnlinePlayerInfo prototype) {
    ...
    public static final class Builder extends
        ...
        OnlinePlayerInfoOuterClass.OnlinePlayerInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return OnlinePlayerInfoOuterClass.internal_static_OnlinePlayerInfo_descriptor;
      }
      ...
      // Construct using OnlinePlayerInfoOuterClass.OnlinePlayerInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public OnlinePlayerInfoOuterClass.OnlinePlayerInfo getDefaultInstanceForType() {
        return OnlinePlayerInfoOuterClass.OnlinePlayerInfo.getDefaultInstance();
      }

      @java.lang.Override
      public OnlinePlayerInfoOuterClass.OnlinePlayerInfo build() {
        OnlinePlayerInfoOuterClass.OnlinePlayerInfo result = buildPartial();
      ...
      @java.lang.Override
      public OnlinePlayerInfoOuterClass.OnlinePlayerInfo buildPartial() {
        OnlinePlayerInfoOuterClass.OnlinePlayerInfo result = new OnlinePlayerInfoOuterClass.OnlinePlayerInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof OnlinePlayerInfoOuterClass.OnlinePlayerInfo) {
          return mergeFrom((OnlinePlayerInfoOuterClass.OnlinePlayerInfo)other);
        } else {
      ...
      public Builder mergeFrom(OnlinePlayerInfoOuterClass.OnlinePlayerInfo other) {
        if (other == OnlinePlayerInfoOuterClass.OnlinePlayerInfo.getDefaultInstance()) return this;
        if (other.getUid() != 0) {
          setUid(other.getUid());
        }
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        OnlinePlayerInfoOuterClass.OnlinePlayerInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (OnlinePlayerInfoOuterClass.OnlinePlayerInfo) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final OnlinePlayerInfoOuterClass.OnlinePlayerInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new OnlinePlayerInfoOuterClass.OnlinePlayerInfo();
    }

    public static OnlinePlayerInfoOuterClass.OnlinePlayerInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ilePicture\022\r\n\005psnId\030\r \001(\tb\006proto3"
    };
