...
public final class FurnitureMakeSlotOuterClass {
  ...
  public interface FurnitureMakeSlotOrBuilder extends
    ...
    /**
     * <code>repeated .FurnitureMakeData furnitureMakeDataList = 4;</code>
     */
    java.util.List<FurnitureMakeDataOuterClass.FurnitureMakeData> 
        getFurnitureMakeDataListList();
    /**
     * <code>repeated .FurnitureMakeData furnitureMakeDataList = 4;</code>
     */
    FurnitureMakeDataOuterClass.FurnitureMakeData getFurnitureMakeDataList(int index);
    /**
     * <code>repeated .FurnitureMakeData furnitureMakeDataList = 4;</code>
     */
     ...
     * <code>repeated .FurnitureMakeData furnitureMakeDataList = 4;</code>
     */
    java.util.List<? extends FurnitureMakeDataOuterClass.FurnitureMakeDataOrBuilder> 
        getFurnitureMakeDataListOrBuilderList();
    /**
     * <code>repeated .FurnitureMakeData furnitureMakeDataList = 4;</code>
     */
    FurnitureMakeDataOuterClass.FurnitureMakeDataOrBuilder getFurnitureMakeDataListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 34: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                furnitureMakeDataList_ = new java.util.ArrayList<FurnitureMakeDataOuterClass.FurnitureMakeData>();
                mutable_bitField0_ |= 0x00000001;
              }
              furnitureMakeDataList_.add(
                  input.readMessage(FurnitureMakeDataOuterClass.FurnitureMakeData.parser(), extensionRegistry));
              break;
            }
            default: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return FurnitureMakeSlotOuterClass.internal_static_FurnitureMakeSlot_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              FurnitureMakeSlotOuterClass.FurnitureMakeSlot.class, FurnitureMakeSlotOuterClass.FurnitureMakeSlot.Builder.class);
    }

    public static final int FURNITUREMAKEDATALIST_FIELD_NUMBER = 4;
    private java.util.List<FurnitureMakeDataOuterClass.FurnitureMakeData> furnitureMakeDataList_;
    /**
     * <code>repeated .FurnitureMakeData furnitureMakeDataList = 4;</code>
     */
    @java.lang.Override
    public java.util.List<FurnitureMakeDataOuterClass.FurnitureMakeData> getFurnitureMakeDataListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends FurnitureMakeDataOuterClass.FurnitureMakeDataOrBuilder> 
        getFurnitureMakeDataListOrBuilderList() {
      return furnitureMakeDataList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public FurnitureMakeDataOuterClass.FurnitureMakeDataOrBuilder getFurnitureMakeDataListOrBuilder(
        int index) {
      return furnitureMakeDataList_.get(index);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < furnitureMakeDataList_.size(); i++) {
        output.writeMessage(4, furnitureMakeDataList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < furnitureMakeDataList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, furnitureMakeDataList_.get(i));
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof FurnitureMakeSlotOuterClass.FurnitureMakeSlot)) {
        return super.equals(obj);
      }
      FurnitureMakeSlotOuterClass.FurnitureMakeSlot other = (FurnitureMakeSlotOuterClass.FurnitureMakeSlot) obj;
    ...
    public int hashCode() {
      ...
      if (getFurnitureMakeDataListCount() > 0) {
        hash = (37 * hash) + FURNITUREMAKEDATALIST_FIELD_NUMBER;
    ...
    public static FurnitureMakeSlotOuterClass.FurnitureMakeSlot parseFrom(
    ...
    public static FurnitureMakeSlotOuterClass.FurnitureMakeSlot parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static FurnitureMakeSlotOuterClass.FurnitureMakeSlot parseFrom(
    ...
    public static FurnitureMakeSlotOuterClass.FurnitureMakeSlot parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static FurnitureMakeSlotOuterClass.FurnitureMakeSlot parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static FurnitureMakeSlotOuterClass.FurnitureMakeSlot parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(FurnitureMakeSlotOuterClass.FurnitureMakeSlot prototype) {
    ...
    public static final class Builder extends
        ...
        FurnitureMakeSlotOuterClass.FurnitureMakeSlotOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return FurnitureMakeSlotOuterClass.internal_static_FurnitureMakeSlot_descriptor;
      }
      ...
      // Construct using FurnitureMakeSlotOuterClass.FurnitureMakeSlot.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public FurnitureMakeSlotOuterClass.FurnitureMakeSlot getDefaultInstanceForType() {
        return FurnitureMakeSlotOuterClass.FurnitureMakeSlot.getDefaultInstance();
      }

      @java.lang.Override
      public FurnitureMakeSlotOuterClass.FurnitureMakeSlot build() {
        FurnitureMakeSlotOuterClass.FurnitureMakeSlot result = buildPartial();
      ...
      @java.lang.Override
      public FurnitureMakeSlotOuterClass.FurnitureMakeSlot buildPartial() {
        FurnitureMakeSlotOuterClass.FurnitureMakeSlot result = new FurnitureMakeSlotOuterClass.FurnitureMakeSlot(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof FurnitureMakeSlotOuterClass.FurnitureMakeSlot) {
          return mergeFrom((FurnitureMakeSlotOuterClass.FurnitureMakeSlot)other);
        } else {
      ...
      public Builder mergeFrom(FurnitureMakeSlotOuterClass.FurnitureMakeSlot other) {
        if (other == FurnitureMakeSlotOuterClass.FurnitureMakeSlot.getDefaultInstance()) return this;
        if (furnitureMakeDataListBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        FurnitureMakeSlotOuterClass.FurnitureMakeSlot parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (FurnitureMakeSlotOuterClass.FurnitureMakeSlot) e.getUnfinishedMessage();
      ...
      private void ensureFurnitureMakeDataListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          furnitureMakeDataList_ = new java.util.ArrayList<FurnitureMakeDataOuterClass.FurnitureMakeData>(furnitureMakeDataList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          FurnitureMakeDataOuterClass.FurnitureMakeData, FurnitureMakeDataOuterClass.FurnitureMakeData.Builder, FurnitureMakeDataOuterClass.FurnitureMakeDataOrBuilder> furnitureMakeDataListBuilder_;
      ...
      public Builder setFurnitureMakeDataList(
          int index, FurnitureMakeDataOuterClass.FurnitureMakeData value) {
        if (furnitureMakeDataListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setFurnitureMakeDataList(
          int index, FurnitureMakeDataOuterClass.FurnitureMakeData.Builder builderForValue) {
        if (furnitureMakeDataListBuilder_ == null) {
          ensureFurnitureMakeDataListIsMutable();
       ...
       */
      public Builder addFurnitureMakeDataList(
          FurnitureMakeDataOuterClass.FurnitureMakeData.Builder builderForValue) {
        if (furnitureMakeDataListBuilder_ == null) {
          ensureFurnitureMakeDataListIsMutable();
      ...
      public Builder addAllFurnitureMakeDataList(
          java.lang.Iterable<? extends FurnitureMakeDataOuterClass.FurnitureMakeData> values) {
        if (furnitureMakeDataListBuilder_ == null) {
          ensureFurnitureMakeDataListIsMutable();
       ...
       * <code>repeated .FurnitureMakeData furnitureMakeDataList = 4;</code>
       */
      public FurnitureMakeDataOuterClass.FurnitureMakeData.Builder getFurnitureMakeDataListBuilder(
          int index) {
      ...
      public FurnitureMakeDataOuterClass.FurnitureMakeData.Builder addFurnitureMakeDataListBuilder() {
        return getFurnitureMakeDataListFieldBuilder().addBuilder(
            FurnitureMakeDataOuterClass.FurnitureMakeData.getDefaultInstance());
      }
      /**
       * <code>repeated .FurnitureMakeData furnitureMakeDataList = 4;</code>
       */
      public FurnitureMakeDataOuterClass.FurnitureMakeData.Builder addFurnitureMakeDataListBuilder(
          int index) {
        return getFurnitureMakeDataListFieldBuilder().addBuilder(
            index, FurnitureMakeDataOuterClass.FurnitureMakeData.getDefaultInstance());
      }
      /**
       * <code>repeated .FurnitureMakeData furnitureMakeDataList = 4;</code>
       */
      public java.util.List<FurnitureMakeDataOuterClass.FurnitureMakeData.Builder> 
           getFurnitureMakeDataListBuilderList() {
        return getFurnitureMakeDataListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          FurnitureMakeDataOuterClass.FurnitureMakeData, FurnitureMakeDataOuterClass.FurnitureMakeData.Builder, FurnitureMakeDataOuterClass.FurnitureMakeDataOrBuilder> 
          getFurnitureMakeDataListFieldBuilder() {
        if (furnitureMakeDataListBuilder_ == null) {
    ...
    private static final FurnitureMakeSlotOuterClass.FurnitureMakeSlot DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new FurnitureMakeSlotOuterClass.FurnitureMakeSlot();
    }

    public static FurnitureMakeSlotOuterClass.FurnitureMakeSlot getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "Data.proto\"F\n\021FurnitureMakeSlot\0221\n\025furni" +
      "tureMakeDataList\030\004 \003(\0132\022.FurnitureMakeDa" +
      "tab\006proto3"
    };
