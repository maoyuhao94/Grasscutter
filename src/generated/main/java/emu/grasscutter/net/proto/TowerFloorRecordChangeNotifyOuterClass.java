...
public final class TowerFloorRecordChangeNotifyOuterClass {
  ...
  public interface TowerFloorRecordChangeNotifyOrBuilder extends
    ...
    /**
     * <code>bool isFinishedEntranceFloor = 11;</code>
     * @return The isFinishedEntranceFloor.
     */
    boolean getIsFinishedEntranceFloor();

    /**
     * <code>repeated .TowerFloorRecord towerFloorRecordList = 12;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return TowerFloorRecordChangeNotifyOuterClass.internal_static_TowerFloorRecordChangeNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify.class, TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify.Builder.class);
    }

    /**
     * Protobuf enum {@code TowerFloorRecordChangeNotify.OAOPHOGEGKK}
     */
    public enum OAOPHOGEGKK
       ...
       */
      public static final OAOPHOGEGKK DCDNILFDFLB = NONE;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 2455;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 2455;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static OAOPHOGEGKK valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static OAOPHOGEGKK forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 2455: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<OAOPHOGEGKK>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          OAOPHOGEGKK> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<OAOPHOGEGKK>() {
              public OAOPHOGEGKK findValueByNumber(int number) {
                return OAOPHOGEGKK.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify.getDescriptor().getEnumTypes().get(0);
      }

      private static final OAOPHOGEGKK[] VALUES = getStaticValuesArray();
      private static OAOPHOGEGKK[] getStaticValuesArray() {
        return new OAOPHOGEGKK[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, 
        };
      }
      public static OAOPHOGEGKK valueOf(
      ...
      private OAOPHOGEGKK(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:TowerFloorRecordChangeNotify.OAOPHOGEGKK)
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify)) {
        return super.equals(obj);
      }
      TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify other = (TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify) obj;
    ...
    public static TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify parseFrom(
    ...
    public static TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify parseFrom(
    ...
    public static TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify prototype) {
    ...
    public static final class Builder extends
        ...
        TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return TowerFloorRecordChangeNotifyOuterClass.internal_static_TowerFloorRecordChangeNotify_descriptor;
      }
      ...
      // Construct using TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify getDefaultInstanceForType() {
        return TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify.getDefaultInstance();
      }

      @java.lang.Override
      public TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify build() {
        TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify result = buildPartial();
      ...
      @java.lang.Override
      public TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify buildPartial() {
        TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify result = new TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify) {
          return mergeFrom((TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify)other);
        } else {
      ...
      public Builder mergeFrom(TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify other) {
        if (other == TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify) e.getUnfinishedMessage();
    ...
    private static final TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify();
    }

    public static TowerFloorRecordChangeNotifyOuterClass.TowerFloorRecordChangeNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "werFloorRecord.proto\"\301\001\n\034TowerFloorRecor" +
      "dChangeNotify\022\037\n\027isFinishedEntranceFloor" +
      "\030\013 \001(\010\022/\n\024towerFloorRecordList\030\014 \003(\0132\021.T" +
      "owerFloorRecord\"O\n\013OAOPHOGEGKK\022\010\n\004NONE\020\000" +
      "\022\020\n\013PEPPOHPHJOJ\020\227\023\022\017\n\013DCDNILFDFLB\020\000\022\017\n\013N" +
