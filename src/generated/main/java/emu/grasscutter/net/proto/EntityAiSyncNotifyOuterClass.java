...
public final class EntityAiSyncNotifyOuterClass {
  ...
  public interface EntityAiSyncNotifyOrBuilder extends
    ...
    /**
     * <code>repeated uint32 localAvatarAlertedMonsterList = 8;</code>
    ...
    /**
     * <code>repeated .AiSyncInfo infoList = 10;</code>
     */
    java.util.List<AiSyncInfoOuterClass.AiSyncInfo> 
        getInfoListList();
    /**
     * <code>repeated .AiSyncInfo infoList = 10;</code>
     */
     ...
     * <code>repeated .AiSyncInfo infoList = 10;</code>
     */
    java.util.List<? extends AiSyncInfoOuterClass.AiSyncInfoOrBuilder> 
        getInfoListOrBuilderList();
    /**
     * <code>repeated .AiSyncInfo infoList = 10;</code>
     */
    AiSyncInfoOuterClass.AiSyncInfoOrBuilder getInfoListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 82: {
              if (!((mutable_bitField0_ & 0x00000002) != 0)) {
                infoList_ = new java.util.ArrayList<AiSyncInfoOuterClass.AiSyncInfo>();
                mutable_bitField0_ |= 0x00000002;
              }
              infoList_.add(
                  input.readMessage(AiSyncInfoOuterClass.AiSyncInfo.parser(), extensionRegistry));
              break;
            }
            default: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return EntityAiSyncNotifyOuterClass.internal_static_EntityAiSyncNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              EntityAiSyncNotifyOuterClass.EntityAiSyncNotify.class, EntityAiSyncNotifyOuterClass.EntityAiSyncNotify.Builder.class);
    }

    /**
     * Protobuf enum {@code EntityAiSyncNotify.ELGOOLKKFPB}
     */
    public enum ELGOOLKKFPB
       ...
       */
      public static final ELGOOLKKFPB DCDNILFDFLB = NONE;
      /**
       * <code>EAJIABGAOCI = 1;</code>
       */
      public static final ELGOOLKKFPB EAJIABGAOCI = NNBKOLMPOEA;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 354;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 354;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static ELGOOLKKFPB valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static ELGOOLKKFPB forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 354: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<ELGOOLKKFPB>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          ELGOOLKKFPB> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<ELGOOLKKFPB>() {
              public ELGOOLKKFPB findValueByNumber(int number) {
                return ELGOOLKKFPB.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return EntityAiSyncNotifyOuterClass.EntityAiSyncNotify.getDescriptor().getEnumTypes().get(0);
      }

      private static final ELGOOLKKFPB[] VALUES = getStaticValuesArray();
      private static ELGOOLKKFPB[] getStaticValuesArray() {
        return new ELGOOLKKFPB[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, EAJIABGAOCI, 
        };
      }
      public static ELGOOLKKFPB valueOf(
      ...
      private ELGOOLKKFPB(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:EntityAiSyncNotify.ELGOOLKKFPB)
    }
    ...
    private java.util.List<AiSyncInfoOuterClass.AiSyncInfo> infoList_;
    /**
     * <code>repeated .AiSyncInfo infoList = 10;</code>
     */
    @java.lang.Override
    public java.util.List<AiSyncInfoOuterClass.AiSyncInfo> getInfoListList() {
      return infoList_;
    }
    /**
     * <code>repeated .AiSyncInfo infoList = 10;</code>
     */
    @java.lang.Override
    public java.util.List<? extends AiSyncInfoOuterClass.AiSyncInfoOrBuilder> 
        getInfoListOrBuilderList() {
      return infoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public AiSyncInfoOuterClass.AiSyncInfoOrBuilder getInfoListOrBuilder(
        int index) {
      return infoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof EntityAiSyncNotifyOuterClass.EntityAiSyncNotify)) {
        return super.equals(obj);
      }
      EntityAiSyncNotifyOuterClass.EntityAiSyncNotify other = (EntityAiSyncNotifyOuterClass.EntityAiSyncNotify) obj;
    ...
    public int hashCode() {
      ...
      if (getLocalAvatarAlertedMonsterListCount() > 0) {
        hash = (37 * hash) + LOCALAVATARALERTEDMONSTERLIST_FIELD_NUMBER;
    ...
    public static EntityAiSyncNotifyOuterClass.EntityAiSyncNotify parseFrom(
    ...
    public static EntityAiSyncNotifyOuterClass.EntityAiSyncNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static EntityAiSyncNotifyOuterClass.EntityAiSyncNotify parseFrom(
    ...
    public static EntityAiSyncNotifyOuterClass.EntityAiSyncNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static EntityAiSyncNotifyOuterClass.EntityAiSyncNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static EntityAiSyncNotifyOuterClass.EntityAiSyncNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(EntityAiSyncNotifyOuterClass.EntityAiSyncNotify prototype) {
    ...
    public static final class Builder extends
        ...
        EntityAiSyncNotifyOuterClass.EntityAiSyncNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return EntityAiSyncNotifyOuterClass.internal_static_EntityAiSyncNotify_descriptor;
      }
      ...
      // Construct using EntityAiSyncNotifyOuterClass.EntityAiSyncNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public EntityAiSyncNotifyOuterClass.EntityAiSyncNotify getDefaultInstanceForType() {
        return EntityAiSyncNotifyOuterClass.EntityAiSyncNotify.getDefaultInstance();
      }

      @java.lang.Override
      public EntityAiSyncNotifyOuterClass.EntityAiSyncNotify build() {
        EntityAiSyncNotifyOuterClass.EntityAiSyncNotify result = buildPartial();
      ...
      @java.lang.Override
      public EntityAiSyncNotifyOuterClass.EntityAiSyncNotify buildPartial() {
        EntityAiSyncNotifyOuterClass.EntityAiSyncNotify result = new EntityAiSyncNotifyOuterClass.EntityAiSyncNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof EntityAiSyncNotifyOuterClass.EntityAiSyncNotify) {
          return mergeFrom((EntityAiSyncNotifyOuterClass.EntityAiSyncNotify)other);
        } else {
      ...
      public Builder mergeFrom(EntityAiSyncNotifyOuterClass.EntityAiSyncNotify other) {
        if (other == EntityAiSyncNotifyOuterClass.EntityAiSyncNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        EntityAiSyncNotifyOuterClass.EntityAiSyncNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (EntityAiSyncNotifyOuterClass.EntityAiSyncNotify) e.getUnfinishedMessage();
      ...
      private void ensureInfoListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          infoList_ = new java.util.ArrayList<AiSyncInfoOuterClass.AiSyncInfo>(infoList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          AiSyncInfoOuterClass.AiSyncInfo, AiSyncInfoOuterClass.AiSyncInfo.Builder, AiSyncInfoOuterClass.AiSyncInfoOrBuilder> infoListBuilder_;
      ...
      public Builder setInfoList(
          int index, AiSyncInfoOuterClass.AiSyncInfo value) {
        if (infoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setInfoList(
          int index, AiSyncInfoOuterClass.AiSyncInfo.Builder builderForValue) {
        if (infoListBuilder_ == null) {
          ensureInfoListIsMutable();
       ...
       */
      public Builder addInfoList(
          AiSyncInfoOuterClass.AiSyncInfo.Builder builderForValue) {
        if (infoListBuilder_ == null) {
          ensureInfoListIsMutable();
      ...
      public Builder addAllInfoList(
          java.lang.Iterable<? extends AiSyncInfoOuterClass.AiSyncInfo> values) {
        if (infoListBuilder_ == null) {
          ensureInfoListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, infoList_);
       ...
       * <code>repeated .AiSyncInfo infoList = 10;</code>
       */
      public AiSyncInfoOuterClass.AiSyncInfo.Builder getInfoListBuilder(
          int index) {
      ...
      public AiSyncInfoOuterClass.AiSyncInfo.Builder addInfoListBuilder() {
        return getInfoListFieldBuilder().addBuilder(
            AiSyncInfoOuterClass.AiSyncInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .AiSyncInfo infoList = 10;</code>
       */
      public AiSyncInfoOuterClass.AiSyncInfo.Builder addInfoListBuilder(
          int index) {
        return getInfoListFieldBuilder().addBuilder(
            index, AiSyncInfoOuterClass.AiSyncInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .AiSyncInfo infoList = 10;</code>
       */
      public java.util.List<AiSyncInfoOuterClass.AiSyncInfo.Builder> 
           getInfoListBuilderList() {
        return getInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          AiSyncInfoOuterClass.AiSyncInfo, AiSyncInfoOuterClass.AiSyncInfo.Builder, AiSyncInfoOuterClass.AiSyncInfoOrBuilder> 
          getInfoListFieldBuilder() {
        if (infoListBuilder_ == null) {
    ...
    private static final EntityAiSyncNotifyOuterClass.EntityAiSyncNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new EntityAiSyncNotifyOuterClass.EntityAiSyncNotify();
    }

    public static EntityAiSyncNotifyOuterClass.EntityAiSyncNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "arAlertedMonsterList\030\010 \003(\r\022\035\n\010infoList\030\n" +
      " \003(\0132\013.AiSyncInfo\"`\n\013ELGOOLKKFPB\022\010\n\004NONE" +
      "\020\000\022\020\n\013PEPPOHPHJOJ\020\342\002\022\017\n\013DCDNILFDFLB\020\000\022\017\n" +
