...
public final class GetFriendShowAvatarInfoRspOuterClass {
  ...
  public interface GetFriendShowAvatarInfoRspOrBuilder extends
     ...
     */
    java.util.List<ShowAvatarInfoOuterClass.ShowAvatarInfo> 
        getShowAvatarInfoListList();
    /**
     * <code>repeated .ShowAvatarInfo showAvatarInfoList = 3;</code>
     */
    ShowAvatarInfoOuterClass.ShowAvatarInfo getShowAvatarInfoList(int index);
    /**
     * <code>repeated .ShowAvatarInfo showAvatarInfoList = 3;</code>
     */
     ...
     * <code>repeated .ShowAvatarInfo showAvatarInfoList = 3;</code>
     */
    java.util.List<? extends ShowAvatarInfoOuterClass.ShowAvatarInfoOrBuilder> 
        getShowAvatarInfoListOrBuilderList();
    /**
     * <code>repeated .ShowAvatarInfo showAvatarInfoList = 3;</code>
     */
    ShowAvatarInfoOuterClass.ShowAvatarInfoOrBuilder getShowAvatarInfoListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 26: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                showAvatarInfoList_ = new java.util.ArrayList<ShowAvatarInfoOuterClass.ShowAvatarInfo>();
                mutable_bitField0_ |= 0x00000001;
              }
              showAvatarInfoList_.add(
                  input.readMessage(ShowAvatarInfoOuterClass.ShowAvatarInfo.parser(), extensionRegistry));
              break;
            }
            case 96: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return GetFriendShowAvatarInfoRspOuterClass.internal_static_GetFriendShowAvatarInfoRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp.class, GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp.Builder.class);
    }
    ...
    public enum DBNKIEDKCKB
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp.getDescriptor().getEnumTypes().get(0);
      }
    ...
    private java.util.List<ShowAvatarInfoOuterClass.ShowAvatarInfo> showAvatarInfoList_;
    /**
     * <code>repeated .ShowAvatarInfo showAvatarInfoList = 3;</code>
     */
    @java.lang.Override
    public java.util.List<ShowAvatarInfoOuterClass.ShowAvatarInfo> getShowAvatarInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends ShowAvatarInfoOuterClass.ShowAvatarInfoOrBuilder> 
        getShowAvatarInfoListOrBuilderList() {
      return showAvatarInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public ShowAvatarInfoOuterClass.ShowAvatarInfoOrBuilder getShowAvatarInfoListOrBuilder(
        int index) {
      return showAvatarInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp)) {
        return super.equals(obj);
      }
      GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp other = (GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp) obj;
    ...
    public static GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp parseFrom(
    ...
    public static GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp parseFrom(
    ...
    public static GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp prototype) {
    ...
    public static final class Builder extends
        ...
        GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return GetFriendShowAvatarInfoRspOuterClass.internal_static_GetFriendShowAvatarInfoRsp_descriptor;
      }
      ...
      // Construct using GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp getDefaultInstanceForType() {
        return GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp.getDefaultInstance();
      }

      @java.lang.Override
      public GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp build() {
        GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp result = buildPartial();
      ...
      @java.lang.Override
      public GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp buildPartial() {
        GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp result = new GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp) {
          return mergeFrom((GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp)other);
        } else {
      ...
      public Builder mergeFrom(GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp other) {
        if (other == GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp.getDefaultInstance()) return this;
        if (showAvatarInfoListBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp) e.getUnfinishedMessage();
      ...
      private void ensureShowAvatarInfoListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          showAvatarInfoList_ = new java.util.ArrayList<ShowAvatarInfoOuterClass.ShowAvatarInfo>(showAvatarInfoList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          ShowAvatarInfoOuterClass.ShowAvatarInfo, ShowAvatarInfoOuterClass.ShowAvatarInfo.Builder, ShowAvatarInfoOuterClass.ShowAvatarInfoOrBuilder> showAvatarInfoListBuilder_;
      ...
      public Builder setShowAvatarInfoList(
          int index, ShowAvatarInfoOuterClass.ShowAvatarInfo value) {
        if (showAvatarInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setShowAvatarInfoList(
          int index, ShowAvatarInfoOuterClass.ShowAvatarInfo.Builder builderForValue) {
        if (showAvatarInfoListBuilder_ == null) {
          ensureShowAvatarInfoListIsMutable();
       ...
       */
      public Builder addShowAvatarInfoList(
          ShowAvatarInfoOuterClass.ShowAvatarInfo.Builder builderForValue) {
        if (showAvatarInfoListBuilder_ == null) {
          ensureShowAvatarInfoListIsMutable();
      ...
      public Builder addAllShowAvatarInfoList(
          java.lang.Iterable<? extends ShowAvatarInfoOuterClass.ShowAvatarInfo> values) {
        if (showAvatarInfoListBuilder_ == null) {
          ensureShowAvatarInfoListIsMutable();
       ...
       * <code>repeated .ShowAvatarInfo showAvatarInfoList = 3;</code>
       */
      public ShowAvatarInfoOuterClass.ShowAvatarInfo.Builder getShowAvatarInfoListBuilder(
          int index) {
      ...
      public ShowAvatarInfoOuterClass.ShowAvatarInfo.Builder addShowAvatarInfoListBuilder() {
        return getShowAvatarInfoListFieldBuilder().addBuilder(
            ShowAvatarInfoOuterClass.ShowAvatarInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .ShowAvatarInfo showAvatarInfoList = 3;</code>
       */
      public ShowAvatarInfoOuterClass.ShowAvatarInfo.Builder addShowAvatarInfoListBuilder(
          int index) {
        return getShowAvatarInfoListFieldBuilder().addBuilder(
            index, ShowAvatarInfoOuterClass.ShowAvatarInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .ShowAvatarInfo showAvatarInfoList = 3;</code>
       */
      public java.util.List<ShowAvatarInfoOuterClass.ShowAvatarInfo.Builder> 
           getShowAvatarInfoListBuilderList() {
        return getShowAvatarInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          ShowAvatarInfoOuterClass.ShowAvatarInfo, ShowAvatarInfoOuterClass.ShowAvatarInfo.Builder, ShowAvatarInfoOuterClass.ShowAvatarInfoOrBuilder> 
          getShowAvatarInfoListFieldBuilder() {
        if (showAvatarInfoListBuilder_ == null) {
    ...
    private static final GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp();
    }

    public static GetFriendShowAvatarInfoRspOuterClass.GetFriendShowAvatarInfoRsp getDefaultInstance() {
