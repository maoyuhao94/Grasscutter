...
public final class EvtBeingHitInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 42: {
              AttackResultOuterClass.AttackResult.Builder subBuilder = null;
              if (attackResult_ != null) {
                subBuilder = attackResult_.toBuilder();
              }
              attackResult_ = input.readMessage(AttackResultOuterClass.AttackResult.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return EvtBeingHitInfoOuterClass.internal_static_EvtBeingHitInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              EvtBeingHitInfoOuterClass.EvtBeingHitInfo.class, EvtBeingHitInfoOuterClass.EvtBeingHitInfo.Builder.class);
    }
    ...
    public AttackResultOuterClass.AttackResult getAttackResult() {
      return attackResult_ == null ? AttackResultOuterClass.AttackResult.getDefaultInstance() : attackResult_;
    }
    /**
     * <code>.AttackResult attackResult = 5;</code>
     */
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof EvtBeingHitInfoOuterClass.EvtBeingHitInfo)) {
        return super.equals(obj);
      }
      EvtBeingHitInfoOuterClass.EvtBeingHitInfo other = (EvtBeingHitInfoOuterClass.EvtBeingHitInfo) obj;
    ...
    public static EvtBeingHitInfoOuterClass.EvtBeingHitInfo parseFrom(
    ...
    public static EvtBeingHitInfoOuterClass.EvtBeingHitInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static EvtBeingHitInfoOuterClass.EvtBeingHitInfo parseFrom(
    ...
    public static EvtBeingHitInfoOuterClass.EvtBeingHitInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static EvtBeingHitInfoOuterClass.EvtBeingHitInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static EvtBeingHitInfoOuterClass.EvtBeingHitInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(EvtBeingHitInfoOuterClass.EvtBeingHitInfo prototype) {
    ...
    public static final class Builder extends
        ...
        EvtBeingHitInfoOuterClass.EvtBeingHitInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return EvtBeingHitInfoOuterClass.internal_static_EvtBeingHitInfo_descriptor;
      }
      ...
      // Construct using EvtBeingHitInfoOuterClass.EvtBeingHitInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public EvtBeingHitInfoOuterClass.EvtBeingHitInfo getDefaultInstanceForType() {
        return EvtBeingHitInfoOuterClass.EvtBeingHitInfo.getDefaultInstance();
      }

      @java.lang.Override
      public EvtBeingHitInfoOuterClass.EvtBeingHitInfo build() {
        EvtBeingHitInfoOuterClass.EvtBeingHitInfo result = buildPartial();
      ...
      @java.lang.Override
      public EvtBeingHitInfoOuterClass.EvtBeingHitInfo buildPartial() {
        EvtBeingHitInfoOuterClass.EvtBeingHitInfo result = new EvtBeingHitInfoOuterClass.EvtBeingHitInfo(this);
        if (attackResultBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof EvtBeingHitInfoOuterClass.EvtBeingHitInfo) {
          return mergeFrom((EvtBeingHitInfoOuterClass.EvtBeingHitInfo)other);
        } else {
      ...
      public Builder mergeFrom(EvtBeingHitInfoOuterClass.EvtBeingHitInfo other) {
        if (other == EvtBeingHitInfoOuterClass.EvtBeingHitInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        EvtBeingHitInfoOuterClass.EvtBeingHitInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (EvtBeingHitInfoOuterClass.EvtBeingHitInfo) e.getUnfinishedMessage();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          AttackResultOuterClass.AttackResult, AttackResultOuterClass.AttackResult.Builder, AttackResultOuterClass.AttackResultOrBuilder> attackResultBuilder_;
      /**
       * <code>.AttackResult attackResult = 5;</code>
       * @return Whether the attackResult field is set.
       */
      ...
      public Builder setAttackResult(
          AttackResultOuterClass.AttackResult.Builder builderForValue) {
        if (attackResultBuilder_ == null) {
      ...
      public Builder mergeAttackResult(AttackResultOuterClass.AttackResult value) {
        if (attackResultBuilder_ == null) {
          if (attackResult_ != null) {
            attackResult_ =
              AttackResultOuterClass.AttackResult.newBuilder(attackResult_).mergeFrom(value).buildPartial();
          } else {
            attackResult_ = value;
          }
          onChanged();
      ...
      public AttackResultOuterClass.AttackResultOrBuilder getAttackResultOrBuilder() {
        if (attackResultBuilder_ != null) {
          ...
          return attackResult_ == null ?
              AttackResultOuterClass.AttackResult.getDefaultInstance() : attackResult_;
        }
      }
      /**
       * <code>.AttackResult attackResult = 5;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          AttackResultOuterClass.AttackResult, AttackResultOuterClass.AttackResult.Builder, AttackResultOuterClass.AttackResultOrBuilder> 
    ...
    private static final EvtBeingHitInfoOuterClass.EvtBeingHitInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new EvtBeingHitInfoOuterClass.EvtBeingHitInfo();
    }

    public static EvtBeingHitInfoOuterClass.EvtBeingHitInfo getDefaultInstance() {
