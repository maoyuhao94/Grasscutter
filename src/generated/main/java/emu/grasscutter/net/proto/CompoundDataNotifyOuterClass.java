...
public final class CompoundDataNotifyOuterClass {
  ...
  public interface CompoundDataNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .CompoundQueueData compoundQueueDataList = 14;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return CompoundDataNotifyOuterClass.internal_static_CompoundDataNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              CompoundDataNotifyOuterClass.CompoundDataNotify.class, CompoundDataNotifyOuterClass.CompoundDataNotify.Builder.class);
    }

    /**
     * Protobuf enum {@code CompoundDataNotify.JGMMCOFEBOL}
     */
    public enum JGMMCOFEBOL
       ...
       */
      public static final JGMMCOFEBOL DCDNILFDFLB = NONE;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 135;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 135;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static JGMMCOFEBOL valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static JGMMCOFEBOL forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 135: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<JGMMCOFEBOL>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          JGMMCOFEBOL> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<JGMMCOFEBOL>() {
              public JGMMCOFEBOL findValueByNumber(int number) {
                return JGMMCOFEBOL.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return CompoundDataNotifyOuterClass.CompoundDataNotify.getDescriptor().getEnumTypes().get(0);
      }

      private static final JGMMCOFEBOL[] VALUES = getStaticValuesArray();
      private static JGMMCOFEBOL[] getStaticValuesArray() {
        return new JGMMCOFEBOL[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, 
        };
      }
      public static JGMMCOFEBOL valueOf(
      ...
      private JGMMCOFEBOL(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:CompoundDataNotify.JGMMCOFEBOL)
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < compoundQueueDataList_.size(); i++) {
        output.writeMessage(14, compoundQueueDataList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < compoundQueueDataList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(14, compoundQueueDataList_.get(i));
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof CompoundDataNotifyOuterClass.CompoundDataNotify)) {
        return super.equals(obj);
      }
      CompoundDataNotifyOuterClass.CompoundDataNotify other = (CompoundDataNotifyOuterClass.CompoundDataNotify) obj;
    ...
    public static CompoundDataNotifyOuterClass.CompoundDataNotify parseFrom(
    ...
    public static CompoundDataNotifyOuterClass.CompoundDataNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static CompoundDataNotifyOuterClass.CompoundDataNotify parseFrom(
    ...
    public static CompoundDataNotifyOuterClass.CompoundDataNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static CompoundDataNotifyOuterClass.CompoundDataNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static CompoundDataNotifyOuterClass.CompoundDataNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(CompoundDataNotifyOuterClass.CompoundDataNotify prototype) {
    ...
    public static final class Builder extends
        ...
        CompoundDataNotifyOuterClass.CompoundDataNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return CompoundDataNotifyOuterClass.internal_static_CompoundDataNotify_descriptor;
      }
      ...
      // Construct using CompoundDataNotifyOuterClass.CompoundDataNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public CompoundDataNotifyOuterClass.CompoundDataNotify getDefaultInstanceForType() {
        return CompoundDataNotifyOuterClass.CompoundDataNotify.getDefaultInstance();
      }

      @java.lang.Override
      public CompoundDataNotifyOuterClass.CompoundDataNotify build() {
        CompoundDataNotifyOuterClass.CompoundDataNotify result = buildPartial();
      ...
      @java.lang.Override
      public CompoundDataNotifyOuterClass.CompoundDataNotify buildPartial() {
        CompoundDataNotifyOuterClass.CompoundDataNotify result = new CompoundDataNotifyOuterClass.CompoundDataNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof CompoundDataNotifyOuterClass.CompoundDataNotify) {
          return mergeFrom((CompoundDataNotifyOuterClass.CompoundDataNotify)other);
        } else {
      ...
      public Builder mergeFrom(CompoundDataNotifyOuterClass.CompoundDataNotify other) {
        if (other == CompoundDataNotifyOuterClass.CompoundDataNotify.getDefaultInstance()) return this;
        if (compoundQueueDataListBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        CompoundDataNotifyOuterClass.CompoundDataNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (CompoundDataNotifyOuterClass.CompoundDataNotify) e.getUnfinishedMessage();
    ...
    private static final CompoundDataNotifyOuterClass.CompoundDataNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new CompoundDataNotifyOuterClass.CompoundDataNotify();
    }

    public static CompoundDataNotifyOuterClass.CompoundDataNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "mpoundQueueDataList\030\016 \003(\0132\022.CompoundQueu" +
      "eData\022\032\n\022unlockCompoundList\030\005 \003(\r\"O\n\013JGM" +
      "MCOFEBOL\022\010\n\004NONE\020\000\022\020\n\013PEPPOHPHJOJ\020\207\001\022\017\n\013" +
