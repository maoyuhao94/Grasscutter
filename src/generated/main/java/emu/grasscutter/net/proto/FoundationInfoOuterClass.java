...
public final class FoundationInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return FoundationInfoOuterClass.internal_static_FoundationInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              FoundationInfoOuterClass.FoundationInfo.class, FoundationInfoOuterClass.FoundationInfo.Builder.class);
    }
     ...
     * @return The status.
     */
    @java.lang.Override public FoundationStatusOuterClass.FoundationStatus getStatus() {
      @SuppressWarnings("deprecation")
      FoundationStatusOuterClass.FoundationStatus result = FoundationStatusOuterClass.FoundationStatus.valueOf(status_);
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof FoundationInfoOuterClass.FoundationInfo)) {
        return super.equals(obj);
      }
      FoundationInfoOuterClass.FoundationInfo other = (FoundationInfoOuterClass.FoundationInfo) obj;
    ...
    public static FoundationInfoOuterClass.FoundationInfo parseFrom(
    ...
    public static FoundationInfoOuterClass.FoundationInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static FoundationInfoOuterClass.FoundationInfo parseFrom(
    ...
    public static FoundationInfoOuterClass.FoundationInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static FoundationInfoOuterClass.FoundationInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static FoundationInfoOuterClass.FoundationInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(FoundationInfoOuterClass.FoundationInfo prototype) {
    ...
    public static final class Builder extends
        ...
        FoundationInfoOuterClass.FoundationInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return FoundationInfoOuterClass.internal_static_FoundationInfo_descriptor;
      }
      ...
      // Construct using FoundationInfoOuterClass.FoundationInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public FoundationInfoOuterClass.FoundationInfo getDefaultInstanceForType() {
        return FoundationInfoOuterClass.FoundationInfo.getDefaultInstance();
      }

      @java.lang.Override
      public FoundationInfoOuterClass.FoundationInfo build() {
        FoundationInfoOuterClass.FoundationInfo result = buildPartial();
      ...
      @java.lang.Override
      public FoundationInfoOuterClass.FoundationInfo buildPartial() {
        FoundationInfoOuterClass.FoundationInfo result = new FoundationInfoOuterClass.FoundationInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof FoundationInfoOuterClass.FoundationInfo) {
          return mergeFrom((FoundationInfoOuterClass.FoundationInfo)other);
        } else {
      ...
      public Builder mergeFrom(FoundationInfoOuterClass.FoundationInfo other) {
        if (other == FoundationInfoOuterClass.FoundationInfo.getDefaultInstance()) return this;
        if (other.status_ != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        FoundationInfoOuterClass.FoundationInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (FoundationInfoOuterClass.FoundationInfo) e.getUnfinishedMessage();
    ...
    private static final FoundationInfoOuterClass.FoundationInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new FoundationInfoOuterClass.FoundationInfo();
    }

    public static FoundationInfoOuterClass.FoundationInfo getDefaultInstance() {
