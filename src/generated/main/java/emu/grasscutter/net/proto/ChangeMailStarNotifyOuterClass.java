...
public final class ChangeMailStarNotifyOuterClass {
  ...
  public interface ChangeMailStarNotifyOrBuilder extends
    ...
    /**
     * <code>repeated uint32 mailIdList = 11;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return ChangeMailStarNotifyOuterClass.internal_static_ChangeMailStarNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ChangeMailStarNotifyOuterClass.ChangeMailStarNotify.class, ChangeMailStarNotifyOuterClass.ChangeMailStarNotify.Builder.class);
    }

    /**
     * Protobuf enum {@code ChangeMailStarNotify.PHAAKAMCIEC}
     */
    public enum PHAAKAMCIEC
       ...
       */
      public static final PHAAKAMCIEC DCDNILFDFLB = NONE;
      /**
       * <code>EAJIABGAOCI = 1;</code>
       */
      public static final PHAAKAMCIEC EAJIABGAOCI = NNBKOLMPOEA;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 1478;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 1478;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static PHAAKAMCIEC valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static PHAAKAMCIEC forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 1478: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<PHAAKAMCIEC>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          PHAAKAMCIEC> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<PHAAKAMCIEC>() {
              public PHAAKAMCIEC findValueByNumber(int number) {
                return PHAAKAMCIEC.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return ChangeMailStarNotifyOuterClass.ChangeMailStarNotify.getDescriptor().getEnumTypes().get(0);
      }

      private static final PHAAKAMCIEC[] VALUES = getStaticValuesArray();
      private static PHAAKAMCIEC[] getStaticValuesArray() {
        return new PHAAKAMCIEC[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, EAJIABGAOCI, 
        };
      }
      public static PHAAKAMCIEC valueOf(
      ...
      private PHAAKAMCIEC(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:ChangeMailStarNotify.PHAAKAMCIEC)
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof ChangeMailStarNotifyOuterClass.ChangeMailStarNotify)) {
        return super.equals(obj);
      }
      ChangeMailStarNotifyOuterClass.ChangeMailStarNotify other = (ChangeMailStarNotifyOuterClass.ChangeMailStarNotify) obj;
    ...
    public static ChangeMailStarNotifyOuterClass.ChangeMailStarNotify parseFrom(
    ...
    public static ChangeMailStarNotifyOuterClass.ChangeMailStarNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ChangeMailStarNotifyOuterClass.ChangeMailStarNotify parseFrom(
    ...
    public static ChangeMailStarNotifyOuterClass.ChangeMailStarNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ChangeMailStarNotifyOuterClass.ChangeMailStarNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static ChangeMailStarNotifyOuterClass.ChangeMailStarNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(ChangeMailStarNotifyOuterClass.ChangeMailStarNotify prototype) {
    ...
    public static final class Builder extends
        ...
        ChangeMailStarNotifyOuterClass.ChangeMailStarNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ChangeMailStarNotifyOuterClass.internal_static_ChangeMailStarNotify_descriptor;
      }
      ...
      // Construct using ChangeMailStarNotifyOuterClass.ChangeMailStarNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public ChangeMailStarNotifyOuterClass.ChangeMailStarNotify getDefaultInstanceForType() {
        return ChangeMailStarNotifyOuterClass.ChangeMailStarNotify.getDefaultInstance();
      }

      @java.lang.Override
      public ChangeMailStarNotifyOuterClass.ChangeMailStarNotify build() {
        ChangeMailStarNotifyOuterClass.ChangeMailStarNotify result = buildPartial();
      ...
      @java.lang.Override
      public ChangeMailStarNotifyOuterClass.ChangeMailStarNotify buildPartial() {
        ChangeMailStarNotifyOuterClass.ChangeMailStarNotify result = new ChangeMailStarNotifyOuterClass.ChangeMailStarNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ChangeMailStarNotifyOuterClass.ChangeMailStarNotify) {
          return mergeFrom((ChangeMailStarNotifyOuterClass.ChangeMailStarNotify)other);
        } else {
      ...
      public Builder mergeFrom(ChangeMailStarNotifyOuterClass.ChangeMailStarNotify other) {
        if (other == ChangeMailStarNotifyOuterClass.ChangeMailStarNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ChangeMailStarNotifyOuterClass.ChangeMailStarNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ChangeMailStarNotifyOuterClass.ChangeMailStarNotify) e.getUnfinishedMessage();
    ...
    private static final ChangeMailStarNotifyOuterClass.ChangeMailStarNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ChangeMailStarNotifyOuterClass.ChangeMailStarNotify();
    }

    public static ChangeMailStarNotifyOuterClass.ChangeMailStarNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\032ChangeMailStarNotify.proto\"\234\001\n\024ChangeM" +
      "ailStarNotify\022\022\n\nmailIdList\030\013 \003(\r\022\016\n\006isS" +
      "tar\030\014 \001(\010\"`\n\013PHAAKAMCIEC\022\010\n\004NONE\020\000\022\020\n\013PE" +
      "PPOHPHJOJ\020\306\013\022\017\n\013DCDNILFDFLB\020\000\022\017\n\013NNBKOLM" +
