...
public final class CodexDataUpdateNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return CodexDataUpdateNotifyOuterClass.internal_static_CodexDataUpdateNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify.class, CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify.Builder.class);
    }
    ...
    public enum IJBHHHDDJOJ
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify)) {
        return super.equals(obj);
      }
      CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify other = (CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify) obj;
    ...
    public static CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify parseFrom(
    ...
    public static CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify parseFrom(
    ...
    public static CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify prototype) {
    ...
    public static final class Builder extends
        ...
        CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return CodexDataUpdateNotifyOuterClass.internal_static_CodexDataUpdateNotify_descriptor;
      }
      ...
      // Construct using CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify getDefaultInstanceForType() {
        return CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify.getDefaultInstance();
      }

      @java.lang.Override
      public CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify build() {
        CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify result = buildPartial();
      ...
      @java.lang.Override
      public CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify buildPartial() {
        CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify result = new CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify(this);
        result.type_ = type_;
        result.id_ = id_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify) {
          return mergeFrom((CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify)other);
        } else {
      ...
      public Builder mergeFrom(CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify other) {
        if (other == CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify.getDefaultInstance()) return this;
        if (other.type_ != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify) e.getUnfinishedMessage();
    ...
    private static final CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify();
    }

    public static CodexDataUpdateNotifyOuterClass.CodexDataUpdateNotify getDefaultInstance() {
