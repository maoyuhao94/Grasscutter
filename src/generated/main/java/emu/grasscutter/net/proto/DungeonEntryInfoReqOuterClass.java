...
public final class DungeonEntryInfoReqOuterClass {
  ...
  public interface DungeonEntryInfoReqOrBuilder extends
    ...
    /**
     * <code>repeated .Uint32Pair scenePointIdList = 12;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 98: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                scenePointIdList_ = new java.util.ArrayList<Uint32PairOuterClass.Uint32Pair>();
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return DungeonEntryInfoReqOuterClass.internal_static_DungeonEntryInfoReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq.class, DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq.Builder.class);
    }

    /**
     * Protobuf enum {@code DungeonEntryInfoReq.EHLGNPMDHDF}
     */
    public enum EHLGNPMDHDF
       ...
       */
      public static final EHLGNPMDHDF DCDNILFDFLB = NONE;
      /**
       * <code>EAJIABGAOCI = 1;</code>
       */
      public static final EHLGNPMDHDF EAJIABGAOCI = NNBKOLMPOEA;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 905;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 905;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static EHLGNPMDHDF valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static EHLGNPMDHDF forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 905: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<EHLGNPMDHDF>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          EHLGNPMDHDF> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<EHLGNPMDHDF>() {
              public EHLGNPMDHDF findValueByNumber(int number) {
                return EHLGNPMDHDF.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq.getDescriptor().getEnumTypes().get(0);
      }

      private static final EHLGNPMDHDF[] VALUES = getStaticValuesArray();
      private static EHLGNPMDHDF[] getStaticValuesArray() {
        return new EHLGNPMDHDF[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, EAJIABGAOCI, 
        };
      }
      public static EHLGNPMDHDF valueOf(
      ...
      private EHLGNPMDHDF(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:DungeonEntryInfoReq.EHLGNPMDHDF)
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < scenePointIdList_.size(); i++) {
        output.writeMessage(12, scenePointIdList_.get(i));
      }
      if (pointId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < scenePointIdList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(12, scenePointIdList_.get(i));
      }
      if (pointId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq)) {
        return super.equals(obj);
      }
      DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq other = (DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq) obj;
    ...
    public int hashCode() {
      ...
      if (getScenePointIdListCount() > 0) {
        hash = (37 * hash) + SCENEPOINTIDLIST_FIELD_NUMBER;
    ...
    public static DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq parseFrom(
    ...
    public static DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq parseFrom(
    ...
    public static DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq prototype) {
    ...
    public static final class Builder extends
        ...
        DungeonEntryInfoReqOuterClass.DungeonEntryInfoReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return DungeonEntryInfoReqOuterClass.internal_static_DungeonEntryInfoReq_descriptor;
      }
      ...
      // Construct using DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq getDefaultInstanceForType() {
        return DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq.getDefaultInstance();
      }

      @java.lang.Override
      public DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq build() {
        DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq result = buildPartial();
      ...
      @java.lang.Override
      public DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq buildPartial() {
        DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq result = new DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq) {
          return mergeFrom((DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq)other);
        } else {
      ...
      public Builder mergeFrom(DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq other) {
        if (other == DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq) e.getUnfinishedMessage();
    ...
    private static final DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq();
    }

    public static DungeonEntryInfoReqOuterClass.DungeonEntryInfoReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "proto\"\300\001\n\023DungeonEntryInfoReq\022\017\n\007pointId" +
      "\030\016 \001(\r\022%\n\020scenePointIdList\030\014 \003(\0132\013.Uint3" +
      "2Pair\022\017\n\007sceneId\030\003 \001(\r\"`\n\013EHLGNPMDHDF\022\010\n" +
      "\004NONE\020\000\022\020\n\013PEPPOHPHJOJ\020\211\007\022\017\n\013DCDNILFDFLB" +
    ...
    internal_static_DungeonEntryInfoReq_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_DungeonEntryInfoReq_descriptor,
        new java.lang.String[] { "PointId", "ScenePointIdList", "SceneId", });
    Uint32PairOuterClass.getDescriptor();
  }
