...
public final class PlayerLoginReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 3538: {
              AdjustTrackingInfoOuterClass.AdjustTrackingInfo.Builder subBuilder = null;
              if (adjustTrackingInfo_ != null) {
                subBuilder = adjustTrackingInfo_.toBuilder();
              }
              adjustTrackingInfo_ = input.readMessage(AdjustTrackingInfoOuterClass.AdjustTrackingInfo.parser(), extensionRegistry);
              if (subBuilder != null) {
            ...
            case 5682: {
              TrackingIOInfoOuterClass.TrackingIOInfo.Builder subBuilder = null;
              if (trackingIoInfo_ != null) {
                subBuilder = trackingIoInfo_.toBuilder();
              }
              trackingIoInfo_ = input.readMessage(TrackingIOInfoOuterClass.TrackingIOInfo.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return PlayerLoginReqOuterClass.internal_static_PlayerLoginReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              PlayerLoginReqOuterClass.PlayerLoginReq.class, PlayerLoginReqOuterClass.PlayerLoginReq.Builder.class);
    }
    ...
    public enum EBCJABNOFCB
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return PlayerLoginReqOuterClass.PlayerLoginReq.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public TrackingIOInfoOuterClass.TrackingIOInfo getTrackingIoInfo() {
      return trackingIoInfo_ == null ? TrackingIOInfoOuterClass.TrackingIOInfo.getDefaultInstance() : trackingIoInfo_;
    }
    /**
     * <code>.TrackingIOInfo trackingIoInfo = 710;</code>
     */
    ...
    public AdjustTrackingInfoOuterClass.AdjustTrackingInfo getAdjustTrackingInfo() {
      return adjustTrackingInfo_ == null ? AdjustTrackingInfoOuterClass.AdjustTrackingInfo.getDefaultInstance() : adjustTrackingInfo_;
    }
    /**
     * <code>.AdjustTrackingInfo adjustTrackingInfo = 442;</code>
     */
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof PlayerLoginReqOuterClass.PlayerLoginReq)) {
        return super.equals(obj);
      }
      PlayerLoginReqOuterClass.PlayerLoginReq other = (PlayerLoginReqOuterClass.PlayerLoginReq) obj;
    ...
    public static PlayerLoginReqOuterClass.PlayerLoginReq parseFrom(
    ...
    public static PlayerLoginReqOuterClass.PlayerLoginReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static PlayerLoginReqOuterClass.PlayerLoginReq parseFrom(
    ...
    public static PlayerLoginReqOuterClass.PlayerLoginReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static PlayerLoginReqOuterClass.PlayerLoginReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static PlayerLoginReqOuterClass.PlayerLoginReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(PlayerLoginReqOuterClass.PlayerLoginReq prototype) {
    ...
    public static final class Builder extends
        ...
        PlayerLoginReqOuterClass.PlayerLoginReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return PlayerLoginReqOuterClass.internal_static_PlayerLoginReq_descriptor;
      }
      ...
      // Construct using PlayerLoginReqOuterClass.PlayerLoginReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public PlayerLoginReqOuterClass.PlayerLoginReq getDefaultInstanceForType() {
        return PlayerLoginReqOuterClass.PlayerLoginReq.getDefaultInstance();
      }

      @java.lang.Override
      public PlayerLoginReqOuterClass.PlayerLoginReq build() {
        PlayerLoginReqOuterClass.PlayerLoginReq result = buildPartial();
      ...
      @java.lang.Override
      public PlayerLoginReqOuterClass.PlayerLoginReq buildPartial() {
        PlayerLoginReqOuterClass.PlayerLoginReq result = new PlayerLoginReqOuterClass.PlayerLoginReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof PlayerLoginReqOuterClass.PlayerLoginReq) {
          return mergeFrom((PlayerLoginReqOuterClass.PlayerLoginReq)other);
        } else {
      ...
      public Builder mergeFrom(PlayerLoginReqOuterClass.PlayerLoginReq other) {
        if (other == PlayerLoginReqOuterClass.PlayerLoginReq.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        PlayerLoginReqOuterClass.PlayerLoginReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (PlayerLoginReqOuterClass.PlayerLoginReq) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          TrackingIOInfoOuterClass.TrackingIOInfo, TrackingIOInfoOuterClass.TrackingIOInfo.Builder, TrackingIOInfoOuterClass.TrackingIOInfoOrBuilder> trackingIoInfoBuilder_;
      /**
       * <code>.TrackingIOInfo trackingIoInfo = 710;</code>
       * @return Whether the trackingIoInfo field is set.
       */
      ...
      public Builder setTrackingIoInfo(
          TrackingIOInfoOuterClass.TrackingIOInfo.Builder builderForValue) {
        if (trackingIoInfoBuilder_ == null) {
      ...
      public Builder mergeTrackingIoInfo(TrackingIOInfoOuterClass.TrackingIOInfo value) {
        if (trackingIoInfoBuilder_ == null) {
          if (trackingIoInfo_ != null) {
            trackingIoInfo_ =
              TrackingIOInfoOuterClass.TrackingIOInfo.newBuilder(trackingIoInfo_).mergeFrom(value).buildPartial();
          } else {
            trackingIoInfo_ = value;
          }
          onChanged();
      ...
      public TrackingIOInfoOuterClass.TrackingIOInfoOrBuilder getTrackingIoInfoOrBuilder() {
        if (trackingIoInfoBuilder_ != null) {
          ...
          return trackingIoInfo_ == null ?
              TrackingIOInfoOuterClass.TrackingIOInfo.getDefaultInstance() : trackingIoInfo_;
        }
      }
      /**
       * <code>.TrackingIOInfo trackingIoInfo = 710;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          TrackingIOInfoOuterClass.TrackingIOInfo, TrackingIOInfoOuterClass.TrackingIOInfo.Builder, TrackingIOInfoOuterClass.TrackingIOInfoOrBuilder> 
  ...
  checkByteStringIsUtf8(value);
      ...
      private AdjustTrackingInfoOuterClass.AdjustTrackingInfo adjustTrackingInfo_;
      private com.google.protobuf.SingleFieldBuilderV3<
          AdjustTrackingInfoOuterClass.AdjustTrackingInfo, AdjustTrackingInfoOuterClass.AdjustTrackingInfo.Builder, AdjustTrackingInfoOuterClass.AdjustTrackingInfoOrBuilder> adjustTrackingInfoBuilder_;
      /**
       * <code>.AdjustTrackingInfo adjustTrackingInfo = 442;</code>
       * @return Whether the adjustTrackingInfo field is set.
       */
      ...
      public Builder setAdjustTrackingInfo(
          AdjustTrackingInfoOuterClass.AdjustTrackingInfo.Builder builderForValue) {
        if (adjustTrackingInfoBuilder_ == null) {
      ...
      public Builder mergeAdjustTrackingInfo(AdjustTrackingInfoOuterClass.AdjustTrackingInfo value) {
        if (adjustTrackingInfoBuilder_ == null) {
          if (adjustTrackingInfo_ != null) {
            adjustTrackingInfo_ =
              AdjustTrackingInfoOuterClass.AdjustTrackingInfo.newBuilder(adjustTrackingInfo_).mergeFrom(value).buildPartial();
          } else {
            adjustTrackingInfo_ = value;
          }
          onChanged();
      ...
      public AdjustTrackingInfoOuterClass.AdjustTrackingInfoOrBuilder getAdjustTrackingInfoOrBuilder() {
        if (adjustTrackingInfoBuilder_ != null) {
          ...
          return adjustTrackingInfo_ == null ?
              AdjustTrackingInfoOuterClass.AdjustTrackingInfo.getDefaultInstance() : adjustTrackingInfo_;
        }
      }
      /**
       * <code>.AdjustTrackingInfo adjustTrackingInfo = 442;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          AdjustTrackingInfoOuterClass.AdjustTrackingInfo, AdjustTrackingInfoOuterClass.AdjustTrackingInfo.Builder, AdjustTrackingInfoOuterClass.AdjustTrackingInfoOrBuilder> 
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final PlayerLoginReqOuterClass.PlayerLoginReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new PlayerLoginReqOuterClass.PlayerLoginReq();
    }

    public static PlayerLoginReqOuterClass.PlayerLoginReq getDefaultInstance() {
