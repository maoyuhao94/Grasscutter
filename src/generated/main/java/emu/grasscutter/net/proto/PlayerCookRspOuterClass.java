...
public final class PlayerCookRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 42: {
              ...
              recipeData_ = input.readMessage(CookRecipeDataOuterClass.CookRecipeData.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return PlayerCookRspOuterClass.internal_static_PlayerCookRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              PlayerCookRspOuterClass.PlayerCookRsp.class, PlayerCookRspOuterClass.PlayerCookRsp.Builder.class);
    }
    ...
    public enum FPFCHMGMNFC
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return PlayerCookRspOuterClass.PlayerCookRsp.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public CookRecipeDataOuterClass.CookRecipeData getRecipeData() {
      return recipeData_ == null ? CookRecipeDataOuterClass.CookRecipeData.getDefaultInstance() : recipeData_;
    }
    /**
     * <code>.CookRecipeData recipeData = 5;</code>
     */
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof PlayerCookRspOuterClass.PlayerCookRsp)) {
        return super.equals(obj);
      }
      PlayerCookRspOuterClass.PlayerCookRsp other = (PlayerCookRspOuterClass.PlayerCookRsp) obj;
    ...
    public static PlayerCookRspOuterClass.PlayerCookRsp parseFrom(
    ...
    public static PlayerCookRspOuterClass.PlayerCookRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static PlayerCookRspOuterClass.PlayerCookRsp parseFrom(
    ...
    public static PlayerCookRspOuterClass.PlayerCookRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static PlayerCookRspOuterClass.PlayerCookRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static PlayerCookRspOuterClass.PlayerCookRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(PlayerCookRspOuterClass.PlayerCookRsp prototype) {
    ...
    public static final class Builder extends
        ...
        PlayerCookRspOuterClass.PlayerCookRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return PlayerCookRspOuterClass.internal_static_PlayerCookRsp_descriptor;
      }
      ...
      // Construct using PlayerCookRspOuterClass.PlayerCookRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public PlayerCookRspOuterClass.PlayerCookRsp getDefaultInstanceForType() {
        return PlayerCookRspOuterClass.PlayerCookRsp.getDefaultInstance();
      }

      @java.lang.Override
      public PlayerCookRspOuterClass.PlayerCookRsp build() {
        PlayerCookRspOuterClass.PlayerCookRsp result = buildPartial();
      ...
      @java.lang.Override
      public PlayerCookRspOuterClass.PlayerCookRsp buildPartial() {
        PlayerCookRspOuterClass.PlayerCookRsp result = new PlayerCookRspOuterClass.PlayerCookRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof PlayerCookRspOuterClass.PlayerCookRsp) {
          return mergeFrom((PlayerCookRspOuterClass.PlayerCookRsp)other);
        } else {
      ...
      public Builder mergeFrom(PlayerCookRspOuterClass.PlayerCookRsp other) {
        if (other == PlayerCookRspOuterClass.PlayerCookRsp.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        PlayerCookRspOuterClass.PlayerCookRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (PlayerCookRspOuterClass.PlayerCookRsp) e.getUnfinishedMessage();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          CookRecipeDataOuterClass.CookRecipeData, CookRecipeDataOuterClass.CookRecipeData.Builder, CookRecipeDataOuterClass.CookRecipeDataOrBuilder> recipeDataBuilder_;
      /**
       * <code>.CookRecipeData recipeData = 5;</code>
       * @return Whether the recipeData field is set.
       */
      ...
      public Builder mergeRecipeData(CookRecipeDataOuterClass.CookRecipeData value) {
        if (recipeDataBuilder_ == null) {
          if (recipeData_ != null) {
            recipeData_ =
              CookRecipeDataOuterClass.CookRecipeData.newBuilder(recipeData_).mergeFrom(value).buildPartial();
          } else {
            recipeData_ = value;
          }
          onChanged();
      ...
      public CookRecipeDataOuterClass.CookRecipeDataOrBuilder getRecipeDataOrBuilder() {
        if (recipeDataBuilder_ != null) {
          ...
          return recipeData_ == null ?
              CookRecipeDataOuterClass.CookRecipeData.getDefaultInstance() : recipeData_;
        }
      }
      /**
       * <code>.CookRecipeData recipeData = 5;</code>
    ...
    private static final PlayerCookRspOuterClass.PlayerCookRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new PlayerCookRspOuterClass.PlayerCookRsp();
    }

    public static PlayerCookRspOuterClass.PlayerCookRsp getDefaultInstance() {
