...
public final class EnterRogueDiaryDungeonReqOuterClass {
  ...
  public interface EnterRogueDiaryDungeonReqOrBuilder extends
    ...
    /**
     * <code>repeated .RogueDiaryAvatar chosenAvatarList = 5;</code>
     */
    ...
    /**
     * <code>repeated uint32 chosenCardList = 2;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return EnterRogueDiaryDungeonReqOuterClass.internal_static_EnterRogueDiaryDungeonReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return EnterRogueDiaryDungeonReqOuterClass.internal_static_EnterRogueDiaryDungeonReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq.class, EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq.Builder.class);
    }

    /**
     * Protobuf enum {@code EnterRogueDiaryDungeonReq.HADGELIIHCG}
     */
    public enum HADGELIIHCG
       ...
       */
      public static final HADGELIIHCG DCDNILFDFLB = NONE;
      /**
       * <code>EAJIABGAOCI = 1;</code>
       */
      public static final HADGELIIHCG EAJIABGAOCI = NNBKOLMPOEA;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 8647;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 8647;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static HADGELIIHCG valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static HADGELIIHCG forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 8647: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<HADGELIIHCG>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          HADGELIIHCG> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<HADGELIIHCG>() {
              public HADGELIIHCG findValueByNumber(int number) {
                return HADGELIIHCG.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq.getDescriptor().getEnumTypes().get(0);
      }

      private static final HADGELIIHCG[] VALUES = getStaticValuesArray();
      private static HADGELIIHCG[] getStaticValuesArray() {
        return new HADGELIIHCG[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, EAJIABGAOCI, 
        };
      }
      public static HADGELIIHCG valueOf(
      ...
      private HADGELIIHCG(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:EnterRogueDiaryDungeonReq.HADGELIIHCG)
    }

    public static final int CHOSENAVATARLIST_FIELD_NUMBER = 5;
    ...
    public static final int CHOSENCARDLIST_FIELD_NUMBER = 2;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < chosenAvatarList_.size(); i++) {
        output.writeMessage(5, chosenAvatarList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < chosenAvatarList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(5, chosenAvatarList_.get(i));
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq)) {
        return super.equals(obj);
      }
      EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq other = (EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq) obj;
    ...
    public static EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq parseFrom(
    ...
    public static EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq parseFrom(
    ...
    public static EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq prototype) {
    ...
    public static final class Builder extends
        ...
        EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return EnterRogueDiaryDungeonReqOuterClass.internal_static_EnterRogueDiaryDungeonReq_descriptor;
      }
      ...
      // Construct using EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq getDefaultInstanceForType() {
        return EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq.getDefaultInstance();
      }

      @java.lang.Override
      public EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq build() {
        EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq result = buildPartial();
      ...
      @java.lang.Override
      public EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq buildPartial() {
        EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq result = new EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq) {
          return mergeFrom((EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq)other);
        } else {
      ...
      public Builder mergeFrom(EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq other) {
        if (other == EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq.getDefaultInstance()) return this;
        if (chosenAvatarListBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq) e.getUnfinishedMessage();
    ...
    private static final EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq();
    }

    public static EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "DiaryAvatar.proto\"\302\001\n\031EnterRogueDiaryDun" +
      "geonReq\022+\n\020chosenAvatarList\030\005 \003(\0132\021.Rogu" +
      "eDiaryAvatar\022\026\n\016chosenCardList\030\002 \003(\r\"`\n\013" +
      "HADGELIIHCG\022\010\n\004NONE\020\000\022\020\n\013PEPPOHPHJOJ\020\307C\022" +
