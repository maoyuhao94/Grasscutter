...
public final class GachaTransferItemOuterClass {
  ...
  public interface GachaTransferItemOrBuilder extends
    ...
    /**
     * <code>bool isTransferItemNew = 3;</code>
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 42: {
              ...
              item_ = input.readMessage(ItemParamOuterClass.ItemParam.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return GachaTransferItemOuterClass.internal_static_GachaTransferItem_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              GachaTransferItemOuterClass.GachaTransferItem.class, GachaTransferItemOuterClass.GachaTransferItem.Builder.class);
    }
    ...
    public ItemParamOuterClass.ItemParam getItem() {
      return item_ == null ? ItemParamOuterClass.ItemParam.getDefaultInstance() : item_;
    }
    /**
     * <code>.ItemParam item = 5;</code>
     */
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof GachaTransferItemOuterClass.GachaTransferItem)) {
        return super.equals(obj);
      }
      GachaTransferItemOuterClass.GachaTransferItem other = (GachaTransferItemOuterClass.GachaTransferItem) obj;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + ISTRANSFERITEMNEW_FIELD_NUMBER;
    ...
    public static GachaTransferItemOuterClass.GachaTransferItem parseFrom(
    ...
    public static GachaTransferItemOuterClass.GachaTransferItem parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static GachaTransferItemOuterClass.GachaTransferItem parseFrom(
    ...
    public static GachaTransferItemOuterClass.GachaTransferItem parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static GachaTransferItemOuterClass.GachaTransferItem parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static GachaTransferItemOuterClass.GachaTransferItem parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(GachaTransferItemOuterClass.GachaTransferItem prototype) {
    ...
    public static final class Builder extends
        ...
        GachaTransferItemOuterClass.GachaTransferItemOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return GachaTransferItemOuterClass.internal_static_GachaTransferItem_descriptor;
      }
      ...
      // Construct using GachaTransferItemOuterClass.GachaTransferItem.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public GachaTransferItemOuterClass.GachaTransferItem getDefaultInstanceForType() {
        return GachaTransferItemOuterClass.GachaTransferItem.getDefaultInstance();
      }

      @java.lang.Override
      public GachaTransferItemOuterClass.GachaTransferItem build() {
        GachaTransferItemOuterClass.GachaTransferItem result = buildPartial();
      ...
      @java.lang.Override
      public GachaTransferItemOuterClass.GachaTransferItem buildPartial() {
        GachaTransferItemOuterClass.GachaTransferItem result = new GachaTransferItemOuterClass.GachaTransferItem(this);
        if (itemBuilder_ == null) {
          result.item_ = item_;
        } else {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof GachaTransferItemOuterClass.GachaTransferItem) {
          return mergeFrom((GachaTransferItemOuterClass.GachaTransferItem)other);
        } else {
      ...
      public Builder mergeFrom(GachaTransferItemOuterClass.GachaTransferItem other) {
        if (other == GachaTransferItemOuterClass.GachaTransferItem.getDefaultInstance()) return this;
        if (other.hasItem()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        GachaTransferItemOuterClass.GachaTransferItem parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (GachaTransferItemOuterClass.GachaTransferItem) e.getUnfinishedMessage();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          ItemParamOuterClass.ItemParam, ItemParamOuterClass.ItemParam.Builder, ItemParamOuterClass.ItemParamOrBuilder> itemBuilder_;
      /**
       * <code>.ItemParam item = 5;</code>
       * @return Whether the item field is set.
       */
      ...
      public Builder mergeItem(ItemParamOuterClass.ItemParam value) {
        if (itemBuilder_ == null) {
          if (item_ != null) {
            item_ =
              ItemParamOuterClass.ItemParam.newBuilder(item_).mergeFrom(value).buildPartial();
          } else {
            item_ = value;
          }
          onChanged();
      ...
      public ItemParamOuterClass.ItemParamOrBuilder getItemOrBuilder() {
        if (itemBuilder_ != null) {
          ...
          return item_ == null ?
              ItemParamOuterClass.ItemParam.getDefaultInstance() : item_;
        }
      }
      /**
       * <code>.ItemParam item = 5;</code>
    ...
    private static final GachaTransferItemOuterClass.GachaTransferItem DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new GachaTransferItemOuterClass.GachaTransferItem();
    }

    public static GachaTransferItemOuterClass.GachaTransferItem getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ItemParam\022\031\n\021isTransferItemNew\030\003 \001(\010b\006pr" +
      "oto3"
    };
