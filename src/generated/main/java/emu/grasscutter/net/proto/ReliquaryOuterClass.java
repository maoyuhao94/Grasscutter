...
public final class ReliquaryOuterClass {
  ...
  public interface ReliquaryOrBuilder extends
    ...
    /**
     * <code>uint32 promoteLevel = 3;</code>
     * @return The promoteLevel.
     */
    int getPromoteLevel();

    /**
     * <code>uint32 mainPropId = 4;</code>
     * @return The mainPropId.
     */
    int getMainPropId();

    /**
     * <code>repeated uint32 appendPropIdList = 5;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return ReliquaryOuterClass.internal_static_Reliquary_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ReliquaryOuterClass.Reliquary.class, ReliquaryOuterClass.Reliquary.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof ReliquaryOuterClass.Reliquary)) {
        return super.equals(obj);
      }
      ReliquaryOuterClass.Reliquary other = (ReliquaryOuterClass.Reliquary) obj;
    ...
    public int hashCode() {
      ...
      if (getAppendPropIdListCount() > 0) {
        hash = (37 * hash) + APPENDPROPIDLIST_FIELD_NUMBER;
    ...
    public static ReliquaryOuterClass.Reliquary parseFrom(
    ...
    public static ReliquaryOuterClass.Reliquary parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ReliquaryOuterClass.Reliquary parseFrom(
    ...
    public static ReliquaryOuterClass.Reliquary parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ReliquaryOuterClass.Reliquary parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static ReliquaryOuterClass.Reliquary parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(ReliquaryOuterClass.Reliquary prototype) {
    ...
    public static final class Builder extends
        ...
        ReliquaryOuterClass.ReliquaryOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ReliquaryOuterClass.internal_static_Reliquary_descriptor;
      }
      ...
      // Construct using ReliquaryOuterClass.Reliquary.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public ReliquaryOuterClass.Reliquary getDefaultInstanceForType() {
        return ReliquaryOuterClass.Reliquary.getDefaultInstance();
      }

      @java.lang.Override
      public ReliquaryOuterClass.Reliquary build() {
        ReliquaryOuterClass.Reliquary result = buildPartial();
      ...
      @java.lang.Override
      public ReliquaryOuterClass.Reliquary buildPartial() {
        ReliquaryOuterClass.Reliquary result = new ReliquaryOuterClass.Reliquary(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ReliquaryOuterClass.Reliquary) {
          return mergeFrom((ReliquaryOuterClass.Reliquary)other);
        } else {
      ...
      public Builder mergeFrom(ReliquaryOuterClass.Reliquary other) {
        if (other == ReliquaryOuterClass.Reliquary.getDefaultInstance()) return this;
        if (other.getLevel() != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ReliquaryOuterClass.Reliquary parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ReliquaryOuterClass.Reliquary) e.getUnfinishedMessage();
    ...
    private static final ReliquaryOuterClass.Reliquary DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ReliquaryOuterClass.Reliquary();
    }

    public static ReliquaryOuterClass.Reliquary getDefaultInstance() {
