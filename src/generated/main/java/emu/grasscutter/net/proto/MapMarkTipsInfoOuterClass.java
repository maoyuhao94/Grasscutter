...
public final class MapMarkTipsInfoOuterClass {
  ...
  public interface MapMarkTipsInfoOrBuilder extends
    ...
    /**
     * <code>.MapMarkTipsType tipsType = 1;</code>
     ...
     * @return The tipsType.
     */
    MapMarkTipsTypeOuterClass.MapMarkTipsType getTipsType();

    /**
     * <code>repeated uint32 pointIdList = 2;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return MapMarkTipsInfoOuterClass.internal_static_MapMarkTipsInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return MapMarkTipsInfoOuterClass.internal_static_MapMarkTipsInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              MapMarkTipsInfoOuterClass.MapMarkTipsInfo.class, MapMarkTipsInfoOuterClass.MapMarkTipsInfo.Builder.class);
    }
     ...
     * @return The tipsType.
     */
    @java.lang.Override public MapMarkTipsTypeOuterClass.MapMarkTipsType getTipsType() {
      @SuppressWarnings("deprecation")
      MapMarkTipsTypeOuterClass.MapMarkTipsType result = MapMarkTipsTypeOuterClass.MapMarkTipsType.valueOf(tipsType_);
      return result == null ? MapMarkTipsTypeOuterClass.MapMarkTipsType.UNRECOGNIZED : result;
    }

    public static final int POINTIDLIST_FIELD_NUMBER = 2;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (tipsType_ != MapMarkTipsTypeOuterClass.MapMarkTipsType.MAP_MARK_TIPS_TYPE_DUNGEON_ELEMENT_TRIAL.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof MapMarkTipsInfoOuterClass.MapMarkTipsInfo)) {
        return super.equals(obj);
      }
      MapMarkTipsInfoOuterClass.MapMarkTipsInfo other = (MapMarkTipsInfoOuterClass.MapMarkTipsInfo) obj;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + TIPSTYPE_FIELD_NUMBER;
      hash = (53 * hash) + tipsType_;
      if (getPointIdListCount() > 0) {
        hash = (37 * hash) + POINTIDLIST_FIELD_NUMBER;
    ...
    public static MapMarkTipsInfoOuterClass.MapMarkTipsInfo parseFrom(
    ...
    public static MapMarkTipsInfoOuterClass.MapMarkTipsInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static MapMarkTipsInfoOuterClass.MapMarkTipsInfo parseFrom(
    ...
    public static MapMarkTipsInfoOuterClass.MapMarkTipsInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static MapMarkTipsInfoOuterClass.MapMarkTipsInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static MapMarkTipsInfoOuterClass.MapMarkTipsInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(MapMarkTipsInfoOuterClass.MapMarkTipsInfo prototype) {
    ...
    public static final class Builder extends
        ...
        MapMarkTipsInfoOuterClass.MapMarkTipsInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return MapMarkTipsInfoOuterClass.internal_static_MapMarkTipsInfo_descriptor;
      }
      ...
      // Construct using MapMarkTipsInfoOuterClass.MapMarkTipsInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public MapMarkTipsInfoOuterClass.MapMarkTipsInfo getDefaultInstanceForType() {
        return MapMarkTipsInfoOuterClass.MapMarkTipsInfo.getDefaultInstance();
      }

      @java.lang.Override
      public MapMarkTipsInfoOuterClass.MapMarkTipsInfo build() {
        MapMarkTipsInfoOuterClass.MapMarkTipsInfo result = buildPartial();
      ...
      @java.lang.Override
      public MapMarkTipsInfoOuterClass.MapMarkTipsInfo buildPartial() {
        MapMarkTipsInfoOuterClass.MapMarkTipsInfo result = new MapMarkTipsInfoOuterClass.MapMarkTipsInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof MapMarkTipsInfoOuterClass.MapMarkTipsInfo) {
          return mergeFrom((MapMarkTipsInfoOuterClass.MapMarkTipsInfo)other);
        } else {
      ...
      public Builder mergeFrom(MapMarkTipsInfoOuterClass.MapMarkTipsInfo other) {
        if (other == MapMarkTipsInfoOuterClass.MapMarkTipsInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        MapMarkTipsInfoOuterClass.MapMarkTipsInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (MapMarkTipsInfoOuterClass.MapMarkTipsInfo) e.getUnfinishedMessage();
       ...
       */
      @java.lang.Override
      public MapMarkTipsTypeOuterClass.MapMarkTipsType getTipsType() {
        @SuppressWarnings("deprecation")
        MapMarkTipsTypeOuterClass.MapMarkTipsType result = MapMarkTipsTypeOuterClass.MapMarkTipsType.valueOf(tipsType_);
        return result == null ? MapMarkTipsTypeOuterClass.MapMarkTipsType.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setTipsType(MapMarkTipsTypeOuterClass.MapMarkTipsType value) {
        if (value == null) {
    ...
    private static final MapMarkTipsInfoOuterClass.MapMarkTipsInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new MapMarkTipsInfoOuterClass.MapMarkTipsInfo();
    }

    public static MapMarkTipsInfoOuterClass.MapMarkTipsInfo getDefaultInstance() {
