...
public final class GCGMsgClientPerformOuterClass {
  ...
  public interface GCGMsgClientPerformOrBuilder extends
    ...
    /**
     * <code>.GCGClientPerformType performType = 2;</code>
     ...
     */
    GCGClientPerformTypeOuterClass.GCGClientPerformType getPerformType();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return GCGMsgClientPerformOuterClass.internal_static_GCGMsgClientPerform_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return GCGMsgClientPerformOuterClass.internal_static_GCGMsgClientPerform_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              GCGMsgClientPerformOuterClass.GCGMsgClientPerform.class, GCGMsgClientPerformOuterClass.GCGMsgClientPerform.Builder.class);
    }

    public static final int PERFORMTYPE_FIELD_NUMBER = 2;
     ...
     * @return The performType.
     */
    @java.lang.Override public GCGClientPerformTypeOuterClass.GCGClientPerformType getPerformType() {
      @SuppressWarnings("deprecation")
      GCGClientPerformTypeOuterClass.GCGClientPerformType result = GCGClientPerformTypeOuterClass.GCGClientPerformType.valueOf(performType_);
      return result == null ? GCGClientPerformTypeOuterClass.GCGClientPerformType.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (performType_ != GCGClientPerformTypeOuterClass.GCGClientPerformType.GCG_CLIENT_PERFORM_TYPE_INVALID.getNumber()) {
        output.writeEnum(2, performType_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (performType_ != GCGClientPerformTypeOuterClass.GCGClientPerformType.GCG_CLIENT_PERFORM_TYPE_INVALID.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
          .computeEnumSize(2, performType_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < paramList_.size(); i++) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof GCGMsgClientPerformOuterClass.GCGMsgClientPerform)) {
        return super.equals(obj);
      }
      GCGMsgClientPerformOuterClass.GCGMsgClientPerform other = (GCGMsgClientPerformOuterClass.GCGMsgClientPerform) obj;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + PERFORMTYPE_FIELD_NUMBER;
    ...
    public static GCGMsgClientPerformOuterClass.GCGMsgClientPerform parseFrom(
    ...
    public static GCGMsgClientPerformOuterClass.GCGMsgClientPerform parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static GCGMsgClientPerformOuterClass.GCGMsgClientPerform parseFrom(
    ...
    public static GCGMsgClientPerformOuterClass.GCGMsgClientPerform parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static GCGMsgClientPerformOuterClass.GCGMsgClientPerform parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static GCGMsgClientPerformOuterClass.GCGMsgClientPerform parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(GCGMsgClientPerformOuterClass.GCGMsgClientPerform prototype) {
    ...
    public static final class Builder extends
        ...
        GCGMsgClientPerformOuterClass.GCGMsgClientPerformOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return GCGMsgClientPerformOuterClass.internal_static_GCGMsgClientPerform_descriptor;
      }
      ...
      // Construct using GCGMsgClientPerformOuterClass.GCGMsgClientPerform.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public GCGMsgClientPerformOuterClass.GCGMsgClientPerform getDefaultInstanceForType() {
        return GCGMsgClientPerformOuterClass.GCGMsgClientPerform.getDefaultInstance();
      }

      @java.lang.Override
      public GCGMsgClientPerformOuterClass.GCGMsgClientPerform build() {
        GCGMsgClientPerformOuterClass.GCGMsgClientPerform result = buildPartial();
      ...
      @java.lang.Override
      public GCGMsgClientPerformOuterClass.GCGMsgClientPerform buildPartial() {
        GCGMsgClientPerformOuterClass.GCGMsgClientPerform result = new GCGMsgClientPerformOuterClass.GCGMsgClientPerform(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof GCGMsgClientPerformOuterClass.GCGMsgClientPerform) {
          return mergeFrom((GCGMsgClientPerformOuterClass.GCGMsgClientPerform)other);
        } else {
      ...
      public Builder mergeFrom(GCGMsgClientPerformOuterClass.GCGMsgClientPerform other) {
        if (other == GCGMsgClientPerformOuterClass.GCGMsgClientPerform.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        GCGMsgClientPerformOuterClass.GCGMsgClientPerform parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (GCGMsgClientPerformOuterClass.GCGMsgClientPerform) e.getUnfinishedMessage();
       ...
       */
      @java.lang.Override
      public GCGClientPerformTypeOuterClass.GCGClientPerformType getPerformType() {
        @SuppressWarnings("deprecation")
        GCGClientPerformTypeOuterClass.GCGClientPerformType result = GCGClientPerformTypeOuterClass.GCGClientPerformType.valueOf(performType_);
        return result == null ? GCGClientPerformTypeOuterClass.GCGClientPerformType.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setPerformType(GCGClientPerformTypeOuterClass.GCGClientPerformType value) {
        if (value == null) {
    ...
    private static final GCGMsgClientPerformOuterClass.GCGMsgClientPerform DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new GCGMsgClientPerformOuterClass.GCGMsgClientPerform();
    }

    public static GCGMsgClientPerformOuterClass.GCGMsgClientPerform getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\013performType\030\002 \001(\0162\025.GCGClientPerformTy" +
      "pe\022\021\n\tparamList\030\005 \003(\rb\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          GCGClientPerformTypeOuterClass.getDescriptor(),
        });
    internal_static_GCGMsgClientPerform_descriptor =
