...
public final class SetUpLunchBoxWidgetRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return SetUpLunchBoxWidgetRspOuterClass.internal_static_SetUpLunchBoxWidgetRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp.class, SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp.Builder.class);
    }
    ...
    public enum MEJCKKOKEFL
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp)) {
        return super.equals(obj);
      }
      SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp other = (SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp) obj;
    ...
    public static SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp parseFrom(
    ...
    public static SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp parseFrom(
    ...
    public static SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp prototype) {
    ...
    public static final class Builder extends
        ...
        SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return SetUpLunchBoxWidgetRspOuterClass.internal_static_SetUpLunchBoxWidgetRsp_descriptor;
      }
      ...
      // Construct using SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp getDefaultInstanceForType() {
        return SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp.getDefaultInstance();
      }

      @java.lang.Override
      public SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp build() {
        SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp result = buildPartial();
      ...
      @java.lang.Override
      public SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp buildPartial() {
        SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp result = new SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp(this);
        if (lunchBoxDataBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp) {
          return mergeFrom((SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp)other);
        } else {
      ...
      public Builder mergeFrom(SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp other) {
        if (other == SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp) e.getUnfinishedMessage();
    ...
    private static final SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp();
    }

    public static SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp getDefaultInstance() {
