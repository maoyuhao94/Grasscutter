...
public final class CoopDataNotifyOuterClass {
  ...
  public interface CoopDataNotifyOrBuilder extends
    ...
    /**
     * <code>repeated uint32 viewedChapterList = 8;</code>
    ...
    /**
     * <code>bool isHaveProgress = 14;</code>
     * @return The isHaveProgress.
     */
    boolean getIsHaveProgress();

    /**
     * <code>repeated .CoopChapter chapterList = 12;</code>
     */
    ...
    /**
     * <code>uint32 curCoopPoint = 1;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return CoopDataNotifyOuterClass.internal_static_CoopDataNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              CoopDataNotifyOuterClass.CoopDataNotify.class, CoopDataNotifyOuterClass.CoopDataNotify.Builder.class);
    }

    /**
     * Protobuf enum {@code CoopDataNotify.MBJJGCCJMPG}
     */
    public enum MBJJGCCJMPG
       ...
       */
      public static final MBJJGCCJMPG DCDNILFDFLB = NONE;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 1981;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 1981;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static MBJJGCCJMPG valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static MBJJGCCJMPG forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 1981: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<MBJJGCCJMPG>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          MBJJGCCJMPG> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<MBJJGCCJMPG>() {
              public MBJJGCCJMPG findValueByNumber(int number) {
                return MBJJGCCJMPG.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return CoopDataNotifyOuterClass.CoopDataNotify.getDescriptor().getEnumTypes().get(0);
      }

      private static final MBJJGCCJMPG[] VALUES = getStaticValuesArray();
      private static MBJJGCCJMPG[] getStaticValuesArray() {
        return new MBJJGCCJMPG[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, 
        };
      }
      public static MBJJGCCJMPG valueOf(
      ...
      private MBJJGCCJMPG(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:CoopDataNotify.MBJJGCCJMPG)
    }

    public static final int VIEWEDCHAPTERLIST_FIELD_NUMBER = 8;
    ...
    public static final int ISHAVEPROGRESS_FIELD_NUMBER = 14;
    ...
    public static final int CHAPTERLIST_FIELD_NUMBER = 12;
    ...
    public static final int CURCOOPPOINT_FIELD_NUMBER = 1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (curCoopPoint_ != 0) {
        output.writeUInt32(1, curCoopPoint_);
      }
      ...
      for (int i = 0; i < chapterList_.size(); i++) {
        output.writeMessage(12, chapterList_.get(i));
      }
      if (isHaveProgress_ != false) {
        output.writeBool(14, isHaveProgress_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (curCoopPoint_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, curCoopPoint_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < viewedChapterList_.size(); i++) {
      ...
      for (int i = 0; i < chapterList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(12, chapterList_.get(i));
      }
      if (isHaveProgress_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(14, isHaveProgress_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof CoopDataNotifyOuterClass.CoopDataNotify)) {
        return super.equals(obj);
      }
      CoopDataNotifyOuterClass.CoopDataNotify other = (CoopDataNotifyOuterClass.CoopDataNotify) obj;
    ...
    public static CoopDataNotifyOuterClass.CoopDataNotify parseFrom(
    ...
    public static CoopDataNotifyOuterClass.CoopDataNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static CoopDataNotifyOuterClass.CoopDataNotify parseFrom(
    ...
    public static CoopDataNotifyOuterClass.CoopDataNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static CoopDataNotifyOuterClass.CoopDataNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static CoopDataNotifyOuterClass.CoopDataNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(CoopDataNotifyOuterClass.CoopDataNotify prototype) {
    ...
    public static final class Builder extends
        ...
        CoopDataNotifyOuterClass.CoopDataNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return CoopDataNotifyOuterClass.internal_static_CoopDataNotify_descriptor;
      }
      ...
      // Construct using CoopDataNotifyOuterClass.CoopDataNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public CoopDataNotifyOuterClass.CoopDataNotify getDefaultInstanceForType() {
        return CoopDataNotifyOuterClass.CoopDataNotify.getDefaultInstance();
      }

      @java.lang.Override
      public CoopDataNotifyOuterClass.CoopDataNotify build() {
        CoopDataNotifyOuterClass.CoopDataNotify result = buildPartial();
      ...
      @java.lang.Override
      public CoopDataNotifyOuterClass.CoopDataNotify buildPartial() {
        CoopDataNotifyOuterClass.CoopDataNotify result = new CoopDataNotifyOuterClass.CoopDataNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof CoopDataNotifyOuterClass.CoopDataNotify) {
          return mergeFrom((CoopDataNotifyOuterClass.CoopDataNotify)other);
        } else {
      ...
      public Builder mergeFrom(CoopDataNotifyOuterClass.CoopDataNotify other) {
        if (other == CoopDataNotifyOuterClass.CoopDataNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        CoopDataNotifyOuterClass.CoopDataNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (CoopDataNotifyOuterClass.CoopDataNotify) e.getUnfinishedMessage();
    ...
    private static final CoopDataNotifyOuterClass.CoopDataNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new CoopDataNotifyOuterClass.CoopDataNotify();
    }

    public static CoopDataNotifyOuterClass.CoopDataNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "o\"\315\001\n\016CoopDataNotify\022\031\n\021viewedChapterLis" +
      "t\030\010 \003(\r\022\026\n\016isHaveProgress\030\016 \001(\010\022!\n\013chapt" +
      "erList\030\014 \003(\0132\014.CoopChapter\022\024\n\014curCoopPoi" +
      "nt\030\001 \001(\r\"O\n\013MBJJGCCJMPG\022\010\n\004NONE\020\000\022\020\n\013PEP" +
      "POHPHJOJ\020\275\017\022\017\n\013DCDNILFDFLB\020\000\022\017\n\013NNBKOLMP" +
    ...
    internal_static_CoopDataNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_CoopDataNotify_descriptor,
        new java.lang.String[] { "ViewedChapterList", "IsHaveProgress", "ChapterList", "CurCoopPoint", });
    CoopChapterOuterClass.getDescriptor();
  }
