...
public final class GCGMsgCostDiceOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return GCGMsgCostDiceOuterClass.internal_static_GCGMsgCostDice_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return GCGMsgCostDiceOuterClass.internal_static_GCGMsgCostDice_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              GCGMsgCostDiceOuterClass.GCGMsgCostDice.class, GCGMsgCostDiceOuterClass.GCGMsgCostDice.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof GCGMsgCostDiceOuterClass.GCGMsgCostDice)) {
        return super.equals(obj);
      }
      GCGMsgCostDiceOuterClass.GCGMsgCostDice other = (GCGMsgCostDiceOuterClass.GCGMsgCostDice) obj;
    ...
    public static GCGMsgCostDiceOuterClass.GCGMsgCostDice parseFrom(
    ...
    public static GCGMsgCostDiceOuterClass.GCGMsgCostDice parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static GCGMsgCostDiceOuterClass.GCGMsgCostDice parseFrom(
    ...
    public static GCGMsgCostDiceOuterClass.GCGMsgCostDice parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static GCGMsgCostDiceOuterClass.GCGMsgCostDice parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static GCGMsgCostDiceOuterClass.GCGMsgCostDice parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(GCGMsgCostDiceOuterClass.GCGMsgCostDice prototype) {
    ...
    public static final class Builder extends
        ...
        GCGMsgCostDiceOuterClass.GCGMsgCostDiceOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return GCGMsgCostDiceOuterClass.internal_static_GCGMsgCostDice_descriptor;
      }
      ...
      // Construct using GCGMsgCostDiceOuterClass.GCGMsgCostDice.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public GCGMsgCostDiceOuterClass.GCGMsgCostDice getDefaultInstanceForType() {
        return GCGMsgCostDiceOuterClass.GCGMsgCostDice.getDefaultInstance();
      }

      @java.lang.Override
      public GCGMsgCostDiceOuterClass.GCGMsgCostDice build() {
        GCGMsgCostDiceOuterClass.GCGMsgCostDice result = buildPartial();
      ...
      @java.lang.Override
      public GCGMsgCostDiceOuterClass.GCGMsgCostDice buildPartial() {
        GCGMsgCostDiceOuterClass.GCGMsgCostDice result = new GCGMsgCostDiceOuterClass.GCGMsgCostDice(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof GCGMsgCostDiceOuterClass.GCGMsgCostDice) {
          return mergeFrom((GCGMsgCostDiceOuterClass.GCGMsgCostDice)other);
        } else {
      ...
      public Builder mergeFrom(GCGMsgCostDiceOuterClass.GCGMsgCostDice other) {
        if (other == GCGMsgCostDiceOuterClass.GCGMsgCostDice.getDefaultInstance()) return this;
        if (other.reason_ != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        GCGMsgCostDiceOuterClass.GCGMsgCostDice parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (GCGMsgCostDiceOuterClass.GCGMsgCostDice) e.getUnfinishedMessage();
    ...
    private static final GCGMsgCostDiceOuterClass.GCGMsgCostDice DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new GCGMsgCostDiceOuterClass.GCGMsgCostDice();
    }

    public static GCGMsgCostDiceOuterClass.GCGMsgCostDice getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "eason\022\024\n\014controllerId\030\t \001(\r\022\033\n\023selectDic" +
      "eIndexList\030\010 \003(\rb\006proto3"
    };
