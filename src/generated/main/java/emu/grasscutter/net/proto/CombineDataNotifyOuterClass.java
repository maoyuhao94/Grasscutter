...
public final class CombineDataNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return CombineDataNotifyOuterClass.internal_static_CombineDataNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              CombineDataNotifyOuterClass.CombineDataNotify.class, CombineDataNotifyOuterClass.CombineDataNotify.Builder.class);
    }
    ...
    public enum NDHNHHMBEFA
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return CombineDataNotifyOuterClass.CombineDataNotify.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof CombineDataNotifyOuterClass.CombineDataNotify)) {
        return super.equals(obj);
      }
      CombineDataNotifyOuterClass.CombineDataNotify other = (CombineDataNotifyOuterClass.CombineDataNotify) obj;
    ...
    public static CombineDataNotifyOuterClass.CombineDataNotify parseFrom(
    ...
    public static CombineDataNotifyOuterClass.CombineDataNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static CombineDataNotifyOuterClass.CombineDataNotify parseFrom(
    ...
    public static CombineDataNotifyOuterClass.CombineDataNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static CombineDataNotifyOuterClass.CombineDataNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static CombineDataNotifyOuterClass.CombineDataNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(CombineDataNotifyOuterClass.CombineDataNotify prototype) {
    ...
    public static final class Builder extends
        ...
        CombineDataNotifyOuterClass.CombineDataNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return CombineDataNotifyOuterClass.internal_static_CombineDataNotify_descriptor;
      }
      ...
      // Construct using CombineDataNotifyOuterClass.CombineDataNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public CombineDataNotifyOuterClass.CombineDataNotify getDefaultInstanceForType() {
        return CombineDataNotifyOuterClass.CombineDataNotify.getDefaultInstance();
      }

      @java.lang.Override
      public CombineDataNotifyOuterClass.CombineDataNotify build() {
        CombineDataNotifyOuterClass.CombineDataNotify result = buildPartial();
      ...
      @java.lang.Override
      public CombineDataNotifyOuterClass.CombineDataNotify buildPartial() {
        CombineDataNotifyOuterClass.CombineDataNotify result = new CombineDataNotifyOuterClass.CombineDataNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof CombineDataNotifyOuterClass.CombineDataNotify) {
          return mergeFrom((CombineDataNotifyOuterClass.CombineDataNotify)other);
        } else {
      ...
      public Builder mergeFrom(CombineDataNotifyOuterClass.CombineDataNotify other) {
        if (other == CombineDataNotifyOuterClass.CombineDataNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        CombineDataNotifyOuterClass.CombineDataNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (CombineDataNotifyOuterClass.CombineDataNotify) e.getUnfinishedMessage();
    ...
    private static final CombineDataNotifyOuterClass.CombineDataNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new CombineDataNotifyOuterClass.CombineDataNotify();
    }

    public static CombineDataNotifyOuterClass.CombineDataNotify getDefaultInstance() {
