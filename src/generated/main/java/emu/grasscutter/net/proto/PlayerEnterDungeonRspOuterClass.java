  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return PlayerEnterDungeonRspOuterClass.internal_static_PlayerEnterDungeonRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp.class, PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp.Builder.class);
    }
    ...
    public enum IJHCMILABEE
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp)) {
        return super.equals(obj);
      }
      PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp other = (PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp) obj;
    ...
    public static PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp parseFrom(
    ...
    public static PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp parseFrom(
    ...
    public static PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp prototype) {
    ...
    public static final class Builder extends
        ...
        PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return PlayerEnterDungeonRspOuterClass.internal_static_PlayerEnterDungeonRsp_descriptor;
      }
      ...
      // Construct using PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp getDefaultInstanceForType() {
        return PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp.getDefaultInstance();
      }

      @java.lang.Override
      public PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp build() {
        PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp result = buildPartial();
      ...
      @java.lang.Override
      public PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp buildPartial() {
        PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp result = new PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp) {
          return mergeFrom((PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp)other);
        } else {
      ...
      public Builder mergeFrom(PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp other) {
        if (other == PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp) e.getUnfinishedMessage();
    ...
    private static final PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp();
    }

    public static PlayerEnterDungeonRspOuterClass.PlayerEnterDungeonRsp getDefaultInstance() {
