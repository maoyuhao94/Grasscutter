...
public final class CostDiceOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return CostDiceOuterClass.internal_static_CostDice_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return CostDiceOuterClass.internal_static_CostDice_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              CostDiceOuterClass.CostDice.class, CostDiceOuterClass.CostDice.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof CostDiceOuterClass.CostDice)) {
        return super.equals(obj);
      }
      CostDiceOuterClass.CostDice other = (CostDiceOuterClass.CostDice) obj;
    ...
    public static CostDiceOuterClass.CostDice parseFrom(
    ...
    public static CostDiceOuterClass.CostDice parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static CostDiceOuterClass.CostDice parseFrom(
    ...
    public static CostDiceOuterClass.CostDice parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static CostDiceOuterClass.CostDice parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static CostDiceOuterClass.CostDice parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(CostDiceOuterClass.CostDice prototype) {
    ...
    public static final class Builder extends
        ...
        CostDiceOuterClass.CostDiceOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return CostDiceOuterClass.internal_static_CostDice_descriptor;
      }
      ...
      // Construct using CostDiceOuterClass.CostDice.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public CostDiceOuterClass.CostDice getDefaultInstanceForType() {
        return CostDiceOuterClass.CostDice.getDefaultInstance();
      }

      @java.lang.Override
      public CostDiceOuterClass.CostDice build() {
        CostDiceOuterClass.CostDice result = buildPartial();
      ...
      @java.lang.Override
      public CostDiceOuterClass.CostDice buildPartial() {
        CostDiceOuterClass.CostDice result = new CostDiceOuterClass.CostDice(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof CostDiceOuterClass.CostDice) {
          return mergeFrom((CostDiceOuterClass.CostDice)other);
        } else {
      ...
      public Builder mergeFrom(CostDiceOuterClass.CostDice other) {
        if (other == CostDiceOuterClass.CostDice.getDefaultInstance()) return this;
        if (other.reason_ != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        CostDiceOuterClass.CostDice parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (CostDiceOuterClass.CostDice) e.getUnfinishedMessage();
    ...
    private static final CostDiceOuterClass.CostDice DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new CostDiceOuterClass.CostDice();
    }

    public static CostDiceOuterClass.CostDice getDefaultInstance() {
