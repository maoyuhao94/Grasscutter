...
public final class BuyGoodsParamOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return BuyGoodsParamOuterClass.internal_static_BuyGoodsParam_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              BuyGoodsParamOuterClass.BuyGoodsParam.class, BuyGoodsParamOuterClass.BuyGoodsParam.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof BuyGoodsParamOuterClass.BuyGoodsParam)) {
        return super.equals(obj);
      }
      BuyGoodsParamOuterClass.BuyGoodsParam other = (BuyGoodsParamOuterClass.BuyGoodsParam) obj;
    ...
    public static BuyGoodsParamOuterClass.BuyGoodsParam parseFrom(
    ...
    public static BuyGoodsParamOuterClass.BuyGoodsParam parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static BuyGoodsParamOuterClass.BuyGoodsParam parseFrom(
    ...
    public static BuyGoodsParamOuterClass.BuyGoodsParam parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static BuyGoodsParamOuterClass.BuyGoodsParam parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static BuyGoodsParamOuterClass.BuyGoodsParam parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(BuyGoodsParamOuterClass.BuyGoodsParam prototype) {
    ...
    public static final class Builder extends
        ...
        BuyGoodsParamOuterClass.BuyGoodsParamOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return BuyGoodsParamOuterClass.internal_static_BuyGoodsParam_descriptor;
      }
      ...
      // Construct using BuyGoodsParamOuterClass.BuyGoodsParam.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public BuyGoodsParamOuterClass.BuyGoodsParam getDefaultInstanceForType() {
        return BuyGoodsParamOuterClass.BuyGoodsParam.getDefaultInstance();
      }

      @java.lang.Override
      public BuyGoodsParamOuterClass.BuyGoodsParam build() {
        BuyGoodsParamOuterClass.BuyGoodsParam result = buildPartial();
      ...
      @java.lang.Override
      public BuyGoodsParamOuterClass.BuyGoodsParam buildPartial() {
        BuyGoodsParamOuterClass.BuyGoodsParam result = new BuyGoodsParamOuterClass.BuyGoodsParam(this);
        if (goodsBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof BuyGoodsParamOuterClass.BuyGoodsParam) {
          return mergeFrom((BuyGoodsParamOuterClass.BuyGoodsParam)other);
        } else {
      ...
      public Builder mergeFrom(BuyGoodsParamOuterClass.BuyGoodsParam other) {
        if (other == BuyGoodsParamOuterClass.BuyGoodsParam.getDefaultInstance()) return this;
        if (other.hasGoods()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        BuyGoodsParamOuterClass.BuyGoodsParam parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (BuyGoodsParamOuterClass.BuyGoodsParam) e.getUnfinishedMessage();
    ...
    private static final BuyGoodsParamOuterClass.BuyGoodsParam DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new BuyGoodsParamOuterClass.BuyGoodsParam();
    }

    public static BuyGoodsParamOuterClass.BuyGoodsParam getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ds\022\020\n\010buyCount\030\003 \001(\rb\006proto3"
    };
