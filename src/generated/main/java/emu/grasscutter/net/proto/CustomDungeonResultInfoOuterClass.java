...
public final class CustomDungeonResultInfoOuterClass {
  ...
  public interface CustomDungeonResultInfoOrBuilder extends
     ...
     */
    java.util.List<ChallengeBriefOuterClass.ChallengeBrief> 
        getChildChallengeListList();
    /**
     * <code>repeated .ChallengeBrief childChallengeList = 3;</code>
     */
    ChallengeBriefOuterClass.ChallengeBrief getChildChallengeList(int index);
    /**
     * <code>repeated .ChallengeBrief childChallengeList = 3;</code>
     */
     ...
     * <code>repeated .ChallengeBrief childChallengeList = 3;</code>
     */
    java.util.List<? extends ChallengeBriefOuterClass.ChallengeBriefOrBuilder> 
        getChildChallengeListOrBuilderList();
    /**
     * <code>repeated .ChallengeBrief childChallengeList = 3;</code>
     */
    ChallengeBriefOuterClass.ChallengeBriefOrBuilder getChildChallengeListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 26: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                childChallengeList_ = new java.util.ArrayList<ChallengeBriefOuterClass.ChallengeBrief>();
                mutable_bitField0_ |= 0x00000001;
              }
              childChallengeList_.add(
                  input.readMessage(ChallengeBriefOuterClass.ChallengeBrief.parser(), extensionRegistry));
              break;
            }
            case 32: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return CustomDungeonResultInfoOuterClass.internal_static_CustomDungeonResultInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo.class, CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo.Builder.class);
    }
     ...
     * @return The finishType.
     */
    @java.lang.Override public CustomDungeonFinishTypeOuterClass.CustomDungeonFinishType getFinishType() {
      @SuppressWarnings("deprecation")
      CustomDungeonFinishTypeOuterClass.CustomDungeonFinishType result = CustomDungeonFinishTypeOuterClass.CustomDungeonFinishType.valueOf(finishType_);
    ...
    private java.util.List<ChallengeBriefOuterClass.ChallengeBrief> childChallengeList_;
    /**
     * <code>repeated .ChallengeBrief childChallengeList = 3;</code>
     */
    @java.lang.Override
    public java.util.List<ChallengeBriefOuterClass.ChallengeBrief> getChildChallengeListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends ChallengeBriefOuterClass.ChallengeBriefOrBuilder> 
        getChildChallengeListOrBuilderList() {
      return childChallengeList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public ChallengeBriefOuterClass.ChallengeBriefOrBuilder getChildChallengeListOrBuilder(
        int index) {
      return childChallengeList_.get(index);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (finishType_ != CustomDungeonFinishTypeOuterClass.CustomDungeonFinishType.CUSTOM_DUNGEON_FINISH_TYPE_PLAY_NORMAL.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo)) {
        return super.equals(obj);
      }
      CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo other = (CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo) obj;
    ...
    public static CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo parseFrom(
    ...
    public static CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo parseFrom(
    ...
    public static CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo prototype) {
    ...
    public static final class Builder extends
        ...
        CustomDungeonResultInfoOuterClass.CustomDungeonResultInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return CustomDungeonResultInfoOuterClass.internal_static_CustomDungeonResultInfo_descriptor;
      }
      ...
      // Construct using CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo getDefaultInstanceForType() {
        return CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo.getDefaultInstance();
      }

      @java.lang.Override
      public CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo build() {
        CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo result = buildPartial();
      ...
      @java.lang.Override
      public CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo buildPartial() {
        CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo result = new CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo) {
          return mergeFrom((CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo)other);
        } else {
      ...
      public Builder mergeFrom(CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo other) {
        if (other == CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo) e.getUnfinishedMessage();
      ...
      private void ensureChildChallengeListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          childChallengeList_ = new java.util.ArrayList<ChallengeBriefOuterClass.ChallengeBrief>(childChallengeList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          ChallengeBriefOuterClass.ChallengeBrief, ChallengeBriefOuterClass.ChallengeBrief.Builder, ChallengeBriefOuterClass.ChallengeBriefOrBuilder> childChallengeListBuilder_;
      ...
      public Builder setChildChallengeList(
          int index, ChallengeBriefOuterClass.ChallengeBrief value) {
        if (childChallengeListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setChildChallengeList(
          int index, ChallengeBriefOuterClass.ChallengeBrief.Builder builderForValue) {
        if (childChallengeListBuilder_ == null) {
          ensureChildChallengeListIsMutable();
       ...
       */
      public Builder addChildChallengeList(
          ChallengeBriefOuterClass.ChallengeBrief.Builder builderForValue) {
        if (childChallengeListBuilder_ == null) {
          ensureChildChallengeListIsMutable();
      ...
      public Builder addAllChildChallengeList(
          java.lang.Iterable<? extends ChallengeBriefOuterClass.ChallengeBrief> values) {
        if (childChallengeListBuilder_ == null) {
          ensureChildChallengeListIsMutable();
       ...
       * <code>repeated .ChallengeBrief childChallengeList = 3;</code>
       */
      public ChallengeBriefOuterClass.ChallengeBrief.Builder getChildChallengeListBuilder(
          int index) {
      ...
      public ChallengeBriefOuterClass.ChallengeBrief.Builder addChildChallengeListBuilder() {
        return getChildChallengeListFieldBuilder().addBuilder(
            ChallengeBriefOuterClass.ChallengeBrief.getDefaultInstance());
      }
      /**
       * <code>repeated .ChallengeBrief childChallengeList = 3;</code>
       */
      public ChallengeBriefOuterClass.ChallengeBrief.Builder addChildChallengeListBuilder(
          int index) {
        return getChildChallengeListFieldBuilder().addBuilder(
            index, ChallengeBriefOuterClass.ChallengeBrief.getDefaultInstance());
      }
      /**
       * <code>repeated .ChallengeBrief childChallengeList = 3;</code>
       */
      public java.util.List<ChallengeBriefOuterClass.ChallengeBrief.Builder> 
           getChildChallengeListBuilderList() {
        return getChildChallengeListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          ChallengeBriefOuterClass.ChallengeBrief, ChallengeBriefOuterClass.ChallengeBrief.Builder, ChallengeBriefOuterClass.ChallengeBriefOrBuilder> 
          getChildChallengeListFieldBuilder() {
        if (childChallengeListBuilder_ == null) {
    ...
    private static final CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo();
    }

    public static CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo getDefaultInstance() {
