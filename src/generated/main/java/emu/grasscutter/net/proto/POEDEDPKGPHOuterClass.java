...
public final class POEDEDPKGPHOuterClass {
  ...
  public interface POEDEDPKGPHOrBuilder extends
     ...
     */
    java.util.List<MGKFOCKHAHIOuterClass.MGKFOCKHAHI> 
        getBlnaldeiekjList();
    /**
     * <code>repeated .MGKFOCKHAHI blnaldeiekj = 1;</code>
     */
    MGKFOCKHAHIOuterClass.MGKFOCKHAHI getBlnaldeiekj(int index);
    /**
     * <code>repeated .MGKFOCKHAHI blnaldeiekj = 1;</code>
     */
     ...
     * <code>repeated .MGKFOCKHAHI blnaldeiekj = 1;</code>
     */
    java.util.List<? extends MGKFOCKHAHIOuterClass.MGKFOCKHAHIOrBuilder> 
        getBlnaldeiekjOrBuilderList();
    /**
     * <code>repeated .MGKFOCKHAHI blnaldeiekj = 1;</code>
     */
    MGKFOCKHAHIOuterClass.MGKFOCKHAHIOrBuilder getBlnaldeiekjOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                blnaldeiekj_ = new java.util.ArrayList<MGKFOCKHAHIOuterClass.MGKFOCKHAHI>();
                mutable_bitField0_ |= 0x00000001;
              }
              blnaldeiekj_.add(
                  input.readMessage(MGKFOCKHAHIOuterClass.MGKFOCKHAHI.parser(), extensionRegistry));
              break;
            }
            case 18: {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return POEDEDPKGPHOuterClass.internal_static_POEDEDPKGPH_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return POEDEDPKGPHOuterClass.internal_static_POEDEDPKGPH_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              POEDEDPKGPHOuterClass.POEDEDPKGPH.class, POEDEDPKGPHOuterClass.POEDEDPKGPH.Builder.class);
    }

    public static final int BLNALDEIEKJ_FIELD_NUMBER = 1;
    private java.util.List<MGKFOCKHAHIOuterClass.MGKFOCKHAHI> blnaldeiekj_;
    /**
     * <code>repeated .MGKFOCKHAHI blnaldeiekj = 1;</code>
     */
    @java.lang.Override
    public java.util.List<MGKFOCKHAHIOuterClass.MGKFOCKHAHI> getBlnaldeiekjList() {
      return blnaldeiekj_;
    }
    /**
     * <code>repeated .MGKFOCKHAHI blnaldeiekj = 1;</code>
     */
    @java.lang.Override
    public java.util.List<? extends MGKFOCKHAHIOuterClass.MGKFOCKHAHIOrBuilder> 
        getBlnaldeiekjOrBuilderList() {
      return blnaldeiekj_;
    }
    /**
     ...
     */
    @java.lang.Override
    public MGKFOCKHAHIOuterClass.MGKFOCKHAHI getBlnaldeiekj(int index) {
     ...
     */
    @java.lang.Override
    public MGKFOCKHAHIOuterClass.MGKFOCKHAHIOrBuilder getBlnaldeiekjOrBuilder(
        int index) {
      return blnaldeiekj_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof POEDEDPKGPHOuterClass.POEDEDPKGPH)) {
        return super.equals(obj);
      }
      POEDEDPKGPHOuterClass.POEDEDPKGPH other = (POEDEDPKGPHOuterClass.POEDEDPKGPH) obj;
    ...
    public static POEDEDPKGPHOuterClass.POEDEDPKGPH parseFrom(
    ...
    public static POEDEDPKGPHOuterClass.POEDEDPKGPH parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static POEDEDPKGPHOuterClass.POEDEDPKGPH parseFrom(
    ...
    public static POEDEDPKGPHOuterClass.POEDEDPKGPH parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static POEDEDPKGPHOuterClass.POEDEDPKGPH parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static POEDEDPKGPHOuterClass.POEDEDPKGPH parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(POEDEDPKGPHOuterClass.POEDEDPKGPH prototype) {
    ...
    public static final class Builder extends
        ...
        POEDEDPKGPHOuterClass.POEDEDPKGPHOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return POEDEDPKGPHOuterClass.internal_static_POEDEDPKGPH_descriptor;
      }
      ...
      // Construct using POEDEDPKGPHOuterClass.POEDEDPKGPH.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public POEDEDPKGPHOuterClass.POEDEDPKGPH getDefaultInstanceForType() {
        return POEDEDPKGPHOuterClass.POEDEDPKGPH.getDefaultInstance();
      }

      @java.lang.Override
      public POEDEDPKGPHOuterClass.POEDEDPKGPH build() {
        POEDEDPKGPHOuterClass.POEDEDPKGPH result = buildPartial();
      ...
      @java.lang.Override
      public POEDEDPKGPHOuterClass.POEDEDPKGPH buildPartial() {
        POEDEDPKGPHOuterClass.POEDEDPKGPH result = new POEDEDPKGPHOuterClass.POEDEDPKGPH(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof POEDEDPKGPHOuterClass.POEDEDPKGPH) {
          return mergeFrom((POEDEDPKGPHOuterClass.POEDEDPKGPH)other);
        } else {
      ...
      public Builder mergeFrom(POEDEDPKGPHOuterClass.POEDEDPKGPH other) {
        if (other == POEDEDPKGPHOuterClass.POEDEDPKGPH.getDefaultInstance()) return this;
        if (blnaldeiekjBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        POEDEDPKGPHOuterClass.POEDEDPKGPH parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (POEDEDPKGPHOuterClass.POEDEDPKGPH) e.getUnfinishedMessage();
      ...
      private void ensureBlnaldeiekjIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          blnaldeiekj_ = new java.util.ArrayList<MGKFOCKHAHIOuterClass.MGKFOCKHAHI>(blnaldeiekj_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          MGKFOCKHAHIOuterClass.MGKFOCKHAHI, MGKFOCKHAHIOuterClass.MGKFOCKHAHI.Builder, MGKFOCKHAHIOuterClass.MGKFOCKHAHIOrBuilder> blnaldeiekjBuilder_;
      ...
      public Builder setBlnaldeiekj(
          int index, MGKFOCKHAHIOuterClass.MGKFOCKHAHI value) {
        if (blnaldeiekjBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setBlnaldeiekj(
          int index, MGKFOCKHAHIOuterClass.MGKFOCKHAHI.Builder builderForValue) {
        if (blnaldeiekjBuilder_ == null) {
          ensureBlnaldeiekjIsMutable();
       ...
       * <code>repeated .MGKFOCKHAHI blnaldeiekj = 1;</code>
       */
      public Builder addBlnaldeiekj(MGKFOCKHAHIOuterClass.MGKFOCKHAHI value) {
        if (blnaldeiekjBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addBlnaldeiekj(
          MGKFOCKHAHIOuterClass.MGKFOCKHAHI.Builder builderForValue) {
        if (blnaldeiekjBuilder_ == null) {
          ensureBlnaldeiekjIsMutable();
      ...
      public Builder addAllBlnaldeiekj(
          java.lang.Iterable<? extends MGKFOCKHAHIOuterClass.MGKFOCKHAHI> values) {
        if (blnaldeiekjBuilder_ == null) {
          ensureBlnaldeiekjIsMutable();
       ...
       * <code>repeated .MGKFOCKHAHI blnaldeiekj = 1;</code>
       */
      public MGKFOCKHAHIOuterClass.MGKFOCKHAHI.Builder getBlnaldeiekjBuilder(
          int index) {
       ...
       * <code>repeated .MGKFOCKHAHI blnaldeiekj = 1;</code>
       */
      public MGKFOCKHAHIOuterClass.MGKFOCKHAHI.Builder addBlnaldeiekjBuilder() {
        return getBlnaldeiekjFieldBuilder().addBuilder(
            MGKFOCKHAHIOuterClass.MGKFOCKHAHI.getDefaultInstance());
      }
      /**
       * <code>repeated .MGKFOCKHAHI blnaldeiekj = 1;</code>
       */
      public MGKFOCKHAHIOuterClass.MGKFOCKHAHI.Builder addBlnaldeiekjBuilder(
          int index) {
        return getBlnaldeiekjFieldBuilder().addBuilder(
            index, MGKFOCKHAHIOuterClass.MGKFOCKHAHI.getDefaultInstance());
      }
      /**
       * <code>repeated .MGKFOCKHAHI blnaldeiekj = 1;</code>
       */
      public java.util.List<MGKFOCKHAHIOuterClass.MGKFOCKHAHI.Builder> 
           getBlnaldeiekjBuilderList() {
        return getBlnaldeiekjFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          MGKFOCKHAHIOuterClass.MGKFOCKHAHI, MGKFOCKHAHIOuterClass.MGKFOCKHAHI.Builder, MGKFOCKHAHIOuterClass.MGKFOCKHAHIOrBuilder> 
          getBlnaldeiekjFieldBuilder() {
        if (blnaldeiekjBuilder_ == null) {
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final POEDEDPKGPHOuterClass.POEDEDPKGPH DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new POEDEDPKGPHOuterClass.POEDEDPKGPH();
    }

    public static POEDEDPKGPHOuterClass.POEDEDPKGPH getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          MGKFOCKHAHIOuterClass.getDescriptor(),
        });
    internal_static_POEDEDPKGPH_descriptor =
