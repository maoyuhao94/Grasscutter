...
public final class GachaWishRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return GachaWishRspOuterClass.internal_static_GachaWishRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              GachaWishRspOuterClass.GachaWishRsp.class, GachaWishRspOuterClass.GachaWishRsp.Builder.class);
    }
    ...
    public enum COIIDDMDPIL
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return GachaWishRspOuterClass.GachaWishRsp.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof GachaWishRspOuterClass.GachaWishRsp)) {
        return super.equals(obj);
      }
      GachaWishRspOuterClass.GachaWishRsp other = (GachaWishRspOuterClass.GachaWishRsp) obj;
    ...
    public static GachaWishRspOuterClass.GachaWishRsp parseFrom(
    ...
    public static GachaWishRspOuterClass.GachaWishRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static GachaWishRspOuterClass.GachaWishRsp parseFrom(
    ...
    public static GachaWishRspOuterClass.GachaWishRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static GachaWishRspOuterClass.GachaWishRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static GachaWishRspOuterClass.GachaWishRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(GachaWishRspOuterClass.GachaWishRsp prototype) {
    ...
    public static final class Builder extends
        ...
        GachaWishRspOuterClass.GachaWishRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return GachaWishRspOuterClass.internal_static_GachaWishRsp_descriptor;
      }
      ...
      // Construct using GachaWishRspOuterClass.GachaWishRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public GachaWishRspOuterClass.GachaWishRsp getDefaultInstanceForType() {
        return GachaWishRspOuterClass.GachaWishRsp.getDefaultInstance();
      }

      @java.lang.Override
      public GachaWishRspOuterClass.GachaWishRsp build() {
        GachaWishRspOuterClass.GachaWishRsp result = buildPartial();
      ...
      @java.lang.Override
      public GachaWishRspOuterClass.GachaWishRsp buildPartial() {
        GachaWishRspOuterClass.GachaWishRsp result = new GachaWishRspOuterClass.GachaWishRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof GachaWishRspOuterClass.GachaWishRsp) {
          return mergeFrom((GachaWishRspOuterClass.GachaWishRsp)other);
        } else {
      ...
      public Builder mergeFrom(GachaWishRspOuterClass.GachaWishRsp other) {
        if (other == GachaWishRspOuterClass.GachaWishRsp.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        GachaWishRspOuterClass.GachaWishRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (GachaWishRspOuterClass.GachaWishRsp) e.getUnfinishedMessage();
    ...
    private static final GachaWishRspOuterClass.GachaWishRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new GachaWishRspOuterClass.GachaWishRsp();
    }

    public static GachaWishRspOuterClass.GachaWishRsp getDefaultInstance() {
