...
public final class DelBackupAvatarTeamRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return DelBackupAvatarTeamRspOuterClass.internal_static_DelBackupAvatarTeamRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp.class, DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp.Builder.class);
    }
    ...
    public enum HMFPBAACAFA
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp)) {
        return super.equals(obj);
      }
      DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp other = (DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp) obj;
    ...
    public static DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp parseFrom(
    ...
    public static DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp parseFrom(
    ...
    public static DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp prototype) {
    ...
    public static final class Builder extends
        ...
        DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return DelBackupAvatarTeamRspOuterClass.internal_static_DelBackupAvatarTeamRsp_descriptor;
      }
      ...
      // Construct using DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp getDefaultInstanceForType() {
        return DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp.getDefaultInstance();
      }

      @java.lang.Override
      public DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp build() {
        DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp result = buildPartial();
      ...
      @java.lang.Override
      public DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp buildPartial() {
        DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp result = new DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp) {
          return mergeFrom((DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp)other);
        } else {
      ...
      public Builder mergeFrom(DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp other) {
        if (other == DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp) e.getUnfinishedMessage();
    ...
    private static final DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp();
    }

    public static DelBackupAvatarTeamRspOuterClass.DelBackupAvatarTeamRsp getDefaultInstance() {
