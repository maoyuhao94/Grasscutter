...
public final class GetDailyDungeonEntryInfoRspOuterClass {
  ...
  public interface GetDailyDungeonEntryInfoRspOrBuilder extends
     ...
     */
    java.util.List<DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo> 
        getDailyDungeonInfoListList();
    /**
     * <code>repeated .DailyDungeonEntryInfo dailyDungeonInfoList = 8;</code>
     */
    DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo getDailyDungeonInfoList(int index);
    /**
     * <code>repeated .DailyDungeonEntryInfo dailyDungeonInfoList = 8;</code>
     */
     ...
     * <code>repeated .DailyDungeonEntryInfo dailyDungeonInfoList = 8;</code>
     */
    java.util.List<? extends DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfoOrBuilder> 
        getDailyDungeonInfoListOrBuilderList();
    /**
     * <code>repeated .DailyDungeonEntryInfo dailyDungeonInfoList = 8;</code>
     */
    DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfoOrBuilder getDailyDungeonInfoListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 66: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                dailyDungeonInfoList_ = new java.util.ArrayList<DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo>();
                mutable_bitField0_ |= 0x00000001;
              }
              dailyDungeonInfoList_.add(
                  input.readMessage(DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo.parser(), extensionRegistry));
              break;
            }
            default: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return GetDailyDungeonEntryInfoRspOuterClass.internal_static_GetDailyDungeonEntryInfoRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp.class, GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp.Builder.class);
    }
    ...
    public enum KIAADEFNINL
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp.getDescriptor().getEnumTypes().get(0);
      }
    ...
    private java.util.List<DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo> dailyDungeonInfoList_;
    /**
     * <code>repeated .DailyDungeonEntryInfo dailyDungeonInfoList = 8;</code>
     */
    @java.lang.Override
    public java.util.List<DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo> getDailyDungeonInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfoOrBuilder> 
        getDailyDungeonInfoListOrBuilderList() {
      return dailyDungeonInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfoOrBuilder getDailyDungeonInfoListOrBuilder(
        int index) {
      return dailyDungeonInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp)) {
        return super.equals(obj);
      }
      GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp other = (GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp) obj;
    ...
    public static GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp parseFrom(
    ...
    public static GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp parseFrom(
    ...
    public static GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp prototype) {
    ...
    public static final class Builder extends
        ...
        GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return GetDailyDungeonEntryInfoRspOuterClass.internal_static_GetDailyDungeonEntryInfoRsp_descriptor;
      }
      ...
      // Construct using GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp getDefaultInstanceForType() {
        return GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp.getDefaultInstance();
      }

      @java.lang.Override
      public GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp build() {
        GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp result = buildPartial();
      ...
      @java.lang.Override
      public GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp buildPartial() {
        GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp result = new GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp) {
          return mergeFrom((GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp)other);
        } else {
      ...
      public Builder mergeFrom(GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp other) {
        if (other == GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp) e.getUnfinishedMessage();
      ...
      private void ensureDailyDungeonInfoListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          dailyDungeonInfoList_ = new java.util.ArrayList<DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo>(dailyDungeonInfoList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo, DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo.Builder, DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfoOrBuilder> dailyDungeonInfoListBuilder_;
      ...
      public Builder setDailyDungeonInfoList(
          int index, DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo value) {
        if (dailyDungeonInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setDailyDungeonInfoList(
          int index, DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo.Builder builderForValue) {
        if (dailyDungeonInfoListBuilder_ == null) {
          ensureDailyDungeonInfoListIsMutable();
       ...
       */
      public Builder addDailyDungeonInfoList(
          DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo.Builder builderForValue) {
        if (dailyDungeonInfoListBuilder_ == null) {
          ensureDailyDungeonInfoListIsMutable();
      ...
      public Builder addAllDailyDungeonInfoList(
          java.lang.Iterable<? extends DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo> values) {
        if (dailyDungeonInfoListBuilder_ == null) {
          ensureDailyDungeonInfoListIsMutable();
       ...
       * <code>repeated .DailyDungeonEntryInfo dailyDungeonInfoList = 8;</code>
       */
      public DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo.Builder getDailyDungeonInfoListBuilder(
          int index) {
      ...
      public DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo.Builder addDailyDungeonInfoListBuilder() {
        return getDailyDungeonInfoListFieldBuilder().addBuilder(
            DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .DailyDungeonEntryInfo dailyDungeonInfoList = 8;</code>
       */
      public DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo.Builder addDailyDungeonInfoListBuilder(
          int index) {
        return getDailyDungeonInfoListFieldBuilder().addBuilder(
            index, DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .DailyDungeonEntryInfo dailyDungeonInfoList = 8;</code>
       */
      public java.util.List<DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo.Builder> 
           getDailyDungeonInfoListBuilderList() {
        return getDailyDungeonInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo, DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo.Builder, DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfoOrBuilder> 
          getDailyDungeonInfoListFieldBuilder() {
        if (dailyDungeonInfoListBuilder_ == null) {
    ...
    private static final GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp();
    }

    public static GetDailyDungeonEntryInfoRspOuterClass.GetDailyDungeonEntryInfoRsp getDefaultInstance() {
