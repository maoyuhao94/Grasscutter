...
public final class WidgetCoolDownNotifyOuterClass {
  ...
  public interface WidgetCoolDownNotifyOrBuilder extends
     ...
     * <code>repeated .WidgetCoolDownData groupCoolDownDataList = 10;</code>
     */
    WidgetCoolDownDataOuterClass.WidgetCoolDownData getGroupCoolDownDataList(int index);
    /**
     * <code>repeated .WidgetCoolDownData groupCoolDownDataList = 10;</code>
     */
     ...
     * <code>repeated .WidgetCoolDownData groupCoolDownDataList = 10;</code>
     */
    WidgetCoolDownDataOuterClass.WidgetCoolDownDataOrBuilder getGroupCoolDownDataListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 82: {
              if (!((mutable_bitField0_ & 0x00000002) != 0)) {
                groupCoolDownDataList_ = new java.util.ArrayList<WidgetCoolDownDataOuterClass.WidgetCoolDownData>();
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return WidgetCoolDownNotifyOuterClass.internal_static_WidgetCoolDownNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify.class, WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify.Builder.class);
    }
    ...
    public enum EBLBOPIBPGA
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify.getDescriptor().getEnumTypes().get(0);
      }
    ...
    private java.util.List<WidgetCoolDownDataOuterClass.WidgetCoolDownData> groupCoolDownDataList_;
    /**
     * <code>repeated .WidgetCoolDownData groupCoolDownDataList = 10;</code>
     */
    @java.lang.Override
    public java.util.List<WidgetCoolDownDataOuterClass.WidgetCoolDownData> getGroupCoolDownDataListList() {
     ...
     */
    @java.lang.Override
    public WidgetCoolDownDataOuterClass.WidgetCoolDownDataOrBuilder getGroupCoolDownDataListOrBuilder(
        int index) {
      return groupCoolDownDataList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify)) {
        return super.equals(obj);
      }
      WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify other = (WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify) obj;
    ...
    public static WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify parseFrom(
    ...
    public static WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify parseFrom(
    ...
    public static WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify prototype) {
    ...
    public static final class Builder extends
        ...
        WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return WidgetCoolDownNotifyOuterClass.internal_static_WidgetCoolDownNotify_descriptor;
      }
      ...
      // Construct using WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify getDefaultInstanceForType() {
        return WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify.getDefaultInstance();
      }

      @java.lang.Override
      public WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify build() {
        WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify result = buildPartial();
      ...
      @java.lang.Override
      public WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify buildPartial() {
        WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify result = new WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify) {
          return mergeFrom((WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify)other);
        } else {
      ...
      public Builder mergeFrom(WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify other) {
        if (other == WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify.getDefaultInstance()) return this;
        if (normalCoolDownDataListBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify) e.getUnfinishedMessage();
      ...
      private void ensureGroupCoolDownDataListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          groupCoolDownDataList_ = new java.util.ArrayList<WidgetCoolDownDataOuterClass.WidgetCoolDownData>(groupCoolDownDataList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          WidgetCoolDownDataOuterClass.WidgetCoolDownData, WidgetCoolDownDataOuterClass.WidgetCoolDownData.Builder, WidgetCoolDownDataOuterClass.WidgetCoolDownDataOrBuilder> groupCoolDownDataListBuilder_;
       ...
       * <code>repeated .WidgetCoolDownData groupCoolDownDataList = 10;</code>
       */
      public WidgetCoolDownDataOuterClass.WidgetCoolDownData.Builder getGroupCoolDownDataListBuilder(
          int index) {
    ...
    private static final WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify();
    }

    public static WidgetCoolDownNotifyOuterClass.WidgetCoolDownNotify getDefaultInstance() {
