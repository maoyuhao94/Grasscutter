...
public final class MechanicusInfoOuterClass {
  ...
  public interface MechanicusInfoOrBuilder extends
     ...
     * <code>repeated .Uint32Pair gearLevelPairList = 6;</code>
     */
    Uint32PairOuterClass.Uint32Pair getGearLevelPairList(int index);
    /**
     * <code>repeated .Uint32Pair gearLevelPairList = 6;</code>
     */
     ...
     * <code>repeated .Uint32Pair gearLevelPairList = 6;</code>
     */
    Uint32PairOuterClass.Uint32PairOrBuilder getGearLevelPairListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 50: {
              if (!((mutable_bitField0_ & 0x00000002) != 0)) {
                gearLevelPairList_ = new java.util.ArrayList<Uint32PairOuterClass.Uint32Pair>();
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return MechanicusInfoOuterClass.internal_static_MechanicusInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return MechanicusInfoOuterClass.internal_static_MechanicusInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              MechanicusInfoOuterClass.MechanicusInfo.class, MechanicusInfoOuterClass.MechanicusInfo.Builder.class);
    }
    ...
    private java.util.List<Uint32PairOuterClass.Uint32Pair> gearLevelPairList_;
    /**
     * <code>repeated .Uint32Pair gearLevelPairList = 6;</code>
     */
    @java.lang.Override
    public java.util.List<Uint32PairOuterClass.Uint32Pair> getGearLevelPairListList() {
     ...
     */
    @java.lang.Override
    public Uint32PairOuterClass.Uint32Pair getGearLevelPairList(int index) {
     ...
     */
    @java.lang.Override
    public Uint32PairOuterClass.Uint32PairOrBuilder getGearLevelPairListOrBuilder(
        int index) {
      return gearLevelPairList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof MechanicusInfoOuterClass.MechanicusInfo)) {
        return super.equals(obj);
      }
      MechanicusInfoOuterClass.MechanicusInfo other = (MechanicusInfoOuterClass.MechanicusInfo) obj;
    ...
    public static MechanicusInfoOuterClass.MechanicusInfo parseFrom(
    ...
    public static MechanicusInfoOuterClass.MechanicusInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static MechanicusInfoOuterClass.MechanicusInfo parseFrom(
    ...
    public static MechanicusInfoOuterClass.MechanicusInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static MechanicusInfoOuterClass.MechanicusInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static MechanicusInfoOuterClass.MechanicusInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(MechanicusInfoOuterClass.MechanicusInfo prototype) {
    ...
    public static final class Builder extends
        ...
        MechanicusInfoOuterClass.MechanicusInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return MechanicusInfoOuterClass.internal_static_MechanicusInfo_descriptor;
      }
      ...
      // Construct using MechanicusInfoOuterClass.MechanicusInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public MechanicusInfoOuterClass.MechanicusInfo getDefaultInstanceForType() {
        return MechanicusInfoOuterClass.MechanicusInfo.getDefaultInstance();
      }

      @java.lang.Override
      public MechanicusInfoOuterClass.MechanicusInfo build() {
        MechanicusInfoOuterClass.MechanicusInfo result = buildPartial();
      ...
      @java.lang.Override
      public MechanicusInfoOuterClass.MechanicusInfo buildPartial() {
        MechanicusInfoOuterClass.MechanicusInfo result = new MechanicusInfoOuterClass.MechanicusInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof MechanicusInfoOuterClass.MechanicusInfo) {
          return mergeFrom((MechanicusInfoOuterClass.MechanicusInfo)other);
        } else {
      ...
      public Builder mergeFrom(MechanicusInfoOuterClass.MechanicusInfo other) {
        if (other == MechanicusInfoOuterClass.MechanicusInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        MechanicusInfoOuterClass.MechanicusInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (MechanicusInfoOuterClass.MechanicusInfo) e.getUnfinishedMessage();
      ...
      private void ensureGearLevelPairListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          gearLevelPairList_ = new java.util.ArrayList<Uint32PairOuterClass.Uint32Pair>(gearLevelPairList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          Uint32PairOuterClass.Uint32Pair, Uint32PairOuterClass.Uint32Pair.Builder, Uint32PairOuterClass.Uint32PairOrBuilder> gearLevelPairListBuilder_;
       ...
       * <code>repeated .Uint32Pair gearLevelPairList = 6;</code>
       */
      public Builder addGearLevelPairList(Uint32PairOuterClass.Uint32Pair value) {
        if (gearLevelPairListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .Uint32Pair gearLevelPairList = 6;</code>
       */
      public Uint32PairOuterClass.Uint32Pair.Builder getGearLevelPairListBuilder(
          int index) {
       ...
       * <code>repeated .Uint32Pair gearLevelPairList = 6;</code>
       */
      public Uint32PairOuterClass.Uint32Pair.Builder addGearLevelPairListBuilder() {
    ...
    private static final MechanicusInfoOuterClass.MechanicusInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new MechanicusInfoOuterClass.MechanicusInfo();
    }

    public static MechanicusInfoOuterClass.MechanicusInfo getDefaultInstance() {
