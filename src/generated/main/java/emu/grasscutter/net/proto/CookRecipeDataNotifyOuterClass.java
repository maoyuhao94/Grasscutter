...
public final class CookRecipeDataNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return CookRecipeDataNotifyOuterClass.internal_static_CookRecipeDataNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              CookRecipeDataNotifyOuterClass.CookRecipeDataNotify.class, CookRecipeDataNotifyOuterClass.CookRecipeDataNotify.Builder.class);
    }
    ...
    public enum OBKCEHGMAHN
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return CookRecipeDataNotifyOuterClass.CookRecipeDataNotify.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof CookRecipeDataNotifyOuterClass.CookRecipeDataNotify)) {
        return super.equals(obj);
      }
      CookRecipeDataNotifyOuterClass.CookRecipeDataNotify other = (CookRecipeDataNotifyOuterClass.CookRecipeDataNotify) obj;
    ...
    public static CookRecipeDataNotifyOuterClass.CookRecipeDataNotify parseFrom(
    ...
    public static CookRecipeDataNotifyOuterClass.CookRecipeDataNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static CookRecipeDataNotifyOuterClass.CookRecipeDataNotify parseFrom(
    ...
    public static CookRecipeDataNotifyOuterClass.CookRecipeDataNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static CookRecipeDataNotifyOuterClass.CookRecipeDataNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static CookRecipeDataNotifyOuterClass.CookRecipeDataNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(CookRecipeDataNotifyOuterClass.CookRecipeDataNotify prototype) {
    ...
    public static final class Builder extends
        ...
        CookRecipeDataNotifyOuterClass.CookRecipeDataNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return CookRecipeDataNotifyOuterClass.internal_static_CookRecipeDataNotify_descriptor;
      }
      ...
      // Construct using CookRecipeDataNotifyOuterClass.CookRecipeDataNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public CookRecipeDataNotifyOuterClass.CookRecipeDataNotify getDefaultInstanceForType() {
        return CookRecipeDataNotifyOuterClass.CookRecipeDataNotify.getDefaultInstance();
      }

      @java.lang.Override
      public CookRecipeDataNotifyOuterClass.CookRecipeDataNotify build() {
        CookRecipeDataNotifyOuterClass.CookRecipeDataNotify result = buildPartial();
      ...
      @java.lang.Override
      public CookRecipeDataNotifyOuterClass.CookRecipeDataNotify buildPartial() {
        CookRecipeDataNotifyOuterClass.CookRecipeDataNotify result = new CookRecipeDataNotifyOuterClass.CookRecipeDataNotify(this);
        if (recipeDataBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof CookRecipeDataNotifyOuterClass.CookRecipeDataNotify) {
          return mergeFrom((CookRecipeDataNotifyOuterClass.CookRecipeDataNotify)other);
        } else {
      ...
      public Builder mergeFrom(CookRecipeDataNotifyOuterClass.CookRecipeDataNotify other) {
        if (other == CookRecipeDataNotifyOuterClass.CookRecipeDataNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        CookRecipeDataNotifyOuterClass.CookRecipeDataNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (CookRecipeDataNotifyOuterClass.CookRecipeDataNotify) e.getUnfinishedMessage();
    ...
    private static final CookRecipeDataNotifyOuterClass.CookRecipeDataNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new CookRecipeDataNotifyOuterClass.CookRecipeDataNotify();
    }

    public static CookRecipeDataNotifyOuterClass.CookRecipeDataNotify getDefaultInstance() {
