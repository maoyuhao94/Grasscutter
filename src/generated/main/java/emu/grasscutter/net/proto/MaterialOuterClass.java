...
public final class MaterialOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return MaterialOuterClass.internal_static_Material_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              MaterialOuterClass.Material.class, MaterialOuterClass.Material.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof MaterialOuterClass.Material)) {
        return super.equals(obj);
      }
      MaterialOuterClass.Material other = (MaterialOuterClass.Material) obj;
    ...
    public static MaterialOuterClass.Material parseFrom(
    ...
    public static MaterialOuterClass.Material parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static MaterialOuterClass.Material parseFrom(
    ...
    public static MaterialOuterClass.Material parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static MaterialOuterClass.Material parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static MaterialOuterClass.Material parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(MaterialOuterClass.Material prototype) {
    ...
    public static final class Builder extends
        ...
        MaterialOuterClass.MaterialOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return MaterialOuterClass.internal_static_Material_descriptor;
      }
      ...
      // Construct using MaterialOuterClass.Material.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public MaterialOuterClass.Material getDefaultInstanceForType() {
        return MaterialOuterClass.Material.getDefaultInstance();
      }

      @java.lang.Override
      public MaterialOuterClass.Material build() {
        MaterialOuterClass.Material result = buildPartial();
      ...
      @java.lang.Override
      public MaterialOuterClass.Material buildPartial() {
        MaterialOuterClass.Material result = new MaterialOuterClass.Material(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof MaterialOuterClass.Material) {
          return mergeFrom((MaterialOuterClass.Material)other);
        } else {
      ...
      public Builder mergeFrom(MaterialOuterClass.Material other) {
        if (other == MaterialOuterClass.Material.getDefaultInstance()) return this;
        if (other.getCount() != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        MaterialOuterClass.Material parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (MaterialOuterClass.Material) e.getUnfinishedMessage();
    ...
    private static final MaterialOuterClass.Material DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new MaterialOuterClass.Material();
    }

    public static MaterialOuterClass.Material getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "nfo\030\002 \001(\0132\023.MaterialDeleteInfob\006proto3"
    };
