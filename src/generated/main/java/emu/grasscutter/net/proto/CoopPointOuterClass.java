...
public final class CoopPointOuterClass {
  ...
  public interface CoopPointOrBuilder extends
    ...
    /**
     * <code>uint32 selfConfidence = 15;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return CoopPointOuterClass.internal_static_CoopPoint_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              CoopPointOuterClass.CoopPoint.class, CoopPointOuterClass.CoopPoint.Builder.class);
    }
    ...
    public static final int SELFCONFIDENCE_FIELD_NUMBER = 15;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof CoopPointOuterClass.CoopPoint)) {
        return super.equals(obj);
      }
      CoopPointOuterClass.CoopPoint other = (CoopPointOuterClass.CoopPoint) obj;
    ...
    public static CoopPointOuterClass.CoopPoint parseFrom(
    ...
    public static CoopPointOuterClass.CoopPoint parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static CoopPointOuterClass.CoopPoint parseFrom(
    ...
    public static CoopPointOuterClass.CoopPoint parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static CoopPointOuterClass.CoopPoint parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static CoopPointOuterClass.CoopPoint parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(CoopPointOuterClass.CoopPoint prototype) {
    ...
    public static final class Builder extends
        ...
        CoopPointOuterClass.CoopPointOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return CoopPointOuterClass.internal_static_CoopPoint_descriptor;
      }
      ...
      // Construct using CoopPointOuterClass.CoopPoint.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public CoopPointOuterClass.CoopPoint getDefaultInstanceForType() {
        return CoopPointOuterClass.CoopPoint.getDefaultInstance();
      }

      @java.lang.Override
      public CoopPointOuterClass.CoopPoint build() {
        CoopPointOuterClass.CoopPoint result = buildPartial();
      ...
      @java.lang.Override
      public CoopPointOuterClass.CoopPoint buildPartial() {
        CoopPointOuterClass.CoopPoint result = new CoopPointOuterClass.CoopPoint(this);
        result.id_ = id_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof CoopPointOuterClass.CoopPoint) {
          return mergeFrom((CoopPointOuterClass.CoopPoint)other);
        } else {
      ...
      public Builder mergeFrom(CoopPointOuterClass.CoopPoint other) {
        if (other == CoopPointOuterClass.CoopPoint.getDefaultInstance()) return this;
        if (other.getId() != 0) {
          setId(other.getId());
        }
        if (other.state_ != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        CoopPointOuterClass.CoopPoint parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (CoopPointOuterClass.CoopPoint) e.getUnfinishedMessage();
    ...
    private static final CoopPointOuterClass.CoopPoint DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new CoopPointOuterClass.CoopPoint();
    }

    public static CoopPointOuterClass.CoopPoint getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\017CoopPoint.proto\032\013State.proto\"F\n\tCoopPo" +
      "int\022\n\n\002id\030\n \001(\r\022\025\n\005state\030\005 \001(\0162\006.State\022\026" +
      "\n\016selfConfidence\030\017 \001(\rb\006proto3"
    };
