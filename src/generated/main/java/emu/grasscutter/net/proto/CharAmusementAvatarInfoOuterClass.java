...
public final class CharAmusementAvatarInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return CharAmusementAvatarInfoOuterClass.internal_static_CharAmusementAvatarInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo.class, CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo)) {
        return super.equals(obj);
      }
      CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo other = (CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo) obj;
    ...
    public static CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo parseFrom(
    ...
    public static CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo parseFrom(
    ...
    public static CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo prototype) {
    ...
    public static final class Builder extends
        ...
        CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return CharAmusementAvatarInfoOuterClass.internal_static_CharAmusementAvatarInfo_descriptor;
      }
      ...
      // Construct using CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo getDefaultInstanceForType() {
        return CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo.getDefaultInstance();
      }

      @java.lang.Override
      public CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo build() {
        CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo result = buildPartial();
      ...
      @java.lang.Override
      public CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo buildPartial() {
        CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo result = new CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo) {
          return mergeFrom((CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo)other);
        } else {
      ...
      public Builder mergeFrom(CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo other) {
        if (other == CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo.getDefaultInstance()) return this;
        if (other.getUid() != 0) {
          setUid(other.getUid());
        }
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo) e.getUnfinishedMessage();
    ...
    private static final CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo();
    }

    public static CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "rIdList\030\013 \003(\r\022\023\n\013pmahgkplcgi\030\001 \001(\rb\006prot" +
      "o3"
    };
