...
public final class AbilityAppliedModifierOuterClass {
  ...
  private static final long serialVersionUID = 0L;
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 90: {
              ModifierDurabilityOuterClass.ModifierDurability.Builder subBuilder = null;
              if (modifierDurability_ != null) {
                subBuilder = modifierDurability_.toBuilder();
              }
              modifierDurability_ = input.readMessage(ModifierDurabilityOuterClass.ModifierDurability.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return AbilityAppliedModifierOuterClass.internal_static_AbilityAppliedModifier_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              AbilityAppliedModifierOuterClass.AbilityAppliedModifier.class, AbilityAppliedModifierOuterClass.AbilityAppliedModifier.Builder.class);
    }
    ...
    public ModifierDurabilityOuterClass.ModifierDurability getModifierDurability() {
      return modifierDurability_ == null ? ModifierDurabilityOuterClass.ModifierDurability.getDefaultInstance() : modifierDurability_;
    }
    /**
     * <code>.ModifierDurability modifierDurability = 11;</code>
     */
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof AbilityAppliedModifierOuterClass.AbilityAppliedModifier)) {
        return super.equals(obj);
      }
      AbilityAppliedModifierOuterClass.AbilityAppliedModifier other = (AbilityAppliedModifierOuterClass.AbilityAppliedModifier) obj;
    ...
    public static AbilityAppliedModifierOuterClass.AbilityAppliedModifier parseFrom(
    ...
    public static AbilityAppliedModifierOuterClass.AbilityAppliedModifier parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static AbilityAppliedModifierOuterClass.AbilityAppliedModifier parseFrom(
    ...
    public static AbilityAppliedModifierOuterClass.AbilityAppliedModifier parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static AbilityAppliedModifierOuterClass.AbilityAppliedModifier parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static AbilityAppliedModifierOuterClass.AbilityAppliedModifier parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(AbilityAppliedModifierOuterClass.AbilityAppliedModifier prototype) {
    ...
    public static final class Builder extends
        ...
        AbilityAppliedModifierOuterClass.AbilityAppliedModifierOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return AbilityAppliedModifierOuterClass.internal_static_AbilityAppliedModifier_descriptor;
      }
      ...
      // Construct using AbilityAppliedModifierOuterClass.AbilityAppliedModifier.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public AbilityAppliedModifierOuterClass.AbilityAppliedModifier getDefaultInstanceForType() {
        return AbilityAppliedModifierOuterClass.AbilityAppliedModifier.getDefaultInstance();
      }

      @java.lang.Override
      public AbilityAppliedModifierOuterClass.AbilityAppliedModifier build() {
        AbilityAppliedModifierOuterClass.AbilityAppliedModifier result = buildPartial();
      ...
      @java.lang.Override
      public AbilityAppliedModifierOuterClass.AbilityAppliedModifier buildPartial() {
        AbilityAppliedModifierOuterClass.AbilityAppliedModifier result = new AbilityAppliedModifierOuterClass.AbilityAppliedModifier(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof AbilityAppliedModifierOuterClass.AbilityAppliedModifier) {
          return mergeFrom((AbilityAppliedModifierOuterClass.AbilityAppliedModifier)other);
        } else {
      ...
      public Builder mergeFrom(AbilityAppliedModifierOuterClass.AbilityAppliedModifier other) {
        if (other == AbilityAppliedModifierOuterClass.AbilityAppliedModifier.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        AbilityAppliedModifierOuterClass.AbilityAppliedModifier parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (AbilityAppliedModifierOuterClass.AbilityAppliedModifier) e.getUnfinishedMessage();
      ...
      private ModifierDurabilityOuterClass.ModifierDurability modifierDurability_;
      private com.google.protobuf.SingleFieldBuilderV3<
          ModifierDurabilityOuterClass.ModifierDurability, ModifierDurabilityOuterClass.ModifierDurability.Builder, ModifierDurabilityOuterClass.ModifierDurabilityOrBuilder> modifierDurabilityBuilder_;
      /**
       * <code>.ModifierDurability modifierDurability = 11;</code>
       * @return Whether the modifierDurability field is set.
       */
      ...
      public Builder setModifierDurability(
          ModifierDurabilityOuterClass.ModifierDurability.Builder builderForValue) {
        if (modifierDurabilityBuilder_ == null) {
      ...
      public Builder mergeModifierDurability(ModifierDurabilityOuterClass.ModifierDurability value) {
        if (modifierDurabilityBuilder_ == null) {
          if (modifierDurability_ != null) {
            modifierDurability_ =
              ModifierDurabilityOuterClass.ModifierDurability.newBuilder(modifierDurability_).mergeFrom(value).buildPartial();
          } else {
            modifierDurability_ = value;
          }
          onChanged();
      ...
      public ModifierDurabilityOuterClass.ModifierDurabilityOrBuilder getModifierDurabilityOrBuilder() {
        if (modifierDurabilityBuilder_ != null) {
          ...
          return modifierDurability_ == null ?
              ModifierDurabilityOuterClass.ModifierDurability.getDefaultInstance() : modifierDurability_;
        }
      }
      /**
       * <code>.ModifierDurability modifierDurability = 11;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          ModifierDurabilityOuterClass.ModifierDurability, ModifierDurabilityOuterClass.ModifierDurability.Builder, ModifierDurabilityOuterClass.ModifierDurabilityOrBuilder> 
    ...
    private static final AbilityAppliedModifierOuterClass.AbilityAppliedModifier DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new AbilityAppliedModifierOuterClass.AbilityAppliedModifier();
    }

    public static AbilityAppliedModifierOuterClass.AbilityAppliedModifier getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "fModifier\030\r \001(\010b\006proto3"
    };
