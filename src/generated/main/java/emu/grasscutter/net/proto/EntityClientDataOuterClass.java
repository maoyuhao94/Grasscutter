...
public final class EntityClientDataOuterClass {
  ...
  public interface EntityClientDataOrBuilder extends
    ...
    /**
     * <code>uint32 windChangeSceneTime = 1;</code>
     * @return The windChangeSceneTime.
     */
    int getWindChangeSceneTime();

    /**
     * <code>float windmillSyncAngle = 2;</code>
     * @return The windmillSyncAngle.
     */
    float getWindmillSyncAngle();

    /**
     * <code>int32 windChangeTargetLevel = 3;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return EntityClientDataOuterClass.internal_static_EntityClientData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              EntityClientDataOuterClass.EntityClientData.class, EntityClientDataOuterClass.EntityClientData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof EntityClientDataOuterClass.EntityClientData)) {
        return super.equals(obj);
      }
      EntityClientDataOuterClass.EntityClientData other = (EntityClientDataOuterClass.EntityClientData) obj;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + WINDCHANGESCENETIME_FIELD_NUMBER;
      hash = (53 * hash) + getWindChangeSceneTime();
      hash = (37 * hash) + WINDMILLSYNCANGLE_FIELD_NUMBER;
      hash = (53 * hash) + java.lang.Float.floatToIntBits(
          getWindmillSyncAngle());
      hash = (37 * hash) + WINDCHANGETARGETLEVEL_FIELD_NUMBER;
    ...
    public static EntityClientDataOuterClass.EntityClientData parseFrom(
    ...
    public static EntityClientDataOuterClass.EntityClientData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static EntityClientDataOuterClass.EntityClientData parseFrom(
    ...
    public static EntityClientDataOuterClass.EntityClientData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static EntityClientDataOuterClass.EntityClientData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static EntityClientDataOuterClass.EntityClientData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(EntityClientDataOuterClass.EntityClientData prototype) {
    ...
    public static final class Builder extends
        ...
        EntityClientDataOuterClass.EntityClientDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return EntityClientDataOuterClass.internal_static_EntityClientData_descriptor;
      }
      ...
      // Construct using EntityClientDataOuterClass.EntityClientData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public EntityClientDataOuterClass.EntityClientData getDefaultInstanceForType() {
        return EntityClientDataOuterClass.EntityClientData.getDefaultInstance();
      }

      @java.lang.Override
      public EntityClientDataOuterClass.EntityClientData build() {
        EntityClientDataOuterClass.EntityClientData result = buildPartial();
      ...
      @java.lang.Override
      public EntityClientDataOuterClass.EntityClientData buildPartial() {
        EntityClientDataOuterClass.EntityClientData result = new EntityClientDataOuterClass.EntityClientData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof EntityClientDataOuterClass.EntityClientData) {
          return mergeFrom((EntityClientDataOuterClass.EntityClientData)other);
        } else {
      ...
      public Builder mergeFrom(EntityClientDataOuterClass.EntityClientData other) {
        if (other == EntityClientDataOuterClass.EntityClientData.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        EntityClientDataOuterClass.EntityClientData parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (EntityClientDataOuterClass.EntityClientData) e.getUnfinishedMessage();
    ...
    private static final EntityClientDataOuterClass.EntityClientData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new EntityClientDataOuterClass.EntityClientData();
    }

    public static EntityClientDataOuterClass.EntityClientData getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "dmillSyncAngle\030\002 \001(\002\022\035\n\025windChangeTarget" +
      "Level\030\003 \001(\005b\006proto3"
    };
