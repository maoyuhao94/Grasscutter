...
public final class TakeHuntingOfferReqOuterClass {
  ...
  public interface TakeHuntingOfferReqOrBuilder extends
    ...
    /**
     * <code>.HuntingPair huntingPair = 1;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return TakeHuntingOfferReqOuterClass.internal_static_TakeHuntingOfferReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return TakeHuntingOfferReqOuterClass.internal_static_TakeHuntingOfferReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq.class, TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq.Builder.class);
    }

    /**
     * Protobuf enum {@code TakeHuntingOfferReq.IBCEKBFOLAN}
     */
    public enum IBCEKBFOLAN
       ...
       */
      public static final IBCEKBFOLAN DCDNILFDFLB = NONE;
      /**
       * <code>EAJIABGAOCI = 1;</code>
       */
      public static final IBCEKBFOLAN EAJIABGAOCI = NNBKOLMPOEA;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 4338;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 4338;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static IBCEKBFOLAN valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static IBCEKBFOLAN forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 4338: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<IBCEKBFOLAN>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          IBCEKBFOLAN> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<IBCEKBFOLAN>() {
              public IBCEKBFOLAN findValueByNumber(int number) {
                return IBCEKBFOLAN.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq.getDescriptor().getEnumTypes().get(0);
      }

      private static final IBCEKBFOLAN[] VALUES = getStaticValuesArray();
      private static IBCEKBFOLAN[] getStaticValuesArray() {
        return new IBCEKBFOLAN[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, EAJIABGAOCI, 
        };
      }
      public static IBCEKBFOLAN valueOf(
      ...
      private IBCEKBFOLAN(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:TakeHuntingOfferReq.IBCEKBFOLAN)
    }

    public static final int HUNTINGPAIR_FIELD_NUMBER = 1;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq)) {
        return super.equals(obj);
      }
      TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq other = (TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq) obj;
    ...
    public static TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq parseFrom(
    ...
    public static TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq parseFrom(
    ...
    public static TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq prototype) {
    ...
    public static final class Builder extends
        ...
        TakeHuntingOfferReqOuterClass.TakeHuntingOfferReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return TakeHuntingOfferReqOuterClass.internal_static_TakeHuntingOfferReq_descriptor;
      }
      ...
      // Construct using TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq getDefaultInstanceForType() {
        return TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq.getDefaultInstance();
      }

      @java.lang.Override
      public TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq build() {
        TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq result = buildPartial();
      ...
      @java.lang.Override
      public TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq buildPartial() {
        TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq result = new TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq(this);
        if (huntingPairBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq) {
          return mergeFrom((TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq)other);
        } else {
      ...
      public Builder mergeFrom(TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq other) {
        if (other == TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq) e.getUnfinishedMessage();
    ...
    private static final TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq();
    }

    public static TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "gPair\030\001 \001(\0132\014.HuntingPair\022\016\n\006cityId\030\016 \001(" +
      "\r\"`\n\013IBCEKBFOLAN\022\010\n\004NONE\020\000\022\020\n\013PEPPOHPHJO" +
