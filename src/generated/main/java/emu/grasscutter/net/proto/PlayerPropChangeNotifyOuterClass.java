...
public final class PlayerPropChangeNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return PlayerPropChangeNotifyOuterClass.internal_static_PlayerPropChangeNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify.class, PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify.Builder.class);
    }
    ...
    public enum NHOMLNBEJIC
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify)) {
        return super.equals(obj);
      }
      PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify other = (PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify) obj;
    ...
    public static PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify parseFrom(
    ...
    public static PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify parseFrom(
    ...
    public static PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify prototype) {
    ...
    public static final class Builder extends
        ...
        PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return PlayerPropChangeNotifyOuterClass.internal_static_PlayerPropChangeNotify_descriptor;
      }
      ...
      // Construct using PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify getDefaultInstanceForType() {
        return PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify.getDefaultInstance();
      }

      @java.lang.Override
      public PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify build() {
        PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify result = buildPartial();
      ...
      @java.lang.Override
      public PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify buildPartial() {
        PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify result = new PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify) {
          return mergeFrom((PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify)other);
        } else {
      ...
      public Builder mergeFrom(PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify other) {
        if (other == PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify) e.getUnfinishedMessage();
    ...
    private static final PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify();
    }

    public static PlayerPropChangeNotifyOuterClass.PlayerPropChangeNotify getDefaultInstance() {
