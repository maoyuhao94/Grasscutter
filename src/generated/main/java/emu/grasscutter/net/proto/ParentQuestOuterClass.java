...
public final class ParentQuestOuterClass {
  ...
  public interface ParentQuestOrBuilder extends
     ...
     */
    java.util.List<ChildQuestOuterClass.ChildQuest> 
        getChildQuestListList();
    /**
     * <code>repeated .ChildQuest childQuestList = 10;</code>
     */
    ChildQuestOuterClass.ChildQuest getChildQuestList(int index);
    /**
     * <code>repeated .ChildQuest childQuestList = 10;</code>
     */
     ...
     * <code>repeated .ChildQuest childQuestList = 10;</code>
     */
    java.util.List<? extends ChildQuestOuterClass.ChildQuestOrBuilder> 
        getChildQuestListOrBuilderList();
    /**
     * <code>repeated .ChildQuest childQuestList = 10;</code>
     */
    ChildQuestOuterClass.ChildQuestOrBuilder getChildQuestListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 58: {
              ...
              randomInfo_ = input.readMessage(ParentQuestRandomInfoOuterClass.ParentQuestRandomInfo.parser(), extensionRegistry);
              if (subBuilder != null) {
            ...
            case 82: {
              if (!((mutable_bitField0_ & 0x00000002) != 0)) {
                childQuestList_ = new java.util.ArrayList<ChildQuestOuterClass.ChildQuest>();
                mutable_bitField0_ |= 0x00000002;
              }
              childQuestList_.add(
                  input.readMessage(ChildQuestOuterClass.ChildQuest.parser(), extensionRegistry));
              break;
            }
            case 88: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return ParentQuestOuterClass.internal_static_ParentQuest_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ParentQuestOuterClass.ParentQuest.class, ParentQuestOuterClass.ParentQuest.Builder.class);
    }
    ...
    public ParentQuestRandomInfoOuterClass.ParentQuestRandomInfo getRandomInfo() {
      return randomInfo_ == null ? ParentQuestRandomInfoOuterClass.ParentQuestRandomInfo.getDefaultInstance() : randomInfo_;
    }
    /**
     * <code>.ParentQuestRandomInfo randomInfo = 7;</code>
     */
    ...
    private java.util.List<ChildQuestOuterClass.ChildQuest> childQuestList_;
    /**
     * <code>repeated .ChildQuest childQuestList = 10;</code>
     */
    @java.lang.Override
    public java.util.List<ChildQuestOuterClass.ChildQuest> getChildQuestListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends ChildQuestOuterClass.ChildQuestOrBuilder> 
        getChildQuestListOrBuilderList() {
      return childQuestList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public ChildQuestOuterClass.ChildQuestOrBuilder getChildQuestListOrBuilder(
        int index) {
      return childQuestList_.get(index);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  ParentQuestOuterClass.internal_static_ParentQuest_TimeVarMapEntry_descriptor, 
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof ParentQuestOuterClass.ParentQuest)) {
        return super.equals(obj);
      }
      ParentQuestOuterClass.ParentQuest other = (ParentQuestOuterClass.ParentQuest) obj;
    ...
    public static ParentQuestOuterClass.ParentQuest parseFrom(
    ...
    public static ParentQuestOuterClass.ParentQuest parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ParentQuestOuterClass.ParentQuest parseFrom(
    ...
    public static ParentQuestOuterClass.ParentQuest parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ParentQuestOuterClass.ParentQuest parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static ParentQuestOuterClass.ParentQuest parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(ParentQuestOuterClass.ParentQuest prototype) {
    ...
    public static final class Builder extends
        ...
        ParentQuestOuterClass.ParentQuestOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ParentQuestOuterClass.internal_static_ParentQuest_descriptor;
      }
      ...
      // Construct using ParentQuestOuterClass.ParentQuest.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public ParentQuestOuterClass.ParentQuest getDefaultInstanceForType() {
        return ParentQuestOuterClass.ParentQuest.getDefaultInstance();
      }

      @java.lang.Override
      public ParentQuestOuterClass.ParentQuest build() {
        ParentQuestOuterClass.ParentQuest result = buildPartial();
      ...
      @java.lang.Override
      public ParentQuestOuterClass.ParentQuest buildPartial() {
        ParentQuestOuterClass.ParentQuest result = new ParentQuestOuterClass.ParentQuest(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ParentQuestOuterClass.ParentQuest) {
          return mergeFrom((ParentQuestOuterClass.ParentQuest)other);
        } else {
      ...
      public Builder mergeFrom(ParentQuestOuterClass.ParentQuest other) {
        if (other == ParentQuestOuterClass.ParentQuest.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ParentQuestOuterClass.ParentQuest parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ParentQuestOuterClass.ParentQuest) e.getUnfinishedMessage();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          ParentQuestRandomInfoOuterClass.ParentQuestRandomInfo, ParentQuestRandomInfoOuterClass.ParentQuestRandomInfo.Builder, ParentQuestRandomInfoOuterClass.ParentQuestRandomInfoOrBuilder> randomInfoBuilder_;
      /**
       * <code>.ParentQuestRandomInfo randomInfo = 7;</code>
       * @return Whether the randomInfo field is set.
       */
      ...
      public Builder setRandomInfo(
          ParentQuestRandomInfoOuterClass.ParentQuestRandomInfo.Builder builderForValue) {
        if (randomInfoBuilder_ == null) {
      ...
      public Builder mergeRandomInfo(ParentQuestRandomInfoOuterClass.ParentQuestRandomInfo value) {
        if (randomInfoBuilder_ == null) {
          if (randomInfo_ != null) {
            randomInfo_ =
              ParentQuestRandomInfoOuterClass.ParentQuestRandomInfo.newBuilder(randomInfo_).mergeFrom(value).buildPartial();
          } else {
            randomInfo_ = value;
          }
          onChanged();
      ...
      public ParentQuestRandomInfoOuterClass.ParentQuestRandomInfoOrBuilder getRandomInfoOrBuilder() {
        if (randomInfoBuilder_ != null) {
          ...
          return randomInfo_ == null ?
              ParentQuestRandomInfoOuterClass.ParentQuestRandomInfo.getDefaultInstance() : randomInfo_;
        }
      }
      /**
       * <code>.ParentQuestRandomInfo randomInfo = 7;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          ParentQuestRandomInfoOuterClass.ParentQuestRandomInfo, ParentQuestRandomInfoOuterClass.ParentQuestRandomInfo.Builder, ParentQuestRandomInfoOuterClass.ParentQuestRandomInfoOrBuilder> 
      ...
      private void ensureChildQuestListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          childQuestList_ = new java.util.ArrayList<ChildQuestOuterClass.ChildQuest>(childQuestList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          ChildQuestOuterClass.ChildQuest, ChildQuestOuterClass.ChildQuest.Builder, ChildQuestOuterClass.ChildQuestOrBuilder> childQuestListBuilder_;
      ...
      public Builder setChildQuestList(
          int index, ChildQuestOuterClass.ChildQuest value) {
        if (childQuestListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setChildQuestList(
          int index, ChildQuestOuterClass.ChildQuest.Builder builderForValue) {
        if (childQuestListBuilder_ == null) {
          ensureChildQuestListIsMutable();
       ...
       */
      public Builder addChildQuestList(
          ChildQuestOuterClass.ChildQuest.Builder builderForValue) {
        if (childQuestListBuilder_ == null) {
          ensureChildQuestListIsMutable();
      ...
      public Builder addAllChildQuestList(
          java.lang.Iterable<? extends ChildQuestOuterClass.ChildQuest> values) {
        if (childQuestListBuilder_ == null) {
          ensureChildQuestListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .ChildQuest childQuestList = 10;</code>
       */
      public ChildQuestOuterClass.ChildQuest.Builder getChildQuestListBuilder(
          int index) {
      ...
      public ChildQuestOuterClass.ChildQuest.Builder addChildQuestListBuilder() {
        return getChildQuestListFieldBuilder().addBuilder(
            ChildQuestOuterClass.ChildQuest.getDefaultInstance());
      }
      /**
       * <code>repeated .ChildQuest childQuestList = 10;</code>
       */
      public ChildQuestOuterClass.ChildQuest.Builder addChildQuestListBuilder(
          int index) {
        return getChildQuestListFieldBuilder().addBuilder(
            index, ChildQuestOuterClass.ChildQuest.getDefaultInstance());
      }
      /**
       * <code>repeated .ChildQuest childQuestList = 10;</code>
       */
      public java.util.List<ChildQuestOuterClass.ChildQuest.Builder> 
           getChildQuestListBuilderList() {
        return getChildQuestListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          ChildQuestOuterClass.ChildQuest, ChildQuestOuterClass.ChildQuest.Builder, ChildQuestOuterClass.ChildQuestOrBuilder> 
          getChildQuestListFieldBuilder() {
        if (childQuestListBuilder_ == null) {
    ...
    private static final ParentQuestOuterClass.ParentQuest DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ParentQuestOuterClass.ParentQuest();
    }

    public static ParentQuestOuterClass.ParentQuest getDefaultInstance() {
