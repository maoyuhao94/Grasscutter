...
public final class SceneRouteChangeInfoOuterClass {
  ...
  public interface SceneRouteChangeInfoOrBuilder extends
     ...
     */
    java.util.List<RoutePointChangeInfoOuterClass.RoutePointChangeInfo> 
        getPointListList();
    /**
     * <code>repeated .RoutePointChangeInfo pointList = 14;</code>
     */
    RoutePointChangeInfoOuterClass.RoutePointChangeInfo getPointList(int index);
    /**
     * <code>repeated .RoutePointChangeInfo pointList = 14;</code>
     */
     ...
     * <code>repeated .RoutePointChangeInfo pointList = 14;</code>
     */
    java.util.List<? extends RoutePointChangeInfoOuterClass.RoutePointChangeInfoOrBuilder> 
        getPointListOrBuilderList();
    /**
     * <code>repeated .RoutePointChangeInfo pointList = 14;</code>
     */
    RoutePointChangeInfoOuterClass.RoutePointChangeInfoOrBuilder getPointListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 114: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                pointList_ = new java.util.ArrayList<RoutePointChangeInfoOuterClass.RoutePointChangeInfo>();
                mutable_bitField0_ |= 0x00000001;
              }
              pointList_.add(
                  input.readMessage(RoutePointChangeInfoOuterClass.RoutePointChangeInfo.parser(), extensionRegistry));
              break;
            }
            default: {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return SceneRouteChangeInfoOuterClass.internal_static_SceneRouteChangeInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo.class, SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo.Builder.class);
    }
    ...
    private java.util.List<RoutePointChangeInfoOuterClass.RoutePointChangeInfo> pointList_;
    /**
     * <code>repeated .RoutePointChangeInfo pointList = 14;</code>
     */
    @java.lang.Override
    public java.util.List<RoutePointChangeInfoOuterClass.RoutePointChangeInfo> getPointListList() {
      return pointList_;
    }
    /**
     * <code>repeated .RoutePointChangeInfo pointList = 14;</code>
     */
    @java.lang.Override
    public java.util.List<? extends RoutePointChangeInfoOuterClass.RoutePointChangeInfoOrBuilder> 
        getPointListOrBuilderList() {
      return pointList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public RoutePointChangeInfoOuterClass.RoutePointChangeInfoOrBuilder getPointListOrBuilder(
        int index) {
      return pointList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo)) {
        return super.equals(obj);
      }
      SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo other = (SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo) obj;
    ...
    public static SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo parseFrom(
    ...
    public static SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo parseFrom(
    ...
    public static SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo prototype) {
    ...
    public static final class Builder extends
        ...
        SceneRouteChangeInfoOuterClass.SceneRouteChangeInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return SceneRouteChangeInfoOuterClass.internal_static_SceneRouteChangeInfo_descriptor;
      }
      ...
      // Construct using SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo getDefaultInstanceForType() {
        return SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo.getDefaultInstance();
      }

      @java.lang.Override
      public SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo build() {
        SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo result = buildPartial();
      ...
      @java.lang.Override
      public SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo buildPartial() {
        SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo result = new SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo) {
          return mergeFrom((SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo)other);
        } else {
      ...
      public Builder mergeFrom(SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo other) {
        if (other == SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo) e.getUnfinishedMessage();
      ...
      private void ensurePointListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          pointList_ = new java.util.ArrayList<RoutePointChangeInfoOuterClass.RoutePointChangeInfo>(pointList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          RoutePointChangeInfoOuterClass.RoutePointChangeInfo, RoutePointChangeInfoOuterClass.RoutePointChangeInfo.Builder, RoutePointChangeInfoOuterClass.RoutePointChangeInfoOrBuilder> pointListBuilder_;
      ...
      public Builder setPointList(
          int index, RoutePointChangeInfoOuterClass.RoutePointChangeInfo value) {
        if (pointListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setPointList(
          int index, RoutePointChangeInfoOuterClass.RoutePointChangeInfo.Builder builderForValue) {
        if (pointListBuilder_ == null) {
          ensurePointListIsMutable();
       ...
       */
      public Builder addPointList(
          RoutePointChangeInfoOuterClass.RoutePointChangeInfo.Builder builderForValue) {
        if (pointListBuilder_ == null) {
          ensurePointListIsMutable();
      ...
      public Builder addAllPointList(
          java.lang.Iterable<? extends RoutePointChangeInfoOuterClass.RoutePointChangeInfo> values) {
        if (pointListBuilder_ == null) {
          ensurePointListIsMutable();
       ...
       * <code>repeated .RoutePointChangeInfo pointList = 14;</code>
       */
      public RoutePointChangeInfoOuterClass.RoutePointChangeInfo.Builder getPointListBuilder(
          int index) {
      ...
      public RoutePointChangeInfoOuterClass.RoutePointChangeInfo.Builder addPointListBuilder() {
        return getPointListFieldBuilder().addBuilder(
            RoutePointChangeInfoOuterClass.RoutePointChangeInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .RoutePointChangeInfo pointList = 14;</code>
       */
      public RoutePointChangeInfoOuterClass.RoutePointChangeInfo.Builder addPointListBuilder(
          int index) {
        return getPointListFieldBuilder().addBuilder(
            index, RoutePointChangeInfoOuterClass.RoutePointChangeInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .RoutePointChangeInfo pointList = 14;</code>
       */
      public java.util.List<RoutePointChangeInfoOuterClass.RoutePointChangeInfo.Builder> 
           getPointListBuilderList() {
        return getPointListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          RoutePointChangeInfoOuterClass.RoutePointChangeInfo, RoutePointChangeInfoOuterClass.RoutePointChangeInfo.Builder, RoutePointChangeInfoOuterClass.RoutePointChangeInfoOrBuilder> 
          getPointListFieldBuilder() {
        if (pointListBuilder_ == null) {
    ...
    private static final SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo();
    }

    public static SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "outeId\030\006 \001(\rb\006proto3"
    };
