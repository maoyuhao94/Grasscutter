...
public final class AvatarPromoteRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return AvatarPromoteRspOuterClass.internal_static_AvatarPromoteRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              AvatarPromoteRspOuterClass.AvatarPromoteRsp.class, AvatarPromoteRspOuterClass.AvatarPromoteRsp.Builder.class);
    }
    ...
    public enum CNLNLEOAILH
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return AvatarPromoteRspOuterClass.AvatarPromoteRsp.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof AvatarPromoteRspOuterClass.AvatarPromoteRsp)) {
        return super.equals(obj);
      }
      AvatarPromoteRspOuterClass.AvatarPromoteRsp other = (AvatarPromoteRspOuterClass.AvatarPromoteRsp) obj;
    ...
    public static AvatarPromoteRspOuterClass.AvatarPromoteRsp parseFrom(
    ...
    public static AvatarPromoteRspOuterClass.AvatarPromoteRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static AvatarPromoteRspOuterClass.AvatarPromoteRsp parseFrom(
    ...
    public static AvatarPromoteRspOuterClass.AvatarPromoteRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static AvatarPromoteRspOuterClass.AvatarPromoteRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static AvatarPromoteRspOuterClass.AvatarPromoteRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(AvatarPromoteRspOuterClass.AvatarPromoteRsp prototype) {
    ...
    public static final class Builder extends
        ...
        AvatarPromoteRspOuterClass.AvatarPromoteRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return AvatarPromoteRspOuterClass.internal_static_AvatarPromoteRsp_descriptor;
      }
      ...
      // Construct using AvatarPromoteRspOuterClass.AvatarPromoteRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public AvatarPromoteRspOuterClass.AvatarPromoteRsp getDefaultInstanceForType() {
        return AvatarPromoteRspOuterClass.AvatarPromoteRsp.getDefaultInstance();
      }

      @java.lang.Override
      public AvatarPromoteRspOuterClass.AvatarPromoteRsp build() {
        AvatarPromoteRspOuterClass.AvatarPromoteRsp result = buildPartial();
      ...
      @java.lang.Override
      public AvatarPromoteRspOuterClass.AvatarPromoteRsp buildPartial() {
        AvatarPromoteRspOuterClass.AvatarPromoteRsp result = new AvatarPromoteRspOuterClass.AvatarPromoteRsp(this);
        result.guid_ = guid_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof AvatarPromoteRspOuterClass.AvatarPromoteRsp) {
          return mergeFrom((AvatarPromoteRspOuterClass.AvatarPromoteRsp)other);
        } else {
      ...
      public Builder mergeFrom(AvatarPromoteRspOuterClass.AvatarPromoteRsp other) {
        if (other == AvatarPromoteRspOuterClass.AvatarPromoteRsp.getDefaultInstance()) return this;
        if (other.getGuid() != 0L) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        AvatarPromoteRspOuterClass.AvatarPromoteRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (AvatarPromoteRspOuterClass.AvatarPromoteRsp) e.getUnfinishedMessage();
    ...
    private static final AvatarPromoteRspOuterClass.AvatarPromoteRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new AvatarPromoteRspOuterClass.AvatarPromoteRsp();
    }

    public static AvatarPromoteRspOuterClass.AvatarPromoteRsp getDefaultInstance() {
