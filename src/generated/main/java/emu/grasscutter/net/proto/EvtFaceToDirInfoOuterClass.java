...
public final class EvtFaceToDirInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return EvtFaceToDirInfoOuterClass.internal_static_EvtFaceToDirInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return EvtFaceToDirInfoOuterClass.internal_static_EvtFaceToDirInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo.class, EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo)) {
        return super.equals(obj);
      }
      EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo other = (EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo) obj;
    ...
    public static EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo parseFrom(
    ...
    public static EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo parseFrom(
    ...
    public static EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo prototype) {
    ...
    public static final class Builder extends
        ...
        EvtFaceToDirInfoOuterClass.EvtFaceToDirInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return EvtFaceToDirInfoOuterClass.internal_static_EvtFaceToDirInfo_descriptor;
      }
      ...
      // Construct using EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo getDefaultInstanceForType() {
        return EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo.getDefaultInstance();
      }

      @java.lang.Override
      public EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo build() {
        EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo result = buildPartial();
      ...
      @java.lang.Override
      public EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo buildPartial() {
        EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo result = new EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo(this);
        if (faceDirBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo) {
          return mergeFrom((EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo)other);
        } else {
      ...
      public Builder mergeFrom(EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo other) {
        if (other == EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo.getDefaultInstance()) return this;
        if (other.hasFaceDir()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo) e.getUnfinishedMessage();
    ...
    private static final EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo();
    }

    public static EvtFaceToDirInfoOuterClass.EvtFaceToDirInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\026EvtFaceToDirInfo.proto\032\016Rotation.proto" +
      "\"@\n\020EvtFaceToDirInfo\022\032\n\007faceDir\030\002 \001(\0132\t." +
      "Rotation\022\020\n\010entityId\030\005 \001(\rb\006proto3"
    };
