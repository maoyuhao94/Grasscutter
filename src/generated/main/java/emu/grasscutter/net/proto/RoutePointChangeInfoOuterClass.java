...
public final class RoutePointChangeInfoOuterClass {
  ...
  public interface RoutePointChangeInfoOrBuilder extends
    ...
    /**
     * <code>float targetVelocity = 7;</code>
     * @return The targetVelocity.
     */
    float getTargetVelocity();

    /**
     * <code>uint32 pointIndex = 11;</code>
     * @return The pointIndex.
     */
    int getPointIndex();

    /**
     * <code>float waitTime = 15;</code>
     * @return The waitTime.
     */
    float getWaitTime();
  }
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return RoutePointChangeInfoOuterClass.internal_static_RoutePointChangeInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              RoutePointChangeInfoOuterClass.RoutePointChangeInfo.class, RoutePointChangeInfoOuterClass.RoutePointChangeInfo.Builder.class);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (java.lang.Float.floatToRawIntBits(targetVelocity_) != 0) {
        output.writeFloat(7, targetVelocity_);
      }
      if (pointIndex_ != 0) {
        output.writeUInt32(11, pointIndex_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (java.lang.Float.floatToRawIntBits(targetVelocity_) != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeFloatSize(7, targetVelocity_);
      }
      if (pointIndex_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(11, pointIndex_);
      }
      if (java.lang.Float.floatToRawIntBits(waitTime_) != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof RoutePointChangeInfoOuterClass.RoutePointChangeInfo)) {
        return super.equals(obj);
      }
      RoutePointChangeInfoOuterClass.RoutePointChangeInfo other = (RoutePointChangeInfoOuterClass.RoutePointChangeInfo) obj;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + TARGETVELOCITY_FIELD_NUMBER;
    ...
    public static RoutePointChangeInfoOuterClass.RoutePointChangeInfo parseFrom(
    ...
    public static RoutePointChangeInfoOuterClass.RoutePointChangeInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static RoutePointChangeInfoOuterClass.RoutePointChangeInfo parseFrom(
    ...
    public static RoutePointChangeInfoOuterClass.RoutePointChangeInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static RoutePointChangeInfoOuterClass.RoutePointChangeInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static RoutePointChangeInfoOuterClass.RoutePointChangeInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(RoutePointChangeInfoOuterClass.RoutePointChangeInfo prototype) {
    ...
    public static final class Builder extends
        ...
        RoutePointChangeInfoOuterClass.RoutePointChangeInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return RoutePointChangeInfoOuterClass.internal_static_RoutePointChangeInfo_descriptor;
      }
      ...
      // Construct using RoutePointChangeInfoOuterClass.RoutePointChangeInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public RoutePointChangeInfoOuterClass.RoutePointChangeInfo getDefaultInstanceForType() {
        return RoutePointChangeInfoOuterClass.RoutePointChangeInfo.getDefaultInstance();
      }

      @java.lang.Override
      public RoutePointChangeInfoOuterClass.RoutePointChangeInfo build() {
        RoutePointChangeInfoOuterClass.RoutePointChangeInfo result = buildPartial();
      ...
      @java.lang.Override
      public RoutePointChangeInfoOuterClass.RoutePointChangeInfo buildPartial() {
        RoutePointChangeInfoOuterClass.RoutePointChangeInfo result = new RoutePointChangeInfoOuterClass.RoutePointChangeInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof RoutePointChangeInfoOuterClass.RoutePointChangeInfo) {
          return mergeFrom((RoutePointChangeInfoOuterClass.RoutePointChangeInfo)other);
        } else {
      ...
      public Builder mergeFrom(RoutePointChangeInfoOuterClass.RoutePointChangeInfo other) {
        if (other == RoutePointChangeInfoOuterClass.RoutePointChangeInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        RoutePointChangeInfoOuterClass.RoutePointChangeInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (RoutePointChangeInfoOuterClass.RoutePointChangeInfo) e.getUnfinishedMessage();
    ...
    private static final RoutePointChangeInfoOuterClass.RoutePointChangeInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new RoutePointChangeInfoOuterClass.RoutePointChangeInfo();
    }

    public static RoutePointChangeInfoOuterClass.RoutePointChangeInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\032RoutePointChangeInfo.proto\"T\n\024RoutePoi" +
      "ntChangeInfo\022\026\n\016targetVelocity\030\007 \001(\002\022\022\n\n" +
      "pointIndex\030\013 \001(\r\022\020\n\010waitTime\030\017 \001(\002b\006prot" +
      "o3"
    };
