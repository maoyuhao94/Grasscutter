...
public final class PrivateChatNotifyOuterClass {
  ...
  public interface PrivateChatNotifyOrBuilder extends
    ...
    /**
     * <code>.ChatInfo chatInfo = 15;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return PrivateChatNotifyOuterClass.internal_static_PrivateChatNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              PrivateChatNotifyOuterClass.PrivateChatNotify.class, PrivateChatNotifyOuterClass.PrivateChatNotify.Builder.class);
    }

    /**
     * Protobuf enum {@code PrivateChatNotify.NIGEJLOFMAO}
     */
    public enum NIGEJLOFMAO
       ...
       */
      public static final NIGEJLOFMAO DCDNILFDFLB = NONE;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 5037;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 5037;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static NIGEJLOFMAO valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static NIGEJLOFMAO forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 5037: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<NIGEJLOFMAO>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          NIGEJLOFMAO> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<NIGEJLOFMAO>() {
              public NIGEJLOFMAO findValueByNumber(int number) {
                return NIGEJLOFMAO.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return PrivateChatNotifyOuterClass.PrivateChatNotify.getDescriptor().getEnumTypes().get(0);
      }

      private static final NIGEJLOFMAO[] VALUES = getStaticValuesArray();
      private static NIGEJLOFMAO[] getStaticValuesArray() {
        return new NIGEJLOFMAO[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, 
        };
      }
      public static NIGEJLOFMAO valueOf(
      ...
      private NIGEJLOFMAO(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:PrivateChatNotify.NIGEJLOFMAO)
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof PrivateChatNotifyOuterClass.PrivateChatNotify)) {
        return super.equals(obj);
      }
      PrivateChatNotifyOuterClass.PrivateChatNotify other = (PrivateChatNotifyOuterClass.PrivateChatNotify) obj;
    ...
    public static PrivateChatNotifyOuterClass.PrivateChatNotify parseFrom(
    ...
    public static PrivateChatNotifyOuterClass.PrivateChatNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static PrivateChatNotifyOuterClass.PrivateChatNotify parseFrom(
    ...
    public static PrivateChatNotifyOuterClass.PrivateChatNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static PrivateChatNotifyOuterClass.PrivateChatNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static PrivateChatNotifyOuterClass.PrivateChatNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(PrivateChatNotifyOuterClass.PrivateChatNotify prototype) {
    ...
    public static final class Builder extends
        ...
        PrivateChatNotifyOuterClass.PrivateChatNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return PrivateChatNotifyOuterClass.internal_static_PrivateChatNotify_descriptor;
      }
      ...
      // Construct using PrivateChatNotifyOuterClass.PrivateChatNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public PrivateChatNotifyOuterClass.PrivateChatNotify getDefaultInstanceForType() {
        return PrivateChatNotifyOuterClass.PrivateChatNotify.getDefaultInstance();
      }

      @java.lang.Override
      public PrivateChatNotifyOuterClass.PrivateChatNotify build() {
        PrivateChatNotifyOuterClass.PrivateChatNotify result = buildPartial();
      ...
      @java.lang.Override
      public PrivateChatNotifyOuterClass.PrivateChatNotify buildPartial() {
        PrivateChatNotifyOuterClass.PrivateChatNotify result = new PrivateChatNotifyOuterClass.PrivateChatNotify(this);
        if (chatInfoBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof PrivateChatNotifyOuterClass.PrivateChatNotify) {
          return mergeFrom((PrivateChatNotifyOuterClass.PrivateChatNotify)other);
        } else {
      ...
      public Builder mergeFrom(PrivateChatNotifyOuterClass.PrivateChatNotify other) {
        if (other == PrivateChatNotifyOuterClass.PrivateChatNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        PrivateChatNotifyOuterClass.PrivateChatNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (PrivateChatNotifyOuterClass.PrivateChatNotify) e.getUnfinishedMessage();
    ...
    private static final PrivateChatNotifyOuterClass.PrivateChatNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new PrivateChatNotifyOuterClass.PrivateChatNotify();
    }

    public static PrivateChatNotifyOuterClass.PrivateChatNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "o\"\201\001\n\021PrivateChatNotify\022\033\n\010chatInfo\030\017 \001(" +
      "\0132\t.ChatInfo\"O\n\013NIGEJLOFMAO\022\010\n\004NONE\020\000\022\020\n" +
