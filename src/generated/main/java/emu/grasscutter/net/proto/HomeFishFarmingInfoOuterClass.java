...
public final class HomeFishFarmingInfoOuterClass {
  ...
  public interface HomeFishFarmingInfoOrBuilder extends
    ...
    /**
     * <code>uint32 fishpondGuid = 4;</code>
     * @return The fishpondGuid.
     */
    int getFishpondGuid();

    /**
     * <code>repeated uint32 fishIdList = 6;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return HomeFishFarmingInfoOuterClass.internal_static_HomeFishFarmingInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return HomeFishFarmingInfoOuterClass.internal_static_HomeFishFarmingInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo.class, HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo.Builder.class);
    }

    public static final int FISHPONDGUID_FIELD_NUMBER = 4;
    ...
    public static final int FISHIDLIST_FIELD_NUMBER = 6;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (fishpondGuid_ != 0) {
        output.writeUInt32(4, fishpondGuid_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (fishpondGuid_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(4, fishpondGuid_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < fishIdList_.size(); i++) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo)) {
        return super.equals(obj);
      }
      HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo other = (HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo) obj;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + FISHPONDGUID_FIELD_NUMBER;
    ...
    public static HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo parseFrom(
    ...
    public static HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo parseFrom(
    ...
    public static HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo prototype) {
    ...
    public static final class Builder extends
        ...
        HomeFishFarmingInfoOuterClass.HomeFishFarmingInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return HomeFishFarmingInfoOuterClass.internal_static_HomeFishFarmingInfo_descriptor;
      }
      ...
      // Construct using HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo getDefaultInstanceForType() {
        return HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo.getDefaultInstance();
      }

      @java.lang.Override
      public HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo build() {
        HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo result = buildPartial();
      ...
      @java.lang.Override
      public HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo buildPartial() {
        HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo result = new HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo) {
          return mergeFrom((HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo)other);
        } else {
      ...
      public Builder mergeFrom(HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo other) {
        if (other == HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo) e.getUnfinishedMessage();
    ...
    private static final HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo();
    }

    public static HomeFishFarmingInfoOuterClass.HomeFishFarmingInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\031HomeFishFarmingInfo.proto\"?\n\023HomeFishF" +
      "armingInfo\022\024\n\014fishpondGuid\030\004 \001(\r\022\022\n\nfish" +
      "IdList\030\006 \003(\rb\006proto3"
    };
