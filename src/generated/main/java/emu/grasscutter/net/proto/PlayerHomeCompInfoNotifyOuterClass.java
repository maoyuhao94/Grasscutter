...
public final class PlayerHomeCompInfoNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 42: {
              ...
              compInfo_ = input.readMessage(PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return PlayerHomeCompInfoNotifyOuterClass.internal_static_PlayerHomeCompInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify.class, PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify.Builder.class);
    }
    ...
    public enum KECOKOCMONG
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo getCompInfo() {
      return compInfo_ == null ? PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo.getDefaultInstance() : compInfo_;
    }
    /**
     * <code>.PlayerHomeCompInfo compInfo = 5;</code>
     */
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify)) {
        return super.equals(obj);
      }
      PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify other = (PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify) obj;
    ...
    public static PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify parseFrom(
    ...
    public static PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify parseFrom(
    ...
    public static PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return PlayerHomeCompInfoNotifyOuterClass.internal_static_PlayerHomeCompInfoNotify_descriptor;
      }
      ...
      // Construct using PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify getDefaultInstanceForType() {
        return PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify build() {
        PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify result = buildPartial();
      ...
      @java.lang.Override
      public PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify buildPartial() {
        PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify result = new PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify(this);
        if (compInfoBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify) {
          return mergeFrom((PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify other) {
        if (other == PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify) e.getUnfinishedMessage();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo, PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo.Builder, PlayerHomeCompInfoOuterClass.PlayerHomeCompInfoOrBuilder> compInfoBuilder_;
      /**
       * <code>.PlayerHomeCompInfo compInfo = 5;</code>
       * @return Whether the compInfo field is set.
       */
      ...
      public Builder setCompInfo(
          PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo.Builder builderForValue) {
        if (compInfoBuilder_ == null) {
      ...
      public Builder mergeCompInfo(PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo value) {
        if (compInfoBuilder_ == null) {
          if (compInfo_ != null) {
            compInfo_ =
              PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo.newBuilder(compInfo_).mergeFrom(value).buildPartial();
          } else {
            compInfo_ = value;
          }
          onChanged();
      ...
      public PlayerHomeCompInfoOuterClass.PlayerHomeCompInfoOrBuilder getCompInfoOrBuilder() {
        if (compInfoBuilder_ != null) {
          ...
          return compInfo_ == null ?
              PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo.getDefaultInstance() : compInfo_;
        }
      }
      /**
       * <code>.PlayerHomeCompInfo compInfo = 5;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo, PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo.Builder, PlayerHomeCompInfoOuterClass.PlayerHomeCompInfoOrBuilder> 
    ...
    private static final PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify();
    }

    public static PlayerHomeCompInfoNotifyOuterClass.PlayerHomeCompInfoNotify getDefaultInstance() {
