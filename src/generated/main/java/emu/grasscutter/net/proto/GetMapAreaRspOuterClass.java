...
public final class GetMapAreaRspOuterClass {
  ...
  public interface GetMapAreaRspOrBuilder extends
    ...
    /**
     * <code>repeated .MapAreaInfo mapAreaInfoList = 3;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return GetMapAreaRspOuterClass.internal_static_GetMapAreaRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              GetMapAreaRspOuterClass.GetMapAreaRsp.class, GetMapAreaRspOuterClass.GetMapAreaRsp.Builder.class);
    }

    /**
     * Protobuf enum {@code GetMapAreaRsp.JOGNHEGALAH}
     */
    public enum JOGNHEGALAH
       ...
       */
      public static final JOGNHEGALAH DCDNILFDFLB = NONE;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>PEPPOHPHJOJ = 3213;</code>
       */
      public static final int PEPPOHPHJOJ_VALUE = 3213;
      /**
       * <code>DCDNILFDFLB = 0;</code>
       */
      ...
      public static JOGNHEGALAH valueOf(int value) {
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static JOGNHEGALAH forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 3213: return PEPPOHPHJOJ;
          case 1: return NNBKOLMPOEA;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<JOGNHEGALAH>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          JOGNHEGALAH> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<JOGNHEGALAH>() {
              public JOGNHEGALAH findValueByNumber(int number) {
                return JOGNHEGALAH.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return GetMapAreaRspOuterClass.GetMapAreaRsp.getDescriptor().getEnumTypes().get(0);
      }

      private static final JOGNHEGALAH[] VALUES = getStaticValuesArray();
      private static JOGNHEGALAH[] getStaticValuesArray() {
        return new JOGNHEGALAH[] {
          NONE, PEPPOHPHJOJ, DCDNILFDFLB, NNBKOLMPOEA, 
        };
      }
      public static JOGNHEGALAH valueOf(
      ...
      private JOGNHEGALAH(int index, int value) {
        this.index = index;
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:GetMapAreaRsp.JOGNHEGALAH)
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof GetMapAreaRspOuterClass.GetMapAreaRsp)) {
        return super.equals(obj);
      }
      GetMapAreaRspOuterClass.GetMapAreaRsp other = (GetMapAreaRspOuterClass.GetMapAreaRsp) obj;
    ...
    public static GetMapAreaRspOuterClass.GetMapAreaRsp parseFrom(
    ...
    public static GetMapAreaRspOuterClass.GetMapAreaRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static GetMapAreaRspOuterClass.GetMapAreaRsp parseFrom(
    ...
    public static GetMapAreaRspOuterClass.GetMapAreaRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static GetMapAreaRspOuterClass.GetMapAreaRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static GetMapAreaRspOuterClass.GetMapAreaRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(GetMapAreaRspOuterClass.GetMapAreaRsp prototype) {
    ...
    public static final class Builder extends
        ...
        GetMapAreaRspOuterClass.GetMapAreaRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return GetMapAreaRspOuterClass.internal_static_GetMapAreaRsp_descriptor;
      }
      ...
      // Construct using GetMapAreaRspOuterClass.GetMapAreaRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public GetMapAreaRspOuterClass.GetMapAreaRsp getDefaultInstanceForType() {
        return GetMapAreaRspOuterClass.GetMapAreaRsp.getDefaultInstance();
      }

      @java.lang.Override
      public GetMapAreaRspOuterClass.GetMapAreaRsp build() {
        GetMapAreaRspOuterClass.GetMapAreaRsp result = buildPartial();
      ...
      @java.lang.Override
      public GetMapAreaRspOuterClass.GetMapAreaRsp buildPartial() {
        GetMapAreaRspOuterClass.GetMapAreaRsp result = new GetMapAreaRspOuterClass.GetMapAreaRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof GetMapAreaRspOuterClass.GetMapAreaRsp) {
          return mergeFrom((GetMapAreaRspOuterClass.GetMapAreaRsp)other);
        } else {
      ...
      public Builder mergeFrom(GetMapAreaRspOuterClass.GetMapAreaRsp other) {
        if (other == GetMapAreaRspOuterClass.GetMapAreaRsp.getDefaultInstance()) return this;
        if (mapAreaInfoListBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        GetMapAreaRspOuterClass.GetMapAreaRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (GetMapAreaRspOuterClass.GetMapAreaRsp) e.getUnfinishedMessage();
    ...
    private static final GetMapAreaRspOuterClass.GetMapAreaRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new GetMapAreaRspOuterClass.GetMapAreaRsp();
    }

    public static GetMapAreaRspOuterClass.GetMapAreaRsp getDefaultInstance() {
