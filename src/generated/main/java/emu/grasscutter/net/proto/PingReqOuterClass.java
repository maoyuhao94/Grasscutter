  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return PingReqOuterClass.internal_static_PingReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              PingReqOuterClass.PingReq.class, PingReqOuterClass.PingReq.Builder.class);
    }
    ...
    public enum HCOPEMHOJKP
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return PingReqOuterClass.PingReq.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof PingReqOuterClass.PingReq)) {
        return super.equals(obj);
      }
      PingReqOuterClass.PingReq other = (PingReqOuterClass.PingReq) obj;
    ...
    public static PingReqOuterClass.PingReq parseFrom(
    ...
    public static PingReqOuterClass.PingReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static PingReqOuterClass.PingReq parseFrom(
    ...
    public static PingReqOuterClass.PingReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static PingReqOuterClass.PingReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static PingReqOuterClass.PingReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(PingReqOuterClass.PingReq prototype) {
    ...
    public static final class Builder extends
        ...
        PingReqOuterClass.PingReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return PingReqOuterClass.internal_static_PingReq_descriptor;
      }
      ...
      // Construct using PingReqOuterClass.PingReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public PingReqOuterClass.PingReq getDefaultInstanceForType() {
        return PingReqOuterClass.PingReq.getDefaultInstance();
      }

      @java.lang.Override
      public PingReqOuterClass.PingReq build() {
        PingReqOuterClass.PingReq result = buildPartial();
      ...
      @java.lang.Override
      public PingReqOuterClass.PingReq buildPartial() {
        PingReqOuterClass.PingReq result = new PingReqOuterClass.PingReq(this);
        result.seq_ = seq_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof PingReqOuterClass.PingReq) {
          return mergeFrom((PingReqOuterClass.PingReq)other);
        } else {
      ...
      public Builder mergeFrom(PingReqOuterClass.PingReq other) {
        if (other == PingReqOuterClass.PingReq.getDefaultInstance()) return this;
        if (other.getSeq() != 0) {
          setSeq(other.getSeq());
        }
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        PingReqOuterClass.PingReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (PingReqOuterClass.PingReq) e.getUnfinishedMessage();
    ...
    private static final PingReqOuterClass.PingReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new PingReqOuterClass.PingReq();
    }

    public static PingReqOuterClass.PingReq getDefaultInstance() {
