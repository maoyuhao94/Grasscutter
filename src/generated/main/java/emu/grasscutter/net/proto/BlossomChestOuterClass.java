...
public final class BlossomChestOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return BlossomChestOuterClass.internal_static_BlossomChest_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return BlossomChestOuterClass.internal_static_BlossomChest_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              BlossomChestOuterClass.BlossomChest.class, BlossomChestOuterClass.BlossomChest.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof BlossomChestOuterClass.BlossomChest)) {
        return super.equals(obj);
      }
      BlossomChestOuterClass.BlossomChest other = (BlossomChestOuterClass.BlossomChest) obj;
    ...
    public static BlossomChestOuterClass.BlossomChest parseFrom(
    ...
    public static BlossomChestOuterClass.BlossomChest parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static BlossomChestOuterClass.BlossomChest parseFrom(
    ...
    public static BlossomChestOuterClass.BlossomChest parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static BlossomChestOuterClass.BlossomChest parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static BlossomChestOuterClass.BlossomChest parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(BlossomChestOuterClass.BlossomChest prototype) {
    ...
    public static final class Builder extends
        ...
        BlossomChestOuterClass.BlossomChestOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return BlossomChestOuterClass.internal_static_BlossomChest_descriptor;
      }
      ...
      // Construct using BlossomChestOuterClass.BlossomChest.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public BlossomChestOuterClass.BlossomChest getDefaultInstanceForType() {
        return BlossomChestOuterClass.BlossomChest.getDefaultInstance();
      }

      @java.lang.Override
      public BlossomChestOuterClass.BlossomChest build() {
        BlossomChestOuterClass.BlossomChest result = buildPartial();
      ...
      @java.lang.Override
      public BlossomChestOuterClass.BlossomChest buildPartial() {
        BlossomChestOuterClass.BlossomChest result = new BlossomChestOuterClass.BlossomChest(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof BlossomChestOuterClass.BlossomChest) {
          return mergeFrom((BlossomChestOuterClass.BlossomChest)other);
        } else {
      ...
      public Builder mergeFrom(BlossomChestOuterClass.BlossomChest other) {
        if (other == BlossomChestOuterClass.BlossomChest.getDefaultInstance()) return this;
        if (other.getResin() != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        BlossomChestOuterClass.BlossomChest parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (BlossomChestOuterClass.BlossomChest) e.getUnfinishedMessage();
    ...
    private static final BlossomChestOuterClass.BlossomChest DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new BlossomChestOuterClass.BlossomChest();
    }

    public static BlossomChestOuterClass.BlossomChest getDefaultInstance() {
