...
public final class AvatarEquipAffixStartNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 42: {
              AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.Builder subBuilder = null;
              if (equipAffixInfo_ != null) {
                subBuilder = equipAffixInfo_.toBuilder();
              }
              equipAffixInfo_ = input.readMessage(AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return AvatarEquipAffixStartNotifyOuterClass.internal_static_AvatarEquipAffixStartNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify.class, AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify.Builder.class);
    }
    ...
    public enum CIBOKBFGLBI
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo getEquipAffixInfo() {
      return equipAffixInfo_ == null ? AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.getDefaultInstance() : equipAffixInfo_;
    }
    /**
     * <code>.AvatarEquipAffixInfo equipAffixInfo = 5;</code>
     */
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify)) {
        return super.equals(obj);
      }
      AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify other = (AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify) obj;
    ...
    public static AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify parseFrom(
    ...
    public static AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify parseFrom(
    ...
    public static AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify prototype) {
    ...
    public static final class Builder extends
        ...
        AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return AvatarEquipAffixStartNotifyOuterClass.internal_static_AvatarEquipAffixStartNotify_descriptor;
      }
      ...
      // Construct using AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify getDefaultInstanceForType() {
        return AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify.getDefaultInstance();
      }

      @java.lang.Override
      public AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify build() {
        AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify result = buildPartial();
      ...
      @java.lang.Override
      public AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify buildPartial() {
        AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify result = new AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify(this);
        if (equipAffixInfoBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify) {
          return mergeFrom((AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify)other);
        } else {
      ...
      public Builder mergeFrom(AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify other) {
        if (other == AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify) e.getUnfinishedMessage();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo, AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.Builder, AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfoOrBuilder> equipAffixInfoBuilder_;
      /**
       * <code>.AvatarEquipAffixInfo equipAffixInfo = 5;</code>
       * @return Whether the equipAffixInfo field is set.
       */
      ...
      public Builder mergeEquipAffixInfo(AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo value) {
        if (equipAffixInfoBuilder_ == null) {
          if (equipAffixInfo_ != null) {
            equipAffixInfo_ =
              AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.newBuilder(equipAffixInfo_).mergeFrom(value).buildPartial();
          } else {
            equipAffixInfo_ = value;
          }
          onChanged();
      ...
      public AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfoOrBuilder getEquipAffixInfoOrBuilder() {
        if (equipAffixInfoBuilder_ != null) {
          ...
          return equipAffixInfo_ == null ?
              AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.getDefaultInstance() : equipAffixInfo_;
        }
      }
      /**
       * <code>.AvatarEquipAffixInfo equipAffixInfo = 5;</code>
    ...
    private static final AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify();
    }

    public static AvatarEquipAffixStartNotifyOuterClass.AvatarEquipAffixStartNotify getDefaultInstance() {
